...
// Fragment Shader
//
// id: 3774 - fxc/glsl_SM_4_0_WeightedCloth.hlsl_PS_ps30_gbuffer_no_faction_colour_40.glsl
//
...
/*93*/	r2.xyz = (-r0.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*94*/	r0.xyz = (r0.wwww * r2.xyzx + r0.xyzx).xyz;
/*95*/	r2.xyz = (r1.xyzx * r0.xyzx).xyz;
/*96*/	r2.w = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*97*/	r2.w = saturate(-r2.w * 15.000000 + 1.000000);
/*98*/	r3.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000)).xy;
/*99*/	r3.xyzw = (texture(s_fire_map, r3.xyxx.st)).xyzw;
/*100*/	r3.x = log2(r3.z);
/*101*/	r3.x = r3.x * 1.800000;
/*102*/	r3.x = exp2(r3.x);
/*103*/	r3.x = r3.x * 10.000000;
/*104*/	r3.x = min(r3.x, 1.000000);
/*105*/	r2.w = r2.w + r3.x;
/*106*/	r2.w = r2.w * 0.500000;
/*107*/	r3.x = 0;
/*108*/	r3.y = cb0.data[26].x * 0.050000;
/*109*/	r3.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000) + r3.xyxx).xy;
/*110*/	r4.xyzw = (texture(s_fire_map, r3.xyxx.st)).xyzw;
/*111*/	r3.x = saturate(r4.x * 5.000000);
/*112*/	r4.xyz = (r3.xxxx * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*113*/	r3.x = r3.z * 0.250000;
/*114*/	r4.xyz = (r4.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r3.xxxx).xyz;
/*115*/	r4.xyz = (r2.wwww * r4.xyzx + r3.xxxx).xyz;
/*116*/	r0.xyz = (-r0.xyzx * r1.xyzx + r4.xyzx).xyz;
/*117*/	r1.x = r1.w * -2.000000 + 3.000000;
/*118*/	r1.y = r1.w * r1.w;
/*119*/	r1.xy = (-r1.xxxx * r1.yyyy + vec4(1.000000, 0.975000, 0.000000, 0.000000)).xy;
/*120*/	r1.z = -r3.w + 1.000000;
/*121*/	r1.z = log2(r1.z);
/*122*/	r1.z = r1.z * r1.x;
/*123*/	r1.z = exp2(r1.z);
/*124*/	r1.z = min(r1.z, 1.000000);
/*125*/	r1.x = r1.x * r1.z;
/*126*/	r1.y = max(r1.y, 0.000000);
/*127*/	r0.xyz = (r1.xxxx * r0.xyzx + r2.xyzx).xyz;
/*128*/	r1.xzw = (r3.zzzz * vec4(0.250000, 0.000000, 0.250000, 0.250000) + -r0.xxyz).xzw;
/*129*/	r0.xyz = (r1.yyyy * r1.xzwx + r0.xyzx).xyz;
/*130*/	r1.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*131*/	r1.xyz = (-r0.xyzx + r1.xxxx).xyz;
/*132*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*133*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*134*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*135*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*136*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*137*/	r1.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*138*/	r0.xyz = (r0.wwww * r1.xyzx).xyz;
/*139*/	r0.xyz = (r0.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r1.xyzx).xyz;
/*140*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*141*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*142*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*143*/	r1.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*144*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & uint(0x3c008081u));
/*145*/	color2.xyzw = saturate(r0.xyzw);
/*146*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*147*/	r0.w = 1.000000;
/*148*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*149*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*150*/	color3.x = r1.x / r0.x;
/*151*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*152*/	color4 = floatBitsToUint(vsOut_T9.z);
/*153*/	return;
}
