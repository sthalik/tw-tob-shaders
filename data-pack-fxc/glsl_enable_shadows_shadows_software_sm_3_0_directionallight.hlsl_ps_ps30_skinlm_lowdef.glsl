...
// Fragment Shader
//
// id: 276 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_DirectionalLight.hlsl_PS_ps30_skinlm_lowdef.glsl
//
...
/*253*/	color0.xyz = saturate(r6.xxxx * r0.xyzx + r1.xyzx).xyz;
/*254*/	r0.x = uintBitsToFloat((2.000000 < r4.y) ? 0xffffffffu : 0x00000000u);
/*255*/	r0.y = saturate(-r4.y * cb3.data[4].x);
/*256*/	color0.w = (floatBitsToUint(r0.x) > 0x00000000u) ? saturate(1.000000) : saturate(r0.y);
/*257*/	return;
}
