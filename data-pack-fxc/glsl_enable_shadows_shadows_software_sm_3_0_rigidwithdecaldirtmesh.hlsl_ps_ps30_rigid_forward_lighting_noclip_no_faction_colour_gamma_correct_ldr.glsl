...
// Fragment Shader
//
// id: 4953 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecaldirtmesh.hlsl_PS_ps30_rigid_forward_lighting_noclip_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*71*/	r7.xyz = (r0.wwww * r6.xyzx + r7.xyzx).xyz;
/*72*/	r1.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*73*/	r1.w = inversesqrt(r1.w);
/*74*/	r7.xyz = (r1.wwww * r7.xyzx).xyz;
/*75*/	r0.xyz = (mix(r7.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
...
/*85*/	  r3.xy = (r3.xyxx + vec4(0.200000, 0.300000, 0.000000, 0.000000)).xy;
/*86*/	}
...
/*119*/	    r0.w = r0.w * r0.w;
/*120*/	    r0.w = r0.w * r1.w;
/*121*/	    r3.y = r0.w * -r3.y + r3.y;
/*122*/	    r1.w = -r3.x + 0.200000;
/*123*/	    r3.x = r0.w * r1.w + r3.x;
...
/*152*/	  }
/*153*/	}
/*154*/	r0.w = vsOut_T7.y * -r3.x + r3.x;
/*155*/	r3.xzw = (r1.xxyz * vec4(5.000000, 0.000000, 5.000000, 5.000000) + vec4(0.200000, 0.000000, 0.200000, 0.200000)).xzw;
/*156*/	r3.xzw = (-r1.xxyz + r3.xxzw).xzw;
/*157*/	r1.xyz = saturate(vsOut_T7.yyyy * r3.xzwx + r1.xyzx).xyz;
/*158*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*159*/	r3.xzw = (-r1.xxyz + r1.wwww).xzw;
/*160*/	r1.xyz = (vsOut_T7.zzzz * r3.xzwx + r1.xyzx).xyz;
/*161*/	r1.w = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*162*/	r3.xzw = (-r2.xxyz + r1.wwww).xzw;
/*163*/	r2.xyz = (vsOut_T7.zzzz * r3.xzwx + r2.xyzx).xyz;
...
/*171*/	r3.xzw = (r2.wwww * r4.xxyz).xzw;
/*172*/	r2.w = -r3.y + 1.000000;
/*173*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*174*/	r5.y = dot(vec3(r3.xzwx), vec3(r0.xyzx));
/*175*/	r5.y = r5.y + r5.y;
/*176*/	r5.yzw = (r0.xxyz * -r5.yyyy + r3.xxzw).yzw;
...
/*202*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.xzwx));
...
/*231*/	  r0.z = r3.y * r3.y;
/*232*/	    r3.y = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*233*/	  r0.z = r0.z * r3.y + r6.x;
/*234*/	  r0.z = r0.z * 0.500000 + 0.500000;
/*235*/	  r0.z = r0.z * 2.000000 + -1.000000;
/*236*/	  r3.y = -r0.z * r0.z + 1.000000;
/*237*/	  r3.y = max(r3.y, 0.001000);
/*238*/	  r3.y = log2(r3.y);
/*239*/	  r5.x = r3.y * 4.950617;
/*240*/	  r3.y = r3.y * 0.346574 + 4.546885;
...
/*280*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.xzwx));
