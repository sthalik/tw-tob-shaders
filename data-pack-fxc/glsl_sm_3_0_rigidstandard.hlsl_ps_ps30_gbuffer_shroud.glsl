...
// Fragment Shader
//
// id: 654 - fxc/glsl_SM_3_0_rigidstandard.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*103*/	    r4.w = cb2.data[1].x * cb2.data[1].x;
/*104*/	    r4.w = r4.w * 1.250000;
/*105*/	    r4.w = min(r4.w, 1.000000);
/*106*/	    r5.w = saturate(cb2.data[1].x * cb2.data[1].x + -0.800000);
...
/*130*/	    r4.w = dot(vec2(cb2.data[0].xyxx), vec2(cb2.data[0].xyxx));
/*131*/	    r4.w = sqrt(r4.w);
...
/*146*/	  }
/*147*/	}
/*148*/	r0.w = uintBitsToFloat((0.500000 < cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*149*/	if(floatBitsToUint(r0.w) != 0u) {
/*150*/	  r4.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*151*/	  r5.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*152*/	  r4.xyzw = r4.xyzw / r5.xyzw;
/*153*/	  r5.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*154*/	  r4.xyzw = r4.xyzw * r5.xyzw + cb1.data[4].xyxy;
/*155*/	  r5.xyzw = (textureLod(s_shroud, r4.zwzz.st, r4.w)).xyzw;
/*156*/	  r4.xyzw = r4.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*157*/	  r4.xyzw = saturate(r4.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*158*/	  r6.xyzw = r4.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*159*/	  r4.xyzw = r4.xyzw * r4.xyzw;
/*160*/	  r4.xyzw = r4.xyzw * r6.xyzw;
/*161*/	  r0.w = r5.x * r4.x;
/*162*/	  r0.w = r0.w * r4.y;
/*163*/	  r0.w = r4.z * -r0.w + r0.w;
/*164*/	  r0.w = r4.w * -r0.w + r0.w;
/*165*/	} else {
/*166*/	  r0.w = 1.000000;
/*167*/	}
/*168*/	r4.xy = (r0.wwww + vec4(-0.100000, -0.500000, 0.000000, 0.000000)).xy;
/*169*/	r0.w = saturate(r4.x * 2.500000);
/*170*/	r4.x = r0.w * -2.000000 + 3.000000;
/*171*/	r0.w = r0.w * r0.w;
/*172*/	r0.w = r0.w * r4.x;
/*173*/	r4.x = saturate(r4.y + r4.y);
/*174*/	r4.y = r4.x * -2.000000 + 3.000000;
/*175*/	r4.x = r4.x * r4.x;
/*176*/	r4.x = r4.x * r4.y;
/*177*/	r0.w = r0.w * 0.200000;
/*178*/	r4.yzw = saturate(r0.wwww * r0.xxyz).yzw;
/*179*/	r0.xyz = (r0.xyzx + -r4.yzwy).xyz;
/*180*/	r0.xyz = (r4.xxxx * r0.xyzx + r4.yzwy).xyz;
/*181*/	r0.w = vsOut_T7.y * -r1.x + r1.x;
/*182*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*183*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*184*/	r0.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*185*/	r4.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*186*/	r4.xyz = (-r0.xyzx + r4.xxxx).xyz;
/*187*/	r0.xyz = (vsOut_T7.zzzz * r4.xyzx + r0.xyzx).xyz;
/*188*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*189*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*190*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*191*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*192*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*193*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*194*/	r2.x = inversesqrt(r2.x);
/*195*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*196*/	color3.x = r2.w / r3.w;
/*197*/	r2.w = max(abs(r2.z), abs(r2.y));
/*198*/	r2.w = max(r2.w, abs(r2.x));
/*199*/	r2.xyz = (r2.xyzx / r2.wwww).xyz;
/*200*/	r1.xyz = (r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*201*/	color0.xyzw = saturate(r1.xyzw);
/*202*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*203*/	r4.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*204*/	color2.xyzw = saturate(r4.xyzw);
/*205*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*206*/	color4 = vsOut_P1;
/*207*/	return;
}
