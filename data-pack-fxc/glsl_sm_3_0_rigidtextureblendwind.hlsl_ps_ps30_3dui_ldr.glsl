...
// Fragment Shader
//
// id: 1329 - fxc/glsl_SM_3_0_rigidtextureblendwind.hlsl_PS_ps30_3dui_LDR.glsl
//
...
/*0*/	r0.x = cb1.data[26].x + cb4.data[8].x;
...
/*47*/	r2.xy = (cb4.data[0].zwzz * r2.xyxx + cb4.data[0].xyxx).xy;
/*48*/	r2.zw = (cb4.data[1].zzzw * r2.zzzw + cb4.data[1].xxxy).zw;
...
/*53*/	r0.w = -cb5.data[11].w + 1.000000;
/*54*/	r0.w = max(r2.w, r0.w);
/*55*/	r3.xyzw = -cb5.data[12].xyzw + vec4(1.000000, 1.000000, 1.000000, 1.000000);
...
/*64*/	r5.xy = (cb4.data[2].zwzz * r5.xyxx + cb4.data[2].xyxx).xy;
/*65*/	r5.zw = (cb4.data[3].zzzw * r5.zzzw + cb4.data[3].xxxy).zw;
...
/*80*/	r6.xy = (cb4.data[4].zwzz * r6.xyxx + cb4.data[4].xyxx).xy;
/*81*/	r6.zw = (cb4.data[5].zzzw * r6.zzzw + cb4.data[5].xxxy).zw;
...
/*87*/	r0.w = r0.w * r3.x;
/*88*/	r3.xyz = (-cb5.data[13].xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
...
/*101*/	r9.xy = (cb4.data[6].zwzz * r9.xyxx + cb4.data[6].xyxx).xy;
/*102*/	r9.zw = (cb4.data[7].zzzw * r9.zzzw + cb4.data[7].xxxy).zw;
...
/*113*/	r2.xyz = (r2.xyzx * cb5.data[4].xyzx).xyz;
/*114*/	color0.w = r2.w * vsOut_T2.w;
/*115*/	r3.xyz = (r4.xyzx * cb5.data[5].xyzx).xyz;
/*116*/	r0.w = max(r4.w, cb5.data[12].x);
/*117*/	r1.w = -cb5.data[0].w + 1.000000;
/*118*/	r4.xyzw = uintBitsToFloat(uvec4(equal(cb5.data[14].xyzw, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu);
...
/*122*/	r1.w = r1.w * cb5.data[0].z;
/*123*/	r2.w = r0.w * r1.w;
/*124*/	r0.w = -r1.w * r0.w + 1.000000;
/*125*/	r3.xyz = (r2.wwww * r3.xyzx).xyz;
/*126*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*127*/	r3.xyz = (r5.xyzx * cb5.data[6].xyzx).xyz;
/*128*/	r0.w = max(r5.w, cb5.data[12].y);
/*129*/	r5.xy = (-cb5.data[1].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*132*/	r4.xy = (r4.xyxx * cb5.data[1].xzxx).xy;
/*133*/	r1.w = r0.w * r4.x;
/*134*/	r0.w = -r4.x * r0.w + 1.000000;
/*135*/	r3.xyz = (r1.wwww * r3.xyzx).xyz;
/*136*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*137*/	r3.xyz = (r7.xyzx * cb5.data[7].xyzx).xyz;
/*138*/	r0.w = max(r7.w, cb5.data[12].z);
/*139*/	r1.w = r0.w * r4.y;
/*140*/	r0.w = -r4.y * r0.w + 1.000000;
/*141*/	r3.xyz = (r1.wwww * r3.xyzx).xyz;
/*142*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*143*/	r3.xyz = (r6.xyzx * cb5.data[8].xyzx).xyz;
/*144*/	r0.w = max(r6.w, cb5.data[12].w);
/*145*/	r4.xy = (-cb5.data[2].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
/*146*/	r1.w = uintBitsToFloat((r4.w >= r4.x) ? 0xffffffffu : 0x00000000u);
/*147*/	r1.w = uintBitsToFloat(floatBitsToUint(r1.w) & uint(0x3f800000u));
/*148*/	r1.w = r1.w * cb5.data[2].x;
/*149*/	r2.w = r0.w * r1.w;
/*150*/	r0.w = -r1.w * r0.w + 1.000000;
/*151*/	r3.xyz = (r2.wwww * r3.xyzx).xyz;
/*152*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*153*/	r3.xyz = (r8.xyzx * cb5.data[9].xyzx).xyz;
/*154*/	r0.w = max(r8.w, cb5.data[13].x);
/*155*/	r4.xzw = (uintBitsToFloat(uvec4(equal(cb5.data[15].xxyz, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xzw;
...
/*159*/	r1.w = r1.w * cb5.data[2].z;
/*160*/	r2.w = r0.w * r1.w;
/*161*/	r0.w = -r1.w * r0.w + 1.000000;
/*162*/	r3.xyz = (r2.wwww * r3.xyzx).xyz;
/*163*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*164*/	r3.xyz = (r9.xyzx * cb5.data[10].xyzx).xyz;
/*165*/	r0.w = max(r9.w, cb5.data[13].y);
/*166*/	r4.xy = (-cb5.data[3].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*169*/	r4.xy = (r4.xyxx * cb5.data[3].xzxx).xy;
/*170*/	r1.w = r0.w * r4.x;
/*171*/	r0.w = -r4.x * r0.w + 1.000000;
/*172*/	r3.xyz = (r1.wwww * r3.xyzx).xyz;
/*173*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*174*/	r3.xyz = (r10.xyzx * cb5.data[11].xyzx).xyz;
/*175*/	r0.w = max(r10.w, cb5.data[13].z);
/*176*/	r1.w = r0.w * r4.y;
...
/*206*/	r0.w = saturate(dot(vec3(r0.xyzx), vec3(-cb5.data[16].xyzx)));
...
/*211*/	r1.xyz = (r1.xyzx * r1.wwww + -cb5.data[16].xyzx).xyz;
...
/*262*/	r1.w = max(cb3.data[2].z, 0.001000);
...
/*273*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*274*/	return;
}
