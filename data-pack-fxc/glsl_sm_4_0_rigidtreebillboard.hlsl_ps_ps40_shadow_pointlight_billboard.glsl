...
// Fragment Shader
//
// id: 1355 - fxc/glsl_SM_4_0_rigidtreebillboard.hlsl_PS_ps40_shadow_pointlight_billboard.glsl
//
...
/*0*/	r0.xw = (gsOut_T0.xxxy).xw;
/*1*/	r0.yz = (vec4(0, 0, 0.250000, 0)).yz;
/*2*/	r1.w = 0;
/*3*/	r1.xyz = (gsOut_T0.xyzx * vec4(10.000000, 10.000000, 0.250000, 0.000000)).xyz;
/*4*/	r0.xy = (r0.xyxx + r1.zwzz).xy;
/*5*/	r1.zw = (r1.zzzw + gsOut_T0.xxxy).zw;
...
/*10*/	r0.x = -r0.w + r3.w;
/*11*/	r0.x = gsOut_T1.y * r0.x + r0.w;
/*12*/	r3.xyzw = (texture(s_diffuse_burn_map, r1.zwzz.st)).xyzw;
/*13*/	r1.xyzw = (texture(s_diffuse_map_tree, r1.zwzz.st)).xyzw;
/*14*/	r0.y = -r1.w + r3.w;
/*15*/	r0.y = gsOut_T1.y * r0.y + r1.w;
/*16*/	r0.x = -r0.y + r0.x;
/*17*/	r0.z = uintBitsToFloat((r2.x < gsOut_T0.w) ? 0xffffffffu : 0x00000000u);
/*18*/	r0.w = r2.x + -gsOut_T1.x;
...
/*25*/	color0.x = gl_FragCoord.z / gl_FragCoord.w;
/*26*/	color0.yzw = (vec4(0, 0, 0, 1.000000)).yzw;
/*27*/	return;
}
