...
// Fragment Shader
//
// id: 1535 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_particle_vfx_main.hlsl_PS_ps_main.glsl
//
...
/*222*/	    r5.x = uintBitsToFloat((0.000000 < r3.y) ? 0xffffffffu : 0x00000000u);
/*223*/	    r3.y = uintBitsToFloat((r3.y < 0.000000) ? 0xffffffffu : 0x00000000u);
/*224*/	    r3.y = intBitsToFloat(1 + ~floatBitsToInt(r5.x) + floatBitsToInt(r3.y));
...
/*240*/	    r5.xyzw = r3.zzww * vec4(0.140012, 0.140012, 0.140012, 0.140012) + vec4(1.273239, 1.000000, 1.273239, 1.000000);
/*241*/	    r5.xy = (r5.xzxx / r5.ywyy).xy;
/*242*/	    r3.zw = (-r3.zzzw * r5.xxxy).zw;
/*243*/	    r5.xy = (uintBitsToFloat(uvec4(lessThan(vec4(0.000000, 0.000000, 0.000000, 0.000000), r3.xyxx)) * 0xffffffffu)).xy;
/*244*/	    r3.x = uintBitsToFloat((r3.x < 0.000000) ? 0xffffffffu : 0x00000000u);
/*245*/	    r3.x = intBitsToFloat(1 + ~floatBitsToInt(r5.x) + floatBitsToInt(r3.x));
...
/*253*/	    r3.y = 1 + ~floatBitsToInt(r5.y);
...
/*282*/	  r5.xyzw = (textureLod(s_environment, r2.xyzx.stp, r0.w)).xyzw;
...
/*297*/	  r0.yzw = (r0.yyyy * r5.xxyz).yzw;
