...
// Vertex Shader
//
// id: 119 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_sprite.hlsl_VS_highlight_circumference_vertex.glsl
//
...
/*18*/	r0.x = uintBitsToFloat((cb1.data[0].x >= -cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*19*/	r0.x = (floatBitsToUint(r0.x) > 0x00000000u) ? 1.000000 : -1.000000;
/*20*/	r0.y = r0.x * cb1.data[0].x;
/*21*/	r0.y = fract(r0.y);
/*22*/	vsOut_T3.x = r0.y * r0.x;
/*23*/	vsOut_T3.yzw = (vsIn_T2.yyzw).yzw;
/*24*/	vsOut_T4.xyzw = vsIn_T3.xyzw * cb1.data[1].xyxy + cb1.data[1].zwzw;
/*25*/	vsOut_T5.z = vsIn_P0.w;
/*26*/	return;
}
