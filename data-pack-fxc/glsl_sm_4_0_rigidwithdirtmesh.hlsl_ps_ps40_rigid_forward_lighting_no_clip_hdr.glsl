...
// Fragment Shader
//
// id: 1200 - fxc/glsl_SM_4_0_rigidwithdirtmesh.hlsl_PS_ps40_rigid_forward_lighting_no_clip_HDR.glsl
//
...
/*38*/	r3.zw = (vsOut_T1.xxxy * cb3.data[2].xxxy + vsOut_T6.yyyz).zw;
...
/*172*/	r5.w = saturate(r0.z * 60.000000);
/*173*/	r5.w = -r0.z + r5.w;
...
/*187*/	r6.xzw = (r0.xxyw * r6.xxzw).xzw;
/*188*/	r5.y = -r0.z + 1.000000;
...
/*286*/	r0.xyw = (r0.xyxw * r7.xxxx).xyw;
/*287*/	r0.xyw = (r0.xyxw * cb1.data[1].xyxz).xyw;
/*288*/	r0.xyw = (r3.xyxz * r0.xyxw).xyw;
/*289*/	r0.xyw = (r5.xxxx * r0.xyxw).xyw;
/*290*/	r0.xyw = (r4.xyxz * cb1.data[1].xyxz + r0.xyxw).xyw;
/*291*/	r0.xyw = (r0.xyxw + r6.xzxw).xyw;
...
/*304*/	r1.x = exp2(r1.x);
/*305*/	r1.x = r4.w * r1.x;
/*306*/	r0.z = r1.x * r5.w + r0.z;
/*307*/	r1.xyz = (r6.xyzx * r0.zzzz).xyz;
/*308*/	color0.xyz = (r1.xyzx * r2.xyzx + r0.xywx).xyz;
