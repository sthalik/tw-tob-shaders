...
// Fragment Shader
//
// id: 1958 - fxc/glsl_SM_3_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_skin.glsl
//
...
/*69*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*70*/	color1.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
/*71*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*72*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*73*/	r0.w = 1.000000;
/*74*/	r1.w = dot(r0.xyzw, cb0.data[11].xyzw);
/*75*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*76*/	color3.x = r1.w / r0.x;
/*77*/	r0.x = max(abs(r1.z), abs(r1.y));
/*78*/	r0.x = max(r0.x, abs(r1.x));
/*79*/	r0.xyz = (r1.xyzx / r0.xxxx).xyz;
/*80*/	color0.xyz = saturate(r0.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*81*/	color0.w = saturate(r2.y);
/*82*/	color2.xyzw = r3.xyzz;
/*83*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*84*/	color4 = floatBitsToUint(vsOut_T9.z);
/*85*/	return;
}
