// Flat Varyings: 6 7 10

//
// Shader Model 4
// Vertex Shader
//
// id: 793 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_rigidterrainblend.hlsl_VS_vs30_main.glsl
//
...
/*43*/	r0.x = intBitsToFloat(gl_InstanceID + floatBitsToInt(cb2.data[4].w));
