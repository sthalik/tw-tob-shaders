...
// Fragment Shader
//
// id: 6051 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdecal.hlsl_PS_ps30_imposter_skin_40.glsl
//
...
/*29*/	r0.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*30*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*31*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*32*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*33*/	color0.w = 1.000000;
/*34*/	return;
}
