...
// Fragment Shader
//
// id: 4947 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecaldirtmesh.hlsl_PS_ps30_rigid_forward_lighting_gamma_correct_LDR.glsl
//
...
/*144*/	    r1.w = -r3.x + 0.200000;
/*145*/	    r3.x = r0.z * r1.w + r3.x;
...
/*193*/	r3.xzw = (r2.wwww * r4.xxyz).xzw;
/*194*/	r2.w = -r3.y + 1.000000;
/*195*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*196*/	r5.y = dot(vec3(r3.xzwx), vec3(r1.xyzx));
/*197*/	r5.y = r5.y + r5.y;
/*198*/	r5.yzw = (r1.xxyz * -r5.yyyy + r3.xxzw).yzw;
...
/*224*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.xzwx));
...
/*253*/	  r1.z = r3.y * r3.y;
/*254*/	    r3.y = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*255*/	  r1.z = r1.z * r3.y + r6.x;
/*256*/	  r1.z = r1.z * 0.500000 + 0.500000;
/*257*/	  r1.z = r1.z * 2.000000 + -1.000000;
/*258*/	  r3.y = -r1.z * r1.z + 1.000000;
/*259*/	  r3.y = max(r3.y, 0.001000);
/*260*/	  r3.y = log2(r3.y);
/*261*/	  r5.x = r3.y * 4.950617;
...
/*302*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.xzwx));
