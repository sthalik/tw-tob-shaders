...
// Fragment Shader
//
// id: 1822 - fxc/glsl_SM_4_0_weighted.hlsl_PS_ps30_gbuffer_skin_40.glsl
//
...
/*41*/	r0.w = -vsOut_T4.z + 1.000000;
/*42*/	r1.xyz = (vsOut_T4.zzzz * cb1.data[3].xyzx).xyz;
/*43*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
...
/*49*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*50*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*51*/	color2.xyzw = r0.xyzz;
/*52*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*53*/	r0.w = 1.000000;
/*54*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*55*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*56*/	color3.x = r1.x / r0.x;
/*57*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*58*/	color4 = floatBitsToUint(vsOut_T9.z);
/*59*/	return;
}
