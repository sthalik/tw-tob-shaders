...
// Fragment Shader
//
// id: 1711 - fxc/glsl_SM_4_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_40.glsl
//
...
/*67*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*73*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
...
/*87*/	r4.w = 1.000000;
/*88*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*89*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*90*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*91*/	color3.x = r0.w / r2.w;
/*92*/	r0.w = max(abs(r2.z), abs(r2.y));
/*93*/	r0.w = max(r0.w, abs(r2.x));
/*94*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*95*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*96*/	color0.w = saturate(r3.y);
/*97*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*98*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*99*/	color2.xyzw = saturate(r1.xyzw);
