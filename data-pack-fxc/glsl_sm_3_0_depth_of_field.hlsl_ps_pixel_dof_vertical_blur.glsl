...
// Fragment Shader
//
// id: 1521 - fxc/glsl_SM_3_0_depth_of_field.hlsl_PS_pixel_dof_vertical_blur.glsl
//
...
/*0*/	r0.xz = (vec4(0, 0, 0, 0)).xz;
/*1*/	r1.xyzw = vec4(-14.000000, -12.000000, -13.000000, -11.000000) / cb0.data[27].yyyy;
/*2*/	r0.yw = (r1.xxxz).yw;
...
/*26*/	r1.xz = (vec4(0, 0, 0, 0)).xz;
/*27*/	r3.xyzw = vec4(-10.000000, -8.000000, -9.000000, -7.000000) / cb0.data[27].yyyy;
/*28*/	r1.yw = (r3.xxxz).yw;
...
/*52*/	r1.xz = (vec4(0, 0, 0, 0)).xz;
/*53*/	r3.xyzw = vec4(-6.000000, -4.000000, -5.000000, -3.000000) / cb0.data[27].yyyy;
/*54*/	r1.yw = (r3.xxxz).yw;
...
/*78*/	r1.xz = (vec4(0, 0, 0, 0)).xz;
/*79*/	r3.xyzw = vec4(-2.000000, 3.000000, -1.000000, 2.000000) / cb0.data[27].yyyy;
/*80*/	r1.yw = (r3.xxxz).yw;
...
/*97*/	r4.y = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(cb0.data[27].y)).y;
/*98*/	r4.xz = (vec4(0, 0, 0, 0)).xz;
...
/*116*/	r7.xyzw = vec4(4.000000, 7.000000, 5.000000, 6.000000) / cb0.data[27].yyyy;
/*117*/	r3.w = r7.x;
...
/*123*/	r8.yw = (r7.zzzw).yw;
/*124*/	r8.xz = (vec4(0, 0, 0, 0)).xz;
...
/*140*/	r11.xyzw = vec4(8.000000, 11.000000, 9.000000, 10.000000) / cb0.data[27].yyyy;
/*141*/	r7.w = r11.x;
...
/*147*/	r12.yw = (r11.zzzw).yw;
/*148*/	r12.xz = (vec4(0, 0, 0, 0)).xz;
...
/*164*/	r14.xyz = (vec4(12.000000, 13.000000, 14.000000, 0.000000) / cb0.data[27].yyyy).xyz;
/*165*/	r14.w = 0;
/*166*/	r15.xyzw = r2.xyxy * cb0.data[27].zwzw + r14.wxwy;
/*167*/	r2.xy = (r2.xyxx * cb0.data[27].zwzz + r14.wzww).xy;
