...
// Fragment Shader
//
// id: 5792 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdecal.hlsl_PS_ps30_imposter_40.glsl
//
...
/*42*/	r2.yzw = (-r0.xxyz + r0.wwww).yzw;
/*43*/	r0.xyz = (vsOut_T7.yyyy * r2.yzwy + r0.xyzx).xyz;
/*44*/	r0.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*45*/	r2.yzw = (-r1.xxyz + r0.wwww).yzw;
/*46*/	r1.xyz = (vsOut_T7.yyyy * r2.yzwy + r1.xyzx).xyz;
/*47*/	r0.w = vsOut_T7.y * -r2.x + r2.x;
/*48*/	r0.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*49*/	r2.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*50*/	r2.xyz = (-r0.xyzx + r2.xyzx).xyz;
/*51*/	r0.xyz = saturate(vsOut_T7.xxxx * r2.xyzx + r0.xyzx).xyz;
/*52*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*53*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
