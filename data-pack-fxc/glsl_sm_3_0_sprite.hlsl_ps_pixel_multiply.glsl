...
// Fragment Shader
//
// id: 185 - fxc/glsl_SM_3_0_sprite.hlsl_PS_pixel_multiply.glsl
//
...
/*34*/	r0.xyz = (exp2(r0.xyzx)).xyz;
/*35*/	r0.xyz = (r0.xyzx + vec4(-1.000000, -1.000000, -1.000000, 0.000000)).xyz;
/*36*/	color0.xyz = (r0.wwww * r0.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*37*/	color0.w = r0.w;
/*38*/	return;
}
