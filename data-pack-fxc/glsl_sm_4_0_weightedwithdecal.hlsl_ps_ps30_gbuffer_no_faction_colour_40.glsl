...
// Fragment Shader
//
// id: 1723 - fxc/glsl_SM_4_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_no_faction_colour_40.glsl
//
...
/*49*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*55*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
...
/*65*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*66*/	r0.w = inversesqrt(r0.w);
/*67*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*68*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*69*/	r4.w = 1.000000;
/*70*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*71*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*72*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*73*/	color3.x = r0.w / r2.w;
/*74*/	r0.w = max(abs(r2.z), abs(r2.y));
/*75*/	r0.w = max(r0.w, abs(r2.x));
/*76*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*77*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*78*/	color0.w = saturate(r3.y);
/*79*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*80*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*81*/	color2.xyzw = saturate(r1.xyzw);
