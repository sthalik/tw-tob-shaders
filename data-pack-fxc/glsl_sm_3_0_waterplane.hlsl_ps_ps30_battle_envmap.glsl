...
// Fragment Shader
//
// id: 6640 - fxc/glsl_SM_3_0_waterplane.hlsl_PS_ps30_battle_envmap.glsl
//
...
/*2*/	r0.xy = (r0.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + r0.zzzz).xy;
...
/*7*/	r1.xy = (r1.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + r0.zzzz).xy;
...
/*15*/	r0.w = max(abs(r0.z), abs(r0.y));
/*16*/	r0.w = max(r0.w, abs(r0.x));
/*17*/	r1.xyz = (r0.xyzx / r0.wwww).xyz;
/*18*/	r0.xyzw = (texture(s_environment, r0.xyzx.stp)).xyzw;
/*19*/	color3.xyz = (r0.xyzx * vec4(0.150000, 0.150000, 0.150000, 0.000000) + cb1.data[9].xyzx).xyz;
/*20*/	color0.xyz = saturate(r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*21*/	color0.w = 0.120000;
/*22*/	color1.xyzw = vec4(0, 0, 0, 0.100000);
/*23*/	color2.xyzw = vec4(1.000000, 1.000000, 1.000000, 0.015686);
/*24*/	color3.w = 1.000000;
/*25*/	return;
}
