...
// Fragment Shader
//
// id: 1889 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_skin_40.glsl
//
...
/*52*/	r0.w = -vsOut_T4.z + 1.000000;
/*53*/	r1.xyz = (vsOut_T4.zzzz * cb2.data[3].xyzx).xyz;
/*54*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
...
/*59*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*60*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*61*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*62*/	color2.xyzw = r0.xyzz;
