...
// Fragment Shader
//
// id: 6280 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithburn.hlsl_PS_ps30_skin_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*12*/	r1.zw = (vsOut_T1.xxxy * vec4(0.000000, 0.000000, 1.200000, 1.500000)).zw;
/*13*/	r3.x = r1.z;
/*14*/	r3.y = cb1.data[26].x * 0.050000 + r1.w;
/*15*/	r3.xyzw = (texture(s_fire_map, r3.xyxx.st)).xyzw;
/*16*/	r4.xyzw = (texture(s_fire_map, r1.zwzz.st)).xyzw;
/*17*/	r1.z = saturate(r3.x * 5.000000);
/*18*/	r3.xyz = (r1.zzzz * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*19*/	r1.z = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*20*/	r1.z = saturate(-r1.z * 15.000000 + 1.000000);
/*21*/	r1.w = log2(r4.z);
/*22*/	r1.w = r1.w * 1.800000;
/*23*/	r1.w = exp2(r1.w);
/*24*/	r1.w = r1.w * 10.000000;
/*25*/	r1.w = min(r1.w, 1.000000);
/*26*/	r1.z = r1.w + r1.z;
/*27*/	r1.z = r1.z * 0.500000;
/*28*/	r1.w = -r4.w + 1.000000;
/*29*/	r1.w = log2(r1.w);
/*30*/	r1.w = r1.w * vsOut_T7.z;
/*31*/	r1.w = exp2(r1.w);
/*32*/	r1.w = min(r1.w, 1.000000);
/*33*/	r1.w = r1.w * vsOut_T7.z;
/*34*/	r2.z = r4.z * 0.250000;
/*35*/	r3.xyz = (r3.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r2.zzzz).xyz;
/*36*/	r3.xyz = (r1.zzzz * r3.xyzx + r2.zzzz).xyz;
/*37*/	r3.xyz = (-r0.xyzx + r3.xyzx).xyz;
/*38*/	r0.xyz = (r1.wwww * r3.xyzx + r0.xyzx).xyz;
/*39*/	r1.z = vsOut_T7.z + -0.025000;
/*40*/	r1.z = max(r1.z, 0.000000);
/*41*/	r3.xyz = (r4.zzzz * vec4(0.250000, 0.250000, 0.250000, 0.000000) + -r0.xyzx).xyz;
/*42*/	r0.xyz = (r1.zzzz * r3.xyzx + r0.xyzx).xyz;
/*43*/	r1.z = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*44*/	r1.z = inversesqrt(r1.z);
/*45*/	r3.xyz = (r1.zzzz * vsOut_T3.xyzx).xyz;
/*46*/	r1.z = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*47*/	r1.z = inversesqrt(r1.z);
/*48*/	r4.xyz = (r1.zzzz * vsOut_T5.xyzx).xyz;
/*49*/	r1.z = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*50*/	r1.z = inversesqrt(r1.z);
/*51*/	r5.xyz = (r1.zzzz * vsOut_T2.xyzx).xyz;
/*52*/	r1.yzw = (r1.yyyy * r4.xxyz).yzw;
/*53*/	r1.xyz = (r1.xxxx * r3.xyzx + r1.yzwy).xyz;
/*54*/	r1.xyz = (r0.wwww * r5.xyzx + r1.xyzx).xyz;
