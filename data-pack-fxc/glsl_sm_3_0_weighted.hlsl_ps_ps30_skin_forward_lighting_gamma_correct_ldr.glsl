...
// Fragment Shader
//
// id: 1864 - fxc/glsl_SM_3_0_weighted.hlsl_PS_ps30_skin_forward_lighting_gamma_correct_LDR.glsl
//
...
/*25*/	r1.xyz = (vsOut_T4.zzzz * cb4.data[3].xyzx).xyz;
...
/*56*/	r0.w = dot(vec3(r2.xyzx), vec3(-cb2.data[0].yzwy));
...
/*73*/	r3.xyz = (r3.xyzx * cb2.data[1].xyzx).xyz;
/*74*/	r0.w = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
...
/*79*/	r0.w = r0.w + r0.w;
/*80*/	r6.xyz = (r2.xyzx * -r0.wwww + cb2.data[0].yzwy).xyz;
/*81*/	r0.w = r1.w * r1.w;
/*82*/	r7.xyz = (vsOut_T0.xyzx + -cb1.data[0].xyzx).xyz;
/*83*/	r1.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*84*/	r2.w = inversesqrt(r1.w);
/*85*/	r1.w = sqrt(r1.w);
/*86*/	r8.xyz = (r2.wwww * r7.xyzx).xyz;
/*87*/	r2.w = saturate(dot(vec3(r8.xyzx), vec3(-cb2.data[0].yzwy)));
/*88*/	r2.w = r2.w * r2.w;
/*89*/	r2.w = r2.w * r2.w;
/*90*/	r0.w = r0.w * r2.w;
/*91*/	r0.w = r4.z * r0.w;
/*92*/	r4.yzw = (r4.yyyy * cb2.data[1].xxyz).yzw;
/*93*/	r4.yzw = (r4.yyzw * vec4(0.000000, -0.300000, -1.000000, -1.000000) + cb2.data[1].xxyz).yzw;
...
/*120*/	r0.w = r5.w * r0.w;
/*121*/	r4.xyz = (r2.xyzx * -r2.wwww + -r8.xyzx).xyz;
...
/*124*/	r2.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*125*/	r2.w = inversesqrt(r2.w);
/*126*/	r4.xyz = (r2.wwww * r4.xyzx).xyz;
...
/*129*/	r8.xyz = (mix(cb2.data[2].xyzx, cb2.data[3].xyzx, greaterThan(floatBitsToUint(r6.xxxx), uvec4(0)))).xyz/**/;
/*130*/	r6.xyw = (mix(cb2.data[4].xyxz, cb2.data[5].xyxz, greaterThan(floatBitsToUint(r6.yyyy), uvec4(0)))).xyw/**/;
/*131*/	r9.xyz = (mix(cb2.data[6].xyzx, cb2.data[7].xyzx, greaterThan(floatBitsToUint(r6.zzzz), uvec4(0)))).xyz/**/;
/*132*/	r6.xyz = (r4.yyyy * r6.xywx).xyz;
/*133*/	r4.xyw = (r4.xxxx * r8.xyxz + r6.xyxz).xyw;
/*134*/	r4.xyz = (r4.zzzz * r9.xyzx + r4.xywx).xyz;
...
/*146*/	r6.xyz = (mix(cb2.data[2].xyzx, cb2.data[3].xyzx, greaterThan(floatBitsToUint(r4.xxxx), uvec4(0)))).xyz/**/;
/*147*/	r4.xyw = (mix(cb2.data[4].xyxz, cb2.data[5].xyxz, greaterThan(floatBitsToUint(r4.yyyy), uvec4(0)))).xyw/**/;
/*148*/	r8.xyz = (mix(cb2.data[6].xyzx, cb2.data[7].xyzx, greaterThan(floatBitsToUint(r4.zzzz), uvec4(0)))).xyz/**/;
...
/*156*/	r0.xyz = (r3.xyzx + r0.xyzx).xyz;
/*157*/	r7.w = max(r7.y, 0.000000);
/*158*/	r2.xyzw = (texture(s_sky, r7.xwzx.stp)).xyzw;
/*159*/	r0.w = dot(vec2(r7.xzxx), vec2(r7.xzxx));
/*160*/	r0.w = sqrt(r0.w);
/*161*/	r1.xyz = (cb2.data[1].xyzx * cb3.data[0].xyzx).xyz;
/*162*/	r1.xyz = (r1.xyzx * vec4(1.500000, 1.500000, 1.500000, 0.000000)).xyz;
/*163*/	r1.xyz = (r1.xyzx * abs(cb2.data[0].zzzz)).xyz;
/*164*/	r2.xyz = (-r1.xyzx * r5.xxxx + r2.xyzx).xyz;
/*165*/	r1.xyz = (r5.xxxx * r1.xyzx).xyz;
/*166*/	r2.w = saturate(cb3.data[1].x)/**/;
/*167*/	r2.w = -r2.w + 1.000000;
/*168*/	r2.w = r2.w * 1000.000000;
/*169*/	r1.w = r1.w / r2.w;
/*170*/	r2.w = saturate(cb3.data[0].w)/**/;
/*171*/	r2.w = -r2.w + 1.000000;
/*172*/	r2.w = r2.w * 8.000000 + -4.000000;
/*173*/	r1.w = r1.w + r2.w;
/*174*/	r1.w = r1.w * 1.442695;
/*175*/	r1.w = exp2(r1.w);
/*176*/	r1.w = cb3.data[1].y / r1.w;
/*177*/	r1.w = saturate(-r1.w + cb3.data[1].y);
/*178*/	r2.w = -vsOut_T0.y + cb3.data[1].w;
/*179*/	r2.w = r2.w + -cb3.data[1].z;
/*180*/	r3.x = -cb3.data[1].z + cb3.data[1].w;
/*181*/	r3.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r3.x)).x;
/*182*/	r2.w = saturate(r2.w * r3.x);
/*183*/	r3.x = r2.w * -2.000000 + 3.000000;
/*184*/	r2.w = r2.w * r2.w;
/*185*/	r2.w = r2.w * r3.x;
/*186*/	r1.w = cb3.data[2].x * r2.w + r1.w;
/*187*/	r2.w = saturate(dot(vec2(r1.wwww), vec2(cb3.data[2].yyyy)));
/*188*/	r1.xyz = (r2.wwww * r2.xyzx + r1.xyzx).xyz;
/*189*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*190*/	r2.x = max(cb3.data[2].z, 0.001000);
/*191*/	r2.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r2.x)).x;
/*192*/	r0.w = r0.w * r2.x;
/*193*/	r0.w = min(r0.w, 1.000000);
/*194*/	r2.x = r0.w * -2.000000 + 3.000000;
/*195*/	r0.w = r0.w * r0.w;
/*196*/	r0.w = r0.w * r2.x;
/*197*/	r0.w = saturate(r1.w * r0.w);
/*198*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*199*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*200*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*201*/	r0.xyz = (exp2(r0.xyzx)).xyz;
/*202*/	color0.xyz = (min(r0.xyzx, vec4(1.000000, 1.000000, 1.000000, 0.000000))).xyz;
