...
// Fragment Shader
//
// id: 2201 - fxc/glsl_SM_4_0_weightedwithburn.hlsl_PS_ps30_gbuffer_skin_no_faction_colour_slm_40.glsl
//
...
/*70*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
...
/*75*/	color2.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*76*/	color2.w = 0;
/*77*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*78*/	r0.w = 1.000000;
/*79*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*80*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*81*/	color3.x = r1.x / r0.x;
