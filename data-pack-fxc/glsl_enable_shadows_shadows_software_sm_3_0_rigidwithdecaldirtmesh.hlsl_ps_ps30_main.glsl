...
// Fragment Shader
//
// id: 4908 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecaldirtmesh.hlsl_PS_ps30_main.glsl
//
...
/*83*/	r7.xyz = (r3.zzzz * r6.xyzx + r7.xyzx).xyz;
/*84*/	r1.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*85*/	r1.w = inversesqrt(r1.w);
/*86*/	r7.xyz = (r1.wwww * r7.xyzx).xyz;
/*87*/	r3.xyz = (mix(r7.xyzx, r3.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
...
/*97*/	  r2.xy = (r2.xyxx + vec4(0.200000, 0.300000, 0.000000, 0.000000)).xy;
/*98*/	}
...
/*131*/	    r0.w = r0.w * r0.w;
/*132*/	    r0.w = r0.w * r1.w;
/*133*/	    r2.y = r0.w * -r2.y + r2.y;
/*134*/	    r1.w = -r2.x + 0.200000;
/*135*/	    r2.x = r0.w * r1.w + r2.x;
...
/*164*/	  }
/*165*/	}
/*166*/	r0.w = vsOut_T7.y * -r2.x + r2.x;
/*167*/	r2.xzw = (r0.xxyz * vec4(5.000000, 0.000000, 5.000000, 5.000000) + vec4(0.200000, 0.000000, 0.200000, 0.200000)).xzw;
/*168*/	r2.xzw = (-r0.xxyz + r2.xxzw).xzw;
/*169*/	r0.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
/*170*/	r1.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*171*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*172*/	r0.xyz = (vsOut_T7.zzzz * r2.xzwx + r0.xyzx).xyz;
/*173*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*174*/	r2.xzw = (-r1.xxyz + r1.wwww).xzw;
/*175*/	r1.xyz = (vsOut_T7.zzzz * r2.xzwx + r1.xyzx).xyz;
/*176*/	r0.w = vsOut_T7.z * -r0.w + r0.w;
/*177*/	r1.w = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*178*/	r1.w = inversesqrt(r1.w);
/*179*/	r2.xzw = (r1.wwww * r3.xxyz).xzw;
...
/*184*/	r4.w = -r2.y + 1.000000;
/*185*/	r5.x = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*186*/	r5.y = dot(vec3(r4.xyzx), vec3(r2.xzwx));
/*187*/	r5.y = r5.y + r5.y;
/*188*/	r5.yzw = (r2.xxzw * -r5.yyyy + r4.xxyz).yzw;
...
/*195*/	r7.x = -r0.w + r7.x;
/*196*/	r7.yzw = (r2.xxzw * vec4(0.000000, 1.000000, 4.000000, 1.000000)).yzw;
...
/*225*/	}
/*226*/	r2.x = dot(vec3(r2.xzwx), vec3(-cb1.data[0].yzwy));
/*227*/	r2.z = max(r2.x, 0.000000);
/*228*/	r2.x = uintBitsToFloat((0.000000 < r2.x) ? 0xffffffffu : 0x00000000u);
/*229*/	if(floatBitsToUint(r2.x) != 0u) {
/*230*/	  r2.x = dot(vec3(-cb1.data[0].yzwy), vec3(r5.yzwy));
/*231*/	  r2.x = max(r2.x, -1.000000);
/*232*/	  r2.x = min(r2.x, 1.000000);
/*233*/	  r2.w = -abs(r2.x) + 1.000000;
/*234*/	  r2.w = sqrt(r2.w);
/*235*/	  r5.y = abs(r2.x) * -0.018729 + 0.074261;
/*236*/	  r5.y = r5.y * abs(r2.x) + -0.212114;
/*237*/	  r5.y = r5.y * abs(r2.x) + 1.570729;
/*238*/	  r5.z = r2.w * r5.y;
/*239*/	  r5.z = r5.z * -2.000000 + 3.141593;
/*240*/	  r2.x = uintBitsToFloat((r2.x < -r2.x) ? 0xffffffffu : 0x00000000u);
/*241*/	  r2.x = uintBitsToFloat(floatBitsToUint(r2.x) & floatBitsToUint(r5.z));
/*242*/	  r2.x = r5.y * r2.w + r2.x;
/*243*/	  r2.y = r2.y * r2.y;
/*244*/	    r2.w = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*245*/	  r2.y = r2.y * r2.w + r6.x;
/*246*/	  r2.y = r2.y * 0.500000 + 0.500000;
/*247*/	  r2.y = r2.y * 2.000000 + -1.000000;
/*248*/	  r2.w = -r2.y * r2.y + 1.000000;
/*249*/	  r2.w = max(r2.w, 0.001000);
/*250*/	  r2.w = log2(r2.w);
/*251*/	  r5.x = r2.w * 4.950617;
/*252*/	  r2.w = r2.w * 0.346574 + 4.546885;
/*253*/	  r5.y = uintBitsToFloat((0.000000 < r2.y) ? 0xffffffffu : 0x00000000u);
/*254*/	  r2.y = uintBitsToFloat((r2.y < 0.000000) ? 0xffffffffu : 0x00000000u);
/*255*/	  r2.y = intBitsToFloat(1 + ~floatBitsToInt(r5.y) + floatBitsToInt(r2.y));
/*256*/	  r2.y = floatBitsToInt(r2.y);
...
/*261*/	  r2.w = sqrt(r2.w);
/*262*/	  r2.y = r2.w * r2.y;
/*263*/	  r2.y = r2.y * 1.414214;
/*264*/	  r2.y = 0.008727 / r2.y;
/*265*/	  r2.y = max(r2.y, 0.000100);
/*266*/	  r2.xw = (r2.xxxx + vec4(-0.008727, 0.000000, 0.000000, 0.008727)).xw;
/*267*/	  r2.y = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r2.y)).y;
/*268*/	  r2.xy = (r2.yyyy * r2.xwxx).xy;
