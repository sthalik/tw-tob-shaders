...
// Fragment Shader
//
// id: 1314 - fxc/glsl_SM_3_0_rigidtextureblend.hlsl_PS_ps30_3dui_constant_HDR.glsl
//
...
/*5*/	r0.zw = (cb5.data[0].zzzw * vsOut_C0.xxxy + cb5.data[0].xxxy).zw;
...
/*8*/	r0.x = -cb6.data[11].w + 1.000000;
/*9*/	r0.x = max(r1.w, r0.x);
/*10*/	r0.zw = (cb5.data[1].zzzw * vsOut_C0.zzzw + cb5.data[1].xxxy).zw;
...
/*13*/	r3.xyzw = -cb6.data[12].xyzw + vec4(1.000000, 1.000000, 1.000000, 1.000000);
...
/*21*/	r4.xy = (cb5.data[2].zwzz * vsOut_C1.xyxx + cb5.data[2].xyxx).xy;
...
/*25*/	r0.x = r0.y * r0.x;
/*26*/	r0.yw = (cb5.data[3].zzzw * vsOut_C1.zzzw + cb5.data[3].xxxy).yw;
...
/*36*/	r3.xy = (cb5.data[4].zwzz * vsOut_C2.xyxx + cb5.data[4].xyxx).xy;
...
/*40*/	r0.x = r0.y * r0.x;
/*41*/	r0.yw = (cb5.data[5].zzzw * vsOut_C2.zzzw + cb5.data[5].xxxy).yw;
...
/*44*/	r0.yzw = (-cb6.data[13].xxyz + vec4(0.000000, 1.000000, 1.000000, 1.000000)).yzw;
...
/*52*/	r7.zw = (cb5.data[6].zzzw * vsOut_C3.xxxy + cb5.data[6].xxxy).zw;
...
/*56*/	r0.x = r0.y * r0.x;
/*57*/	r0.yz = (cb5.data[7].zzwz * vsOut_C3.zzwz + cb5.data[7].xxyx).yz;
...
/*64*/	r0.xyz = (r1.xyzx * cb6.data[4].xyzx).xyz;
/*65*/	color0.w = r1.w * vsOut_T2.w;
/*66*/	r1.xyz = (r2.xyzx * cb6.data[5].xyzx).xyz;
/*67*/	r0.w = max(r2.w, cb6.data[12].x);
/*68*/	r1.w = -cb6.data[0].w + 1.000000;
/*69*/	r2.xyzw = uintBitsToFloat(uvec4(equal(cb6.data[14].xyzw, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu);
...
/*73*/	r1.w = r1.w * cb6.data[0].z;
/*74*/	r2.x = r0.w * r1.w;
/*75*/	r0.w = -r1.w * r0.w + 1.000000;
/*76*/	r1.xyz = (r1.xyzx * r2.xxxx).xyz;
/*77*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*78*/	r1.xyz = (r4.xyzx * cb6.data[6].xyzx).xyz;
/*79*/	r0.w = max(r4.w, cb6.data[12].y);
/*80*/	r4.xy = (-cb6.data[1].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*83*/	r2.xy = (r2.xyxx * cb6.data[1].xzxx).xy;
/*84*/	r1.w = r0.w * r2.x;
/*85*/	r0.w = -r2.x * r0.w + 1.000000;
/*86*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*87*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*88*/	r1.xyz = (r5.xyzx * cb6.data[7].xyzx).xyz;
/*89*/	r0.w = max(r5.w, cb6.data[12].z);
/*90*/	r1.w = r0.w * r2.y;
/*91*/	r0.w = -r2.y * r0.w + 1.000000;
/*92*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*93*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*94*/	r1.xyz = (r6.xyzx * cb6.data[8].xyzx).xyz;
/*95*/	r0.w = max(r6.w, cb6.data[12].w);
/*96*/	r2.xy = (-cb6.data[2].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
/*97*/	r1.w = uintBitsToFloat((r2.w >= r2.x) ? 0xffffffffu : 0x00000000u);
/*98*/	r1.w = uintBitsToFloat(floatBitsToUint(r1.w) & uint(0x3f800000u));
/*99*/	r1.w = r1.w * cb6.data[2].x;
/*100*/	r2.x = r0.w * r1.w;
/*101*/	r0.w = -r1.w * r0.w + 1.000000;
/*102*/	r1.xyz = (r1.xyzx * r2.xxxx).xyz;
/*103*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*104*/	r1.xyz = (r3.xyzx * cb6.data[9].xyzx).xyz;
/*105*/	r0.w = max(r3.w, cb6.data[13].x);
/*106*/	r2.xzw = (uintBitsToFloat(uvec4(equal(cb6.data[15].xxyz, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xzw;
...
/*110*/	r1.w = r1.w * cb6.data[2].z;
/*111*/	r2.x = r0.w * r1.w;
/*112*/	r0.w = -r1.w * r0.w + 1.000000;
/*113*/	r1.xyz = (r1.xyzx * r2.xxxx).xyz;
/*114*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*115*/	r1.xyz = (r8.xyzx * cb6.data[10].xyzx).xyz;
/*116*/	r0.w = max(r8.w, cb6.data[13].y);
/*117*/	r2.xy = (-cb6.data[3].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*120*/	r2.xy = (r2.xyxx * cb6.data[3].xzxx).xy;
/*121*/	r1.w = r0.w * r2.x;
/*122*/	r0.w = -r2.x * r0.w + 1.000000;
/*123*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*124*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*125*/	r1.xyz = (r7.xyzx * cb6.data[11].xyzx).xyz;
/*126*/	r0.w = max(r7.w, cb6.data[13].z);
/*127*/	r1.w = r0.w * r2.y;
...
/*164*/	r2.xyz = (r2.xyzx * r0.wwww + -cb6.data[16].xyzx).xyz;
...
/*169*/	r1.x = saturate(dot(vec3(r1.xyzx), vec3(-cb6.data[16].xyzx)));
...
/*220*/	r1.w = r1.w + -cb4.data[0].x;
/*221*/	r3.x = -cb4.data[0].x + cb4.data[0].y;
/*222*/	r1.w = r1.w / r3.x;
/*223*/	r1.w = r1.w + -1.000000;
/*224*/	r1.w = saturate(r1.w * 1.176471);
/*225*/	r1.xyz = (r1.wwww * r2.yzwy + r1.xyzx).xyz;
/*226*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*227*/	r2.y = max(r1.w, cb4.data[0].x);
/*228*/	r2.y = min(r2.y, cb4.data[0].y);
/*229*/	r2.y = r2.y + -cb4.data[0].x;
/*230*/	r2.y = r2.y / r3.x;
/*231*/	r2.z = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*232*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*233*/	r1.w = (floatBitsToUint(r2.z) > 0x00000000u) ? r1.w : 1.000000;
/*234*/	r1.w = r1.w * r2.y;
/*235*/	r1.xyz = saturate(r1.wwww * r1.xyzx).xyz;
/*236*/	r1.w = 0.500000;
/*237*/	r3.xyzw = (texture(g_scurve_texture_sampler, r1.xwxx.st)).xyzw;
/*238*/	r4.xyzw = (texture(g_scurve_texture_sampler, r1.ywyy.st)).xyzw;
/*239*/	r1.xyzw = (texture(g_scurve_texture_sampler, r1.zwzz.st)).xyzw;
/*240*/	r3.z = r1.z;
/*241*/	r3.y = r4.y;
/*242*/	r1.xyz = (-r0.xyzx + r3.xyzx).xyz;
/*243*/	r1.w = max(cb3.data[2].z, 0.001000);
/*244*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*245*/	r1.w = r1.w * r2.x;
/*246*/	r1.w = min(r1.w, 1.000000);
/*247*/	r2.x = r1.w * -2.000000 + 3.000000;
/*248*/	r1.w = r1.w * r1.w;
/*249*/	r1.w = r1.w * r2.x;
/*250*/	r0.w = saturate(r0.w * r1.w);
/*251*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*252*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*253*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*254*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*255*/	return;
}
