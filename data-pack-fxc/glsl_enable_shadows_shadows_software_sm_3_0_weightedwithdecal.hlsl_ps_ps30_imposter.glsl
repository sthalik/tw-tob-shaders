...
// Fragment Shader
//
// id: 5794 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecal.hlsl_PS_ps30_imposter.glsl
//
...
/*41*/	r2.yzw = (-r0.xxyz + r0.wwww).yzw;
/*42*/	r0.xyz = (vsOut_T7.yyyy * r2.yzwy + r0.xyzx).xyz;
/*43*/	r0.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*44*/	r2.yzw = (-r1.xxyz + r0.wwww).yzw;
/*45*/	r1.xyz = (vsOut_T7.yyyy * r2.yzwy + r1.xyzx).xyz;
/*46*/	r0.w = vsOut_T7.y * -r2.x + r2.x;
/*47*/	r0.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*48*/	r2.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*49*/	r2.xyz = (-r0.xyzx + r2.xyzx).xyz;
/*50*/	r0.xyz = saturate(vsOut_T7.xxxx * r2.xyzx + r0.xyzx).xyz;
/*51*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*52*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*53*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*54*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*55*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*56*/	color0.w = 1.000000;
/*57*/	return;
}
