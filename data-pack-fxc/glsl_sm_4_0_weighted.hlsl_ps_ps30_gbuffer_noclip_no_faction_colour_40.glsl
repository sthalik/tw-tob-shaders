...
// Fragment Shader
//
// id: 1598 - fxc/glsl_SM_4_0_weighted.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour_40.glsl
//
...
/*33*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
...
/*41*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*42*/	r1.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*43*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & uint(0x3c008081u));
/*44*/	color2.xyzw = saturate(r0.xyzw);
/*45*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*46*/	r0.w = 1.000000;
/*47*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*48*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*49*/	color3.x = r1.x / r0.x;
/*50*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*51*/	color4 = floatBitsToUint(vsOut_T9.z);
/*52*/	return;
}
