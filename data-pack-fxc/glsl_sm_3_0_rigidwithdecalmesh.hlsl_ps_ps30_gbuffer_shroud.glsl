...
// Fragment Shader
//
// id: 1072 - fxc/glsl_SM_3_0_rigidwithdecalmesh.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*98*/	r0.w = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*111*/	  r0.w = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*131*/	    r4.w = cb2.data[1].x * cb2.data[1].x;
/*132*/	    r4.w = r4.w * 1.250000;
/*133*/	    r4.w = min(r4.w, 1.000000);
/*134*/	    r5.w = saturate(cb2.data[1].x * cb2.data[1].x + -0.800000);
...
/*158*/	    r4.w = dot(vec2(cb2.data[0].xyxx), vec2(cb2.data[0].xyxx));
/*159*/	    r4.w = sqrt(r4.w);
...
/*174*/	  }
/*175*/	}
/*176*/	r0.w = uintBitsToFloat((0.500000 < cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*177*/	if(floatBitsToUint(r0.w) != 0u) {
/*178*/	  r4.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*179*/	  r5.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*180*/	  r4.xyzw = r4.xyzw / r5.xyzw;
/*181*/	  r5.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*182*/	  r4.xyzw = r4.xyzw * r5.xyzw + cb1.data[4].xyxy;
/*183*/	  r5.xyzw = (textureLod(s_shroud, r4.zwzz.st, r4.w)).xyzw;
/*184*/	  r4.xyzw = r4.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*185*/	  r4.xyzw = saturate(r4.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*186*/	  r6.xyzw = r4.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*187*/	  r4.xyzw = r4.xyzw * r4.xyzw;
/*188*/	  r4.xyzw = r4.xyzw * r6.xyzw;
/*189*/	  r0.w = r5.x * r4.x;
/*190*/	  r0.w = r0.w * r4.y;
/*191*/	  r0.w = r4.z * -r0.w + r0.w;
/*192*/	  r0.w = r4.w * -r0.w + r0.w;
/*193*/	} else {
/*194*/	  r0.w = 1.000000;
/*195*/	}
/*196*/	r4.xy = (r0.wwww + vec4(-0.100000, -0.500000, 0.000000, 0.000000)).xy;
/*197*/	r0.w = saturate(r4.x * 2.500000);
/*198*/	r4.x = r0.w * -2.000000 + 3.000000;
/*199*/	r0.w = r0.w * r0.w;
/*200*/	r0.w = r0.w * r4.x;
/*201*/	r4.x = saturate(r4.y + r4.y);
/*202*/	r4.y = r4.x * -2.000000 + 3.000000;
/*203*/	r4.x = r4.x * r4.x;
/*204*/	r4.x = r4.x * r4.y;
/*205*/	r0.w = r0.w * 0.200000;
/*206*/	r4.yzw = saturate(r0.wwww * r0.xxyz).yzw;
/*207*/	r0.xyz = (r0.xyzx + -r4.yzwy).xyz;
/*208*/	r0.xyz = (r4.xxxx * r0.xyzx + r4.yzwy).xyz;
/*209*/	r0.w = vsOut_T7.y * -r1.x + r1.x;
/*210*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*211*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*212*/	r0.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*213*/	r4.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*214*/	r4.xyz = (-r0.xyzx + r4.xxxx).xyz;
/*215*/	r0.xyz = (vsOut_T7.zzzz * r4.xyzx + r0.xyzx).xyz;
/*216*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*217*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*218*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*219*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*220*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*221*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*222*/	r2.x = inversesqrt(r2.x);
/*223*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*224*/	color3.x = r2.w / r3.w;
/*225*/	r2.w = max(abs(r2.z), abs(r2.y));
/*226*/	r2.w = max(r2.w, abs(r2.x));
/*227*/	r2.xyz = (r2.xyzx / r2.wwww).xyz;
/*228*/	r1.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*229*/	color0.xyzw = saturate(r1.xzwy);
/*230*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*231*/	r4.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*232*/	color2.xyzw = saturate(r4.xyzw);
/*233*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*234*/	color4 = vsOut_P1;
/*235*/	return;
}
