...
// Vertex Shader
//
// id: 345 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_LenseFlare.hlsl_VS_vs30_flare_1.glsl
//
...
/*19*/	r0.y = r0.x * 0.600000 + 0.400000;
/*20*/	r0.x = r0.x * cb1.data[1].x;
/*21*/	vsOut_C0.xyz = (r0.xxxx * vec4(2.500000, 2.500000, 2.500000, 0.000000)).xyz;
