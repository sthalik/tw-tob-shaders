...
// Fragment Shader
//
// id: 1665 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_no_faction_colour_40.glsl
//
...
/*58*/	r1.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*59*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & uint(0x3c008081u));
/*60*/	color2.xyzw = saturate(r0.xyzw);
/*61*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*62*/	r0.w = 1.000000;
/*63*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*64*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*65*/	color3.x = r1.x / r0.x;
/*66*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*67*/	color4 = floatBitsToUint(vsOut_T9.z);
/*68*/	return;
}
