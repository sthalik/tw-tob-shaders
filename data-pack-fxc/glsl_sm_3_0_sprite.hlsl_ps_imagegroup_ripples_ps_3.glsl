...
// Fragment Shader
//
// id: 170 - fxc/glsl_SM_3_0_sprite.hlsl_PS_imagegroup_ripples_ps_3.glsl
//
...
/*49*/	r0.y = -abs(vsOut_T3.z) + abs(vsOut_T3.w);
/*50*/	r0.y = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r0.y)).y;
/*51*/	r0.z = -abs(vsOut_T3.z) + cb1.data[0].y;
/*52*/	r0.y = saturate(r0.y * r0.z);
/*53*/	r0.z = r0.y * -2.000000 + 3.000000;
/*54*/	r0.y = r0.y * r0.y;
/*55*/	r0.w = r0.y * r0.z;
/*56*/	r0.y = -r0.z * r0.y + 1.000000;
/*57*/	r0.z = uintBitsToFloat((vsOut_T3.z < 0.000000) ? 0xffffffffu : 0x00000000u);
/*58*/	r0.y = (floatBitsToUint(r0.z) > 0x00000000u) ? r0.y : r0.w;
/*59*/	r0.z = r0.y * 0.090000 + 0.010000;
/*60*/	r0.w = r0.z * r0.x;
/*61*/	r0.w = uintBitsToFloat((r0.w >= -r0.w) ? 0xffffffffu : 0x00000000u);
/*62*/	r0.w = (floatBitsToUint(r0.w) > 0x00000000u) ? r0.z : -r0.z;
/*63*/	r1.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r0.w)).x;
/*64*/	r0.x = r0.x * r1.x;
/*65*/	r0.x = fract(r0.x);
/*66*/	r0.x = r0.x * r0.w;
/*67*/	r0.x = r0.x / r0.z;
/*68*/	r0.x = r0.x * 6.283185;
/*69*/	r0.x = sin(-r0.x);
/*70*/	r0.x = r0.x + 1.000000;
/*71*/	r0.z = -r0.x + 1.000000;
/*72*/	r0.x = r0.y * r0.z + r0.x;
/*73*/	r0.x = r0.x * r1.w;
/*74*/	color0.w = r0.y * r0.x;
/*75*/	return;
}
