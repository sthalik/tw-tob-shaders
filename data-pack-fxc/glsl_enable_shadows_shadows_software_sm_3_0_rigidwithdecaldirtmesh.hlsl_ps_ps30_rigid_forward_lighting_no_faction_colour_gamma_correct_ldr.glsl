...
// Fragment Shader
//
// id: 4951 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecaldirtmesh.hlsl_PS_ps30_rigid_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*126*/	    r1.w = -r3.x + 0.200000;
/*127*/	    r3.x = r0.w * r1.w + r3.x;
...
/*175*/	r3.xzw = (r2.wwww * r4.xxyz).xzw;
/*176*/	r2.w = -r3.y + 1.000000;
/*177*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*178*/	r5.y = dot(vec3(r3.xzwx), vec3(r0.xyzx));
/*179*/	r5.y = r5.y + r5.y;
/*180*/	r5.yzw = (r0.xxyz * -r5.yyyy + r3.xxzw).yzw;
...
/*206*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.xzwx));
...
/*235*/	  r0.z = r3.y * r3.y;
/*236*/	    r3.y = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*237*/	  r0.z = r0.z * r3.y + r6.x;
/*238*/	  r0.z = r0.z * 0.500000 + 0.500000;
/*239*/	  r0.z = r0.z * 2.000000 + -1.000000;
/*240*/	  r3.y = -r0.z * r0.z + 1.000000;
/*241*/	  r3.y = max(r3.y, 0.001000);
/*242*/	  r3.y = log2(r3.y);
/*243*/	  r5.x = r3.y * 4.950617;
...
/*284*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.xzwx));
