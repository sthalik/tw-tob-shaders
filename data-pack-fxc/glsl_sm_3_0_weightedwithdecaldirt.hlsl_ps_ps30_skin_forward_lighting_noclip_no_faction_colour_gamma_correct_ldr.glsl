...
// Fragment Shader
//
// id: 2071 - fxc/glsl_SM_3_0_weightedwithdecaldirt.hlsl_PS_ps30_skin_forward_lighting_noclip_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*71*/	r2.x = dot(vec3(r5.xyzx), vec3(r5.xyzx));
/*72*/	r2.z = inversesqrt(r2.x);
...
/*138*/	r2.y = r1.w + r1.w;
/*139*/	r3.xyz = (r3.xyzx * -r2.yyyy + -r6.xyzx).xyz;
/*140*/	r3.xyz = (r3.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*141*/	r2.y = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*142*/	r2.y = inversesqrt(r2.y);
/*143*/	r3.xyz = (r2.yyyy * r3.xyzx).xyz;
