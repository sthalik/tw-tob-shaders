...
// Fragment Shader
//
// id: 2027 - fxc/glsl_SM_4_0_weightedwithdecaldirt.hlsl_PS_ps30_gbuffer_skin_noclip_40.glsl
//
...
/*44*/	r2.zw = (vsOut_T1.xxxy * cb1.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*69*/	r3.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*70*/	r0.w = -vsOut_T4.z + 1.000000;
/*71*/	r4.xyz = (vsOut_T4.zzzz * cb2.data[3].xyzx).xyz;
/*72*/	r0.xyz = (r0.xyzx * r0.wwww + r4.xyzx).xyz;
...
/*78*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*79*/	color1.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
...
/*89*/	color0.xyz = saturate(r0.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*90*/	color0.w = saturate(r2.y);
