...
// Fragment Shader
//
// id: 67 - fxc/glsl_SM_3_0_sprite.hlsl_PS_pixel_sv.glsl
//
...
/*10*/	r0.x = -vsOut_T0.x * r0.x + 1.000000;
/*11*/	r1.y = r0.x * vsOut_T0.y;
/*12*/	r0.x = -vsOut_T0.x * r0.z + 1.000000;
...
/*27*/	r0.w = uintBitsToFloat((vsOut_T0.x == 0.000000) ? 0xffffffffu : 0x00000000u);
/*28*/	color0.xyz = (mix(r0.xyzx, vsOut_T0.yyyy, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
