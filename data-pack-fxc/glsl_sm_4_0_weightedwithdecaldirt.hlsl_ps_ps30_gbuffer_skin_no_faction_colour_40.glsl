...
// Fragment Shader
//
// id: 2035 - fxc/glsl_SM_4_0_weightedwithdecaldirt.hlsl_PS_ps30_gbuffer_skin_no_faction_colour_40.glsl
//
...
/*40*/	r2.zw = (vsOut_T1.xxxy * cb1.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*71*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*72*/	color1.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
/*73*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*74*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*75*/	r0.w = 1.000000;
/*76*/	r1.w = dot(r0.xyzw, cb0.data[11].xyzw);
/*77*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*78*/	color3.x = r1.w / r0.x;
/*79*/	r0.x = max(abs(r1.z), abs(r1.y));
/*80*/	r0.x = max(r0.x, abs(r1.x));
/*81*/	r0.xyz = (r1.xyzx / r0.xxxx).xyz;
/*82*/	color0.xyz = saturate(r0.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*83*/	color0.w = saturate(r2.y);
/*84*/	color2.xyzw = r3.xyzz;
