...
// Fragment Shader
//
// id: 1826 - fxc/glsl_SM_4_0_weighted.hlsl_PS_ps30_gbuffer_skin_noclip_40.glsl
//
...
/*38*/	r0.w = -vsOut_T4.z + 1.000000;
/*39*/	r1.xyz = (vsOut_T4.zzzz * cb1.data[3].xyzx).xyz;
/*40*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*41*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*42*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*43*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*44*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*45*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*46*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*47*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*48*/	color2.xyzw = r0.xyzz;
/*49*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*50*/	r0.w = 1.000000;
/*51*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*52*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*53*/	color3.x = r1.x / r0.x;
/*54*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*55*/	color4 = floatBitsToUint(vsOut_T9.z);
/*56*/	return;
}
