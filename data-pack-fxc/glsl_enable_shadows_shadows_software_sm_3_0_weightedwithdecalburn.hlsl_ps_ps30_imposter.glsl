...
// Fragment Shader
//
// id: 6984 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecalburn.hlsl_PS_ps30_imposter.glsl
//
...
/*39*/	}
/*40*/	r2.yz = (vsOut_T1.xxyx * vec4(0.000000, 1.200000, 1.500000, 0.000000)).yz;
/*41*/	r3.x = r2.y;
/*42*/	r3.y = cb1.data[26].x * 0.050000 + r2.z;
/*43*/	r3.xyzw = (texture(s_fire_map, r3.xyxx.st)).xyzw;
/*44*/	r4.xyzw = (texture(s_fire_map, r2.yzyy.st)).xyzw;
/*45*/	r0.w = saturate(r3.x * 5.000000);
/*46*/	r2.yzw = (r0.wwww * vec4(0.000000, 0.530000, 0.070000, -0.120000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*47*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*48*/	r0.w = saturate(-r0.w * 15.000000 + 1.000000);
/*49*/	r1.w = log2(r4.z);
...
/*54*/	r0.w = r0.w + r1.w;
/*55*/	r0.w = r0.w * 0.500000;
/*56*/	r1.w = -r4.w + 1.000000;
/*57*/	r1.w = log2(r1.w);
/*58*/	r1.w = r1.w * vsOut_T7.z;
/*59*/	r1.w = exp2(r1.w);
/*60*/	r1.w = min(r1.w, 1.000000);
/*61*/	r1.w = r1.w * vsOut_T7.z;
/*62*/	r3.x = r4.z * 0.250000;
/*63*/	r2.yzw = (r2.yyzw * vec4(0.000000, 2.000000, 2.000000, 2.000000) + -r3.xxxx).yzw;
/*64*/	r2.yzw = (r0.wwww * r2.yyzw + r3.xxxx).yzw;
/*65*/	r2.yzw = (-r0.xxyz + r2.yyzw).yzw;
/*66*/	r0.xyz = (r1.wwww * r2.yzwy + r0.xyzx).xyz;
/*67*/	r0.w = vsOut_T7.z + -0.025000;
/*68*/	r0.w = max(r0.w, 0.000000);
/*69*/	r2.yzw = (r4.zzzz * vec4(0.000000, 0.250000, 0.250000, 0.250000) + -r0.xxyz).yzw;
/*70*/	r0.xyz = (r0.wwww * r2.yzwy + r0.xyzx).xyz;
/*71*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*72*/	r2.yzw = (-r0.xxyz + r0.wwww).yzw;
/*73*/	r0.xyz = (vsOut_T7.yyyy * r2.yzwy + r0.xyzx).xyz;
/*74*/	r0.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*75*/	r2.yzw = (-r1.xxyz + r0.wwww).yzw;
/*76*/	r1.xyz = (vsOut_T7.yyyy * r2.yzwy + r1.xyzx).xyz;
/*77*/	r0.w = vsOut_T7.y * -r2.x + r2.x;
/*78*/	r0.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*79*/	r2.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*80*/	r2.xyz = (-r0.xyzx + r2.xyzx).xyz;
/*81*/	r0.xyz = saturate(vsOut_T7.xxxx * r2.xyzx + r0.xyzx).xyz;
/*82*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*83*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*84*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*85*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*86*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*87*/	color0.w = 1.000000;
/*88*/	return;
}
