...
// Fragment Shader
//
// id: 1176 - fxc/glsl_SM_3_0_rigidwithdirtmesh.hlsl_PS_ps30_gbuffer_alpha_test.glsl
//
...
/*83*/	r0.w = uintBitsToFloat((floatBitsToInt(cb1.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*96*/	  r0.w = uintBitsToFloat((0.000000 < cb1.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*116*/	    r4.w = cb1.data[1].x * cb1.data[1].x;
/*117*/	    r4.w = r4.w * 1.250000;
/*118*/	    r4.w = min(r4.w, 1.000000);
/*119*/	    r5.w = saturate(cb1.data[1].x * cb1.data[1].x + -0.800000);
...
/*143*/	    r4.w = dot(vec2(cb1.data[0].xyxx), vec2(cb1.data[0].xyxx));
/*144*/	    r4.w = sqrt(r4.w);
...
/*159*/	  }
/*160*/	}
/*161*/	r0.w = vsOut_T7.y * -r1.x + r1.x;
/*162*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*163*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*164*/	r0.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*165*/	r4.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*166*/	r4.xyz = (-r0.xyzx + r4.xxxx).xyz;
/*167*/	r0.xyz = (vsOut_T7.zzzz * r4.xyzx + r0.xyzx).xyz;
/*168*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*169*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*170*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*171*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*172*/	r0.w = uintBitsToFloat((cb2.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*173*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*174*/	r2.x = inversesqrt(r2.x);
/*175*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*176*/	color3.x = r2.w / r3.w;
/*177*/	r2.w = max(abs(r2.z), abs(r2.y));
/*178*/	r2.w = max(r2.w, abs(r2.x));
/*179*/	r2.xyz = (r2.xyzx / r2.wwww).xyz;
/*180*/	r1.xyz = (r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*181*/	color0.xyzw = saturate(r1.xyzw);
/*182*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*183*/	r4.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*184*/	color2.xyzw = saturate(r4.xyzw);
/*185*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*186*/	color4 = vsOut_P1;
/*187*/	return;
}
