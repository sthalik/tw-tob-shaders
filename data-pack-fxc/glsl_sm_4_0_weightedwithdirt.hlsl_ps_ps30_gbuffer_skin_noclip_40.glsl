...
// Fragment Shader
//
// id: 1893 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_skin_noclip_40.glsl
//
...
/*49*/	r0.w = -vsOut_T4.z + 1.000000;
/*50*/	r1.xyz = (vsOut_T4.zzzz * cb2.data[3].xyzx).xyz;
/*51*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
...
/*57*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*58*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*59*/	color2.xyzw = r0.xyzz;
...
/*66*/	color4 = floatBitsToUint(vsOut_T9.z);
/*67*/	return;
}
