...
// Fragment Shader
//
// id: 1966 - fxc/glsl_SM_3_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour.glsl
//
...
/*56*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*57*/	color1.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
...
/*67*/	color0.xyz = saturate(r0.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*68*/	color0.w = saturate(r2.y);
