...
// Fragment Shader
//
// id: 5344 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdirtburnmesh.hlsl_PS_ps30_rigid_forward_lighting_gamma_correct_LDR.glsl
//
...
/*42*/	r3.zw = (vsOut_T1.xxxy * cb5.data[2].xxxy + vsOut_T6.yyyz).zw;
...
/*55*/	r4.x = 0;
/*56*/	r4.y = cb1.data[26].x * 0.050000;
