...
// Fragment Shader
//
// id: 3054 - fxc/glsl_SM_4_0_weightedwithdecaldirtburn.hlsl_PS_ps30_gbuffer_noclip_40.glsl
//
...
/*108*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*112*/	r0.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*113*/	r0.w = inversesqrt(r0.w);
/*114*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
/*115*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*116*/	r0.w = inversesqrt(r0.w);
/*117*/	r4.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*118*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*119*/	r0.w = inversesqrt(r0.w);
/*120*/	r5.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*121*/	r4.xyz = (r2.yyyy * r4.xyzx).xyz;
/*122*/	r2.xyw = (r2.xxxx * r3.xzxw + r4.xyxz).xyw;
/*123*/	r2.xyz = (r2.zzzz * r5.xyzx + r2.xywx).xyz;
/*124*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*125*/	r0.w = inversesqrt(r0.w);
/*126*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*127*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*128*/	r4.w = 1.000000;
/*129*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*130*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*131*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*132*/	color3.x = r0.w / r2.w;
/*133*/	r0.w = max(abs(r2.z), abs(r2.y));
/*134*/	r0.w = max(r0.w, abs(r2.x));
/*135*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*136*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*137*/	color0.w = saturate(r3.y);
/*138*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*139*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*140*/	color2.xyzw = saturate(r1.xyzw);
/*141*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*142*/	color4 = floatBitsToUint(vsOut_T9.z);
/*143*/	return;
}
