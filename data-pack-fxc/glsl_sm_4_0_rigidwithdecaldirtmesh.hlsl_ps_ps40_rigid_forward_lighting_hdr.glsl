...
// Fragment Shader
//
// id: 931 - fxc/glsl_SM_4_0_rigidwithdecaldirtmesh.hlsl_PS_ps40_rigid_forward_lighting_HDR.glsl
//
...
/*99*/	r0.z = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*112*/	  r0.z = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*191*/	r3.xzw = (vsOut_T0.xxyz + -cb0.data[0].xxyz).xzw;
/*192*/	r1.w = dot(vec3(r3.xzwx), vec3(r3.xzwx));
/*193*/	r1.w = inversesqrt(r1.w);
/*194*/	r3.xzw = (r1.wwww * r3.xxzw).xzw;
/*195*/	r1.w = -r3.y + 1.000000;
/*196*/	r2.w = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*197*/	r4.x = dot(vec3(r3.xzwx), vec3(r1.xyzx));
/*198*/	r4.x = r4.x + r4.x;
/*199*/	r4.xyz = (r1.xyzx * -r4.xxxx + r3.xzwx).xyz;
...
/*205*/	r5.w = saturate(r0.z * 60.000000);
/*206*/	r5.w = -r0.z + r5.w;
/*207*/	r6.xzw = (r1.xxyz * vec4(1.000000, 0.000000, 4.000000, 1.000000)).xzw;
...
/*236*/	}
/*237*/	r5.y = dot(vec3(r1.xyzx), vec3(-cb1.data[0].yzwy));
...
/*295*/	  r3.y = 1 + ~floatBitsToInt(r4.z);
/*296*/	  r3.y = r3.y * r4.y + 1.000000;
/*297*/	  r2.w = r3.y * 0.500000 + -r2.w;
/*298*/	  r3.y = min(r7.x, 1.000000);
/*299*/	  r1.w = r1.w * 1.570796;
/*300*/	  r1.w = sin(r1.w);
/*301*/	  r3.y = r3.y + -1.000000;
/*302*/	  r1.w = r1.w * r3.y + 1.000000;
/*303*/	  r3.x = dot(vec3(-cb1.data[0].yzwy), vec3(r3.xzwx));
/*304*/	  r3.x = max(r3.x, 0.000000);
/*305*/	  r3.x = log2(r3.x);
/*306*/	  r3.x = r3.x * 10.000000;
/*307*/	  r3.x = exp2(r3.x);
/*308*/	  r3.x = r4.w * r3.x;
/*309*/	  r3.x = r3.x * r5.w + r0.z;
...
/*319*/	r0.xyw = (r0.xyxw * r7.xxxx).xyw;
/*320*/	r0.xyw = (r0.xyxw * cb1.data[1].xyxz).xyw;
/*321*/	r0.xyw = (r3.xyxz * r0.xyxw).xyw;
/*322*/	r0.xyw = (r5.xxxx * r0.xyxw).xyw;
/*323*/	r0.xyw = (r4.xyxz * cb1.data[1].xyxz + r0.xyxw).xyw;
/*324*/	r0.xyw = (r0.xyxw + r6.xzxw).xyw;
...
/*329*/	r1.w = dot(vec3(-r3.xyzx), vec3(r1.xyzx));
/*330*/	r1.w = r1.w + r1.w;
/*331*/	r1.xyz = (r1.xyzx * -r1.wwww + -r3.xyzx).xyz;
/*332*/	r6.xyzw = (textureLod(s_environment, r1.xyzx.stp, r6.y)).xyzw;
/*333*/	r1.x = dot(vec3(r1.xyzx), vec3(-r3.xyzx));
/*334*/	r1.x = max(r1.x, 0.000000);
/*335*/	r1.x = log2(r1.x);
/*336*/	r1.x = r1.x * 10.000000;
/*337*/	r1.x = exp2(r1.x);
/*338*/	r1.x = r4.w * r1.x;
/*339*/	r0.z = r1.x * r5.w + r0.z;
/*340*/	r1.xyz = (r6.xyzx * r0.zzzz).xyz;
/*341*/	color0.xyz = (r1.xyzx * r2.xyzx + r0.xywx).xyz;
