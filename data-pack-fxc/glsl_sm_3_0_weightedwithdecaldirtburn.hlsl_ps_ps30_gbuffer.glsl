...
// Fragment Shader
//
// id: 3052 - fxc/glsl_SM_3_0_weightedwithdecaldirtburn.hlsl_PS_ps30_gbuffer.glsl
//
...
/*60*/	r3.zw = (vsOut_T1.xxxy * cb1.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*73*/	r4.x = r3.z;
/*74*/	r4.y = cb0.data[26].x * 0.050000 + r3.w;
...
/*110*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*114*/	r0.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*115*/	r0.w = inversesqrt(r0.w);
/*116*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
/*117*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*118*/	r0.w = inversesqrt(r0.w);
/*119*/	r4.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*120*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*121*/	r0.w = inversesqrt(r0.w);
/*122*/	r5.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*123*/	r4.xyz = (r2.yyyy * r4.xyzx).xyz;
/*124*/	r2.xyw = (r2.xxxx * r3.xzxw + r4.xyxz).xyw;
/*125*/	r2.xyz = (r2.zzzz * r5.xyzx + r2.xywx).xyz;
/*126*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*127*/	r0.w = inversesqrt(r0.w);
/*128*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*129*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*130*/	r4.w = 1.000000;
/*131*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*132*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*133*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*134*/	color3.x = r0.w / r2.w;
/*135*/	r0.w = max(abs(r2.z), abs(r2.y));
/*136*/	r0.w = max(r0.w, abs(r2.x));
/*137*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*138*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*139*/	color0.w = saturate(r3.y);
/*140*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*141*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*142*/	color2.xyzw = saturate(r1.xyzw);
/*143*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*144*/	color4 = floatBitsToUint(vsOut_T9.z);
/*145*/	return;
}
