...
// Fragment Shader
//
// id: 5746 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdirt.hlsl_PS_ps30_weighted_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*67*/	r3.xyz = (vsOut_T0.xyzx + -cb1.data[0].xyzx).xyz;
/*68*/	r1.w = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*69*/	r2.w = inversesqrt(r1.w);
/*70*/	r4.yzw = (r2.wwww * r3.xxyz).yzw;
/*71*/	r2.w = -r4.x + 1.000000;
/*72*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*73*/	r5.y = dot(vec3(r4.yzwy), vec3(r2.xyzx));
/*74*/	r5.y = r5.y + r5.y;
/*75*/	r5.yzw = (r2.xxyz * -r5.yyyy + r4.yyzw).yzw;
...
/*101*/	  r6.y = dot(vec3(r5.yzwy), vec3(r4.yzwy));
...
/*179*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r4.yzwy));
...
/*190*/	}
/*191*/	r4.xyz = saturate(r6.zzzz * r2.xzwx).xyz;
/*192*/	r1.xyz = (r1.xyzx * r4.xyzx).xyz;
...
/*233*/	r1.x = r1.x * r1.x;
/*234*/	r1.x = r1.x * r1.y;
/*235*/	r1.y = dot(vec2(r3.xzxx), vec2(r3.xzxx));
/*236*/	r1.y = sqrt(r1.y);
...
/*249*/	r3.w = max(r3.y, 0.000000);
/*250*/	r3.xyzw = (texture(s_sky, r3.xwzx.stp)).xyzw;
