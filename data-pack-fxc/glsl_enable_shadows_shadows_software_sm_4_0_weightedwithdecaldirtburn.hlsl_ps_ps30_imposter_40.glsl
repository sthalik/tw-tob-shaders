...
// Fragment Shader
//
// id: 7125 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdecaldirtburn.hlsl_PS_ps30_imposter_40.glsl
//
...
/*42*/	r2.yz = (vsOut_T1.xxyx * cb2.data[2].xxyx + vsOut_T6.xxyx).yz;
...
/*49*/	r2.yz = (vsOut_T1.xxyx * vec4(0.000000, 1.200000, 1.500000, 0.000000)).yz;
/*50*/	r3.x = r2.y;
/*51*/	r3.y = cb1.data[26].x * 0.050000 + r2.z;
/*52*/	r3.xyzw = (texture(s_fire_map, r3.xyxx.st)).xyzw;
/*53*/	r4.xyzw = (texture(s_fire_map, r2.yzyy.st)).xyzw;
/*54*/	r0.w = saturate(r3.x * 5.000000);
/*55*/	r2.yzw = (r0.wwww * vec4(0.000000, 0.530000, 0.070000, -0.120000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*56*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*57*/	r0.w = saturate(-r0.w * 15.000000 + 1.000000);
/*58*/	r1.w = log2(r4.z);
/*59*/	r1.w = r1.w * 1.800000;
/*60*/	r1.w = exp2(r1.w);
/*61*/	r1.w = r1.w * 10.000000;
/*62*/	r1.w = min(r1.w, 1.000000);
/*63*/	r0.w = r0.w + r1.w;
/*64*/	r0.w = r0.w * 0.500000;
/*65*/	r1.w = -r4.w + 1.000000;
/*66*/	r1.w = log2(r1.w);
/*67*/	r1.w = r1.w * vsOut_T7.z;
/*68*/	r1.w = exp2(r1.w);
/*69*/	r1.w = min(r1.w, 1.000000);
/*70*/	r1.w = r1.w * vsOut_T7.z;
/*71*/	r3.x = r4.z * 0.250000;
/*72*/	r2.yzw = (r2.yyzw * vec4(0.000000, 2.000000, 2.000000, 2.000000) + -r3.xxxx).yzw;
/*73*/	r2.yzw = (r0.wwww * r2.yyzw + r3.xxxx).yzw;
/*74*/	r2.yzw = (-r0.xxyz + r2.yyzw).yzw;
/*75*/	r0.xyz = (r1.wwww * r2.yzwy + r0.xyzx).xyz;
/*76*/	r0.w = vsOut_T7.z + -0.025000;
/*77*/	r0.w = max(r0.w, 0.000000);
/*78*/	r2.yzw = (r4.zzzz * vec4(0.000000, 0.250000, 0.250000, 0.250000) + -r0.xxyz).yzw;
/*79*/	r0.xyz = (r0.wwww * r2.yzwy + r0.xyzx).xyz;
/*80*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*81*/	r2.yzw = (-r0.xxyz + r0.wwww).yzw;
/*82*/	r0.xyz = (vsOut_T7.yyyy * r2.yzwy + r0.xyzx).xyz;
/*83*/	r0.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*84*/	r2.yzw = (-r1.xxyz + r0.wwww).yzw;
/*85*/	r1.xyz = (vsOut_T7.yyyy * r2.yzwy + r1.xyzx).xyz;
/*86*/	r0.w = vsOut_T7.y * -r2.x + r2.x;
/*87*/	r0.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*88*/	r2.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*89*/	r2.xyz = (-r0.xyzx + r2.xyzx).xyz;
/*90*/	r0.xyz = saturate(vsOut_T7.xxxx * r2.xyzx + r0.xyzx).xyz;
/*91*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*92*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*93*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*94*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*95*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*96*/	color0.w = 1.000000;
/*97*/	return;
}
