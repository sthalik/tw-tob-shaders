...
// Fragment Shader
//
// id: 5133 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecalmesh.hlsl_PS_ps30_rigid_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*62*/	r7.xyz = (r0.wwww * r6.xyzx + r7.xyzx).xyz;
/*63*/	r1.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*64*/	r1.w = inversesqrt(r1.w);
/*65*/	r7.xyz = (r1.wwww * r7.xyzx).xyz;
/*66*/	r0.xyz = (mix(r7.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
...
/*113*/	    r1.w = -r3.x + 0.200000;
/*114*/	    r3.x = r0.w * r1.w + r3.x;
...
/*162*/	r3.xzw = (r2.wwww * r4.xxyz).xzw;
/*163*/	r2.w = -r3.y + 1.000000;
/*164*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*165*/	r5.y = dot(vec3(r3.xzwx), vec3(r0.xyzx));
/*166*/	r5.y = r5.y + r5.y;
/*167*/	r5.yzw = (r0.xxyz * -r5.yyyy + r3.xxzw).yzw;
...
/*193*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.xzwx));
...
/*222*/	  r0.z = r3.y * r3.y;
/*223*/	    r3.y = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*224*/	  r0.z = r0.z * r3.y + r6.x;
/*225*/	  r0.z = r0.z * 0.500000 + 0.500000;
/*226*/	  r0.z = r0.z * 2.000000 + -1.000000;
/*227*/	  r3.y = -r0.z * r0.z + 1.000000;
/*228*/	  r3.y = max(r3.y, 0.001000);
/*229*/	  r3.y = log2(r3.y);
/*230*/	  r5.x = r3.y * 4.950617;
/*231*/	  r3.y = r3.y * 0.346574 + 4.546885;
...
/*236*/	  r5.x = r3.y * r3.y + -r5.x;
/*237*/	  r5.x = sqrt(r5.x);
/*238*/	  r3.y = -r3.y + r5.x;
/*239*/	  r3.y = max(r3.y, 0.000000);
/*240*/	  r3.y = sqrt(r3.y);
/*241*/	  r0.z = r0.z * r3.y;
...
/*271*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.xzwx));
