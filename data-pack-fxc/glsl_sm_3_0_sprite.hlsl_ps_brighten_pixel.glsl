...
// Fragment Shader
//
// id: 28 - fxc/glsl_SM_3_0_sprite.hlsl_PS_brighten_pixel.glsl
//
...
/*25*/	r1.x = sin(r1.x);
/*26*/	r1.y = vsOut_T1.x + 1.000000;
/*27*/	r0.xyz = saturate(r0.xyzx * r1.yyyy).xyz;
/*28*/	color0.w = r0.w;
/*29*/	r1.yzw = (r0.xxyz * vec4(0.000000, 3.000000, 3.000000, 3.000000)).yzw;
/*30*/	r1.yzw = (min(r1.yyzw, vec4(0.000000, 1.000000, 1.000000, 1.000000))).yzw;
/*31*/	r1.yzw = (-r0.xxyz * vec4(0.000000, 0.250000, 0.250000, 0.250000) + r1.yyzw).yzw;
/*32*/	r2.xyz = (r0.xyzx * vec4(0.250000, 0.250000, 0.250000, 0.000000)).xyz;
/*33*/	r1.xyz = (r1.xxxx * r1.yzwy + r2.xyzx).xyz;
