...
// Fragment Shader
//
// id: 97 - fxc/glsl_SM_3_0_sprite.hlsl_PS_pixel_texture_blue_channel.glsl
//
...
/*2*/	color0.z = (floatBitsToUint(r0.y) > 0x00000000u) ? r0.x : r0.z;
/*3*/	color0.xyw = (vec4(0, 0, 0, 1.000000)).xyw;
/*4*/	return;
}
