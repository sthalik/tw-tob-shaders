...
// Fragment Shader
//
// id: 5121 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdecalmesh.hlsl_PS_ps30_imposter_no_faction_colour_40.glsl
//
...
/*35*/	}
/*36*/	r1.w = uintBitsToFloat((0.000000 < vsOut_T6.w) ? 0xffffffffu : 0x00000000u);
/*37*/	if(floatBitsToUint(r1.w) != 0u) {
/*38*/	  r1.w = uintBitsToFloat((0.000000 < cb1.data[1].x) ? 0xffffffffu : 0x00000000u);
/*39*/	  if(floatBitsToUint(r1.w) != 0u) {
/*40*/	    r1.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*41*/	    r1.w = inversesqrt(r1.w);
/*42*/	    r2.xyz = (r1.wwww * vsOut_T3.xyzx).xyz;
/*43*/	    r1.w = dot(vec3(vsOut_T4.xyzx), vec3(vsOut_T4.xyzx));
/*44*/	    r1.w = inversesqrt(r1.w);
/*45*/	    r3.xyz = (r1.wwww * vsOut_T4.xyzx).xyz;
/*46*/	    r1.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*47*/	    r1.w = inversesqrt(r1.w);
/*48*/	    r4.xyz = (r1.wwww * vsOut_T2.xyzx).xyz;
/*49*/	    r3.xyz = (r1.yyyy * r3.xyzx).xyz;
/*50*/	    r2.xyz = (r1.xxxx * r2.xyzx + r3.xyzx).xyz;
/*51*/	    r2.xyz = (r1.zzzz * r4.xyzx + r2.xyzx).xyz;
/*52*/	    r1.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*53*/	    r1.w = inversesqrt(r1.w);
/*54*/	    r2.xyz = (r1.wwww * r2.xyzx).xyz;
/*55*/	    r1.xyz = (mix(r2.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
/*56*/	    r2.xy = (vsOut_T0.xzxx * vec4(0.000500, 0.000500, 0.000000, 0.000000)).xy;
/*57*/	    r2.xyzw = (texture(s_snow_normals, r2.xyxx.st)).xyzw;
/*58*/	    r2.xy = (r2.wyww + vec4(0.001961, 0.001961, 0.000000, 0.000000)).xy;
/*59*/	    r2.xz = (r2.xxyx * vec4(2.000000, 0.000000, 2.000000, 0.000000) + vec4(-1.000000, 0.000000, -1.000000, 0.000000)).xz;
/*60*/	    r0.w = dot(vec2(r2.xzxx), vec2(r2.xzxx));
/*61*/	    r0.w = -r0.w + 1.000000;
/*62*/	    r0.w = max(r0.w, 0.000000);
/*63*/	    r2.y = sqrt(r0.w);
/*64*/	    r1.xyz = (r2.xyzx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r1.xyzx).xyz;
/*65*/	    r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*66*/	    r0.w = inversesqrt(r0.w);
/*67*/	    r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*68*/	    r2.xz = (cb1.data[0].xxyx).xz/**/;
/*69*/	    r2.y = -1.000000;
/*70*/	    r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*71*/	    r0.w = inversesqrt(r0.w);
/*72*/	    r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*73*/	    r0.w = saturate(dot(vec3(-r2.xyzx), vec3(r1.xyzx)));
/*74*/	    r1.x = cb1.data[1].x * cb1.data[1].x;
/*75*/	    r1.x = r1.x * 1.250000;
/*76*/	    r1.x = min(r1.x, 1.000000);
/*77*/	    r1.y = saturate(cb1.data[1].x * cb1.data[1].x + -0.800000);
/*78*/	    r1.y = r1.y * 4.000000;
/*79*/	    r1.x = r1.x * 0.200000 + r1.y;
/*80*/	    r1.x = r1.x * -0.700000 + 1.000000;
/*81*/	    r0.w = r0.w + -r1.x;
/*82*/	    r0.w = saturate(r0.w * 200.000000);
/*83*/	    r1.x = r0.w * -2.000000 + 3.000000;
/*84*/	    r0.w = r0.w * r0.w;
/*85*/	    r0.w = r0.w * r1.x;
/*86*/	    r1.xyz = (-r0.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*87*/	    r0.xyz = (r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*88*/	  }
/*89*/	}
/*90*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*91*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*92*/	r0.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*93*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*94*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*95*/	r0.xyz = saturate(vsOut_T7.zzzz * r1.xyzx + r0.xyzx).xyz;
/*96*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*97*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*98*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*99*/	color0.w = 1.000000;
/*100*/	return;
}
