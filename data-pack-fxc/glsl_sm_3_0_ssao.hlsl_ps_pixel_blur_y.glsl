...
// Fragment Shader
//
// id: 1428 - fxc/glsl_SM_3_0_ssao.hlsl_PS_pixel_blur_y.glsl
//
...
uniform sampler2D blur_x_target_sampler;
...
/*0*/	r0.w = 1.000000;
/*1*/	r1.xz = (vec4(0, 0, 0, 0)).xz;
/*2*/	r2.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(cb1.data[0].w)).x;
/*3*/	r3.xyz = (r2.xxxx * vec4(-4.000000, -2.000000, -3.000000, 0.000000)).xyz;
/*4*/	r1.yw = (r3.xxxz).yw;
...
/*27*/	r0.x = exp2(r0.x);
/*28*/	r5.xyzw = (textureLod(blur_x_target_sampler, r1.zwzz.st, 0.000000)).xyzw;
/*29*/	r0.w = r0.x * r5.x;
/*30*/	r5.w = 1.000000;
...
/*34*/	r1.xyzw = (textureLod(blur_x_target_sampler, r1.xyxx.st, 0.000000)).xyzw;
...
/*51*/	r5.xyzw = (textureLod(blur_x_target_sampler, r3.xyxx.st, 0.000000)).xyzw;
...
/*66*/	r1.xyzw = (textureLod(blur_x_target_sampler, r1.xyxx.st, 0.000000)).xyzw;
/*67*/	r3.w = 1.000000;
...
/*79*/	r1.xyzw = (textureLod(blur_x_target_sampler, r4.xyxx.st, 0.000000)).xyzw;
/*80*/	r0.w = r0.w + r1.x;
/*81*/	r2.y = 0;
/*82*/	r1.xy = (r2.yxyy + r4.xyxx).xy;
...
/*85*/	r1.xyzw = (textureLod(blur_x_target_sampler, r1.xyxx.st, 0.000000)).xyzw;
/*86*/	r3.w = 1.000000;
...
/*98*/	r1.xy = (r2.yxyy * vec4(1.000000, 4.000000, 0.000000, 0.000000) + r4.xyxx).xy;
/*99*/	r2.xyzw = r2.yzyw + r4.xyxy;
...
/*110*/	r1.z = exp2(r1.z);
/*111*/	r3.xyzw = (textureLod(blur_x_target_sampler, r2.xyxx.st, 0.000000)).xyzw;
...
/*116*/	r2.xyzw = (textureLod(blur_x_target_sampler, r2.zwzz.st, 0.000000)).xyzw;
/*117*/	r3.w = 1.000000;
...
/*130*/	r1.xyzw = (textureLod(blur_x_target_sampler, r1.xyxx.st, 0.000000)).xyzw;
/*131*/	r2.w = 1.000000;
