...
// Fragment Shader
//
// id: 4891 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidtileddirtmapfiremesh.hlsl_PS_ps30_rigid_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*23*/	r3.zw = (vsOut_T1.xxxy * cb5.data[2].xxxy).zw;
...
/*33*/	r6.x = 0;
/*34*/	r6.y = cb1.data[26].x * 0.050000;
/*35*/	r6.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000) + r6.xyxx).xy;
/*36*/	r6.xyzw = (texture(s_fire_map, r6.xyxx.st)).xyzw;
/*37*/	r7.xyzw = (texture(s_fire_map, r3.zwzz.st)).xyzw;
/*38*/	r1.w = saturate(r6.x * 5.000000);
/*39*/	r6.xyz = (r1.wwww * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*40*/	r1.w = dot(vec3(r5.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
...
/*49*/	r2.w = -r7.w + 1.000000;
/*50*/	r2.w = log2(r2.w);
/*51*/	r2.w = r2.w * vsOut_T7.x;
/*52*/	r2.w = exp2(r2.w);
/*53*/	r2.w = min(r2.w, 1.000000);
/*54*/	r2.w = r2.w * vsOut_T7.x;
/*55*/	r3.z = r7.z * 0.250000;
/*56*/	r6.xyz = (r6.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r3.zzzz).xyz;
/*57*/	r6.xyz = (r1.wwww * r6.xyzx + r3.zzzz).xyz;
/*58*/	r1.xyz = (-r1.xyzx * r4.xyzx + r6.xyzx).xyz;
/*59*/	r1.xyz = (r2.wwww * r1.xyzx + r5.xyzx).xyz;
/*60*/	r1.w = vsOut_T7.x + -0.025000;
/*61*/	r1.w = max(r1.w, 0.000000);
/*62*/	r4.xyz = (r7.zzzz * vec4(0.250000, 0.250000, 0.250000, 0.000000) + -r1.xyzx).xyz;
...
/*75*/	r0.xyw = (r0.wwww * r6.xyxz + r7.xyxz).xyw;
/*76*/	r1.w = dot(vec3(r0.xywx), vec3(r0.xywx));
/*77*/	r1.w = inversesqrt(r1.w);
/*78*/	r0.xyw = (r0.xyxw * r1.wwww).xyw;
/*79*/	r0.xyz = (mix(r0.xywx, vsOut_T2.xyzx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
