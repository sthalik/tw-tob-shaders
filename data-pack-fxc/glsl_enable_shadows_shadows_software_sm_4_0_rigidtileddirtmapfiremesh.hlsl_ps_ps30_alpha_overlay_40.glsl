...
// Fragment Shader
//
// id: 4865 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidtileddirtmapfiremesh.hlsl_PS_ps30_alpha_overlay_40.glsl
//
...
/*131*/	    r1.w = cb3.data[1].x * cb3.data[1].x;
/*132*/	    r1.w = r1.w * 1.250000;
/*133*/	    r1.w = min(r1.w, 1.000000);
/*134*/	    r2.w = saturate(cb3.data[1].x * cb3.data[1].x + -0.800000);
...
/*158*/	    r1.w = dot(vec2(cb3.data[0].xyxx), vec2(cb3.data[0].xyxx));
/*159*/	    r1.w = sqrt(r1.w);
...
/*195*/	r5.x = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
...
/*211*/	r9.xyz = (mix(cb1.data[2].xyzx, cb1.data[3].xyzx, greaterThan(floatBitsToUint(r8.xxxx), uvec4(0)))).xyz/**/;
/*212*/	r8.xyw = (mix(cb1.data[4].xyxz, cb1.data[5].xyxz, greaterThan(floatBitsToUint(r8.yyyy), uvec4(0)))).xyw/**/;
/*213*/	r10.xyz = (mix(cb1.data[6].xyzx, cb1.data[7].xyzx, greaterThan(floatBitsToUint(r8.zzzz), uvec4(0)))).xyz/**/;
...
/*240*/	  r1.x = dot(vec3(-cb1.data[0].yzwy), vec3(r5.yzwy));
...
/*302*/	  r2.w = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
...
/*325*/	r2.w = 1.000000;
/*326*/	r1.x = dot(r2.xyzw, cb0.data[9].xyzw);
/*327*/	r1.y = dot(r2.xyzw, cb0.data[10].xyzw);
/*328*/	r0.w = dot(r2.xyzw, cb0.data[12].xyzw);
