...
// Vertex Shader
//
// id: 9 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_sprite.hlsl_VS_vertex_gamma.glsl
//
...
/*12*/	vsOut_T1.xyzw = vsIn_T2.xyzw;
/*13*/	vsOut_T2.xyzw = vsIn_T3.xyzw * cb1.data[1].xyxy + cb1.data[1].zwzw;
/*14*/	return;
}
