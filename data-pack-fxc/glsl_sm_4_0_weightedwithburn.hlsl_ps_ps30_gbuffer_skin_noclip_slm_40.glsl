...
// Fragment Shader
//
// id: 2193 - fxc/glsl_SM_4_0_weightedwithburn.hlsl_PS_ps30_gbuffer_skin_noclip_slm_40.glsl
//
...
/*76*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*77*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*78*/	r0.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*79*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*80*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*81*/	color2.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*82*/	color2.w = 0;
