...
// Fragment Shader
//
// id: 5346 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdirtburnmesh.hlsl_PS_ps30_rigid_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*51*/	r4.x = 0;
/*52*/	r4.y = cb1.data[26].x * 0.050000;
...
/*57*/	r4.xyz = (r1.wwww * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*58*/	r1.w = dot(vec3(r0.xywx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
...
/*73*/	r3.z = r5.z * 0.250000;
/*74*/	r4.xyz = (r4.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r3.zzzz).xyz;
/*75*/	r4.xyz = (r1.wwww * r4.xyzx + r3.zzzz).xyz;
/*76*/	r4.xyz = (-r0.xywx + r4.xyzx).xyz;
/*77*/	r0.xyw = (r2.wwww * r4.xyxz + r0.xyxw).xyw;
/*78*/	r1.w = vsOut_T7.x + -0.025000;
/*79*/	r1.w = max(r1.w, 0.000000);
/*80*/	r4.xyz = (r5.zzzz * vec4(0.250000, 0.250000, 0.250000, 0.000000) + -r0.xywx).xyz;
...
/*93*/	r7.xyz = (r1.zzzz * r6.xyzx + r7.xyzx).xyz;
/*94*/	r1.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*95*/	r1.w = inversesqrt(r1.w);
/*96*/	r7.xyz = (r1.wwww * r7.xyzx).xyz;
/*97*/	r1.xyz = (mix(r7.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
