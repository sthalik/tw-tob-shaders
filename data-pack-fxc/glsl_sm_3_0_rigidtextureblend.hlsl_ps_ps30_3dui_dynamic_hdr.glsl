...
// Fragment Shader
//
// id: 1317 - fxc/glsl_SM_3_0_rigidtextureblend.hlsl_PS_ps30_3dui_dynamic_HDR.glsl
//
...
/*5*/	r0.zw = (cb4.data[0].zzzw * vsOut_C0.xxxy + cb4.data[0].xxxy).zw;
...
/*8*/	r0.x = -cb5.data[11].w + 1.000000;
/*9*/	r0.x = max(r1.w, r0.x);
/*10*/	r0.zw = (cb4.data[1].zzzw * vsOut_C0.zzzw + cb4.data[1].xxxy).zw;
...
/*13*/	r3.xyzw = -cb5.data[12].xyzw + vec4(1.000000, 1.000000, 1.000000, 1.000000);
...
/*21*/	r4.xy = (cb4.data[2].zwzz * vsOut_C1.xyxx + cb4.data[2].xyxx).xy;
...
/*25*/	r0.x = r0.y * r0.x;
/*26*/	r0.yw = (cb4.data[3].zzzw * vsOut_C1.zzzw + cb4.data[3].xxxy).yw;
...
/*36*/	r3.xy = (cb4.data[4].zwzz * vsOut_C2.xyxx + cb4.data[4].xyxx).xy;
...
/*40*/	r0.x = r0.y * r0.x;
/*41*/	r0.yw = (cb4.data[5].zzzw * vsOut_C2.zzzw + cb4.data[5].xxxy).yw;
...
/*44*/	r0.yzw = (-cb5.data[13].xxyz + vec4(0.000000, 1.000000, 1.000000, 1.000000)).yzw;
...
/*52*/	r7.zw = (cb4.data[6].zzzw * vsOut_C3.xxxy + cb4.data[6].xxxy).zw;
...
/*56*/	r0.x = r0.y * r0.x;
/*57*/	r0.yz = (cb4.data[7].zzwz * vsOut_C3.zzwz + cb4.data[7].xxyx).yz;
...
/*64*/	r0.xyz = (r1.xyzx * cb5.data[4].xyzx).xyz;
/*65*/	color0.w = r1.w * vsOut_T2.w;
/*66*/	r1.xyz = (r2.xyzx * cb5.data[5].xyzx).xyz;
/*67*/	r0.w = max(r2.w, cb5.data[12].x);
/*68*/	r1.w = -cb5.data[0].w + 1.000000;
/*69*/	r2.xyzw = uintBitsToFloat(uvec4(equal(cb5.data[14].xyzw, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu);
...
/*73*/	r1.w = r1.w * cb5.data[0].z;
/*74*/	r2.x = r0.w * r1.w;
/*75*/	r0.w = -r1.w * r0.w + 1.000000;
/*76*/	r1.xyz = (r1.xyzx * r2.xxxx).xyz;
/*77*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*78*/	r1.xyz = (r4.xyzx * cb5.data[6].xyzx).xyz;
/*79*/	r0.w = max(r4.w, cb5.data[12].y);
/*80*/	r4.xy = (-cb5.data[1].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*83*/	r2.xy = (r2.xyxx * cb5.data[1].xzxx).xy;
/*84*/	r1.w = r0.w * r2.x;
/*85*/	r0.w = -r2.x * r0.w + 1.000000;
/*86*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*87*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*88*/	r1.xyz = (r5.xyzx * cb5.data[7].xyzx).xyz;
/*89*/	r0.w = max(r5.w, cb5.data[12].z);
/*90*/	r1.w = r0.w * r2.y;
/*91*/	r0.w = -r2.y * r0.w + 1.000000;
/*92*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*93*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*94*/	r1.xyz = (r6.xyzx * cb5.data[8].xyzx).xyz;
/*95*/	r0.w = max(r6.w, cb5.data[12].w);
/*96*/	r2.xy = (-cb5.data[2].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
/*97*/	r1.w = uintBitsToFloat((r2.w >= r2.x) ? 0xffffffffu : 0x00000000u);
/*98*/	r1.w = uintBitsToFloat(floatBitsToUint(r1.w) & uint(0x3f800000u));
/*99*/	r1.w = r1.w * cb5.data[2].x;
/*100*/	r2.x = r0.w * r1.w;
/*101*/	r0.w = -r1.w * r0.w + 1.000000;
/*102*/	r1.xyz = (r1.xyzx * r2.xxxx).xyz;
/*103*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*104*/	r1.xyz = (r3.xyzx * cb5.data[9].xyzx).xyz;
/*105*/	r0.w = max(r3.w, cb5.data[13].x);
/*106*/	r2.xzw = (uintBitsToFloat(uvec4(equal(cb5.data[15].xxyz, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xzw;
...
/*110*/	r1.w = r1.w * cb5.data[2].z;
/*111*/	r2.x = r0.w * r1.w;
/*112*/	r0.w = -r1.w * r0.w + 1.000000;
/*113*/	r1.xyz = (r1.xyzx * r2.xxxx).xyz;
/*114*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*115*/	r1.xyz = (r8.xyzx * cb5.data[10].xyzx).xyz;
/*116*/	r0.w = max(r8.w, cb5.data[13].y);
/*117*/	r2.xy = (-cb5.data[3].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*120*/	r2.xy = (r2.xyxx * cb5.data[3].xzxx).xy;
/*121*/	r1.w = r0.w * r2.x;
/*122*/	r0.w = -r2.x * r0.w + 1.000000;
/*123*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*124*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
/*125*/	r1.xyz = (r7.xyzx * cb5.data[11].xyzx).xyz;
/*126*/	r0.w = max(r7.w, cb5.data[13].z);
/*127*/	r1.w = r0.w * r2.y;
...
/*161*/	r2.xyz = (-vsOut_T0.xyzx + cb1.data[0].xyzx).xyz;
/*162*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*163*/	r0.w = inversesqrt(r0.w);
/*164*/	r2.xyz = (r2.xyzx * r0.wwww + -cb5.data[16].xyzx).xyz;
...
/*169*/	r1.x = saturate(dot(vec3(r1.xyzx), vec3(-cb5.data[16].xyzx)));
...
/*179*/	r0.w = -vsOut_T0.y + cb3.data[1].w;
/*180*/	r0.w = r0.w + -cb3.data[1].z;
/*181*/	r1.x = -cb3.data[1].z + cb3.data[1].w;
...
/*193*/	r2.xyz = (vsOut_T0.xyzx + -cb1.data[0].xyzx).xyz;
...
/*199*/	r1.x = exp2(r1.x);
/*200*/	r1.x = cb3.data[1].y / r1.x;
/*201*/	r1.x = saturate(-r1.x + cb3.data[1].y);
/*202*/	r0.w = cb3.data[2].x * r0.w + r1.x;
/*203*/	r1.x = saturate(dot(vec2(r0.wwww), vec2(cb3.data[2].yyyy)));
/*204*/	r1.yzw = (cb2.data[1].xxyz * cb3.data[0].xxyz).yzw;
/*205*/	r1.yzw = (r1.yyzw * vec4(0.000000, 1.500000, 1.500000, 1.500000)).yzw;
/*206*/	r1.yzw = (r1.yyzw * abs(cb2.data[0].zzzz)).yzw;
/*207*/	r3.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
...
/*216*/	r1.w = max(r1.y, r1.x);
/*217*/	r1.w = max(r1.z, r1.w);
/*218*/	r2.yzw = (-r1.xxyz + r1.wwww).yzw;
/*219*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*220*/	r3.xyzw = (textureLod(g_black_and_white_points_sampler, vec4(0.500000, 0.500000, 0.000000, 0.000000).st, 0.000000)).xyzw;
/*221*/	r1.w = r1.w + -r3.x;
/*222*/	r3.z = -r3.x + r3.y;
/*223*/	r1.w = r1.w / r3.z;
/*224*/	r1.w = r1.w + -1.000000;
/*225*/	r1.w = saturate(r1.w * 1.176471);
/*226*/	r1.xyz = (r1.wwww * r2.yzwy + r1.xyzx).xyz;
/*227*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*228*/	r2.y = max(r3.x, r1.w);
/*229*/	r2.y = min(r3.y, r2.y);
/*230*/	r2.y = -r3.x + r2.y;
/*231*/	r2.y = r2.y / r3.z;
/*232*/	r2.z = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*233*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*234*/	r1.w = (floatBitsToUint(r2.z) > 0x00000000u) ? r1.w : 1.000000;
/*235*/	r1.w = r1.w * r2.y;
/*236*/	r1.xyz = saturate(r1.wwww * r1.xyzx).xyz;
/*237*/	r1.w = 0.500000;
/*238*/	r3.xyzw = (texture(g_scurve_texture_sampler, r1.xwxx.st)).xyzw;
/*239*/	r4.xyzw = (texture(g_scurve_texture_sampler, r1.ywyy.st)).xyzw;
/*240*/	r1.xyzw = (texture(g_scurve_texture_sampler, r1.zwzz.st)).xyzw;
/*241*/	r3.z = r1.z;
/*242*/	r3.y = r4.y;
/*243*/	r1.xyz = (-r0.xyzx + r3.xyzx).xyz;
/*244*/	r1.w = max(cb3.data[2].z, 0.001000);
/*245*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*246*/	r1.w = r1.w * r2.x;
/*247*/	r1.w = min(r1.w, 1.000000);
/*248*/	r2.x = r1.w * -2.000000 + 3.000000;
/*249*/	r1.w = r1.w * r1.w;
/*250*/	r1.w = r1.w * r2.x;
/*251*/	r0.w = saturate(r0.w * r1.w);
/*252*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*253*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*254*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*255*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*256*/	return;
}
