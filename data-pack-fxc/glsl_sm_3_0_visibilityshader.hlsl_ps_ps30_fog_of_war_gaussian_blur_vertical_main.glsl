...
// Fragment Shader
//
// id: 3921 - fxc/glsl_SM_3_0_VisibilityShader.hlsl_PS_ps30_fog_of_war_gaussian_blur_vertical_main.glsl
//
...
/*8*/	  r2.xy = (r0.wwww * vec4(0.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*15*/	  r2.xyzw = (textureLod(s_fog_of_war_source, r2.xyxx.st, 0.000000)).xyzw;
/*16*/	  r1.xyzw = r2.xxxx * r0.wwww + r1.xyzw;
/*17*/	  r0.z = intBitsToFloat(floatBitsToInt(r0.z) + int(1));
/*18*/	}
/*19*/	color0.xyzw = r1.xyzw * vec4(1.317786, 1.317786, 1.317786, 1.317786);
/*20*/	return;
}
