...
// Fragment Shader
//
// id: 2637 - fxc/glsl_SM_4_0_weightedwithburn.hlsl_PS_ps30_gbuffer_no_faction_colour_40.glsl
//
...
/*67*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*68*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*69*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*70*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*71*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*72*/	r0.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
