...
// Fragment Shader
//
// id: 2321 - fxc/glsl_SM_4_0_weightedwithdirtburn.hlsl_PS_ps30_gbuffer_skin_noclip_40.glsl
//
...
/*79*/	r0.w = -vsOut_T4.z + 1.000000;
/*80*/	r1.xyz = (vsOut_T4.zzzz * cb2.data[3].xyzx).xyz;
/*81*/	r0.xyz = (r0.xyzx * r0.wwww + r1.xyzx).xyz;
...
/*87*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*88*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*89*/	color2.xyzw = r0.xyzz;
/*90*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*91*/	r0.w = 1.000000;
/*92*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*93*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*94*/	color3.x = r1.x / r0.x;
