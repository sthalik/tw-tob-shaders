...
// Fragment Shader
//
// id: 1962 - fxc/glsl_SM_3_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_skin_noclip.glsl
//
...
/*66*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*67*/	color1.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
...
/*77*/	color0.xyz = saturate(r0.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*78*/	color0.w = saturate(r2.y);
