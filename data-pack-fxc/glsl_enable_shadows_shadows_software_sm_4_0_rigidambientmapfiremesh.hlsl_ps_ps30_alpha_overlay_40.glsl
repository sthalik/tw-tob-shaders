...
// Fragment Shader
//
// id: 4516 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidambientmapfiremesh.hlsl_PS_ps30_alpha_overlay_40.glsl
//
...
/*124*/	    r1.w = cb3.data[1].x * cb3.data[1].x;
/*125*/	    r1.w = r1.w * 1.250000;
/*126*/	    r1.w = min(r1.w, 1.000000);
/*127*/	    r2.w = saturate(cb3.data[1].x * cb3.data[1].x + -0.800000);
...
/*151*/	    r1.w = dot(vec2(cb3.data[0].xyxx), vec2(cb3.data[0].xyxx));
/*152*/	    r1.w = sqrt(r1.w);
...
/*188*/	r5.x = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
...
/*204*/	r9.xyz = (mix(cb1.data[2].xyzx, cb1.data[3].xyzx, greaterThan(floatBitsToUint(r8.xxxx), uvec4(0)))).xyz/**/;
/*205*/	r8.xyw = (mix(cb1.data[4].xyxz, cb1.data[5].xyxz, greaterThan(floatBitsToUint(r8.yyyy), uvec4(0)))).xyw/**/;
/*206*/	r10.xyz = (mix(cb1.data[6].xyzx, cb1.data[7].xyzx, greaterThan(floatBitsToUint(r8.zzzz), uvec4(0)))).xyz/**/;
...
/*233*/	  r1.x = dot(vec3(-cb1.data[0].yzwy), vec3(r5.yzwy));
...
/*295*/	  r2.w = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
...
/*318*/	r2.w = 1.000000;
/*319*/	r1.x = dot(r2.xyzw, cb0.data[9].xyzw);
/*320*/	r1.y = dot(r2.xyzw, cb0.data[10].xyzw);
/*321*/	r0.w = dot(r2.xyzw, cb0.data[12].xyzw);
