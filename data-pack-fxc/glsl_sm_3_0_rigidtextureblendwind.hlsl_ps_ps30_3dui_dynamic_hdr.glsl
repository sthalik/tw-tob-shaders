...
// Fragment Shader
//
// id: 1335 - fxc/glsl_SM_3_0_rigidtextureblendwind.hlsl_PS_ps30_3dui_dynamic_HDR.glsl
//
...
/*265*/	r3.xyzw = (textureLod(g_black_and_white_points_sampler, vec4(0.500000, 0.500000, 0.000000, 0.000000).st, 0.000000)).xyzw;
/*266*/	r1.w = r1.w + -r3.x;
/*267*/	r3.z = -r3.x + r3.y;
/*268*/	r1.w = r1.w / r3.z;
/*269*/	r1.w = r1.w + -1.000000;
/*270*/	r1.w = saturate(r1.w * 1.176471);
/*271*/	r1.xyz = (r1.wwww * r2.yzwy + r1.xyzx).xyz;
/*272*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*273*/	r2.y = max(r3.x, r1.w);
/*274*/	r2.y = min(r3.y, r2.y);
/*275*/	r2.y = -r3.x + r2.y;
/*276*/	r2.y = r2.y / r3.z;
/*277*/	r2.z = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*278*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*279*/	r1.w = (floatBitsToUint(r2.z) > 0x00000000u) ? r1.w : 1.000000;
/*280*/	r1.w = r1.w * r2.y;
/*281*/	r1.xyz = saturate(r1.wwww * r1.xyzx).xyz;
/*282*/	r1.w = 0.500000;
/*283*/	r3.xyzw = (texture(g_scurve_texture_sampler, r1.xwxx.st)).xyzw;
/*284*/	r4.xyzw = (texture(g_scurve_texture_sampler, r1.ywyy.st)).xyzw;
/*285*/	r1.xyzw = (texture(g_scurve_texture_sampler, r1.zwzz.st)).xyzw;
/*286*/	r3.z = r1.z;
/*287*/	r3.y = r4.y;
/*288*/	r1.xyz = (-r0.xyzx + r3.xyzx).xyz;
/*289*/	r1.w = max(cb3.data[2].z, 0.001000);
/*290*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*291*/	r1.w = r1.w * r2.x;
/*292*/	r1.w = min(r1.w, 1.000000);
/*293*/	r2.x = r1.w * -2.000000 + 3.000000;
/*294*/	r1.w = r1.w * r1.w;
/*295*/	r1.w = r1.w * r2.x;
/*296*/	r0.w = saturate(r0.w * r1.w);
/*297*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*298*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*299*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*300*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*301*/	return;
}
