...
// Fragment Shader
//
// id: 7801 - fxc/glsl_SM_3_0_waterplane.hlsl_PS_ps30_campaign_lake.glsl
//
...
/*316*/	color3.xyz = (r0.wwww * r0.xyzx + r1.xyzx).xyz;
/*317*/	color1.xyzw = vec4(0, 0, 0, 0.020000);
/*318*/	color2.xyzw = vec4(1.000000, 1.000000, 1.000000, 0.015686);
/*319*/	color3.w = 1.000000;
/*320*/	return;
}
