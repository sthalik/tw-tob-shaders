...
// Vertex Shader
//
// id: 34 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_sprite.hlsl_VS_alpha_over_sin_time_vertex.glsl
//
...
/*12*/	r0.x = -vsIn_T2.z + cb1.data[0].x;
...
/*17*/	r0.x = r0.x * r0.x;
/*18*/	r0.x = r0.x * r0.y;
/*19*/	r0.x = r0.x * r0.z + vsIn_T2.x;
/*20*/	r0.x = r0.x * 1.570796;
/*21*/	vsOut_T1.x = sin(r0.x);
/*22*/	vsOut_T1.yzw = (vsIn_T2.yyzw).yzw;
/*23*/	vsOut_T2.xyzw = vsIn_T3.xyzw * cb1.data[1].xyxy + cb1.data[1].zwzw;
/*24*/	return;
}
