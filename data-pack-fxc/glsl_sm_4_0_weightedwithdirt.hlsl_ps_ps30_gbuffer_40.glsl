...
// Fragment Shader
//
// id: 1652 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_40.glsl
//
...
/*64*/	r1.xyz = (-r0.xyzx + r1.xxxx).xyz;
/*65*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*66*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*67*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*68*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*69*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*70*/	r1.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*71*/	r0.xyz = (r0.wwww * r1.xyzx).xyz;
/*72*/	r0.xyz = (r0.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r1.xyzx).xyz;
/*73*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*74*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*75*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*76*/	r1.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*77*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & uint(0x3c008081u));
/*78*/	color2.xyzw = saturate(r0.xyzw);
