...
// Fragment Shader
//
// id: 905 - fxc/glsl_SM_3_0_rigidwithdecaldirtmesh.hlsl_PS_ps30_gbuffer_alpha_test.glsl
//
...
/*120*/	  r1.xy = (r1.xyxx + vec4(0.200000, 0.300000, 0.000000, 0.000000)).xy;
/*121*/	}
...
/*196*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*197*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*198*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*199*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*200*/	r0.w = uintBitsToFloat((cb2.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*201*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*202*/	r2.x = inversesqrt(r2.x);
/*203*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*204*/	color3.x = r2.w / r3.w;
/*205*/	r2.w = max(abs(r2.z), abs(r2.y));
/*206*/	r2.w = max(r2.w, abs(r2.x));
/*207*/	r2.xyz = (r2.xyzx / r2.wwww).xyz;
/*208*/	r1.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*209*/	color0.xyzw = saturate(r1.xzwy);
