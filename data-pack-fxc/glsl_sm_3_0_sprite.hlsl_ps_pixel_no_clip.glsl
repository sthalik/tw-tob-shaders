...
// Fragment Shader
//
// id: 87 - fxc/glsl_SM_3_0_sprite.hlsl_PS_pixel_no_clip.glsl
//
...
/*19*/	r0.xyzw = uintBitsToFloat(floatBitsToUint(r0.xyzw) & floatBitsToUint(r1.xxxx));
/*20*/	if(r1.y != 0) discard;
/*21*/	r0.xyz = saturate(r0.xyzx).xyz;
/*22*/	color0.w = r0.w;
