...
// Fragment Shader
//
// id: 2197 - fxc/glsl_SM_4_0_weightedwithburn.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour_slm_40.glsl
//
...
/*62*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*63*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*64*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
...
/*72*/	color2.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*73*/	color2.w = 0;
/*74*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*75*/	r0.w = 1.000000;
/*76*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*77*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*78*/	color3.x = r1.x / r0.x;
