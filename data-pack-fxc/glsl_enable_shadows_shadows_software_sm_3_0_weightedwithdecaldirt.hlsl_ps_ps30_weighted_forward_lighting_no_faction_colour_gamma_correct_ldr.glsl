...
// Fragment Shader
//
// id: 5864 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecaldirt.hlsl_PS_ps30_weighted_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*80*/	r4.xyz = (vsOut_T0.xyzx + -cb1.data[0].xyzx).xyz;
/*81*/	r1.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*82*/	r2.w = inversesqrt(r1.w);
/*83*/	r3.xzw = (r2.wwww * r4.xxyz).xzw;
/*84*/	r2.w = -r3.y + 1.000000;
/*85*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*86*/	r5.y = dot(vec3(r3.xzwx), vec3(r2.xyzx));
/*87*/	r5.y = r5.y + r5.y;
/*88*/	r5.yzw = (r2.xxyz * -r5.yyyy + r3.xxzw).yzw;
...
/*114*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.xzwx));
...
/*192*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.xzwx));
...
/*203*/	}
/*204*/	r3.xyz = saturate(r6.zzzz * r2.xzwx).xyz;
/*205*/	r1.xyz = (r1.xyzx * r3.xyzx).xyz;
...
/*246*/	r1.x = r1.x * r1.x;
/*247*/	r1.x = r1.x * r1.y;
/*248*/	r1.y = dot(vec2(r4.xzxx), vec2(r4.xzxx));
/*249*/	r1.y = sqrt(r1.y);
...
/*262*/	r4.w = max(r4.y, 0.000000);
/*263*/	r3.xyzw = (texture(s_sky, r4.xwzx.stp)).xyzw;
