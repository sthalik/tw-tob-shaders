...
// Vertex Shader
//
// id: 130 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_sprite.hlsl_VS_VertexCooldown_vs_2.glsl
//
...
/*18*/	r0.x = -vsIn_T2.x + vsIn_T2.y;
/*19*/	r0.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r0.x)).x;
/*20*/	r0.y = -vsIn_T2.x + cb1.data[0].y;
/*21*/	r0.x = saturate(r0.x * r0.y);
/*22*/	r0.y = r0.x * -2.000000 + 3.000000;
/*23*/	r0.x = r0.x * r0.x;
/*24*/	r0.x = r0.x * r0.y;
/*25*/	vsOut_T3.x = -r0.x * 6.283185 + 3.141593;
/*26*/	vsOut_T3.y = 0;
/*27*/	vsOut_T3.zw = (vsIn_T2.zzzw).zw;
/*28*/	vsOut_T4.xyzw = vsIn_T3.xyzw * cb1.data[1].xyxy + cb1.data[1].zwzw;
/*29*/	vsOut_T5.z = vsIn_P0.w;
/*30*/	return;
}
