...
// Fragment Shader
//
// id: 1717 - fxc/glsl_SM_3_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_noclip.glsl
//
...
/*63*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*69*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
...
/*79*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*80*/	r0.w = inversesqrt(r0.w);
/*81*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*82*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*83*/	r4.w = 1.000000;
/*84*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*85*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*86*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*87*/	color3.x = r0.w / r2.w;
/*88*/	r0.w = max(abs(r2.z), abs(r2.y));
/*89*/	r0.w = max(r0.w, abs(r2.x));
/*90*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*91*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*92*/	color0.w = saturate(r3.y);
/*93*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*94*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*95*/	color2.xyzw = saturate(r1.xyzw);
