...
// Fragment Shader
//
// id: 174 - fxc/glsl_SM_3_0_sprite.hlsl_PS_pixel_sepia_fade.glsl
//
...
/*32*/	r0.w = r0.w * vsOut_T1.x;
/*33*/	color0.w = r0.w;
/*34*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*35*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*36*/	r0.xyz = (exp2(r0.xyzx)).xyz;
/*37*/	color0.x = dot(vec3(r0.xyzx), vec3(vec4(0.590000, 0.769000, 0.189000, 0.000000)));
/*38*/	color0.y = dot(vec3(r0.xyzx), vec3(vec4(0.349000, 0.686000, 0.168000, 0.000000)));
/*39*/	color0.z = dot(vec3(r0.xyzx), vec3(vec4(0.272000, 0.534000, 0.131000, 0.000000)));
/*40*/	return;
}
