...
// Fragment Shader
//
// id: 283 - fxc/glsl_SM_3_0_EditorDynamicGeometry.hlsl_PS_ps30_main.glsl
//
...
/*37*/	r2.xyzw = (texture(s_diffuse, vsOut_T3.xyxx.st)).xyzw;
/*38*/	r1.xyz = (-r2.xyzx * vsOut_C0.xyzx + r1.xyzx).xyz;
/*39*/	r2.xyzw = r2.xyzw * vsOut_C0.xyzw;
