...
// Fragment Shader
//
// id: 2181 - fxc/glsl_SM_4_0_weightedwithburn.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour_40.glsl
//
...
/*67*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*68*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*69*/	color2.xyzw = r0.xyzz;
/*70*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*71*/	r0.w = 1.000000;
/*72*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*73*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*74*/	color3.x = r1.x / r0.x;
