...
// Fragment Shader
//
// id: 5213 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdirtmesh.hlsl_PS_ps30_alpha_blend_40.glsl
//
...
/*47*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy + vsOut_T6.yyyz).zw;
...
/*52*/	r0.xyz = (r2.wwww * r4.xyzx + r0.xyzx).xyz;
/*53*/	r1.xy = (r3.zwzz * r4.wwww + r1.xyxx).xy;
/*54*/	r3.z = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*55*/	r3.z = inversesqrt(r3.z);
/*56*/	r1.xyz = (r1.xyzx * r3.zzzz).xyz;
/*57*/	r4.xyz = (r2.wwww * r2.xyzx).xyz;
/*58*/	r2.xyz = (r4.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r2.xyzx).xyz;
...
/*64*/	r5.xyz = (r2.wwww * vsOut_T4.xyzx).xyz;
...
/*69*/	r7.xyz = (r1.xxxx * r4.xyzx + r7.xyzx).xyz;
/*70*/	r7.xyz = (r1.zzzz * r6.xyzx + r7.xyzx).xyz;
/*71*/	r2.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*72*/	r2.w = inversesqrt(r2.w);
/*73*/	r7.xyz = (r2.wwww * r7.xyzx).xyz;
/*74*/	r1.xyz = (mix(r7.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
...
/*126*/	    r2.xyz = (r0.wwww * r9.xyzx + r2.xyzx).xyz;
...
/*130*/	    r2.w = dot(vec2(r7.xyxx), vec2(r7.xyxx));
...
/*136*/	    r2.w = sqrt(r2.w);
/*137*/	    r7.xyz = (r8.xyzx * r2.wwww + r7.xyzx).xyz;
/*138*/	    r2.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*139*/	    r2.w = inversesqrt(r2.w);
/*140*/	    r7.xyz = (r2.wwww * r7.xyzx).xyz;
...
/*147*/	    r4.xyz = (r0.wwww * r4.xyzx + r1.xyzx).xyz;
/*148*/	    r0.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*149*/	    r0.w = inversesqrt(r0.w);
/*150*/	    r1.xyz = (r0.wwww * r4.xyzx).xyz;
/*151*/	  }
/*152*/	}
/*153*/	r0.w = vsOut_T7.y * -r3.y + r3.y;
/*154*/	r3.yzw = (r0.xxyz * vec4(0.000000, 5.000000, 5.000000, 5.000000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*155*/	r3.yzw = (-r0.xxyz + r3.yyzw).yzw;
/*156*/	r0.xyz = saturate(vsOut_T7.yyyy * r3.yzwy + r0.xyzx).xyz;
/*157*/	r2.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*158*/	r3.yzw = (-r0.xxyz + r2.wwww).yzw;
/*159*/	r0.xyz = (vsOut_T7.zzzz * r3.yzwy + r0.xyzx).xyz;
...
/*181*/	r5.w = saturate(r0.w * 60.000000);
/*182*/	r5.w = -r0.w + r5.w;
...
/*196*/	r8.xyz = (r0.xyzx * r8.xyzx).xyz;
/*197*/	r6.w = -r0.w + 1.000000;
...
/*293*/	r3.xyz = (max(r0.wwww, r3.xyzx)).xyz;
/*294*/	r3.xyz = (-r3.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*295*/	r0.xyz = (r0.xyzx * r1.yyyy).xyz;
