...
// Fragment Shader
//
// id: 2341 - fxc/glsl_SM_4_0_weightedwithdirtburn.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour_slm_40.glsl
//
...
/*84*/	color2.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*85*/	color2.w = 0;
/*86*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*87*/	r0.w = 1.000000;
/*88*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*89*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*90*/	color3.x = r1.x / r0.x;
