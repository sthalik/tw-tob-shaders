...
// Fragment Shader
//
// id: 4913 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecaldirtmesh.hlsl_PS_ps30_alpha_test.glsl
//
...
/*103*/	r2.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*104*/	r2.w = inversesqrt(r2.w);
/*105*/	r7.xyz = (r2.wwww * r7.xyzx).xyz;
/*106*/	r1.xyz = (mix(r7.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
...
/*116*/	  r3.xy = (r3.xyxx + vec4(0.200000, 0.300000, 0.000000, 0.000000)).xy;
/*117*/	}
...
/*150*/	    r0.w = r0.w * r0.w;
/*151*/	    r0.w = r0.w * r2.w;
/*152*/	    r3.y = r0.w * -r3.y + r3.y;
/*153*/	    r2.w = -r3.x + 0.200000;
/*154*/	    r3.x = r0.w * r2.w + r3.x;
...
/*183*/	  }
/*184*/	}
/*185*/	r0.w = vsOut_T7.y * -r3.x + r3.x;
/*186*/	r3.xzw = (r0.xxyz * vec4(5.000000, 0.000000, 5.000000, 5.000000) + vec4(0.200000, 0.000000, 0.200000, 0.200000)).xzw;
/*187*/	r3.xzw = (-r0.xxyz + r3.xxzw).xzw;
/*188*/	r0.xyz = saturate(vsOut_T7.yyyy * r3.xzwx + r0.xyzx).xyz;
/*189*/	r2.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*190*/	r3.xzw = (-r0.xxyz + r2.wwww).xzw;
/*191*/	r0.xyz = (vsOut_T7.zzzz * r3.xzwx + r0.xyzx).xyz;
/*192*/	r2.w = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*193*/	r3.xzw = (-r2.xxyz + r2.wwww).xzw;
/*194*/	r2.xyz = (vsOut_T7.zzzz * r3.xzwx + r2.xyzx).xyz;
...
/*201*/	r3.x = inversesqrt(r2.w);
/*202*/	r3.xzw = (r3.xxxx * r4.xxyz).xzw;
/*203*/	r5.x = -r3.y + 1.000000;
/*204*/	r5.y = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*205*/	r5.z = dot(vec3(r3.xzwx), vec3(r1.xyzx));
/*206*/	r5.z = r5.z + r5.z;
/*207*/	r6.xyz = (r1.xyzx * -r5.zzzz + r3.xzwx).xyz;
...
/*233*/	  r6.w = dot(vec3(r6.xyzx), vec3(r3.xzwx));
...
/*262*/	  r1.z = r3.y * r3.y;
/*263*/	    r3.y = (floatBitsToUint(r5.y) > 0x00000000u) ? 0.995900 : -0.000100;
/*264*/	  r1.z = r1.z * r3.y + r7.x;
/*265*/	  r1.z = r1.z * 0.500000 + 0.500000;
/*266*/	  r1.z = r1.z * 2.000000 + -1.000000;
/*267*/	  r3.y = -r1.z * r1.z + 1.000000;
/*268*/	  r3.y = max(r3.y, 0.001000);
/*269*/	  r3.y = log2(r3.y);
/*270*/	  r5.y = r3.y * 4.950617;
/*271*/	  r3.y = r3.y * 0.346574 + 4.546885;
...
/*307*/	  r3.y = r5.x * 1.570796;
/*308*/	  r3.y = sin(r3.y);
/*309*/	  r1.z = r1.z + -1.000000;
/*310*/	  r1.z = r3.y * r1.z + 1.000000;
/*311*/	  r3.x = dot(vec3(-cb1.data[0].yzwy), vec3(r3.xzwx));
