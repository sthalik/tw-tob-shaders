...
// Fragment Shader
//
// id: 5257 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdirtmesh.hlsl_PS_ps40_rigid_forward_lighting_noclip_no_faction_colour_HDR.glsl
//
...
/*22*/	r5.xyzw = (texture(s_decal_dirt_mask, vsOut_T1.xyxx.st)).xyzw;
/*23*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy + vsOut_T6.yyyz).zw;
/*24*/	r6.xyzw = (texture(s_decal_dirt_map, r3.zwzz.st)).xyzw;
/*25*/	r3.zw = (r6.xxxy * vec4(0.000000, 0.000000, 2.000000, 2.000000) + vec4(0.000000, 0.000000, -1.000000, -1.000000)).zw;
/*26*/	r2.w = r5.w * r6.w;
/*27*/	r5.xyz = (-r1.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*28*/	r1.xyz = (r2.wwww * r5.xyzx + r1.xyzx).xyz;
/*29*/	r0.xy = (r3.zwzz * r5.wwww + r0.xyxx).xy;
/*30*/	r3.z = dot(vec3(r0.xywx), vec3(r0.xywx));
/*31*/	r3.z = inversesqrt(r3.z);
/*32*/	r0.xyw = (r0.xyxw * r3.zzzz).xyw;
/*33*/	r5.xyz = (r2.wwww * r2.xyzx).xyz;
/*34*/	r2.xyz = (r5.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r2.xyzx).xyz;
/*35*/	r2.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*36*/	r2.w = inversesqrt(r2.w);
/*37*/	r5.xyz = (r2.wwww * vsOut_T3.xyzx).xyz;
/*38*/	r2.w = dot(vec3(vsOut_T4.xyzx), vec3(vsOut_T4.xyzx));
/*39*/	r2.w = inversesqrt(r2.w);
/*40*/	r6.xyz = (r2.wwww * vsOut_T4.xyzx).xyz;
/*41*/	r2.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*42*/	r2.w = inversesqrt(r2.w);
/*43*/	r7.xyz = (r2.wwww * vsOut_T2.xyzx).xyz;
/*44*/	r8.xyz = (r0.yyyy * r6.xyzx).xyz;
/*45*/	r8.xyz = (r0.xxxx * r5.xyzx + r8.xyzx).xyz;
/*46*/	r8.xyz = (r0.wwww * r7.xyzx + r8.xyzx).xyz;
/*47*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*48*/	r2.w = inversesqrt(r2.w);
/*49*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*50*/	r0.xyz = (mix(r8.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
...
/*56*/	  r8.xy = (r0.wwww * vec4(-0.700000, 0.660000, 0.000000, 0.000000)).xy;
/*57*/	  r3.zw = (vsOut_T1.xxxy * r3.zzzz + r8.xxxy).zw;
/*58*/	  r8.xyzw = (texture(s_fire_map, r3.zwzz.st)).xyzw;
/*59*/	  r2.xyz = (r8.xxxx * vec4(0.600000, 0.600000, 0.600000, 0.000000) + r2.xyzx).xyz;
...
/*66*/	    r8.xyzw = vsOut_T0.xzxz * vec4(0.000500, 0.000500, 0.070000, 0.070000);
/*67*/	    r9.xyzw = (texture(s_snow_normals, r8.xyxx.st)).xyzw;
/*68*/	    r3.zw = (r9.wwwy + vec4(0.000000, 0.000000, 0.001961, 0.001961)).zw;
/*69*/	    r9.xy = (r3.zwzz * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*70*/	    r0.w = dot(vec2(r9.xyxx), vec2(r9.xyxx));
/*71*/	    r0.w = -r0.w + 1.000000;
/*72*/	    r0.w = max(r0.w, 0.000000);
/*73*/	    r9.z = sqrt(r0.w);
/*74*/	    r10.xyz = (r9.xzyx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r0.xyzx).xyz;
/*75*/	    r0.w = dot(vec3(r10.xyzx), vec3(r10.xyzx));
/*76*/	    r0.w = inversesqrt(r0.w);
/*77*/	    r10.xyz = (r0.wwww * r10.xyzx).xyz;
/*78*/	    r11.xz = (cb3.data[0].xxyx).xz/**/;
/*79*/	    r11.y = -1.000000;
/*80*/	    r0.w = dot(vec3(r11.xyzx), vec3(r11.xyzx));
/*81*/	    r0.w = inversesqrt(r0.w);
/*82*/	    r11.xyz = (r0.wwww * r11.xyzx).xyz;
/*83*/	    r0.w = saturate(dot(vec3(-r11.xyzx), vec3(r10.xyzx)));
...
/*99*/	    r10.xyz = (-r1.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*100*/	    r1.xyz = (r0.wwww * r10.xyzx + r1.xyzx).xyz;
/*101*/	    r10.xyz = (-r2.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*102*/	    r2.xyz = (r0.wwww * r10.xyzx + r2.xyzx).xyz;
/*103*/	    r8.xyzw = (texture(s_snow_normals, r8.zwzz.st)).xyzw;
...
/*106*/	    r2.w = dot(vec2(r8.xyxx), vec2(r8.xyxx));
/*107*/	    r2.w = -r2.w + 1.000000;
/*108*/	    r2.w = max(r2.w, 0.000000);
/*109*/	    r8.z = sqrt(r2.w);
/*110*/	    r9.xyz = (r9.xyzx + r9.xyzx).xyz;
/*111*/	    r2.w = dot(vec2(cb3.data[0].xyxx), vec2(cb3.data[0].xyxx));
/*112*/	    r2.w = sqrt(r2.w);
/*113*/	    r8.xyz = (r9.xyzx * r2.wwww + r8.xyzx).xyz;
/*114*/	    r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*115*/	    r2.w = inversesqrt(r2.w);
/*116*/	    r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*117*/	    r6.xyz = (r6.xyzx * r8.yyyy).xyz;
/*118*/	    r5.xyz = (r8.xxxx * r5.xyzx + r6.xyzx).xyz;
/*119*/	    r5.xyz = (r8.zzzz * r7.xyzx + r5.xyzx).xyz;
/*120*/	    r2.w = -r0.y + 1.000000;
/*121*/	    r0.w = min(r0.w, r2.w);
/*122*/	    r5.xyz = (-r0.xyzx + r5.xyzx).xyz;
/*123*/	    r5.xyz = (r0.wwww * r5.xyzx + r0.xyzx).xyz;
/*124*/	    r0.w = dot(vec3(r5.xyzx), vec3(r5.xyzx));
/*125*/	    r0.w = inversesqrt(r0.w);
/*126*/	    r0.xyz = (r0.wwww * r5.xyzx).xyz;
/*127*/	  }
/*128*/	}
/*129*/	r0.w = vsOut_T7.y * -r3.y + r3.y;
/*130*/	r3.yzw = (r1.xxyz * vec4(0.000000, 5.000000, 5.000000, 5.000000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*131*/	r3.yzw = (-r1.xxyz + r3.yyzw).yzw;
/*132*/	r1.xyz = saturate(vsOut_T7.yyyy * r3.yzwy + r1.xyzx).xyz;
