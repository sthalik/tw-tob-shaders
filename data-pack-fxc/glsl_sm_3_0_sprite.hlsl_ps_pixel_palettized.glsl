...
// Fragment Shader
//
// id: 176 - fxc/glsl_SM_3_0_sprite.hlsl_PS_pixel_palettized.glsl
//
...
/*73*/	r0.x = (floatBitsToUint(r0.x) > 0x00000000u) ? r1.z : r1.x;
/*74*/	r0.x = r0.x * vsOut_C0.w;
/*75*/	r0.z = r0.y * r0.x + -0.003922;
/*76*/	r0.x = r0.x * r0.y;
/*77*/	color0.w = r0.x;
/*78*/	r0.x = uintBitsToFloat((r0.z < 0.000000) ? 0xffffffffu : 0x00000000u);
/*79*/	if(r0.x != 0) discard;
/*80*/	r0.xy = (-vsOut_T4.xwxx + vsOut_T5.xyxx).xy;
/*81*/	r0.zw = (vsOut_T4.zzzy + -vsOut_T5.xxxy).zw;
/*82*/	r0.xyzw = uintBitsToFloat(uvec4(lessThan(r0.xyzw, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu);
/*83*/	r0.xy = (uintBitsToFloat(floatBitsToUint(r0.zwzz) | floatBitsToUint(r0.xyxx))).xy;
/*84*/	r0.x = uintBitsToFloat(floatBitsToUint(r0.y) | floatBitsToUint(r0.x));
/*85*/	if(r0.x != 0) discard;
/*86*/	return;
}
