...
// Fragment Shader
//
// id: 3875 - fxc/glsl_SM_3_0_hdr_tone_mapper.hlsl_PS_ps_blur_y.glsl
//
...
/*7*/	  r0.y = r0.w + -5.000000;
/*8*/	  r0.yw = (-r0.xxxy + gl_FragCoord.xxxy).yw;
/*9*/	  r0.yw = (r0.yyyw + cb0.data[28].xxxx).yw;
/*10*/	  r0.yw = (r0.yyyw * cb1.data[0].xxxy).yw;
/*11*/	  r2.xyzw = (textureLod(g_hdr_rgb_texture_sampler, r0.ywyy.st, 0.000000)).xyzw;
