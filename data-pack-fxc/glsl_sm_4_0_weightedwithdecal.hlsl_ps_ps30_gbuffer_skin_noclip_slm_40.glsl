...
// Fragment Shader
//
// id: 1976 - fxc/glsl_SM_4_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_skin_noclip_slm_40.glsl
//
...
/*48*/	r4.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
/*49*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*50*/	r0.w = inversesqrt(r0.w);
/*51*/	r5.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*52*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*53*/	r0.w = inversesqrt(r0.w);
/*54*/	r6.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*55*/	r5.xyz = (r2.yyyy * r5.xyzx).xyz;
/*56*/	r2.xyw = (r2.xxxx * r4.xyxz + r5.xyxz).xyw;
/*57*/	r2.xyz = (r2.zzzz * r6.xyzx + r2.xywx).xyz;
/*58*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*59*/	r0.w = inversesqrt(r0.w);
/*60*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*61*/	r0.w = -vsOut_T4.z + 1.000000;
/*62*/	r4.xyz = (vsOut_T4.zzzz * cb2.data[3].xyzx).xyz;
/*63*/	r0.xyz = (r0.xyzx * r0.wwww + r4.xyzx).xyz;
/*64*/	r0.w = vsOut_T7.x * -r3.x + r3.x;
...
/*68*/	r1.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*69*/	r3.xzw = (-r0.xxyz + r1.wwww).xzw;
/*70*/	r0.xyz = (vsOut_T7.yyyy * r3.xzwx + r0.xyzx).xyz;
/*71*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*72*/	r3.xzw = (-r1.xxyz + r1.wwww).xzw;
/*73*/	color2.xyz = saturate(vsOut_T7.yyyy * r3.xzwx + r1.xyzx).xyz;
/*74*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*75*/	r1.xyz = (vsOut_T0.xyzx).xyz;
/*76*/	r1.w = 1.000000;
/*77*/	r0.w = dot(r1.xyzw, cb0.data[11].xyzw);
/*78*/	r1.x = dot(r1.xyzw, cb0.data[12].xyzw);
/*79*/	color3.x = r0.w / r1.x;
/*80*/	r0.w = max(abs(r2.z), abs(r2.y));
/*81*/	r0.w = max(r0.w, abs(r2.x));
/*82*/	r1.xyz = (r2.xyzx / r0.wwww).xyz;
/*83*/	color0.xyz = saturate(r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*84*/	color0.w = saturate(r3.y);
