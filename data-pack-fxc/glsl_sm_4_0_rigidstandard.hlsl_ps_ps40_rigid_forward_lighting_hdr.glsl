...
// Fragment Shader
//
// id: 674 - fxc/glsl_SM_4_0_rigidstandard.hlsl_PS_ps40_rigid_forward_lighting_HDR.glsl
//
...
/*57*/	r0.z = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*70*/	  r0.z = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*155*/	r4.x = dot(vec3(r3.yzwy), vec3(r1.xyzx));
/*156*/	r4.x = r4.x + r4.x;
/*157*/	r4.xyz = (r1.xyzx * -r4.xxxx + r3.yzwy).xyz;
...
/*163*/	r5.w = saturate(r0.z * 60.000000);
/*164*/	r5.w = -r0.z + r5.w;
/*165*/	r6.xzw = (r1.xxyz * vec4(1.000000, 0.000000, 4.000000, 1.000000)).xzw;
...
/*178*/	r6.xzw = (r0.xxyw * r6.xxzw).xzw;
/*179*/	r5.y = -r0.z + 1.000000;
...
/*194*/	}
/*195*/	r5.y = dot(vec3(r1.xyzx), vec3(-cb1.data[0].yzwy));
...
/*277*/	r0.xyw = (r0.xyxw * r7.xxxx).xyw;
/*278*/	r0.xyw = (r0.xyxw * cb1.data[1].xyxz).xyw;
/*279*/	r0.xyw = (r3.xyxz * r0.xyxw).xyw;
/*280*/	r0.xyw = (r5.xxxx * r0.xyxw).xyw;
/*281*/	r0.xyw = (r4.xyxz * cb1.data[1].xyxz + r0.xyxw).xyw;
/*282*/	r0.xyw = (r0.xyxw + r6.xzxw).xyw;
...
/*287*/	r1.w = dot(vec3(-r3.xyzx), vec3(r1.xyzx));
/*288*/	r1.w = r1.w + r1.w;
/*289*/	r1.xyz = (r1.xyzx * -r1.wwww + -r3.xyzx).xyz;
/*290*/	r6.xyzw = (textureLod(s_environment, r1.xyzx.stp, r6.y)).xyzw;
/*291*/	r1.x = dot(vec3(r1.xyzx), vec3(-r3.xyzx));
/*292*/	r1.x = max(r1.x, 0.000000);
/*293*/	r1.x = log2(r1.x);
/*294*/	r1.x = r1.x * 10.000000;
/*295*/	r1.x = exp2(r1.x);
/*296*/	r1.x = r4.w * r1.x;
/*297*/	r0.z = r1.x * r5.w + r0.z;
/*298*/	r1.xyz = (r6.xyzx * r0.zzzz).xyz;
/*299*/	color0.xyz = (r1.xyzx * r2.xyzx + r0.xywx).xyz;
