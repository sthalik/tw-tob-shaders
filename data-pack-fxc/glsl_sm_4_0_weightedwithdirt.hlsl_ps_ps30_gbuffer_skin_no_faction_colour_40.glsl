...
// Fragment Shader
//
// id: 1901 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_skin_no_faction_colour_40.glsl
//
...
/*50*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*51*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*52*/	color2.xyzw = r0.xyzz;
