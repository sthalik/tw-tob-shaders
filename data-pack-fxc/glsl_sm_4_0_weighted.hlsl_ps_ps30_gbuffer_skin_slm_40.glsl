...
// Fragment Shader
//
// id: 1838 - fxc/glsl_SM_4_0_weighted.hlsl_PS_ps30_gbuffer_skin_slm_40.glsl
//
...
/*49*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*50*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*51*/	r0.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
