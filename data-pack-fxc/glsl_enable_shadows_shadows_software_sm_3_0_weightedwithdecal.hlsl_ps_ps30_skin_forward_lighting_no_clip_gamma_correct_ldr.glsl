...
// Fragment Shader
//
// id: 6063 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecal.hlsl_PS_ps30_skin_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*70*/	r5.w = 1.000000;
/*71*/	r2.x = dot(r5.xyzw, cb1.data[12].xyzw);
/*72*/	r6.xyz = (-cb2.data[35].xyzx * cb2.data[34].zzzz + vsOut_T0.xyzx).xyz;
/*73*/	r7.x = uintBitsToFloat((r2.x >= cb2.data[37].x) ? 0xffffffffu : 0x00000000u);
/*74*/	r7.y = uintBitsToFloat((r2.x >= cb2.data[38].x) ? 0xffffffffu : 0x00000000u);
/*75*/	r7.z = uintBitsToFloat((r2.x >= cb2.data[39].x) ? 0xffffffffu : 0x00000000u);
/*76*/	r7.w = uintBitsToFloat((r2.x >= cb2.data[40].x) ? 0xffffffffu : 0x00000000u);
...
/*262*/	r2.y = r2.y * 127.000000 + 1.600000;
/*263*/	r2.w = log2(r2.w);
/*264*/	r2.y = r2.w * r2.y;
/*265*/	r2.y = exp2(r2.y);
/*266*/	r2.y = min(r2.y, 1.000000);
/*267*/	r1.w = r1.w * r2.y;
/*268*/	r9.xyz = (r1.wwww * cb3.data[1].xyzx).xyz;
/*269*/	r9.xyz = (r8.xxxx * r9.xyzx).xyz;
/*270*/	r1.w = dot(vec3(-r7.xyzx), vec3(r3.xyzx));
/*271*/	r2.y = r1.w + r1.w;
/*272*/	r3.xyz = (r3.xyzx * -r2.yyyy + -r7.xyzx).xyz;
/*273*/	r3.xyz = (r3.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*274*/	r2.y = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*275*/	r2.y = inversesqrt(r2.y);
/*276*/	r3.xyz = (r2.yyyy * r3.xyzx).xyz;
