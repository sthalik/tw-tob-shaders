...
// Fragment Shader
//
// id: 1661 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour_40.glsl
//
...
/*55*/	r1.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*56*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & uint(0x3c008081u));
/*57*/	color2.xyzw = saturate(r0.xyzw);
...
/*64*/	color4 = floatBitsToUint(vsOut_T9.z);
/*65*/	return;
}
