...
// Fragment Shader
//
// id: 4719 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidstandardfire.hlsl_PS_ps30_rigid_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*38*/	r4.x = 0;
/*39*/	r4.y = cb1.data[26].x * 0.050000;
...
/*180*/	r3.yzw = (r2.wwww * r4.xxyz).yzw;
/*181*/	r2.w = -r3.x + 1.000000;
/*182*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*183*/	r5.y = dot(vec3(r3.yzwy), vec3(r1.xyzx));
/*184*/	r5.y = r5.y + r5.y;
/*185*/	r5.yzw = (r1.xxyz * -r5.yyyy + r3.yyzw).yzw;
...
/*211*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.yzwy));
...
/*240*/	  r1.z = r3.x * r3.x;
/*241*/	    r3.x = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*242*/	  r1.z = r1.z * r3.x + r6.x;
/*243*/	  r1.z = r1.z * 0.500000 + 0.500000;
/*244*/	  r1.z = r1.z * 2.000000 + -1.000000;
/*245*/	  r3.x = -r1.z * r1.z + 1.000000;
/*246*/	  r3.x = max(r3.x, 0.001000);
/*247*/	  r3.x = log2(r3.x);
/*248*/	  r5.x = r3.x * 4.950617;
...
/*289*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.yzwy));
