...
// Fragment Shader
//
// id: 4456 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidambientmapmesh.hlsl_PS_ps30_alpha_overlay_40.glsl
//
...
/*59*/	r0.z = uintBitsToFloat((floatBitsToInt(cb3.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*72*/	  r0.z = uintBitsToFloat((0.000000 < cb3.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*92*/	    r1.w = cb3.data[1].x * cb3.data[1].x;
/*93*/	    r1.w = r1.w * 1.250000;
/*94*/	    r1.w = min(r1.w, 1.000000);
/*95*/	    r2.w = saturate(cb3.data[1].x * cb3.data[1].x + -0.800000);
...
/*119*/	    r1.w = dot(vec2(cb3.data[0].xyxx), vec2(cb3.data[0].xyxx));
/*120*/	    r1.w = sqrt(r1.w);
...
/*151*/	r4.xyz = (vsOut_T0.xyzx + -cb0.data[0].xyzx).xyz;
/*152*/	r1.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*153*/	r2.w = inversesqrt(r1.w);
/*154*/	r3.yzw = (r2.wwww * r4.xxyz).yzw;
/*155*/	r2.w = -r3.x + 1.000000;
/*156*/	r5.x = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
...
/*172*/	r9.xyz = (mix(cb1.data[2].xyzx, cb1.data[3].xyzx, greaterThan(floatBitsToUint(r8.xxxx), uvec4(0)))).xyz/**/;
/*173*/	r8.xyw = (mix(cb1.data[4].xyxz, cb1.data[5].xyxz, greaterThan(floatBitsToUint(r8.yyyy), uvec4(0)))).xyw/**/;
/*174*/	r10.xyz = (mix(cb1.data[6].xyzx, cb1.data[7].xyzx, greaterThan(floatBitsToUint(r8.zzzz), uvec4(0)))).xyz/**/;
...
/*263*/	  r2.w = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
...
/*280*/	r0.xyz = (r0.xyzx * cb1.data[1].xyzx).xyz;
/*281*/	r0.xyz = (r3.xyzx * r0.xyzx).xyz;
/*282*/	r0.xyz = (r6.xxxx * r0.xyzx).xyz;
/*283*/	r0.xyz = (r2.xyzx * cb1.data[1].xyzx + r0.xyzx).xyz;
/*284*/	r0.xyz = (r0.xyzx + r7.yzwy).xyz;
/*285*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*286*/	r2.w = 1.000000;
/*287*/	r1.x = dot(r2.xyzw, cb0.data[9].xyzw);
/*288*/	r1.y = dot(r2.xyzw, cb0.data[10].xyzw);
/*289*/	r0.w = dot(r2.xyzw, cb0.data[12].xyzw);
/*290*/	r1.xy = (r1.xyxx / r0.wwww).xy;
/*291*/	r2.xy = (uintBitsToFloat(uvec4(greaterThanEqual(r1.xyxx, cb0.data[34].xyxx)) * 0xffffffffu)).xy;
/*292*/	r1.xy = (uintBitsToFloat(uvec4(greaterThanEqual(cb0.data[34].zwzz, r1.xyxx)) * 0xffffffffu)).xy;
...
/*298*/	r0.w = sqrt(r1.w);
/*299*/	r1.x = saturate(cb2.data[0].w)/**/;
/*300*/	r1.x = -r1.x + 1.000000;
/*301*/	r1.x = r1.x * 8.000000 + -4.000000;
/*302*/	r1.y = saturate(cb2.data[1].x)/**/;
...
/*308*/	r0.w = exp2(r0.w);
/*309*/	r0.w = cb2.data[1].y / r0.w;
/*310*/	r0.w = saturate(-r0.w + cb2.data[1].y);
/*311*/	r1.x = -vsOut_T0.y + cb2.data[1].w;
/*312*/	r1.y = -cb2.data[1].z + cb2.data[1].w;
/*313*/	r1.x = r1.x + -cb2.data[1].z;
...
/*320*/	r1.y = sqrt(r1.y);
/*321*/	r1.z = max(cb2.data[2].z, 0.001000);
...
/*326*/	r1.y = r1.y * r1.y;
/*327*/	r1.y = r1.y * r1.z;
/*328*/	r0.w = cb2.data[2].x * r1.x + r0.w;
/*329*/	r1.xzw = (cb1.data[1].xxyz * cb2.data[0].xxyz).xzw;
/*330*/	r1.xzw = (r1.xxzw * vec4(1.500000, 0.000000, 1.500000, 1.500000)).xzw;
/*331*/	r1.xzw = (r1.xxzw * abs(cb1.data[0].zzzz)).xzw;
/*332*/	r2.xyz = (r6.xxxx * r1.xzwx).xyz;
/*333*/	r4.w = max(r4.y, 0.000000);
/*334*/	r3.xyzw = (texture(s_sky, r4.xwzx.stp)).xyzw;
/*335*/	r2.w = saturate(dot(vec2(r0.wwww), vec2(cb2.data[2].yyyy)));
...
/*340*/	color0.xyz = (r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*341*/	return;
}
