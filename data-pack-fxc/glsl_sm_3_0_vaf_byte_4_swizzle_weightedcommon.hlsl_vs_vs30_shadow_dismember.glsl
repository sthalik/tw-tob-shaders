...
// Vertex Shader
//
// id: 2081 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_weightedcommon.hlsl_VS_vs30_shadow_dismember.glsl
//
...
/*42*/	r0.w = 1.000000;
/*43*/	r1.x = dot(r0.xyzw, vsIn_T0.xyzw);
/*44*/	r1.y = dot(r0.xyzw, vsIn_T1.xyzw);
/*45*/	r1.z = dot(r0.xyzw, vsIn_T2.xyzw);
/*46*/	r1.w = 1.000000;
/*47*/	gl_Position.x = dot(r1.xyzw, cb0.data[9].xyzw);
/*48*/	gl_Position.y = dot(r1.xyzw, cb0.data[10].xyzw);
/*49*/	gl_Position.z = dot(r1.xyzw, cb0.data[11].xyzw);
/*50*/	gl_Position.w = dot(r1.xyzw, cb0.data[12].xyzw);
/*51*/	vsOut_T2.xyzw = r1.xyzw;
/*52*/	vsOut_T1.xy = (vsIn_P3.xyxx).xy;
/*53*/	return;
}
