...
// Fragment Shader
//
// id: 5234 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdirtmesh.hlsl_PS_ps30_imposter.glsl
//
...
/*22*/	r1.xy = (vsOut_T1.xyxx * cb2.data[2].xyxx + vsOut_T6.yzyy).xy;
...
/*27*/	r1.x = uintBitsToFloat((0.000000 < vsOut_T6.w) ? 0xffffffffu : 0x00000000u);
/*28*/	if(floatBitsToUint(r1.x) != 0u) {
/*29*/	  r1.x = uintBitsToFloat((0.000000 < cb1.data[1].x) ? 0xffffffffu : 0x00000000u);
/*30*/	  if(floatBitsToUint(r1.x) != 0u) {
/*31*/	    r3.xyzw = (texture(s_normal_map, vsOut_T1.xyxx.st)).xyzw;
/*32*/	    r1.xy = (r3.wyww + vec4(0.001961, 0.001961, 0.000000, 0.000000)).xy;
/*33*/	    r1.xy = (r1.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*34*/	    r2.z = dot(vec2(r1.xyxx), vec2(r1.xyxx));
/*35*/	    r2.z = -r2.z + 1.000000;
/*36*/	    r2.z = max(r2.z, 0.000000);
/*37*/	    r1.z = sqrt(r2.z);
/*38*/	    r1.xyz = (mix(r1.xyzx, vsOut_T2.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
/*39*/	    r2.xy = (r2.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*40*/	    r1.xy = (r2.xyxx * r1.wwww + r1.xyxx).xy;
...
/*46*/	    r2.xyz = (r1.wwww * vsOut_T3.xyzx).xyz;
/*47*/	    r1.w = dot(vec3(vsOut_T4.xyzx), vec3(vsOut_T4.xyzx));
/*48*/	    r1.w = inversesqrt(r1.w);
/*49*/	    r3.xyz = (r1.wwww * vsOut_T4.xyzx).xyz;
/*50*/	    r1.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*51*/	    r1.w = inversesqrt(r1.w);
/*52*/	    r4.xyz = (r1.wwww * vsOut_T2.xyzx).xyz;
/*53*/	    r3.xyz = (r1.yyyy * r3.xyzx).xyz;
/*54*/	    r2.xyz = (r1.xxxx * r2.xyzx + r3.xyzx).xyz;
/*55*/	    r2.xyz = (r1.zzzz * r4.xyzx + r2.xyzx).xyz;
/*56*/	    r1.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*57*/	    r1.w = inversesqrt(r1.w);
/*58*/	    r2.xyz = (r1.wwww * r2.xyzx).xyz;
/*59*/	    r1.xyz = (mix(r2.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
/*60*/	    r2.xy = (vsOut_T0.xzxx * vec4(0.000500, 0.000500, 0.000000, 0.000000)).xy;
/*61*/	    r2.xyzw = (texture(s_snow_normals, r2.xyxx.st)).xyzw;
/*62*/	    r2.xy = (r2.wyww + vec4(0.001961, 0.001961, 0.000000, 0.000000)).xy;
/*63*/	    r2.xz = (r2.xxyx * vec4(2.000000, 0.000000, 2.000000, 0.000000) + vec4(-1.000000, 0.000000, -1.000000, 0.000000)).xz;
/*64*/	    r0.w = dot(vec2(r2.xzxx), vec2(r2.xzxx));
/*65*/	    r0.w = -r0.w + 1.000000;
/*66*/	    r0.w = max(r0.w, 0.000000);
/*67*/	    r2.y = sqrt(r0.w);
/*68*/	    r1.xyz = (r2.xyzx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r1.xyzx).xyz;
/*69*/	    r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*70*/	    r0.w = inversesqrt(r0.w);
/*71*/	    r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*72*/	    r2.xz = (cb1.data[0].xxyx).xz/**/;
/*73*/	    r2.y = -1.000000;
/*74*/	    r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*75*/	    r0.w = inversesqrt(r0.w);
/*76*/	    r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*77*/	    r0.w = saturate(dot(vec3(-r2.xyzx), vec3(r1.xyzx)));
/*78*/	    r1.x = cb1.data[1].x * cb1.data[1].x;
/*79*/	    r1.x = r1.x * 1.250000;
/*80*/	    r1.x = min(r1.x, 1.000000);
/*81*/	    r1.y = saturate(cb1.data[1].x * cb1.data[1].x + -0.800000);
/*82*/	    r1.y = r1.y * 4.000000;
/*83*/	    r1.x = r1.x * 0.200000 + r1.y;
/*84*/	    r1.x = r1.x * -0.700000 + 1.000000;
/*85*/	    r0.w = r0.w + -r1.x;
/*86*/	    r0.w = saturate(r0.w * 200.000000);
/*87*/	    r1.x = r0.w * -2.000000 + 3.000000;
/*88*/	    r0.w = r0.w * r0.w;
/*89*/	    r0.w = r0.w * r1.x;
/*90*/	    r1.xyz = (-r0.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*91*/	    r0.xyz = (r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*92*/	  }
/*93*/	}
/*94*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*95*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*96*/	r0.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*97*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*98*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*99*/	r0.xyz = saturate(vsOut_T7.zzzz * r1.xyzx + r0.xyzx).xyz;
/*100*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*101*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*102*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*103*/	color0.w = 1.000000;
/*104*/	return;
}
