...
// Fragment Shader
//
// id: 219 - fxc/glsl_SM_3_0_hdr_tone_mapper.hlsl_PS_ps_constant_tone_mapper_with_bloom_and_gamma.glsl
//
...
/*5*/	r2.x = -cb2.data[0].x + cb2.data[0].y;
/*6*/	r2.y = r2.x * -0.340000 + cb2.data[0].y;
/*7*/	r2.z = r2.y / r0.w;
...
/*23*/	r1.x = max(r0.w, cb2.data[0].x);
/*24*/	r1.x = min(r1.x, cb2.data[0].y);
/*25*/	r1.x = r1.x + -cb2.data[0].x;
/*26*/	r1.x = r1.x / r2.x;
...
/*35*/	r2.xyzw = (texture(g_scurve_texture_sampler, r0.ywyy.st)).xyzw;
/*36*/	r0.xyzw = (texture(g_scurve_texture_sampler, r0.zwzz.st)).xyzw;
/*37*/	r1.z = saturate(r0.z);
/*38*/	r1.y = saturate(r2.y);
/*39*/	r0.xyz = (log2(r1.xyzx)).xyz;
/*40*/	r0.xyz = (r0.xyzx * cb1.data[0].zzzz).xyz;
