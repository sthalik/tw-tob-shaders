...
// Vertex Shader
//
// id: 570 - fxc/glsl_SM_3_0_rigidbranchcommon_v3.hlsl_VS_vs30_main.glsl
//
...
/*41*/	vsOut_T0.xyzw = r1.xyzw;
/*42*/	vsOut_C0.xyz = (vsIn_P7.xyzx).xyz;
/*43*/	vsOut_C0.w = -vsIn_T6.y + 1.000000;
/*44*/	vsOut_T1.xy = (vsIn_P5.xyxx).xy;
/*45*/	vsOut_T1.z = vsIn_T6.z;
/*46*/	vsOut_T2.x = dot(vsIn_T0.xyzw, vsIn_P2.xyzw);
/*47*/	vsOut_T2.y = dot(vsIn_T1.xyzw, vsIn_P2.xyzw);
/*48*/	vsOut_T2.z = dot(vsIn_T2.xyzw, vsIn_P2.xyzw);
/*49*/	vsOut_T3.x = dot(vsIn_T0.xyzw, vsIn_P3.xyzw);
/*50*/	vsOut_T3.y = dot(vsIn_T1.xyzw, vsIn_P3.xyzw);
/*51*/	vsOut_T3.z = dot(vsIn_T2.xyzw, vsIn_P3.xyzw);
/*52*/	vsOut_T4.x = dot(vsIn_T0.xyzw, vsIn_P4.xyzw);
/*53*/	vsOut_T4.y = dot(vsIn_T1.xyzw, vsIn_P4.xyzw);
/*54*/	vsOut_T4.z = dot(vsIn_T2.xyzw, vsIn_P4.xyzw);
/*55*/	r0.x = intBitsToFloat(gl_InstanceID + floatBitsToInt(cb2.data[4].w));
/*56*/	r0.yzw = (vec4(0, 0, 0, 0)).yzw;
/*57*/	r0.xyzw = uintBitsToFloat(texelFetch(t_pixel_selection_object_id_texture, floatBitsToInt(r0.xyzw).st, floatBitsToInt(r0.xyzw).a).xyzw);
/*58*/	vsOut_P1 = floatBitsToUint(r0.x);
/*59*/	return;
}
