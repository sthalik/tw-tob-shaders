...
// Fragment Shader
//
// id: 1834 - fxc/glsl_SM_4_0_weighted.hlsl_PS_ps30_gbuffer_skin_no_faction_colour_40.glsl
//
...
/*39*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*40*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*41*/	color2.xyzw = r0.xyzz;
/*42*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*43*/	r0.w = 1.000000;
/*44*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*45*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*46*/	color3.x = r1.x / r0.x;
/*47*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*48*/	color4 = floatBitsToUint(vsOut_T9.z);
/*49*/	return;
}
