...
// Vertex Shader
//
// id: 1398 - fxc/glsl_SM_3_0_VAF_BYTE_4_SWIZZLE_sailsymbol.hlsl_VS_vs30_main.glsl
//
...
/*13*/	vsOut_T0.w = vsIn_T2.x;
/*14*/	r0.x = dot(vec3(vsIn_T0.xyzx), vec3(vsIn_T0.xyzx));
/*15*/	r0.x = inversesqrt(r0.x);
/*16*/	r0.xyz = (r0.xxxx * vsIn_T0.xyzx).xyz;
/*17*/	vsOut_T2.x = dot(vec3(r0.xyzx), vec3(cb1.data[0].xyzx));
/*18*/	vsOut_T2.y = dot(vec3(r0.xyzx), vec3(cb1.data[1].xyzx));
/*19*/	vsOut_T2.z = dot(vec3(r0.xyzx), vec3(cb1.data[2].xyzx));
/*20*/	vsOut_T3.xyzw = vsIn_T1.xyzw;
/*21*/	vsOut_C0.xyzw = vsIn_C0.zyxw;
/*22*/	vsOut_C1.xyzw = vsIn_C1.zyxw;
/*23*/	return;
}
