...
// Fragment Shader
//
// id: 4889 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidtileddirtmapfiremesh.hlsl_PS_ps30_rigid_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*47*/	r6.x = 0;
/*48*/	r6.y = cb1.data[26].x * 0.050000;
...
/*189*/	r3.yzw = (r2.wwww * r4.xxyz).yzw;
/*190*/	r2.w = -r3.x + 1.000000;
/*191*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*192*/	r5.y = dot(vec3(r3.yzwy), vec3(r1.xyzx));
/*193*/	r5.y = r5.y + r5.y;
/*194*/	r5.yzw = (r1.xxyz * -r5.yyyy + r3.yyzw).yzw;
...
/*220*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.yzwy));
...
/*298*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.yzwy));
