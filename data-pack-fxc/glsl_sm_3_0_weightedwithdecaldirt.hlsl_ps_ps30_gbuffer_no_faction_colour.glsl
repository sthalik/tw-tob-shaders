...
// Fragment Shader
//
// id: 1783 - fxc/glsl_SM_3_0_weightedwithdecaldirt.hlsl_PS_ps30_gbuffer_no_faction_colour.glsl
//
...
/*61*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*67*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
...
/*80*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*81*/	r4.w = 1.000000;
/*82*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*83*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*84*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*85*/	color3.x = r0.w / r2.w;
/*86*/	r0.w = max(abs(r2.z), abs(r2.y));
/*87*/	r0.w = max(r0.w, abs(r2.x));
/*88*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*89*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*90*/	color0.w = saturate(r3.y);
/*91*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*92*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*93*/	color2.xyzw = saturate(r1.xyzw);
