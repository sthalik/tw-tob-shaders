...
// Fragment Shader
//
// id: 1332 - fxc/glsl_SM_3_0_rigidtextureblendwind.hlsl_PS_ps30_3dui_constant_HDR.glsl
//
...
/*0*/	r0.x = cb1.data[26].x + cb5.data[8].x;
...
/*47*/	r2.xy = (cb5.data[0].zwzz * r2.xyxx + cb5.data[0].xyxx).xy;
/*48*/	r2.zw = (cb5.data[1].zzzw * r2.zzzw + cb5.data[1].xxxy).zw;
...
/*53*/	r0.w = -cb6.data[11].w + 1.000000;
/*54*/	r0.w = max(r2.w, r0.w);
/*55*/	r3.xyzw = -cb6.data[12].xyzw + vec4(1.000000, 1.000000, 1.000000, 1.000000);
...
/*64*/	r5.xy = (cb5.data[2].zwzz * r5.xyxx + cb5.data[2].xyxx).xy;
/*65*/	r5.zw = (cb5.data[3].zzzw * r5.zzzw + cb5.data[3].xxxy).zw;
...
/*80*/	r6.xy = (cb5.data[4].zwzz * r6.xyxx + cb5.data[4].xyxx).xy;
/*81*/	r6.zw = (cb5.data[5].zzzw * r6.zzzw + cb5.data[5].xxxy).zw;
...
/*87*/	r0.w = r0.w * r3.x;
/*88*/	r3.xyz = (-cb6.data[13].xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
...
/*101*/	r9.xy = (cb5.data[6].zwzz * r9.xyxx + cb5.data[6].xyxx).xy;
/*102*/	r9.zw = (cb5.data[7].zzzw * r9.zzzw + cb5.data[7].xxxy).zw;
...
/*113*/	r2.xyz = (r2.xyzx * cb6.data[4].xyzx).xyz;
/*114*/	color0.w = r2.w * vsOut_T2.w;
/*115*/	r3.xyz = (r4.xyzx * cb6.data[5].xyzx).xyz;
/*116*/	r0.w = max(r4.w, cb6.data[12].x);
/*117*/	r1.w = -cb6.data[0].w + 1.000000;
/*118*/	r4.xyzw = uintBitsToFloat(uvec4(equal(cb6.data[14].xyzw, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu);
...
/*122*/	r1.w = r1.w * cb6.data[0].z;
/*123*/	r2.w = r0.w * r1.w;
/*124*/	r0.w = -r1.w * r0.w + 1.000000;
/*125*/	r3.xyz = (r2.wwww * r3.xyzx).xyz;
/*126*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*127*/	r3.xyz = (r5.xyzx * cb6.data[6].xyzx).xyz;
/*128*/	r0.w = max(r5.w, cb6.data[12].y);
/*129*/	r5.xy = (-cb6.data[1].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*132*/	r4.xy = (r4.xyxx * cb6.data[1].xzxx).xy;
/*133*/	r1.w = r0.w * r4.x;
/*134*/	r0.w = -r4.x * r0.w + 1.000000;
/*135*/	r3.xyz = (r1.wwww * r3.xyzx).xyz;
/*136*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*137*/	r3.xyz = (r7.xyzx * cb6.data[7].xyzx).xyz;
/*138*/	r0.w = max(r7.w, cb6.data[12].z);
/*139*/	r1.w = r0.w * r4.y;
/*140*/	r0.w = -r4.y * r0.w + 1.000000;
/*141*/	r3.xyz = (r1.wwww * r3.xyzx).xyz;
/*142*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*143*/	r3.xyz = (r6.xyzx * cb6.data[8].xyzx).xyz;
/*144*/	r0.w = max(r6.w, cb6.data[12].w);
/*145*/	r4.xy = (-cb6.data[2].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
/*146*/	r1.w = uintBitsToFloat((r4.w >= r4.x) ? 0xffffffffu : 0x00000000u);
/*147*/	r1.w = uintBitsToFloat(floatBitsToUint(r1.w) & uint(0x3f800000u));
/*148*/	r1.w = r1.w * cb6.data[2].x;
/*149*/	r2.w = r0.w * r1.w;
/*150*/	r0.w = -r1.w * r0.w + 1.000000;
/*151*/	r3.xyz = (r2.wwww * r3.xyzx).xyz;
/*152*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*153*/	r3.xyz = (r8.xyzx * cb6.data[9].xyzx).xyz;
/*154*/	r0.w = max(r8.w, cb6.data[13].x);
/*155*/	r4.xzw = (uintBitsToFloat(uvec4(equal(cb6.data[15].xxyz, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xzw;
...
/*159*/	r1.w = r1.w * cb6.data[2].z;
/*160*/	r2.w = r0.w * r1.w;
/*161*/	r0.w = -r1.w * r0.w + 1.000000;
/*162*/	r3.xyz = (r2.wwww * r3.xyzx).xyz;
/*163*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*164*/	r3.xyz = (r9.xyzx * cb6.data[10].xyzx).xyz;
/*165*/	r0.w = max(r9.w, cb6.data[13].y);
/*166*/	r4.xy = (-cb6.data[3].ywyy + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
...
/*169*/	r4.xy = (r4.xyxx * cb6.data[3].xzxx).xy;
/*170*/	r1.w = r0.w * r4.x;
/*171*/	r0.w = -r4.x * r0.w + 1.000000;
/*172*/	r3.xyz = (r1.wwww * r3.xyzx).xyz;
/*173*/	r2.xyz = (r2.xyzx * r0.wwww + r3.xyzx).xyz;
/*174*/	r3.xyz = (r10.xyzx * cb6.data[11].xyzx).xyz;
/*175*/	r0.w = max(r10.w, cb6.data[13].z);
/*176*/	r1.w = r0.w * r4.y;
...
/*206*/	r0.w = saturate(dot(vec3(r0.xyzx), vec3(-cb6.data[16].xyzx)));
/*207*/	r0.w = r0.w + 0.200000;
/*208*/	r1.xyz = (-vsOut_T0.xyzx + cb1.data[0].xyzx).xyz;
/*209*/	r1.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*210*/	r1.w = inversesqrt(r1.w);
/*211*/	r1.xyz = (r1.xyzx * r1.wwww + -cb6.data[16].xyzx).xyz;
...
/*244*/	r1.x = exp2(r1.x);
/*245*/	r1.x = cb3.data[1].y / r1.x;
/*246*/	r1.x = saturate(-r1.x + cb3.data[1].y);
/*247*/	r0.w = cb3.data[2].x * r0.w + r1.x;
/*248*/	r1.x = saturate(dot(vec2(r0.wwww), vec2(cb3.data[2].yyyy)));
/*249*/	r1.yzw = (cb2.data[1].xxyz * cb3.data[0].xxyz).yzw;
/*250*/	r1.yzw = (r1.yyzw * vec4(0.000000, 1.500000, 1.500000, 1.500000)).yzw;
/*251*/	r1.yzw = (r1.yyzw * abs(cb2.data[0].zzzz)).yzw;
...
/*261*/	r1.w = max(r1.y, r1.x);
/*262*/	r1.w = max(r1.z, r1.w);
/*263*/	r2.yzw = (-r1.xxyz + r1.wwww).yzw;
/*264*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*265*/	r1.w = r1.w + -cb4.data[0].x;
/*266*/	r3.x = -cb4.data[0].x + cb4.data[0].y;
/*267*/	r1.w = r1.w / r3.x;
/*268*/	r1.w = r1.w + -1.000000;
/*269*/	r1.w = saturate(r1.w * 1.176471);
/*270*/	r1.xyz = (r1.wwww * r2.yzwy + r1.xyzx).xyz;
/*271*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*272*/	r2.y = max(r1.w, cb4.data[0].x);
/*273*/	r2.y = min(r2.y, cb4.data[0].y);
/*274*/	r2.y = r2.y + -cb4.data[0].x;
/*275*/	r2.y = r2.y / r3.x;
/*276*/	r2.z = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*277*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*278*/	r1.w = (floatBitsToUint(r2.z) > 0x00000000u) ? r1.w : 1.000000;
/*279*/	r1.w = r1.w * r2.y;
/*280*/	r1.xyz = saturate(r1.wwww * r1.xyzx).xyz;
/*281*/	r1.w = 0.500000;
/*282*/	r3.xyzw = (texture(g_scurve_texture_sampler, r1.xwxx.st)).xyzw;
/*283*/	r4.xyzw = (texture(g_scurve_texture_sampler, r1.ywyy.st)).xyzw;
/*284*/	r1.xyzw = (texture(g_scurve_texture_sampler, r1.zwzz.st)).xyzw;
/*285*/	r3.z = r1.z;
/*286*/	r3.y = r4.y;
/*287*/	r1.xyz = (-r0.xyzx + r3.xyzx).xyz;
/*288*/	r1.w = max(cb3.data[2].z, 0.001000);
/*289*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*290*/	r1.w = r1.w * r2.x;
/*291*/	r1.w = min(r1.w, 1.000000);
/*292*/	r2.x = r1.w * -2.000000 + 3.000000;
/*293*/	r1.w = r1.w * r1.w;
/*294*/	r1.w = r1.w * r2.x;
/*295*/	r0.w = saturate(r0.w * r1.w);
/*296*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*297*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*298*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*299*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*300*/	return;
}
