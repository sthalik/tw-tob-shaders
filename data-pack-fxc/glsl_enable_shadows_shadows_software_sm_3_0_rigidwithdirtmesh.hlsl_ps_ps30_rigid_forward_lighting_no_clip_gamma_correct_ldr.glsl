...
// Fragment Shader
//
// id: 5244 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdirtmesh.hlsl_PS_ps30_rigid_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*37*/	r4.xyzw = (texture(s_decal_dirt_mask, vsOut_T1.xyxx.st)).xyzw;
/*38*/	r3.zw = (vsOut_T1.xxxy * cb5.data[2].xxxy + vsOut_T6.yyyz).zw;
/*39*/	r5.xyzw = (texture(s_decal_dirt_map, r3.zwzz.st)).xyzw;
/*40*/	r3.zw = (r5.xxxy * vec4(0.000000, 0.000000, 2.000000, 2.000000) + vec4(0.000000, 0.000000, -1.000000, -1.000000)).zw;
/*41*/	r1.w = r4.w * r5.w;
/*42*/	r4.xyz = (-r0.xywx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*43*/	r0.xyw = (r1.wwww * r4.xyxz + r0.xyxw).xyw;
/*44*/	r1.xy = (r3.zwzz * r4.wwww + r1.xyxx).xy;
/*45*/	r2.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*46*/	r2.w = inversesqrt(r2.w);
/*47*/	r1.xyz = (r1.xyzx * r2.wwww).xyz;
/*48*/	r4.xyz = (r1.wwww * r2.xyzx).xyz;
/*49*/	r2.xyz = (r4.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r2.xyzx).xyz;
/*50*/	r1.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*51*/	r1.w = inversesqrt(r1.w);
/*52*/	r4.xyz = (r1.wwww * vsOut_T3.xyzx).xyz;
/*53*/	r1.w = dot(vec3(vsOut_T4.xyzx), vec3(vsOut_T4.xyzx));
/*54*/	r1.w = inversesqrt(r1.w);
/*55*/	r5.xyz = (r1.wwww * vsOut_T4.xyzx).xyz;
/*56*/	r1.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*57*/	r1.w = inversesqrt(r1.w);
/*58*/	r6.xyz = (r1.wwww * vsOut_T2.xyzx).xyz;
/*59*/	r7.xyz = (r1.yyyy * r5.xyzx).xyz;
/*60*/	r7.xyz = (r1.xxxx * r4.xyzx + r7.xyzx).xyz;
/*61*/	r7.xyz = (r1.zzzz * r6.xyzx + r7.xyzx).xyz;
/*62*/	r1.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*63*/	r1.w = inversesqrt(r1.w);
/*64*/	r7.xyz = (r1.wwww * r7.xyzx).xyz;
/*65*/	r1.xyz = (mix(r7.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
/*66*/	r0.z = uintBitsToFloat((floatBitsToInt(cb4.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*70*/	  r0.z = r3.w * cb1.data[26].x;
/*71*/	  r7.xy = (r0.zzzz * vec4(-0.700000, 0.660000, 0.000000, 0.000000)).xy;
...
/*79*/	  r0.z = uintBitsToFloat((0.000000 < cb4.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*85*/	    r0.z = dot(vec2(r8.xyxx), vec2(r8.xyxx));
/*86*/	    r0.z = -r0.z + 1.000000;
/*87*/	    r0.z = max(r0.z, 0.000000);
/*88*/	    r8.z = sqrt(r0.z);
/*89*/	    r9.xyz = (r8.xzyx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r1.xyzx).xyz;
/*90*/	    r0.z = dot(vec3(r9.xyzx), vec3(r9.xyzx));
/*91*/	    r0.z = inversesqrt(r0.z);
/*92*/	    r9.xyz = (r0.zzzz * r9.xyzx).xyz;
/*93*/	    r10.xz = (cb4.data[0].xxyx).xz/**/;
/*94*/	    r10.y = -1.000000;
/*95*/	    r0.z = dot(vec3(r10.xyzx), vec3(r10.xyzx));
/*96*/	    r0.z = inversesqrt(r0.z);
/*97*/	    r10.xyz = (r0.zzzz * r10.xyzx).xyz;
/*98*/	    r0.z = saturate(dot(vec3(-r10.xyzx), vec3(r9.xyzx)));
/*99*/	    r1.w = cb4.data[1].x * cb4.data[1].x;
/*100*/	    r1.w = r1.w * 1.250000;
/*101*/	    r1.w = min(r1.w, 1.000000);
/*102*/	    r2.w = saturate(cb4.data[1].x * cb4.data[1].x + -0.800000);
...
/*114*/	    r9.xyz = (-r0.xywx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*115*/	    r0.xyw = (r0.zzzz * r9.xyxz + r0.xyxw).xyw;
/*116*/	    r9.xyz = (-r2.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*117*/	    r2.xyz = (r0.zzzz * r9.xyzx + r2.xyzx).xyz;
...
/*121*/	    r1.w = dot(vec2(r7.xyxx), vec2(r7.xyxx));
/*122*/	    r1.w = -r1.w + 1.000000;
/*123*/	    r1.w = max(r1.w, 0.000000);
/*124*/	    r7.z = sqrt(r1.w);
/*125*/	    r8.xyz = (r8.xyzx + r8.xyzx).xyz;
/*126*/	    r1.w = dot(vec2(cb4.data[0].xyxx), vec2(cb4.data[0].xyxx));
/*127*/	    r1.w = sqrt(r1.w);
/*128*/	    r7.xyz = (r8.xyzx * r1.wwww + r7.xyzx).xyz;
/*129*/	    r1.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*130*/	    r1.w = inversesqrt(r1.w);
/*131*/	    r7.xyz = (r1.wwww * r7.xyzx).xyz;
...
/*138*/	    r4.xyz = (r0.zzzz * r4.xyzx + r1.xyzx).xyz;
/*139*/	    r0.z = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*140*/	    r0.z = inversesqrt(r0.z);
/*141*/	    r1.xyz = (r0.zzzz * r4.xyzx).xyz;
/*142*/	  }
/*143*/	}
/*144*/	r0.z = vsOut_T7.y * -r3.y + r3.y;
/*145*/	r3.yzw = (r0.xxyw * vec4(0.000000, 5.000000, 5.000000, 5.000000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*146*/	r3.yzw = (-r0.xxyw + r3.yyzw).yzw;
/*147*/	r0.xyw = saturate(vsOut_T7.yyyy * r3.yzyw + r0.xyxw).xyw;
/*148*/	r1.w = dot(vec3(r0.xywx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*149*/	r3.yzw = (-r0.xxyw + r1.wwww).yzw;
/*150*/	r0.xyw = (vsOut_T7.zzzz * r3.yzyw + r0.xyxw).xyw;
...
/*172*/	r7.x = saturate(r0.z * 60.000000);
/*173*/	r7.x = -r0.z + r7.x;
...
/*179*/	r9.xyz = (mix(cb2.data[2].xyzx, cb2.data[3].xyzx, greaterThan(floatBitsToUint(r8.xxxx), uvec4(0)))).xyz/**/;
/*180*/	r8.xyw = (mix(cb2.data[4].xyxz, cb2.data[5].xyxz, greaterThan(floatBitsToUint(r8.yyyy), uvec4(0)))).xyw/**/;
/*181*/	r10.xyz = (mix(cb2.data[6].xyzx, cb2.data[7].xyzx, greaterThan(floatBitsToUint(r8.zzzz), uvec4(0)))).xyz/**/;
...
/*187*/	r7.yzw = (r0.xxyw * r7.yyzw).yzw;
/*188*/	r6.y = -r0.z + 1.000000;
/*189*/	r7.yzw = (r6.yyyy * r7.yyzw).yzw;
/*190*/	r7.yzw = (r6.xxxx * r7.yyzw).yzw;
/*191*/	if(floatBitsToUint(cb2.data[0].x) != 0u) {
...
/*270*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.yzwy));
/*271*/	  r2.w = max(r2.w, 0.000000);
/*272*/	  r2.w = log2(r2.w);
/*273*/	  r2.w = r2.w * 10.000000;
/*274*/	  r2.w = exp2(r2.w);
/*275*/	  r2.w = r6.w * r2.w;
/*276*/	  r2.w = r2.w * r7.x + r0.z;
...
/*284*/	r3.xyz = (max(r0.zzzz, r3.xyzx)).xyz;
/*285*/	r3.xyz = (-r3.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*286*/	r0.xyz = (r0.xywx * r1.yyyy).xyz;
/*287*/	r0.xyz = (r0.xyzx * cb2.data[1].xyzx).xyz;
/*288*/	r0.xyz = (r3.xyzx * r0.xyzx).xyz;
/*289*/	r0.xyz = (r6.xxxx * r0.xyzx).xyz;
/*290*/	r0.xyz = (r2.xyzx * cb2.data[1].xyzx + r0.xyzx).xyz;
/*291*/	r0.xyz = (r0.xyzx + r7.yzwy).xyz;
/*292*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*293*/	r2.w = 1.000000;
/*294*/	r1.x = dot(r2.xyzw, cb1.data[9].xyzw);
/*295*/	r1.y = dot(r2.xyzw, cb1.data[10].xyzw);
/*296*/	r0.w = dot(r2.xyzw, cb1.data[12].xyzw);
/*297*/	r1.xy = (r1.xyxx / r0.wwww).xy;
/*298*/	r2.xy = (uintBitsToFloat(uvec4(greaterThanEqual(r1.xyxx, cb1.data[34].xyxx)) * 0xffffffffu)).xy;
...
/*305*/	r0.w = sqrt(r1.w);
/*306*/	r1.x = saturate(cb3.data[0].w)/**/;
/*307*/	r1.x = -r1.x + 1.000000;
/*308*/	r1.x = r1.x * 8.000000 + -4.000000;
/*309*/	r1.y = saturate(cb3.data[1].x)/**/;
...
/*315*/	r0.w = exp2(r0.w);
/*316*/	r0.w = cb3.data[1].y / r0.w;
/*317*/	r0.w = saturate(-r0.w + cb3.data[1].y);
/*318*/	r1.x = -vsOut_T0.y + cb3.data[1].w;
/*319*/	r1.y = -cb3.data[1].z + cb3.data[1].w;
/*320*/	r1.x = r1.x + -cb3.data[1].z;
...
/*327*/	r1.y = sqrt(r1.y);
/*328*/	r1.z = max(cb3.data[2].z, 0.001000);
...
/*333*/	r1.y = r1.y * r1.y;
/*334*/	r1.y = r1.y * r1.z;
/*335*/	r0.w = cb3.data[2].x * r1.x + r0.w;
/*336*/	r1.xzw = (cb2.data[1].xxyz * cb3.data[0].xxyz).xzw;
/*337*/	r1.xzw = (r1.xxzw * vec4(1.500000, 0.000000, 1.500000, 1.500000)).xzw;
/*338*/	r1.xzw = (r1.xxzw * abs(cb2.data[0].zzzz)).xzw;
/*339*/	r2.xyz = (r6.xxxx * r1.xzwx).xyz;
/*340*/	r4.w = max(r4.y, 0.000000);
/*341*/	r3.xyzw = (texture(s_sky, r4.xwzx.stp)).xyzw;
/*342*/	r2.w = saturate(dot(vec2(r0.wwww), vec2(cb3.data[2].yyyy)));
