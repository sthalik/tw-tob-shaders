...
// Fragment Shader
//
// id: 3056 - fxc/glsl_SM_3_0_weightedwithdecaldirtburn.hlsl_PS_ps30_gbuffer_noclip.glsl
//
...
/*57*/	r3.zw = (vsOut_T1.xxxy * cb1.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*70*/	r4.x = r3.z;
/*71*/	r4.y = cb0.data[26].x * 0.050000 + r3.w;
...
/*107*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*111*/	r0.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*112*/	r0.w = inversesqrt(r0.w);
/*113*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
/*114*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*115*/	r0.w = inversesqrt(r0.w);
/*116*/	r4.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*117*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*118*/	r0.w = inversesqrt(r0.w);
/*119*/	r5.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*120*/	r4.xyz = (r2.yyyy * r4.xyzx).xyz;
/*121*/	r2.xyw = (r2.xxxx * r3.xzxw + r4.xyxz).xyw;
/*122*/	r2.xyz = (r2.zzzz * r5.xyzx + r2.xywx).xyz;
/*123*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*124*/	r0.w = inversesqrt(r0.w);
/*125*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*126*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*127*/	r4.w = 1.000000;
/*128*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*129*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*130*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*131*/	color3.x = r0.w / r2.w;
/*132*/	r0.w = max(abs(r2.z), abs(r2.y));
/*133*/	r0.w = max(r0.w, abs(r2.x));
/*134*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*135*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*136*/	color0.w = saturate(r3.y);
/*137*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*138*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*139*/	color2.xyzw = saturate(r1.xyzw);
/*140*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*141*/	color4 = floatBitsToUint(vsOut_T9.z);
/*142*/	return;
}
