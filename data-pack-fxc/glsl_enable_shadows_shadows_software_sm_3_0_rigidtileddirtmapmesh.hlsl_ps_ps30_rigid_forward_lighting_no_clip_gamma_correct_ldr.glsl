...
// Fragment Shader
//
// id: 4837 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidtileddirtmapmesh.hlsl_PS_ps30_rigid_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*37*/	r3.zw = (vsOut_T1.xxxy * cb5.data[2].xxxy).zw;
...
/*62*/	r0.z = uintBitsToFloat((floatBitsToInt(cb4.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*75*/	  r0.z = uintBitsToFloat((0.000000 < cb4.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*95*/	    r1.w = cb4.data[1].x * cb4.data[1].x;
/*96*/	    r1.w = r1.w * 1.250000;
/*97*/	    r1.w = min(r1.w, 1.000000);
/*98*/	    r2.w = saturate(cb4.data[1].x * cb4.data[1].x + -0.800000);
...
/*122*/	    r1.w = dot(vec2(cb4.data[0].xyxx), vec2(cb4.data[0].xyxx));
/*123*/	    r1.w = sqrt(r1.w);
...
/*154*/	r4.xyz = (vsOut_T0.xyzx + -cb1.data[0].xyzx).xyz;
/*155*/	r1.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*156*/	r2.w = inversesqrt(r1.w);
/*157*/	r3.yzw = (r2.wwww * r4.xxyz).yzw;
/*158*/	r2.w = -r3.x + 1.000000;
/*159*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*160*/	r5.y = dot(vec3(r3.yzwy), vec3(r1.xyzx));
/*161*/	r5.y = r5.y + r5.y;
/*162*/	r5.yzw = (r1.xxyz * -r5.yyyy + r3.yyzw).yzw;
/*163*/	r6.xyz = (mix(vec4(1.000000, 1.000000, 273.000000, 0), vec4(0.004000, 360.000000, 1.000000, 0), greaterThan(floatBitsToUint(r5.xxxx), uvec4(0)))).xyz;
/*164*/	r6.w = r2.w * 1.539380;
/*165*/	r6.w = cos((r6.w));
/*166*/	r6.w = inversesqrt(r6.w);
/*167*/	r6.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r6.w)).w;
/*168*/	r7.x = saturate(r0.x * 60.000000);
/*169*/	r7.x = -r0.x + r7.x;
/*170*/	r7.yzw = (r1.xxyz * vec4(0.000000, 1.000000, 4.000000, 1.000000)).yzw;
/*171*/	r8.x = dot(vec3(r7.yzwy), vec3(r7.yzwy));
/*172*/	r8.x = inversesqrt(r8.x);
/*173*/	r7.yzw = (r7.yyzw * r8.xxxx).yzw;
/*174*/	r8.xyz = (uintBitsToFloat(uvec4(lessThan(r7.yzwy, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xyz;
/*175*/	r9.xyz = (mix(cb2.data[2].xyzx, cb2.data[3].xyzx, greaterThan(floatBitsToUint(r8.xxxx), uvec4(0)))).xyz/**/;
/*176*/	r8.xyw = (mix(cb2.data[4].xyxz, cb2.data[5].xyxz, greaterThan(floatBitsToUint(r8.yyyy), uvec4(0)))).xyw/**/;
/*177*/	r10.xyz = (mix(cb2.data[6].xyzx, cb2.data[7].xyzx, greaterThan(floatBitsToUint(r8.zzzz), uvec4(0)))).xyz/**/;
/*178*/	r7.yzw = (r7.yyzw * r7.yyzw).yzw;
/*179*/	r8.xyz = (r8.xywx * r7.zzzz).xyz;
/*180*/	r8.xyz = (r7.yyyy * r9.xyzx + r8.xyzx).xyz;
/*181*/	r7.yzw = (r7.wwww * r10.xxyz + r8.xxyz).yzw;
/*182*/	r7.yzw = (r6.yyyy * r7.yyzw).yzw;
/*183*/	r7.yzw = (r0.yyzw * r7.yyzw).yzw;
/*184*/	r6.y = -r0.x + 1.000000;
/*185*/	r7.yzw = (r6.yyyy * r7.yyzw).yzw;
/*186*/	r7.yzw = (r6.xxxx * r7.yyzw).yzw;
/*187*/	if(floatBitsToUint(cb2.data[0].x) != 0u) {
/*188*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.yzwy));
/*189*/	  r6.y = max(r6.y, 0.000000);
/*190*/	  r6.y = log2(r6.y);
/*191*/	  r6.y = r6.y * 10.000000;
/*192*/	  r6.y = exp2(r6.y);
/*193*/	  r6.y = r6.w * r6.y;
/*194*/	  r6.y = r6.y * r7.x + r0.x;
/*195*/	  r8.x = r2.w * 8.000000;
/*196*/	  r8.xyzw = (textureLod(s_environment, r5.yzwy.stp, r8.x)).xyzw;
/*197*/	  r8.xyz = (r6.yyyy * r8.xyzx).xyz;
/*198*/	  r7.yzw = (r8.xxyz * r2.xxyz + r7.yyzw).yzw;
/*199*/	}
/*200*/	r1.x = dot(vec3(r1.xyzx), vec3(-cb2.data[0].yzwy));
/*201*/	r1.y = max(r1.x, 0.000000);
/*202*/	r1.x = uintBitsToFloat((0.000000 < r1.x) ? 0xffffffffu : 0x00000000u);
/*203*/	if(floatBitsToUint(r1.x) != 0u) {
/*204*/	  r1.x = dot(vec3(-cb2.data[0].yzwy), vec3(r5.yzwy));
/*205*/	  r1.x = max(r1.x, -1.000000);
/*206*/	  r1.x = min(r1.x, 1.000000);
/*207*/	  r1.z = -abs(r1.x) + 1.000000;
/*208*/	  r1.z = sqrt(r1.z);
/*209*/	  r5.y = abs(r1.x) * -0.018729 + 0.074261;
/*210*/	  r5.y = r5.y * abs(r1.x) + -0.212114;
/*211*/	  r5.y = r5.y * abs(r1.x) + 1.570729;
/*212*/	  r5.z = r1.z * r5.y;
/*213*/	  r5.z = r5.z * -2.000000 + 3.141593;
/*214*/	  r1.x = uintBitsToFloat((r1.x < -r1.x) ? 0xffffffffu : 0x00000000u);
/*215*/	  r1.x = uintBitsToFloat(floatBitsToUint(r1.x) & floatBitsToUint(r5.z));
/*216*/	  r1.x = r5.y * r1.z + r1.x;
/*217*/	  r1.z = r3.x * r3.x;
/*218*/	    r3.x = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*219*/	  r1.z = r1.z * r3.x + r6.x;
/*220*/	  r1.z = r1.z * 0.500000 + 0.500000;
/*221*/	  r1.z = r1.z * 2.000000 + -1.000000;
/*222*/	  r3.x = -r1.z * r1.z + 1.000000;
/*223*/	  r3.x = max(r3.x, 0.001000);
/*224*/	  r3.x = log2(r3.x);
/*225*/	  r5.x = r3.x * 4.950617;
/*226*/	  r3.x = r3.x * 0.346574 + 4.546885;
/*227*/	  r5.y = uintBitsToFloat((0.000000 < r1.z) ? 0xffffffffu : 0x00000000u);
/*228*/	  r1.z = uintBitsToFloat((r1.z < 0.000000) ? 0xffffffffu : 0x00000000u);
/*229*/	  r1.z = intBitsToFloat(1 + ~floatBitsToInt(r5.y) + floatBitsToInt(r1.z));
/*230*/	  r1.z = floatBitsToInt(r1.z);
/*231*/	  r5.x = r3.x * r3.x + -r5.x;
/*232*/	  r5.x = sqrt(r5.x);
/*233*/	  r3.x = -r3.x + r5.x;
...
/*240*/	  r5.xy = (r1.xxxx + vec4(-0.008727, 0.008727, 0.000000, 0.000000)).xy;
/*241*/	  r1.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.z)).x;
/*242*/	  r1.xz = (r1.xxxx * r5.xxyx).xz;
/*243*/	  r5.xy = (r1.xzxx * vec4(0.707107, 0.707107, 0.000000, 0.000000)).xy;
/*244*/	  r5.xy = (r5.xyxx * r5.xyxx).xy;
/*245*/	  r8.xyzw = r5.xxyy * vec4(0.140012, 0.140012, 0.140012, 0.140012) + vec4(1.273239, 1.000000, 1.273239, 1.000000);
/*246*/	  r5.zw = (r8.xxxz / r8.yyyw).zw;
/*247*/	  r5.xy = (r5.zwzz * -r5.xyxx).xy;
/*248*/	  r5.zw = (uintBitsToFloat(uvec4(lessThan(vec4(0.000000, 0.000000, 0.000000, 0.000000), r1.xxxz)) * 0xffffffffu)).zw;
/*249*/	  r1.x = uintBitsToFloat((r1.x < 0.000000) ? 0xffffffffu : 0x00000000u);
/*250*/	  r1.x = intBitsToFloat(1 + ~floatBitsToInt(r5.z) + floatBitsToInt(r1.x));
/*251*/	  r1.x = floatBitsToInt(r1.x);
/*252*/	  r5.xy = (r5.xyxx * vec4(1.442695, 1.442695, 0.000000, 0.000000)).xy;
/*253*/	  r5.xy = (exp2(r5.xyxx)).xy;
/*254*/	  r5.xy = (-r5.xyxx + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
/*255*/	  r5.xy = (sqrt(r5.xyxx)).xy;
/*256*/	  r1.x = r1.x * r5.x + 1.000000;
/*257*/	  r1.x = r1.x * 0.500000;
/*258*/	  r1.z = 1 + ~floatBitsToInt(r5.w);
/*259*/	  r1.z = r1.z * r5.y + 1.000000;
/*260*/	  r1.x = r1.z * 0.500000 + -r1.x;
/*261*/	  r1.z = min(r1.y, 1.000000);
/*262*/	  r2.w = r2.w * 1.570796;
/*263*/	  r2.w = sin(r2.w);
/*264*/	  r1.z = r1.z + -1.000000;
/*265*/	  r1.z = r2.w * r1.z + 1.000000;
/*266*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r3.yzwy));
/*267*/	  r2.w = max(r2.w, 0.000000);
/*268*/	  r2.w = log2(r2.w);
/*269*/	  r2.w = r2.w * 10.000000;
/*270*/	  r2.w = exp2(r2.w);
/*271*/	  r2.w = r6.w * r2.w;
/*272*/	  r2.w = r2.w * r7.x + r0.x;
/*273*/	  r1.x = r1.z * abs(r1.x);
/*274*/	  r3.xyz = (r2.wwww * r1.xxxx).xyz;
/*275*/	} else {
/*276*/	  r3.xyz = (vec4(0, 0, 0, 0)).xyz;
/*277*/	}
/*278*/	r5.xyz = saturate(r6.zzzz * r3.xyzx).xyz;
...
/*282*/	r0.xyz = (r0.yzwy * r1.yyyy).xyz;
/*283*/	r0.xyz = (r0.xyzx * cb2.data[1].xyzx).xyz;
/*284*/	r0.xyz = (r3.xyzx * r0.xyzx).xyz;
/*285*/	r0.xyz = (r6.xxxx * r0.xyzx).xyz;
/*286*/	r0.xyz = (r2.xyzx * cb2.data[1].xyzx + r0.xyzx).xyz;
/*287*/	r0.xyz = (r0.xyzx + r7.yzwy).xyz;
/*288*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*289*/	r2.w = 1.000000;
/*290*/	r1.x = dot(r2.xyzw, cb1.data[9].xyzw);
/*291*/	r1.y = dot(r2.xyzw, cb1.data[10].xyzw);
/*292*/	r0.w = dot(r2.xyzw, cb1.data[12].xyzw);
/*293*/	r1.xy = (r1.xyxx / r0.wwww).xy;
/*294*/	r2.xy = (uintBitsToFloat(uvec4(greaterThanEqual(r1.xyxx, cb1.data[34].xyxx)) * 0xffffffffu)).xy;
/*295*/	r1.xy = (uintBitsToFloat(uvec4(greaterThanEqual(cb1.data[34].zwzz, r1.xyxx)) * 0xffffffffu)).xy;
...
/*301*/	r0.w = sqrt(r1.w);
/*302*/	r1.x = saturate(cb3.data[0].w)/**/;
/*303*/	r1.x = -r1.x + 1.000000;
/*304*/	r1.x = r1.x * 8.000000 + -4.000000;
/*305*/	r1.y = saturate(cb3.data[1].x)/**/;
...
/*311*/	r0.w = exp2(r0.w);
/*312*/	r0.w = cb3.data[1].y / r0.w;
/*313*/	r0.w = saturate(-r0.w + cb3.data[1].y);
/*314*/	r1.x = -vsOut_T0.y + cb3.data[1].w;
/*315*/	r1.y = -cb3.data[1].z + cb3.data[1].w;
/*316*/	r1.x = r1.x + -cb3.data[1].z;
...
/*323*/	r1.y = sqrt(r1.y);
/*324*/	r1.z = max(cb3.data[2].z, 0.001000);
...
/*329*/	r1.y = r1.y * r1.y;
/*330*/	r1.y = r1.y * r1.z;
/*331*/	r0.w = cb3.data[2].x * r1.x + r0.w;
/*332*/	r1.xzw = (cb2.data[1].xxyz * cb3.data[0].xxyz).xzw;
/*333*/	r1.xzw = (r1.xxzw * vec4(1.500000, 0.000000, 1.500000, 1.500000)).xzw;
/*334*/	r1.xzw = (r1.xxzw * abs(cb2.data[0].zzzz)).xzw;
/*335*/	r2.xyz = (r6.xxxx * r1.xzwx).xyz;
/*336*/	r4.w = max(r4.y, 0.000000);
/*337*/	r3.xyzw = (texture(s_sky, r4.xwzx.stp)).xyzw;
/*338*/	r2.w = saturate(dot(vec2(r0.wwww), vec2(cb3.data[2].yyyy)));
/*339*/	r1.xzw = (-r1.xxzw * r6.xxxx + r3.xxyz).xzw;
/*340*/	r1.xzw = (r2.wwww * r1.xxzw + r2.xxyz).xzw;
/*341*/	r0.w = saturate(r0.w * r1.y);
/*342*/	r1.xyz = (-r0.xyzx + r1.xzwx).xyz;
/*343*/	r0.xyz = saturate(r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*344*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*345*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*346*/	r0.xyz = (exp2(r0.xyzx)).xyz;
/*347*/	color0.xyz = (min(r0.xyzx, vec4(1.000000, 1.000000, 1.000000, 0.000000))).xyz;
/*348*/	return;
}
