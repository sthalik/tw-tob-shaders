...
// Fragment Shader
//
// id: 77 - fxc/glsl_SM_3_0_sprite.hlsl_PS_pixel_s.glsl
//
...
/*2*/	if(r0.x != 0) discard;
/*3*/	r0.x = vsOut_C0.x * 6.000000;
/*4*/	r0.y = uintBitsToFloat((vsOut_C0.x >= 1.000000) ? 0xffffffffu : 0x00000000u);
/*5*/	r0.x = (floatBitsToUint(r0.y) > 0x00000000u) ? 0 : r0.x;
/*6*/	r0.y = floor(r0.x);
/*7*/	r0.x = -r0.y + r0.x;
/*8*/	r0.y = intBitsToFloat(int(r0.y));
/*9*/	r0.z = -r0.x + 1.000000;
/*10*/	r0.x = -vsOut_T0.y * r0.x + 1.000000;
/*11*/	r1.y = r0.x * vsOut_C0.z;
/*12*/	r0.x = -vsOut_T0.y * r0.z + 1.000000;
/*13*/	r0.x = r0.x * vsOut_C0.z;
/*14*/	r1.w = r0.x;
...
/*20*/	r0.w = -vsOut_T0.y + 1.000000;
/*21*/	r1.x = r0.w * vsOut_C0.z;
/*22*/	r0.y = r1.x;
...
/*27*/	r0.w = uintBitsToFloat((vsOut_T0.y == 0.000000) ? 0xffffffffu : 0x00000000u);
/*28*/	color0.xyz = (mix(r0.xyzx, vsOut_C0.zzzz, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
/*29*/	color0.w = vsOut_C0.w;
/*30*/	return;
}
