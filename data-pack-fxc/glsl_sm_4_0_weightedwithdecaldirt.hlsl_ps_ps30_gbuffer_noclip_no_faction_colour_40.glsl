...
// Fragment Shader
//
// id: 1777 - fxc/glsl_SM_4_0_weightedwithdecaldirt.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour_40.glsl
//
...
/*59*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*65*/	r3.xzw = (r0.wwww * vsOut_T3.xxyz).xzw;
/*66*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*67*/	r0.w = inversesqrt(r0.w);
/*68*/	r4.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*69*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*70*/	r0.w = inversesqrt(r0.w);
/*71*/	r5.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
...
/*81*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*82*/	r3.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*83*/	color3.x = r0.w / r2.w;
/*84*/	r0.w = max(abs(r2.z), abs(r2.y));
/*85*/	r0.w = max(r0.w, abs(r2.x));
/*86*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*87*/	color0.xyz = saturate(r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*88*/	color0.w = saturate(r3.y);
/*89*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*90*/	r1.w = uintBitsToFloat(floatBitsToUint(r3.x) & uint(0x3c008081u));
/*91*/	color2.xyzw = saturate(r1.xyzw);
