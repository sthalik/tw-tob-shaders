...
// Fragment Shader
//
// id: 5317 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdirtburnmesh.hlsl_PS_ps30_alpha_blend_40.glsl
//
...
/*65*/	r2.w = saturate(r4.x * 5.000000);
/*66*/	r4.xyz = (r2.wwww * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*67*/	r2.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
...
/*76*/	r3.z = -r5.w + 1.000000;
/*77*/	r3.z = log2(r3.z);
/*78*/	r3.z = r3.z * vsOut_T7.x;
/*79*/	r3.z = exp2(r3.z);
/*80*/	r3.z = min(r3.z, 1.000000);
/*81*/	r3.z = r3.z * vsOut_T7.x;
/*82*/	r3.w = r5.z * 0.250000;
/*83*/	r4.xyz = (r4.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r3.wwww).xyz;
/*84*/	r4.xyz = (r2.wwww * r4.xyzx + r3.wwww).xyz;
/*85*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*86*/	r0.xyz = (r3.zzzz * r4.xyzx + r0.xyzx).xyz;
