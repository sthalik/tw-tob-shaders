...
// Fragment Shader
//
// id: 1850 - fxc/glsl_SM_4_0_weighted.hlsl_PS_ps30_gbuffer_skin_no_faction_colour_slm_40.glsl
//
...
/*44*/	color2.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*45*/	color2.w = 0;
/*46*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*47*/	r0.w = 1.000000;
/*48*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*49*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*50*/	color3.x = r1.x / r0.x;
/*51*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*52*/	color4 = floatBitsToUint(vsOut_T9.z);
/*53*/	return;
}
