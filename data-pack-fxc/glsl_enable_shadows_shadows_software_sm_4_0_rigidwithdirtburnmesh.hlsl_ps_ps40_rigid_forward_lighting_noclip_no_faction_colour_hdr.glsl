...
// Fragment Shader
//
// id: 5358 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdirtburnmesh.hlsl_PS_ps40_rigid_forward_lighting_noclip_no_faction_colour_HDR.glsl
//
...
/*38*/	r5.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000) + r5.xyxx).xy;
/*39*/	r5.xyzw = (texture(s_fire_map, r5.xyxx.st)).xyzw;
/*40*/	r6.xyzw = (texture(s_fire_map, r3.zwzz.st)).xyzw;
/*41*/	r2.w = saturate(r5.x * 5.000000);
/*42*/	r5.xyz = (r2.wwww * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*43*/	r2.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
...
/*52*/	r3.z = -r6.w + 1.000000;
/*53*/	r3.z = log2(r3.z);
/*54*/	r3.z = r3.z * vsOut_T7.x;
/*55*/	r3.z = exp2(r3.z);
/*56*/	r3.z = min(r3.z, 1.000000);
/*57*/	r3.z = r3.z * vsOut_T7.x;
/*58*/	r3.w = r6.z * 0.250000;
/*59*/	r5.xyz = (r5.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r3.wwww).xyz;
/*60*/	r5.xyz = (r2.wwww * r5.xyzx + r3.wwww).xyz;
/*61*/	r5.xyz = (-r1.xyzx + r5.xyzx).xyz;
/*62*/	r1.xyz = (r3.zzzz * r5.xyzx + r1.xyzx).xyz;
/*63*/	r2.w = vsOut_T7.x + -0.025000;
/*64*/	r2.w = max(r2.w, 0.000000);
/*65*/	r5.xyz = (r6.zzzz * vec4(0.250000, 0.250000, 0.250000, 0.000000) + -r1.xyzx).xyz;
...
/*79*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*80*/	r2.w = inversesqrt(r2.w);
/*81*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*82*/	r0.xyz = (mix(r8.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
