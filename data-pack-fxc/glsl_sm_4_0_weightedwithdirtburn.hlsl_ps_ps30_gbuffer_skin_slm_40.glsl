...
// Fragment Shader
//
// id: 2333 - fxc/glsl_SM_4_0_weightedwithdirtburn.hlsl_PS_ps30_gbuffer_skin_slm_40.glsl
//
...
/*52*/	r1.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*53*/	r1.x = saturate(-r1.x * 15.000000 + 1.000000);
/*54*/	r1.yz = (vsOut_T1.xxyx * vec4(0.000000, 1.200000, 1.500000, 0.000000)).yz;
/*55*/	r2.xyzw = (texture(s_fire_map, r1.yzyy.st)).xyzw;
/*56*/	r1.w = log2(r2.z);
/*57*/	r1.w = r1.w * 1.800000;
/*58*/	r1.w = exp2(r1.w);
/*59*/	r1.w = r1.w * 10.000000;
/*60*/	r1.w = min(r1.w, 1.000000);
/*61*/	r1.x = r1.w + r1.x;
/*62*/	r1.x = r1.x * 0.500000;
/*63*/	r1.z = cb0.data[26].x * 0.050000 + r1.z;
/*64*/	r3.xyzw = (texture(s_fire_map, r1.yzyy.st)).xyzw;
/*65*/	r1.y = saturate(r3.x * 5.000000);
/*66*/	r1.yzw = (r1.yyyy * vec4(0.000000, 0.530000, 0.070000, -0.120000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*67*/	r2.x = r2.z * 0.250000;
/*68*/	r1.yzw = (r1.yyzw * vec4(0.000000, 2.000000, 2.000000, 2.000000) + -r2.xxxx).yzw;
/*69*/	r1.xyz = (r1.xxxx * r1.yzwy + r2.xxxx).xyz;
/*70*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*71*/	r1.w = -r2.w + 1.000000;
/*72*/	r1.w = log2(r1.w);
/*73*/	r1.w = r1.w * vsOut_T7.z;
/*74*/	r1.w = exp2(r1.w);
/*75*/	r1.w = min(r1.w, 1.000000);
/*76*/	r1.w = r1.w * vsOut_T7.z;
/*77*/	r0.xyz = (r1.wwww * r1.xyzx + r0.xyzx).xyz;
...
/*81*/	r0.xyz = (r1.wwww * r1.xyzx + r0.xyzx).xyz;
/*82*/	r1.x = -vsOut_T4.z + 1.000000;
/*83*/	r1.yzw = (vsOut_T4.zzzz * cb2.data[3].xxyz).yzw;
/*84*/	r0.xyz = (r0.xyzx * r1.xxxx + r1.yzwy).xyz;
...
/*88*/	r1.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*89*/	r1.xyz = (-r0.xyzx + r1.xxxx).xyz;
/*90*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*91*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*92*/	r1.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*93*/	r0.xyz = (r0.wwww * r1.xyzx).xyz;
/*94*/	r0.xyz = (r0.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r1.xyzx).xyz;
/*95*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*96*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*97*/	color2.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*98*/	color2.w = 0;
/*99*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*100*/	r0.w = 1.000000;
/*101*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*102*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*103*/	color3.x = r1.x / r0.x;
