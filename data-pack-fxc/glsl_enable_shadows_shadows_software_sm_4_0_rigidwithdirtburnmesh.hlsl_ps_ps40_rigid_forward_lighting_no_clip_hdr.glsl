...
// Fragment Shader
//
// id: 5354 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdirtburnmesh.hlsl_PS_ps40_rigid_forward_lighting_no_clip_HDR.glsl
//
...
/*54*/	r5.x = 0;
/*55*/	r5.y = cb0.data[26].x * 0.050000;
/*56*/	r5.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000) + r5.xyxx).xy;
/*57*/	r5.xyzw = (texture(s_fire_map, r5.xyxx.st)).xyzw;
/*58*/	r6.xyzw = (texture(s_fire_map, r3.zwzz.st)).xyzw;
/*59*/	r2.w = saturate(r5.x * 5.000000);
/*60*/	r5.xyz = (r2.wwww * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*61*/	r2.w = dot(vec3(r0.xywx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
...
/*70*/	r3.z = -r6.w + 1.000000;
/*71*/	r3.z = log2(r3.z);
/*72*/	r3.z = r3.z * vsOut_T7.x;
/*73*/	r3.z = exp2(r3.z);
/*74*/	r3.z = min(r3.z, 1.000000);
/*75*/	r3.z = r3.z * vsOut_T7.x;
/*76*/	r3.w = r6.z * 0.250000;
/*77*/	r5.xyz = (r5.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r3.wwww).xyz;
/*78*/	r5.xyz = (r2.wwww * r5.xyzx + r3.wwww).xyz;
/*79*/	r5.xyz = (-r0.xywx + r5.xyzx).xyz;
/*80*/	r0.xyw = (r3.zzzz * r5.xyxz + r0.xyxw).xyw;
/*81*/	r2.w = vsOut_T7.x + -0.025000;
/*82*/	r2.w = max(r2.w, 0.000000);
/*83*/	r5.xyz = (r6.zzzz * vec4(0.250000, 0.250000, 0.250000, 0.000000) + -r0.xywx).xyz;
...
/*96*/	r8.xyz = (r1.zzzz * r7.xyzx + r8.xyzx).xyz;
/*97*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*98*/	r2.w = inversesqrt(r2.w);
/*99*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*100*/	r1.xyz = (mix(r8.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
