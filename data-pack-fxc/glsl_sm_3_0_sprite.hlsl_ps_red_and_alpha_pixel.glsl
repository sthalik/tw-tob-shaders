...
// Fragment Shader
//
// id: 22 - fxc/glsl_SM_3_0_sprite.hlsl_PS_red_and_alpha_pixel.glsl
//
...
/*18*/	r1.x = -r0.x * vsOut_C0.x + 1.000000;
/*19*/	r0.xyzw = r0.xyzw * vsOut_C0.xyzw;
/*20*/	r0.x = r1.x * 0.750000 + r0.x;
/*21*/	color0.w = r0.w;
/*22*/	r0.xyz = saturate(r0.xyzx * vec4(0.250000, 0.250000, 0.250000, 0.000000)).xyz;
/*23*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*24*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*25*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*26*/	return;
}
