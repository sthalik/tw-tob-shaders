...
// Fragment Shader
//
// id: 854 - fxc/glsl_SM_3_0_rigidtileddirtmapfiremesh.hlsl_PS_ps30_gbuffer_alpha_test.glsl
//
...
/*208*/	r1.xyz = (r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*209*/	color0.xyzw = saturate(r1.xyzw);
