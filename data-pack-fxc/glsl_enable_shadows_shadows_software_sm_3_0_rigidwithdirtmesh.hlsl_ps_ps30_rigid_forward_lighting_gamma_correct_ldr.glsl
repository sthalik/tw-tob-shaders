...
// Fragment Shader
//
// id: 5241 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdirtmesh.hlsl_PS_ps30_rigid_forward_lighting_gamma_correct_LDR.glsl
//
...
/*70*/	r0.z = uintBitsToFloat((floatBitsToInt(cb4.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*83*/	  r0.z = uintBitsToFloat((0.000000 < cb4.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*291*/	r0.xyz = (r0.xyzx * cb2.data[1].xyzx).xyz;
