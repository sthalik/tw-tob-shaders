...
// Fragment Shader
//
// id: 6057 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecal.hlsl_PS_ps30_imposter_skin_no_faction_colour.glsl
//
...
/*15*/	}
/*16*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*17*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*18*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*19*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*20*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*21*/	r0.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*22*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*23*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*24*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*25*/	color0.w = 1.000000;
/*26*/	return;
}
