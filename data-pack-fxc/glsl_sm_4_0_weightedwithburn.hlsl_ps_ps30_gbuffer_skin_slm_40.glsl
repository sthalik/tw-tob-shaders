...
// Fragment Shader
//
// id: 2189 - fxc/glsl_SM_4_0_weightedwithburn.hlsl_PS_ps30_gbuffer_skin_slm_40.glsl
//
...
/*79*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*80*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*81*/	r0.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
