...
// Fragment Shader
//
// id: 274 - fxc/glsl_SM_3_0_DirectionalLight.hlsl_PS_ps30_slm_highdef.glsl
//
...
/*166*/	r0.xyw = (r0.xyxw + r8.xyxz).xyw;
/*167*/	r0.z = uintBitsToFloat(floatBitsToUint(r0.z) & uint(1));
/*168*/	if(floatBitsToUint(r0.z) != 0u) {
/*169*/	  r1.xyz = (r4.yyyy * vec4(0.000000, 1.000000, 0.000000, 0.000000)).xyz;
/*170*/	  r1.xyz = (r1.xyzx / vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*171*/	  r1.xyz = (-r1.xyzx + r4.xyzx).xyz;
/*172*/	  r1.w = 1.000000;
/*173*/	  r2.x = dot(r1.xyzw, cb3.data[0].xyzw);
/*174*/	  r2.y = dot(r1.xyzw, cb3.data[1].xyzw);
/*175*/	  r0.z = dot(r1.xyzw, cb3.data[3].xyzw);
/*176*/	  r1.xy = (r2.xyxx / r0.zzzz).xy;
/*177*/	  r1.yz = (r1.xxyx * vec4(0.000000, 0.500000, -0.500000, 0.000000) + vec4(0.000000, 0.500000, 0.500000, 0.000000)).yz;
/*178*/	  r1.xw = (-r1.zzzz + vec4(1.000000, 0.000000, 0.000000, 1.000000)).xw;
/*179*/	  r1.xyzw = (textureLod(s_overlay, r1.ywyy.st, r1.x)).xyzw;
/*180*/	  r0.z = uintBitsToFloat((0.500000 < cb2.data[0].x) ? 0xffffffffu : 0x00000000u);
/*181*/	  if(floatBitsToUint(r0.z) != 0u) {
...
/*193*/	    r0.z = r3.x * r2.x;
/*194*/	    r0.z = r0.z * r2.y;
/*195*/	    r0.z = r2.z * -r0.z + r0.z;
/*196*/	    r0.z = r2.w * -r0.z + r0.z;
/*197*/	  } else {
/*198*/	    r0.z = 1.000000;
/*199*/	  }
/*200*/	  r0.z = saturate(r0.z + -0.500000);
/*201*/	  r0.z = r0.z * 1.900000 + 0.050000;
/*202*/	  r2.x = uintBitsToFloat((r4.y < 0.000000) ? 0xffffffffu : 0x00000000u);
/*203*/	    r2.x = (floatBitsToUint(r2.x) > 0x00000000u) ? 0 : 1.000000;
/*204*/	  r2.yzw = (r0.xxyw * r1.wwww).yzw;
/*205*/	  r1.xyz = (r1.xyzx * r0.zzzz + r2.yzwy).xyz;
/*206*/	  r1.xyz = (-r0.xywx + r1.xyzx).xyz;
/*207*/	  color0.xyz = (r2.xxxx * r1.xyzx + r0.xywx).xyz;
/*208*/	} else {
/*209*/	  color0.xyz = (r0.xywx).xyz;
/*210*/	}
/*211*/	r0.x = uintBitsToFloat((2.000000 < r4.y) ? 0xffffffffu : 0x00000000u);
/*212*/	r0.y = saturate(-r4.y * cb3.data[4].x);
/*213*/	color0.w = (floatBitsToUint(r0.x) > 0x00000000u) ? 1.000000 : r0.y;
/*214*/	return;
}
