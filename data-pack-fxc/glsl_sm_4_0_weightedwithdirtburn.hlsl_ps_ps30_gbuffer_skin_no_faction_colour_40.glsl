...
// Fragment Shader
//
// id: 2329 - fxc/glsl_SM_4_0_weightedwithdirtburn.hlsl_PS_ps30_gbuffer_skin_no_faction_colour_40.glsl
//
...
/*47*/	r1.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000)).xy;
/*48*/	r2.xyzw = (texture(s_fire_map, r1.xyxx.st)).xyzw;
/*49*/	r1.z = log2(r2.z);
/*50*/	r1.z = r1.z * 1.800000;
/*51*/	r1.z = exp2(r1.z);
/*52*/	r1.z = r1.z * 10.000000;
/*53*/	r1.z = min(r1.z, 1.000000);
/*54*/	r0.w = r0.w + r1.z;
/*55*/	r0.w = r0.w * 0.500000;
/*56*/	r1.y = cb0.data[26].x * 0.050000 + r1.y;
/*57*/	r1.xyzw = (texture(s_fire_map, r1.xyxx.st)).xyzw;
/*58*/	r1.x = saturate(r1.x * 5.000000);
/*59*/	r1.xyz = (r1.xxxx * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*60*/	r1.w = r2.z * 0.250000;
/*61*/	r1.xyz = (r1.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r1.wwww).xyz;
/*62*/	r1.xyz = (r0.wwww * r1.xyzx + r1.wwww).xyz;
/*63*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*64*/	r0.w = -r2.w + 1.000000;
/*65*/	r0.w = log2(r0.w);
/*66*/	r0.w = r0.w * vsOut_T7.z;
/*67*/	r0.w = exp2(r0.w);
/*68*/	r0.w = min(r0.w, 1.000000);
/*69*/	r0.w = r0.w * vsOut_T7.z;
/*70*/	r0.xyz = (r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*71*/	r1.xyz = (r2.zzzz * vec4(0.250000, 0.250000, 0.250000, 0.000000) + -r0.xyzx).xyz;
/*72*/	r0.w = vsOut_T7.z + -0.025000;
...
/*80*/	color1.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*81*/	r0.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*82*/	color2.xyzw = r0.xyzz;
/*83*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*84*/	r0.w = 1.000000;
/*85*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*86*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*87*/	color3.x = r1.x / r0.x;
