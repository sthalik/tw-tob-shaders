...
// Fragment Shader
//
// id: 2031 - fxc/glsl_SM_4_0_weightedwithdecaldirt.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour_40.glsl
//
...
/*37*/	r2.zw = (vsOut_T1.xxxy * cb1.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*62*/	r3.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*63*/	r0.w = vsOut_T7.x * -r2.x + r2.x;
...
/*68*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*69*/	color1.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
/*70*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*71*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*72*/	r0.w = 1.000000;
/*73*/	r1.w = dot(r0.xyzw, cb0.data[11].xyzw);
/*74*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*75*/	color3.x = r1.w / r0.x;
/*76*/	r0.x = max(abs(r1.z), abs(r1.y));
/*77*/	r0.x = max(r0.x, abs(r1.x));
/*78*/	r0.xyz = (r1.xyzx / r0.xxxx).xyz;
/*79*/	color0.xyz = saturate(r0.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*80*/	color0.w = saturate(r2.y);
/*81*/	color2.xyzw = r3.xyzz;
