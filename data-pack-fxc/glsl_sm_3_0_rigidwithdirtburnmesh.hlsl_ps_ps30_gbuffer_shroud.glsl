...
// Fragment Shader
//
// id: 1272 - fxc/glsl_SM_3_0_rigidwithdirtburnmesh.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*114*/	r0.w = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*127*/	  r0.w = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*147*/	    r4.w = cb2.data[1].x * cb2.data[1].x;
/*148*/	    r4.w = r4.w * 1.250000;
/*149*/	    r4.w = min(r4.w, 1.000000);
/*150*/	    r5.w = saturate(cb2.data[1].x * cb2.data[1].x + -0.800000);
...
/*174*/	    r4.w = dot(vec2(cb2.data[0].xyxx), vec2(cb2.data[0].xyxx));
/*175*/	    r4.w = sqrt(r4.w);
...
/*190*/	  }
/*191*/	}
/*192*/	r0.w = uintBitsToFloat((0.500000 < cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*193*/	if(floatBitsToUint(r0.w) != 0u) {
/*194*/	  r4.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*195*/	  r5.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*196*/	  r4.xyzw = r4.xyzw / r5.xyzw;
/*197*/	  r5.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*198*/	  r4.xyzw = r4.xyzw * r5.xyzw + cb1.data[4].xyxy;
/*199*/	  r5.xyzw = (textureLod(s_shroud, r4.zwzz.st, r4.w)).xyzw;
/*200*/	  r4.xyzw = r4.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*201*/	  r4.xyzw = saturate(r4.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*202*/	  r6.xyzw = r4.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*203*/	  r4.xyzw = r4.xyzw * r4.xyzw;
/*204*/	  r4.xyzw = r4.xyzw * r6.xyzw;
/*205*/	  r0.w = r5.x * r4.x;
/*206*/	  r0.w = r0.w * r4.y;
/*207*/	  r0.w = r4.z * -r0.w + r0.w;
/*208*/	  r0.w = r4.w * -r0.w + r0.w;
/*209*/	} else {
/*210*/	  r0.w = 1.000000;
/*211*/	}
/*212*/	r4.xy = (r0.wwww + vec4(-0.100000, -0.500000, 0.000000, 0.000000)).xy;
/*213*/	r0.w = saturate(r4.x * 2.500000);
/*214*/	r4.x = r0.w * -2.000000 + 3.000000;
/*215*/	r0.w = r0.w * r0.w;
/*216*/	r0.w = r0.w * r4.x;
/*217*/	r4.x = saturate(r4.y + r4.y);
/*218*/	r4.y = r4.x * -2.000000 + 3.000000;
/*219*/	r4.x = r4.x * r4.x;
/*220*/	r4.x = r4.x * r4.y;
/*221*/	r0.w = r0.w * 0.200000;
/*222*/	r4.yzw = saturate(r0.wwww * r0.xxyz).yzw;
/*223*/	r0.xyz = (r0.xyzx + -r4.yzwy).xyz;
/*224*/	r0.xyz = (r4.xxxx * r0.xyzx + r4.yzwy).xyz;
/*225*/	r0.w = vsOut_T7.y * -r1.x + r1.x;
/*226*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*227*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*228*/	r0.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*229*/	r4.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*230*/	r4.xyz = (-r0.xyzx + r4.xxxx).xyz;
/*231*/	r0.xyz = (vsOut_T7.zzzz * r4.xyzx + r0.xyzx).xyz;
/*232*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*233*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*234*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*235*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*236*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*237*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*238*/	r2.x = inversesqrt(r2.x);
/*239*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*240*/	color3.x = r2.w / r3.w;
/*241*/	r2.w = max(abs(r2.z), abs(r2.y));
/*242*/	r2.w = max(r2.w, abs(r2.x));
/*243*/	r2.xyz = (r2.xyzx / r2.wwww).xyz;
/*244*/	r1.xyz = (r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*245*/	color0.xyzw = saturate(r1.xyzw);
/*246*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*247*/	r4.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*248*/	color2.xyzw = saturate(r4.xyzw);
/*249*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*250*/	color4 = vsOut_P1;
/*251*/	return;
}
