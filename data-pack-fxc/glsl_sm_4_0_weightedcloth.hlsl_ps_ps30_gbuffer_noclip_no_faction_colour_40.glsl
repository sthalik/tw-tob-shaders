...
// Fragment Shader
//
// id: 3770 - fxc/glsl_SM_4_0_WeightedCloth.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour_40.glsl
//
...
/*90*/	r2.xyz = (-r1.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*91*/	r1.xyz = (r1.wwww * r2.xyzx + r1.xyzx).xyz;
/*92*/	r2.xyz = (r0.xyzx * r1.xyzx).xyz;
/*93*/	r2.w = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*94*/	r2.w = saturate(-r2.w * 15.000000 + 1.000000);
/*95*/	r3.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000)).xy;
/*96*/	r3.xyzw = (texture(s_fire_map, r3.xyxx.st)).xyzw;
/*97*/	r3.x = log2(r3.z);
/*98*/	r3.x = r3.x * 1.800000;
/*99*/	r3.x = exp2(r3.x);
/*100*/	r3.x = r3.x * 10.000000;
/*101*/	r3.x = min(r3.x, 1.000000);
/*102*/	r2.w = r2.w + r3.x;
/*103*/	r2.w = r2.w * 0.500000;
/*104*/	r3.x = 0;
/*105*/	r3.y = cb0.data[26].x * 0.050000;
/*106*/	r3.xy = (vsOut_T1.xyxx * vec4(1.200000, 1.500000, 0.000000, 0.000000) + r3.xyxx).xy;
/*107*/	r4.xyzw = (texture(s_fire_map, r3.xyxx.st)).xyzw;
/*108*/	r3.x = saturate(r4.x * 5.000000);
/*109*/	r4.xyz = (r3.xxxx * vec4(0.530000, 0.070000, -0.120000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*110*/	r3.x = r3.z * 0.250000;
/*111*/	r4.xyz = (r4.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + -r3.xxxx).xyz;
/*112*/	r4.xyz = (r2.wwww * r4.xyzx + r3.xxxx).xyz;
/*113*/	r0.xyz = (-r1.xyzx * r0.xyzx + r4.xyzx).xyz;
/*114*/	r1.x = r0.w * -2.000000 + 3.000000;
/*115*/	r0.w = r0.w * r0.w;
/*116*/	r1.xy = (-r1.xxxx * r0.wwww + vec4(1.000000, 0.975000, 0.000000, 0.000000)).xy;
/*117*/	r0.w = -r3.w + 1.000000;
/*118*/	r0.w = log2(r0.w);
/*119*/	r0.w = r0.w * r1.x;
/*120*/	r0.w = exp2(r0.w);
/*121*/	r0.w = min(r0.w, 1.000000);
/*122*/	r0.w = r1.x * r0.w;
/*123*/	r1.x = max(r1.y, 0.000000);
/*124*/	r0.xyz = (r0.wwww * r0.xyzx + r2.xyzx).xyz;
/*125*/	r2.xyz = (r3.zzzz * vec4(0.250000, 0.250000, 0.250000, 0.000000) + -r0.xyzx).xyz;
/*126*/	r0.xyz = (r1.xxxx * r2.xyzx + r0.xyzx).xyz;
/*127*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*128*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*129*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*130*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*131*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*132*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*133*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*134*/	r0.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*135*/	r1.xyz = (r1.wwww * r0.xyzx).xyz;
/*136*/	r0.xyz = (r1.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r0.xyzx).xyz;
/*137*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*138*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*139*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*140*/	r1.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*141*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & uint(0x3c008081u));
/*142*/	color2.xyzw = saturate(r0.xyzw);
/*143*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*144*/	r0.w = 1.000000;
/*145*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*146*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*147*/	color3.x = r1.x / r0.x;
/*148*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*149*/	color4 = floatBitsToUint(vsOut_T9.z);
/*150*/	return;
}
