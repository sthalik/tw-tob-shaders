...
// Fragment Shader
//
// id: 4938 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecaldirtmesh.hlsl_PS_ps30_imposter.glsl
//
...
/*54*/	r2.xy = (vsOut_T1.xyxx * cb2.data[2].xyxx + vsOut_T6.yzyy).xy;
...
/*59*/	r1.w = uintBitsToFloat((0.000000 < vsOut_T6.w) ? 0xffffffffu : 0x00000000u);
...
/*63*/	    r2.xy = (r3.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*64*/	    r1.xy = (r2.xyxx * r2.wwww + r1.xyxx).xy;
...
/*70*/	    r2.xyz = (r1.wwww * vsOut_T3.xyzx).xyz;
/*71*/	    r1.w = dot(vec3(vsOut_T4.xyzx), vec3(vsOut_T4.xyzx));
/*72*/	    r1.w = inversesqrt(r1.w);
/*73*/	    r3.xyz = (r1.wwww * vsOut_T4.xyzx).xyz;
/*74*/	    r1.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*75*/	    r1.w = inversesqrt(r1.w);
/*76*/	    r4.xyz = (r1.wwww * vsOut_T2.xyzx).xyz;
/*77*/	    r3.xyz = (r1.yyyy * r3.xyzx).xyz;
/*78*/	    r2.xyz = (r1.xxxx * r2.xyzx + r3.xyzx).xyz;
/*79*/	    r2.xyz = (r1.zzzz * r4.xyzx + r2.xyzx).xyz;
/*80*/	    r1.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*81*/	    r1.w = inversesqrt(r1.w);
/*82*/	    r2.xyz = (r1.wwww * r2.xyzx).xyz;
/*83*/	    r1.xyz = (mix(r2.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
/*84*/	    r2.xy = (vsOut_T0.xzxx * vec4(0.000500, 0.000500, 0.000000, 0.000000)).xy;
/*85*/	    r2.xyzw = (texture(s_snow_normals, r2.xyxx.st)).xyzw;
/*86*/	    r2.xy = (r2.wyww + vec4(0.001961, 0.001961, 0.000000, 0.000000)).xy;
/*87*/	    r2.xz = (r2.xxyx * vec4(2.000000, 0.000000, 2.000000, 0.000000) + vec4(-1.000000, 0.000000, -1.000000, 0.000000)).xz;
/*88*/	    r0.w = dot(vec2(r2.xzxx), vec2(r2.xzxx));
/*89*/	    r0.w = -r0.w + 1.000000;
/*90*/	    r0.w = max(r0.w, 0.000000);
/*91*/	    r2.y = sqrt(r0.w);
/*92*/	    r1.xyz = (r2.xyzx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r1.xyzx).xyz;
/*93*/	    r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*94*/	    r0.w = inversesqrt(r0.w);
/*95*/	    r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*96*/	    r2.xz = (cb1.data[0].xxyx).xz/**/;
/*97*/	    r2.y = -1.000000;
/*98*/	    r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*99*/	    r0.w = inversesqrt(r0.w);
/*100*/	    r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*101*/	    r0.w = saturate(dot(vec3(-r2.xyzx), vec3(r1.xyzx)));
/*102*/	    r1.x = cb1.data[1].x * cb1.data[1].x;
/*103*/	    r1.x = r1.x * 1.250000;
/*104*/	    r1.x = min(r1.x, 1.000000);
/*105*/	    r1.y = saturate(cb1.data[1].x * cb1.data[1].x + -0.800000);
/*106*/	    r1.y = r1.y * 4.000000;
/*107*/	    r1.x = r1.x * 0.200000 + r1.y;
/*108*/	    r1.x = r1.x * -0.700000 + 1.000000;
/*109*/	    r0.w = r0.w + -r1.x;
/*110*/	    r0.w = saturate(r0.w * 200.000000);
/*111*/	    r1.x = r0.w * -2.000000 + 3.000000;
/*112*/	    r0.w = r0.w * r0.w;
/*113*/	    r0.w = r0.w * r1.x;
/*114*/	    r1.xyz = (-r0.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*115*/	    r0.xyz = (r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*116*/	  }
/*117*/	}
/*118*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*119*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*120*/	r0.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*121*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*122*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*123*/	r0.xyz = saturate(vsOut_T7.zzzz * r1.xyzx + r0.xyzx).xyz;
/*124*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*125*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*126*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*127*/	color0.w = 1.000000;
/*128*/	return;
}
