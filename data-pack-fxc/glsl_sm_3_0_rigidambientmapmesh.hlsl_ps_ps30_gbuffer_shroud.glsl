...
// Fragment Shader
//
// id: 485 - fxc/glsl_SM_3_0_rigidambientmapmesh.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*72*/	r0.w = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*85*/	  r0.w = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*105*/	    r4.w = cb2.data[1].x * cb2.data[1].x;
/*106*/	    r4.w = r4.w * 1.250000;
/*107*/	    r4.w = min(r4.w, 1.000000);
/*108*/	    r5.w = saturate(cb2.data[1].x * cb2.data[1].x + -0.800000);
...
/*132*/	    r4.w = dot(vec2(cb2.data[0].xyxx), vec2(cb2.data[0].xyxx));
/*133*/	    r4.w = sqrt(r4.w);
...
/*148*/	  }
/*149*/	}
/*150*/	r0.x = uintBitsToFloat((0.500000 < cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*151*/	if(floatBitsToUint(r0.x) != 0u) {
/*152*/	  r0.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*153*/	  r4.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*154*/	  r0.xyzw = r0.xyzw / r4.xyzw;
/*155*/	  r4.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*156*/	  r0.xyzw = r0.xyzw * r4.xyzw + cb1.data[4].xyxy;
/*157*/	  r4.xyzw = (textureLod(s_shroud, r0.zwzz.st, r0.w)).xyzw;
/*158*/	  r0.xyzw = r0.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*159*/	  r0.xyzw = saturate(r0.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*160*/	  r6.xyzw = r0.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*161*/	  r0.xyzw = r0.xyzw * r0.xyzw;
/*162*/	  r0.xyzw = r0.xyzw * r6.xyzw;
/*163*/	  r0.x = r4.x * r0.x;
/*164*/	  r0.x = r0.x * r0.y;
/*165*/	  r0.x = r0.z * -r0.x + r0.x;
/*166*/	  r0.x = r0.w * -r0.x + r0.x;
/*167*/	} else {
/*168*/	  r0.x = 1.000000;
/*169*/	}
/*170*/	r0.xy = (r0.xxxx + vec4(-0.100000, -0.500000, 0.000000, 0.000000)).xy;
/*171*/	r0.x = saturate(r0.x * 2.500000);
/*172*/	r0.z = r0.x * -2.000000 + 3.000000;
/*173*/	r0.x = r0.x * r0.x;
/*174*/	r0.x = r0.x * r0.z;
/*175*/	r0.y = saturate(r0.y + r0.y);
/*176*/	r0.z = r0.y * -2.000000 + 3.000000;
/*177*/	r0.y = r0.y * r0.y;
/*178*/	r0.y = r0.y * r0.z;
/*179*/	r0.x = r0.x * 0.200000;
/*180*/	r0.xzw = saturate(r0.xxxx * r5.xxyz).xzw;
/*181*/	r4.xyz = (-r0.xzwx + r5.xyzx).xyz;
/*182*/	r0.xyz = (r0.yyyy * r4.xyzx + r0.xzwx).xyz;
/*183*/	r0.w = vsOut_T7.y * -r1.x + r1.x;
/*184*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*185*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*186*/	r0.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*187*/	r4.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*188*/	r4.xyz = (-r0.xyzx + r4.xxxx).xyz;
/*189*/	r0.xyz = (vsOut_T7.zzzz * r4.xyzx + r0.xyzx).xyz;
/*190*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*191*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*192*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*193*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*194*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*195*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*196*/	r2.x = inversesqrt(r2.x);
/*197*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*198*/	color3.x = r2.w / r3.w;
/*199*/	r2.w = max(abs(r2.z), abs(r2.y));
/*200*/	r2.w = max(r2.w, abs(r2.x));
/*201*/	r2.xyz = (r2.xyzx / r2.wwww).xyz;
/*202*/	r1.xyz = (r2.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*203*/	color0.xyzw = saturate(r1.xyzw);
/*204*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*205*/	r4.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*206*/	color2.xyzw = saturate(r4.xyzw);
