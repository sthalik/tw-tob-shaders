...
// Fragment Shader
//
// id: 271 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_DirectionalLight.hlsl_PS_ps30_slm_lowdef.glsl
//
...
/*296*/	r1.xyz = (r6.xxxx * r0.xywx + r9.xyzx).xyz;
/*297*/	r0.x = uintBitsToFloat(floatBitsToUint(r0.z) & uint(1));
/*298*/	if(floatBitsToUint(r0.x) != 0u) {
/*299*/	  r0.xyz = (r4.yyyy * vec4(0.000000, 1.000000, 0.000000, 0.000000)).xyz;
/*300*/	  r0.xyz = (r0.xyzx / vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*301*/	  r0.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*302*/	  r0.w = 1.000000;
/*303*/	  r2.x = dot(r0.xyzw, cb4.data[0].xyzw);
/*304*/	  r2.y = dot(r0.xyzw, cb4.data[1].xyzw);
/*305*/	  r0.x = dot(r0.xyzw, cb4.data[3].xyzw);
/*306*/	  r0.xy = (r2.xyxx / r0.xxxx).xy;
/*307*/	  r0.yz = (r0.xxyx * vec4(0.000000, 0.500000, -0.500000, 0.000000) + vec4(0.000000, 0.500000, 0.500000, 0.000000)).yz;
/*308*/	  r0.xw = (-r0.zzzz + vec4(1.000000, 0.000000, 0.000000, 1.000000)).xw;
/*309*/	  r0.xyzw = (textureLod(s_overlay, r0.ywyy.st, r0.x)).xyzw;
/*310*/	  r2.x = uintBitsToFloat((0.500000 < cb3.data[0].x) ? 0xffffffffu : 0x00000000u);
/*311*/	  if(floatBitsToUint(r2.x) != 0u) {
...
/*323*/	    r2.x = r3.x * r2.x;
/*324*/	    r2.x = r2.x * r2.y;
/*325*/	    r2.x = r2.z * -r2.x + r2.x;
/*326*/	    r2.x = r2.w * -r2.x + r2.x;
/*327*/	  } else {
/*328*/	    r2.x = 1.000000;
/*329*/	  }
/*330*/	  r2.x = saturate(r2.x + -0.500000);
/*331*/	  r2.x = r2.x * 1.900000 + 0.050000;
/*332*/	  r2.yzw = (r0.wwww * r1.xxyz).yzw;
/*333*/	  r0.xyz = (r0.xyzx * r2.xxxx + r2.yzwy).xyz;
/*334*/	  r0.w = uintBitsToFloat((0.001000 < r4.y) ? 0xffffffffu : 0x00000000u);
/*335*/	  r0.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3f800000u));
/*336*/	  r0.xyz = (-r1.xyzx + r0.xyzx).xyz;
/*337*/	  r1.xyz = (r0.wwww * r0.xyzx + r1.xyzx).xyz;
/*338*/	}
/*339*/	r0.x = uintBitsToFloat((2.000000 < r4.y) ? 0xffffffffu : 0x00000000u);
/*340*/	r0.y = saturate(-r4.y * cb4.data[4].x);
/*341*/	r1.w = (floatBitsToUint(r0.x) > 0x00000000u) ? 1.000000 : r0.y;
/*342*/	color0.xyzw = saturate(r1.xyzw);
/*343*/	return;
}
