...
// Fragment Shader
//
// id: 2776 - fxc/glsl_SM_4_0_weightedwithdirtburn.hlsl_PS_ps30_gbuffer_no_faction_colour_40.glsl
//
...
/*75*/	r1.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*76*/	r1.xyz = (-r0.xyzx + r1.xxxx).xyz;
/*77*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*78*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*79*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*80*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
...
/*88*/	r1.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*89*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & uint(0x3c008081u));
/*90*/	color2.xyzw = saturate(r0.xyzw);
/*91*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*92*/	r0.w = 1.000000;
/*93*/	r1.x = dot(r0.xyzw, cb0.data[11].xyzw);
/*94*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*95*/	color3.x = r1.x / r0.x;
