...
// Fragment Shader
//
// id: 278 - fxc/glsl_SM_3_0_DirectionalLight.hlsl_PS_ps30_skinlm_highdef.glsl
//
...
/*122*/	color0.xyz = (r3.xxxx * r2.xyzx + r0.xyzx).xyz;
/*123*/	r0.x = uintBitsToFloat((2.000000 < r1.y) ? 0xffffffffu : 0x00000000u);
/*124*/	r0.y = saturate(-r1.y * cb2.data[4].x);
/*125*/	color0.w = (floatBitsToUint(r0.x) > 0x00000000u) ? 1.000000 : r0.y;
/*126*/	return;
}
