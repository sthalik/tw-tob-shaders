...
// Fragment Shader
//
// id: 2037 - fxc/glsl_SM_3_0_weightedwithdecaldirt.hlsl_PS_ps30_gbuffer_skin_no_faction_colour.glsl
//
...
/*39*/	r2.zw = (vsOut_T1.xxxy * cb1.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*63*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*64*/	r3.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*65*/	r0.w = vsOut_T7.x * -r2.x + r2.x;
...
/*70*/	r2.xzw = (-r0.xxyz + r1.wwww).xzw;
/*71*/	color1.xyz = saturate(vsOut_T7.yyyy * r2.xzwx + r0.xyzx).xyz;
/*72*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*73*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*74*/	r0.w = 1.000000;
/*75*/	r1.w = dot(r0.xyzw, cb0.data[11].xyzw);
/*76*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*77*/	color3.x = r1.w / r0.x;
/*78*/	r0.x = max(abs(r1.z), abs(r1.y));
/*79*/	r0.x = max(r0.x, abs(r1.x));
/*80*/	r0.xyz = (r1.xyzx / r0.xxxx).xyz;
/*81*/	color0.xyz = saturate(r0.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*82*/	color0.w = saturate(r2.y);
/*83*/	color2.xyzw = r3.xyzz;
