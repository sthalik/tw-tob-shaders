...
// Fragment Shader
//
// id: 306 - fxc/glsl_SM_3_0_blur.hlsl_PS_ps30_main_blur_y.glsl
//
...
/*3*/	r1.xyzw = cb1.data[0].xyxy * vec4(-0.000000, -12.000000, -0.000000, -8.000000) + r0.zwzw;
...
/*8*/	r2.xyzw = cb1.data[0].xyxy * vec4(-0.000000, -4.000000, 0.000000, 4.000000) + r0.zwzw;
...
/*13*/	r0.xyzw = cb1.data[0].xyxy * vec4(0.000000, 8.000000, 0.000000, 12.000000) + r0.xyzw;
