...
// Fragment Shader
//
// id: 1980 - fxc/glsl_SM_4_0_weightedwithdecal.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour_slm_40.glsl
//
...
/*41*/	r4.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
/*42*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*43*/	r0.w = inversesqrt(r0.w);
/*44*/	r5.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*45*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*46*/	r0.w = inversesqrt(r0.w);
/*47*/	r6.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*48*/	r5.xyz = (r2.yyyy * r5.xyzx).xyz;
/*49*/	r2.xyw = (r2.xxxx * r4.xyxz + r5.xyxz).xyw;
/*50*/	r2.xyz = (r2.zzzz * r6.xyzx + r2.xywx).xyz;
/*51*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*52*/	r0.w = inversesqrt(r0.w);
/*53*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*54*/	r0.w = vsOut_T7.x * -r3.x + r3.x;
/*55*/	r3.xzw = (r0.xxyz * vec4(5.000000, 0.000000, 5.000000, 5.000000) + vec4(0.200000, 0.000000, 0.200000, 0.200000)).xzw;
/*56*/	r3.xzw = (-r0.xxyz + r3.xxzw).xzw;
/*57*/	r0.xyz = saturate(vsOut_T7.xxxx * r3.xzwx + r0.xyzx).xyz;
/*58*/	r1.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*59*/	r3.xzw = (-r0.xxyz + r1.wwww).xzw;
/*60*/	r0.xyz = (vsOut_T7.yyyy * r3.xzwx + r0.xyzx).xyz;
/*61*/	r1.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*62*/	r3.xzw = (-r1.xxyz + r1.wwww).xzw;
/*63*/	color2.xyz = saturate(vsOut_T7.yyyy * r3.xzwx + r1.xyzx).xyz;
/*64*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*65*/	r1.xyz = (vsOut_T0.xyzx).xyz;
/*66*/	r1.w = 1.000000;
/*67*/	r0.w = dot(r1.xyzw, cb0.data[11].xyzw);
/*68*/	r1.x = dot(r1.xyzw, cb0.data[12].xyzw);
/*69*/	color3.x = r0.w / r1.x;
/*70*/	r0.w = max(abs(r2.z), abs(r2.y));
/*71*/	r0.w = max(r0.w, abs(r2.x));
/*72*/	r1.xyz = (r2.xyzx / r0.wwww).xyz;
/*73*/	color0.xyz = saturate(r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
