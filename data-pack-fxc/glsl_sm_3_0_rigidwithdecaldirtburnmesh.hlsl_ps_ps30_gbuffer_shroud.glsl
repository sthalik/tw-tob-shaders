...
// Fragment Shader
//
// id: 1019 - fxc/glsl_SM_3_0_rigidwithdecaldirtburnmesh.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*83*/	r4.xy = (vsOut_T1.xyxx * cb3.data[2].xyxx + vsOut_T6.yzyy).xy;
...
/*142*/	r0.w = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*155*/	  r0.w = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*175*/	    r4.w = cb2.data[1].x * cb2.data[1].x;
/*176*/	    r4.w = r4.w * 1.250000;
/*177*/	    r4.w = min(r4.w, 1.000000);
/*178*/	    r5.w = saturate(cb2.data[1].x * cb2.data[1].x + -0.800000);
...
/*202*/	    r4.w = dot(vec2(cb2.data[0].xyxx), vec2(cb2.data[0].xyxx));
/*203*/	    r4.w = sqrt(r4.w);
...
/*218*/	  }
/*219*/	}
/*220*/	r0.w = uintBitsToFloat((0.500000 < cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*221*/	if(floatBitsToUint(r0.w) != 0u) {
/*222*/	  r4.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*223*/	  r5.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*224*/	  r4.xyzw = r4.xyzw / r5.xyzw;
/*225*/	  r5.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*226*/	  r4.xyzw = r4.xyzw * r5.xyzw + cb1.data[4].xyxy;
/*227*/	  r5.xyzw = (textureLod(s_shroud, r4.zwzz.st, r4.w)).xyzw;
/*228*/	  r4.xyzw = r4.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*229*/	  r4.xyzw = saturate(r4.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*230*/	  r6.xyzw = r4.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*231*/	  r4.xyzw = r4.xyzw * r4.xyzw;
/*232*/	  r4.xyzw = r4.xyzw * r6.xyzw;
/*233*/	  r0.w = r5.x * r4.x;
/*234*/	  r0.w = r0.w * r4.y;
/*235*/	  r0.w = r4.z * -r0.w + r0.w;
/*236*/	  r0.w = r4.w * -r0.w + r0.w;
/*237*/	} else {
/*238*/	  r0.w = 1.000000;
/*239*/	}
/*240*/	r4.xy = (r0.wwww + vec4(-0.100000, -0.500000, 0.000000, 0.000000)).xy;
/*241*/	r0.w = saturate(r4.x * 2.500000);
/*242*/	r4.x = r0.w * -2.000000 + 3.000000;
/*243*/	r0.w = r0.w * r0.w;
/*244*/	r0.w = r0.w * r4.x;
/*245*/	r4.x = saturate(r4.y + r4.y);
/*246*/	r4.y = r4.x * -2.000000 + 3.000000;
/*247*/	r4.x = r4.x * r4.x;
/*248*/	r4.x = r4.x * r4.y;
/*249*/	r0.w = r0.w * 0.200000;
/*250*/	r4.yzw = saturate(r0.wwww * r0.xxyz).yzw;
/*251*/	r0.xyz = (r0.xyzx + -r4.yzwy).xyz;
/*252*/	r0.xyz = (r4.xxxx * r0.xyzx + r4.yzwy).xyz;
/*253*/	r0.w = vsOut_T7.y * -r1.x + r1.x;
/*254*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*255*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*256*/	r0.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*257*/	r4.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*258*/	r4.xyz = (-r0.xyzx + r4.xxxx).xyz;
/*259*/	r0.xyz = (vsOut_T7.zzzz * r4.xyzx + r0.xyzx).xyz;
/*260*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*261*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*262*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*263*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*264*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*265*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*266*/	r2.x = inversesqrt(r2.x);
/*267*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*268*/	color3.x = r2.w / r3.w;
/*269*/	r2.w = max(abs(r2.z), abs(r2.y));
/*270*/	r2.w = max(r2.w, abs(r2.x));
/*271*/	r2.xyz = (r2.xyzx / r2.wwww).xyz;
/*272*/	r1.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*273*/	color0.xyzw = saturate(r1.xzwy);
/*274*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*275*/	r4.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*276*/	color2.xyzw = saturate(r4.xyzw);
/*277*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*278*/	color4 = vsOut_P1;
/*279*/	return;
}
