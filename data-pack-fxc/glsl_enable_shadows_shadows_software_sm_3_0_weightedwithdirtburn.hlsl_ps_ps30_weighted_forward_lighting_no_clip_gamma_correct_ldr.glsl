...
// Fragment Shader
//
// id: 6851 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdirtburn.hlsl_PS_ps30_weighted_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*42*/	r5.x = r3.x;
/*43*/	r5.y = cb1.data[26].x * 0.050000 + r3.y;
...
/*98*/	r3.xyz = (vsOut_T0.xyzx + -cb1.data[0].xyzx).xyz;
/*99*/	r1.w = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*100*/	r2.w = inversesqrt(r1.w);
/*101*/	r4.yzw = (r2.wwww * r3.xxyz).yzw;
/*102*/	r2.w = -r4.x + 1.000000;
/*103*/	r5.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*104*/	r5.y = dot(vec3(r4.yzwy), vec3(r2.xyzx));
/*105*/	r5.y = r5.y + r5.y;
/*106*/	r5.yzw = (r2.xxyz * -r5.yyyy + r4.yyzw).yzw;
...
/*132*/	  r6.y = dot(vec3(r5.yzwy), vec3(r4.yzwy));
...
/*161*/	  r2.z = r4.x * r4.x;
/*162*/	    r4.x = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*163*/	  r2.z = r2.z * r4.x + r6.x;
/*164*/	  r2.z = r2.z * 0.500000 + 0.500000;
/*165*/	  r2.z = r2.z * 2.000000 + -1.000000;
/*166*/	  r4.x = -r2.z * r2.z + 1.000000;
/*167*/	  r4.x = max(r4.x, 0.001000);
/*168*/	  r4.x = log2(r4.x);
/*169*/	  r5.x = r4.x * 4.950617;
...
/*210*/	  r2.w = dot(vec3(-cb2.data[0].yzwy), vec3(r4.yzwy));
...
/*221*/	}
/*222*/	r4.xyz = saturate(r6.zzzz * r2.xzwx).xyz;
/*223*/	r1.xyz = (r1.xyzx * r4.xyzx).xyz;
...
/*264*/	r1.x = r1.x * r1.x;
/*265*/	r1.x = r1.x * r1.y;
/*266*/	r1.y = dot(vec2(r3.xzxx), vec2(r3.xzxx));
/*267*/	r1.y = sqrt(r1.y);
...
/*280*/	r3.w = max(r3.y, 0.000000);
/*281*/	r3.xyzw = (texture(s_sky, r3.xwzx.stp)).xyzw;
