...
// Fragment Shader
//
// id: 1657 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_noclip_40.glsl
//
...
/*61*/	r1.xyz = (-r0.xyzx + r1.xxxx).xyz;
/*62*/	r0.xyz = (vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*63*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*64*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*65*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*66*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*67*/	r1.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*68*/	r0.xyz = (r0.wwww * r1.xyzx).xyz;
/*69*/	r0.xyz = (r0.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r1.xyzx).xyz;
