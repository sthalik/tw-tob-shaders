...
// Fragment Shader
//
// id: 5094 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecalmesh.hlsl_PS_ps30_alpha_test.glsl
//
...
/*90*/	r2.w = dot(vec3(r7.xyzx), vec3(r7.xyzx));
/*91*/	r2.w = inversesqrt(r2.w);
/*92*/	r7.xyz = (r2.wwww * r7.xyzx).xyz;
/*93*/	r1.xyz = (mix(r7.xyzx, r1.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
...
/*137*/	    r0.w = r0.w * r0.w;
/*138*/	    r0.w = r0.w * r2.w;
/*139*/	    r3.y = r0.w * -r3.y + r3.y;
/*140*/	    r2.w = -r3.x + 0.200000;
/*141*/	    r3.x = r0.w * r2.w + r3.x;
...
/*170*/	  }
/*171*/	}
/*172*/	r0.w = vsOut_T7.y * -r3.x + r3.x;
/*173*/	r3.xzw = (r0.xxyz * vec4(5.000000, 0.000000, 5.000000, 5.000000) + vec4(0.200000, 0.000000, 0.200000, 0.200000)).xzw;
/*174*/	r3.xzw = (-r0.xxyz + r3.xxzw).xzw;
/*175*/	r0.xyz = saturate(vsOut_T7.yyyy * r3.xzwx + r0.xyzx).xyz;
/*176*/	r2.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*177*/	r3.xzw = (-r0.xxyz + r2.wwww).xzw;
/*178*/	r0.xyz = (vsOut_T7.zzzz * r3.xzwx + r0.xyzx).xyz;
/*179*/	r2.w = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*180*/	r3.xzw = (-r2.xxyz + r2.wwww).xzw;
...
/*188*/	r3.x = inversesqrt(r2.w);
/*189*/	r3.xzw = (r3.xxxx * r4.xxyz).xzw;
/*190*/	r5.x = -r3.y + 1.000000;
/*191*/	r5.y = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*192*/	r5.z = dot(vec3(r3.xzwx), vec3(r1.xyzx));
/*193*/	r5.z = r5.z + r5.z;
/*194*/	r6.xyz = (r1.xyzx * -r5.zzzz + r3.xzwx).xyz;
...
/*220*/	  r6.w = dot(vec3(r6.xyzx), vec3(r3.xzwx));
...
/*294*/	  r3.y = r5.x * 1.570796;
/*295*/	  r3.y = sin(r3.y);
/*296*/	  r1.z = r1.z + -1.000000;
/*297*/	  r1.z = r3.y * r1.z + 1.000000;
/*298*/	  r3.x = dot(vec3(-cb1.data[0].yzwy), vec3(r3.xzwx));
