...
// Fragment Shader
//
// id: 1909 - fxc/glsl_SM_4_0_weightedwithdirt.hlsl_PS_ps30_gbuffer_skin_noclip_slm_40.glsl
//
...
/*49*/	r1.x = -vsOut_T4.z + 1.000000;
/*50*/	r1.yzw = (vsOut_T4.zzzz * cb2.data[3].xxyz).yzw;
/*51*/	r0.xyz = (r0.xyzx * r1.xxxx + r1.yzwy).xyz;
...
/*59*/	r1.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*60*/	r0.xyz = (r0.wwww * r1.xyzx).xyz;
/*61*/	r0.xyz = (r0.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r1.xyzx).xyz;
/*62*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*63*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*64*/	color2.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*65*/	color2.w = 0;
