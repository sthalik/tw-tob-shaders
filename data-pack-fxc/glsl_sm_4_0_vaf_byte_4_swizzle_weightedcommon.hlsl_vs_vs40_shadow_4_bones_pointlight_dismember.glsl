...
// Vertex Shader
//
// id: 2597 - fxc/glsl_SM_4_0_VAF_BYTE_4_SWIZZLE_weightedcommon.hlsl_VS_vs40_shadow_4_bones_pointlight_dismember.glsl
//
...
/*76*/	r0.w = 1.000000;
/*77*/	gl_Position.x = dot(r0.xyzw, vsIn_T0.xyzw);
/*78*/	gl_Position.y = dot(r0.xyzw, vsIn_T1.xyzw);
/*79*/	gl_Position.z = dot(r0.xyzw, vsIn_T2.xyzw);
/*80*/	gl_Position.w = 1.000000;
/*81*/	vsOut_T0.xy = (vsIn_P4.xyxx).xy;
/*82*/	return;
}
