...
// Fragment Shader
//
// id: 5204 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdecalbloodmesh.hlsl_PS_ps40_rigid_forward_lighting_noclip_no_faction_colour_HDR.glsl
//
...
/*50*/	}
/*51*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy).zw;
/*52*/	r3.zw = (r3.zzzw * vec4(0.000000, 0.000000, 0.750000, 0.750000) + vsOut_T6.yyyz).zw;
/*53*/	r5.xyzw = (texture(s_decal_blood_map, r3.zwzz.st)).xyzw;
/*54*/	r2.w = -vsOut_T7.w * 0.900000 + 1.000000;
/*55*/	r2.w = saturate(-r2.w + r5.w);
/*56*/	r2.w = uintBitsToFloat((0.000000 < r2.w) ? 0xffffffffu : 0x00000000u);
/*57*/	if(floatBitsToUint(r2.w) != 0u) {
/*58*/	  r2.w = -r5.w + 1.000000;
/*59*/	  r2.w = saturate(vsOut_T7.w * 0.900000 + -r2.w);
/*60*/	  r2.w = -r2.w + 1.000000;
/*61*/	  r2.w = -r2.w * r2.w + 1.000000;
/*62*/	  r2.w = r2.w * -0.600000 + 1.000000;
/*63*/	  r5.xyz = (r2.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*64*/	  r2.w = saturate(dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
...
/*67*/	  r6.xyz = (r1.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r5.xzzx).xyz;
/*68*/	  r1.xyz = (r2.wwww * r6.xyzx + r5.xyzx).xyz;
...
/*81*/	r8.xyz = (r0.yyyy * r6.xyzx).xyz;
/*82*/	r8.xyz = (r0.xxxx * r5.xyzx + r8.xyzx).xyz;
/*83*/	r8.xyz = (r0.wwww * r7.xyzx + r8.xyzx).xyz;
/*84*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*85*/	r2.w = inversesqrt(r2.w);
/*86*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*87*/	r0.xyz = (mix(r8.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
...
/*93*/	  r8.xy = (r0.wwww * vec4(-0.700000, 0.660000, 0.000000, 0.000000)).xy;
...
/*107*/	    r0.w = dot(vec2(r9.xyxx), vec2(r9.xyxx));
/*108*/	    r0.w = -r0.w + 1.000000;
/*109*/	    r0.w = max(r0.w, 0.000000);
/*110*/	    r9.z = sqrt(r0.w);
/*111*/	    r10.xyz = (r9.xzyx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r0.xyzx).xyz;
...
/*116*/	    r11.y = -1.000000;
/*117*/	    r0.w = dot(vec3(r11.xyzx), vec3(r11.xyzx));
/*118*/	    r0.w = inversesqrt(r0.w);
/*119*/	    r11.xyz = (r0.wwww * r11.xyzx).xyz;
/*120*/	    r0.w = saturate(dot(vec3(-r11.xyzx), vec3(r10.xyzx)));
...
/*136*/	    r10.xyz = (-r1.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*137*/	    r1.xyz = (r0.wwww * r10.xyzx + r1.xyzx).xyz;
/*138*/	    r10.xyz = (-r2.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*139*/	    r2.xyz = (r0.wwww * r10.xyzx + r2.xyzx).xyz;
...
/*157*/	    r2.w = -r0.y + 1.000000;
/*158*/	    r0.w = min(r0.w, r2.w);
/*159*/	    r5.xyz = (-r0.xyzx + r5.xyzx).xyz;
/*160*/	    r5.xyz = (r0.wwww * r5.xyzx + r0.xyzx).xyz;
/*161*/	    r0.w = dot(vec3(r5.xyzx), vec3(r5.xyzx));
/*162*/	    r0.w = inversesqrt(r0.w);
/*163*/	    r0.xyz = (r0.wwww * r5.xyzx).xyz;
/*164*/	  }
/*165*/	}
...
/*170*/	r2.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*171*/	r3.yzw = (-r1.xxyz + r2.wwww).yzw;
...
/*177*/	r2.w = dot(vec3(r0.xyzx), vec3(r0.xyzx));
/*178*/	r2.w = inversesqrt(r2.w);
/*179*/	r0.xyz = (r0.xyzx * r2.wwww).xyz;
...
/*316*/	r3.w = dot(vec3(r5.xyzx), vec3(r0.xyzx));
/*317*/	r3.w = r3.w + r3.w;
/*318*/	r6.xyz = (r0.xyzx * -r3.wwww + r5.xyzx).xyz;
...
/*324*/	r5.w = saturate(r0.w * 60.000000);
/*325*/	r5.w = -r0.w + r5.w;
/*326*/	r8.xzw = (r0.xxyz * vec4(1.000000, 0.000000, 4.000000, 1.000000)).xzw;
...
/*339*/	r8.xzw = (r1.xxyz * r8.xxzw).xzw;
/*340*/	r6.w = -r0.w + 1.000000;
...
/*355*/	}
/*356*/	r6.w = dot(vec3(r0.xyzx), vec3(-cb2.data[0].yzwy));
...
/*436*/	r5.xyz = (max(r0.wwww, r5.xyzx)).xyz;
/*437*/	r5.xyz = (-r5.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*438*/	r1.xyz = (r1.xyzx * r7.yyyy).xyz;
/*439*/	r1.xyz = (r1.xyzx * cb2.data[1].xyzx).xyz;
/*440*/	r1.xyz = (r5.xyzx * r1.xyzx).xyz;
/*441*/	r1.xyz = (r7.xxxx * r1.xyzx).xyz;
/*442*/	r1.xyz = (r6.xyzx * cb2.data[1].xyzx + r1.xyzx).xyz;
/*443*/	r1.xyz = (r3.zzzz * r1.xyzx + r8.xzwx).xyz;
...
/*448*/	r2.w = dot(vec3(-r3.xyzx), vec3(r0.xyzx));
/*449*/	r2.w = r2.w + r2.w;
/*450*/	r0.xyz = (r0.xyzx * -r2.wwww + -r3.xyzx).xyz;
/*451*/	r6.xyzw = (textureLod(s_environment, r0.xyzx.stp, r8.y)).xyzw;
/*452*/	r0.x = dot(vec3(r0.xyzx), vec3(-r3.xyzx));
/*453*/	r0.x = max(r0.x, 0.000000);
/*454*/	r0.x = log2(r0.x);
/*455*/	r0.x = r0.x * 10.000000;
/*456*/	r0.x = exp2(r0.x);
/*457*/	r0.x = r3.w * r0.x;
/*458*/	r0.x = r0.x * r5.w + r0.w;
/*459*/	r0.xyz = (r6.xyzx * r0.xxxx).xyz;
/*460*/	color0.xyz = (r0.xyzx * r2.xyzx + r1.xyzx).xyz;
