...
// Fragment Shader
//
// id: 2120 - fxc/glsl_SM_4_0_weightedwithblood.hlsl_PS_ps30_gbuffer_skin_noclip_slm_40.glsl
//
...
/*36*/	  r3.xw = (vec4(0.020000, 0, 0, 0.800000)).xw;
/*37*/	} else {
/*38*/	  r2.xyzw = (texture(s_specular_colour_map, vsOut_T1.xyxx.st)).xyzw;
/*39*/	  r3.xyzw = (texture(s_gloss_map, vsOut_T1.xyxx.st)).yzwx;
/*40*/	}
/*41*/	r1.z = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*42*/	r1.z = inversesqrt(r1.z);
/*43*/	r4.xyz = (r1.zzzz * vsOut_T3.xyzx).xyz;
/*44*/	r1.z = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*45*/	r1.z = inversesqrt(r1.z);
/*46*/	r5.xyz = (r1.zzzz * vsOut_T5.xyzx).xyz;
/*47*/	r1.z = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*48*/	r1.z = inversesqrt(r1.z);
/*49*/	r6.xyz = (r1.zzzz * vsOut_T2.xyzx).xyz;
/*50*/	r1.yzw = (r1.yyyy * r5.xxyz).yzw;
/*51*/	r1.xyz = (r1.xxxx * r4.xyzx + r1.yzwy).xyz;
/*52*/	r1.xyz = (r0.wwww * r6.xyzx + r1.xyzx).xyz;
/*53*/	r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*54*/	r0.w = inversesqrt(r0.w);
/*55*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*56*/	r0.w = -vsOut_T4.z + 1.000000;
/*57*/	r4.xyz = (vsOut_T4.zzzz * cb2.data[3].xyzx).xyz;
/*58*/	r0.xyz = (r0.xyzx * r0.wwww + r4.xyzx).xyz;
/*59*/	r0.w = vsOut_T7.x * -r3.x + r3.x;
...
/*66*/	r1.w = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*67*/	r4.xyz = (-r2.xyzx + r1.wwww).xyz;
/*68*/	color2.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r2.xyzx).xyz;
/*69*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*70*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*71*/	r2.w = 1.000000;
/*72*/	r0.w = dot(r2.xyzw, cb0.data[11].xyzw);
/*73*/	r1.w = dot(r2.xyzw, cb0.data[12].xyzw);
/*74*/	color3.x = r0.w / r1.w;
/*75*/	r0.w = max(abs(r1.z), abs(r1.y));
/*76*/	r0.w = max(r0.w, abs(r1.x));
/*77*/	r1.xyz = (r1.xyzx / r0.wwww).xyz;
/*78*/	r3.xyz = (r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*79*/	color0.xyzw = saturate(r3.xyzw);
/*80*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*81*/	color2.w = 0;
/*82*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*83*/	color4 = floatBitsToUint(vsOut_T9.z);
/*84*/	return;
}
