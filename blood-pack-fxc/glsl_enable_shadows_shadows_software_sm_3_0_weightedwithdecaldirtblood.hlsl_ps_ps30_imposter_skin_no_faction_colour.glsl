...
// Fragment Shader
//
// id: 6561 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecaldirtblood.hlsl_PS_ps30_imposter_skin_no_faction_colour.glsl
//
...
/*24*/	r1.xy = (vsOut_T1.xyxx * vec4(0.750000, 0.750000, 0.000000, 0.000000)).xy;
/*25*/	r1.xy = (r1.xyxx * cb1.data[2].xyxx + vsOut_T6.xyxx).xy;
/*26*/	r1.xyzw = (texture(s_decal_blood_map, r1.xyxx.st)).xyzw;
/*27*/	r0.w = saturate(r1.w + -1.000000);
/*28*/	r0.w = uintBitsToFloat((0.000000 < r0.w) ? 0xffffffffu : 0x00000000u);
/*29*/	if(floatBitsToUint(r0.w) != 0u) {
/*30*/	  r0.w = -r1.w + 1.000000;
/*31*/	  r0.w = saturate(-r0.w);
/*32*/	  r0.w = -r0.w + 1.000000;
/*33*/	  r0.w = -r0.w * r0.w + 1.000000;
/*34*/	  r0.w = r0.w * -0.600000 + 1.000000;
/*35*/	  r1.xyz = (r0.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
...
/*39*/	  r2.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r1.xzzx).xyz;
/*40*/	  r0.xyz = (r0.wwww * r2.xyzx + r1.xyzx).xyz;
/*41*/	}
...
/*46*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*47*/	r0.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*48*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*49*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*50*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*51*/	color0.w = 1.000000;
/*52*/	return;
}
