...
// Fragment Shader
//
// id: 2485 - fxc/glsl_SM_4_0_weightedwithdecaldirtblood.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour_slm_40.glsl
//
...
/*78*/	r1.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
...
/*85*/	r5.xyz = (r2.yyyy * r5.xyzx).xyz;
/*86*/	r1.xyz = (r2.xxxx * r1.xyzx + r5.xyzx).xyz;
/*87*/	r1.xyz = (r2.zzzz * r6.xyzx + r1.xyzx).xyz;
/*88*/	r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*89*/	r0.w = inversesqrt(r0.w);
/*90*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*91*/	r0.w = vsOut_T7.x * -r3.x + r3.x;
/*92*/	r2.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*93*/	r2.xyz = (-r0.xyzx + r2.xyzx).xyz;
/*94*/	r0.xyz = saturate(vsOut_T7.xxxx * r2.xyzx + r0.xyzx).xyz;
/*95*/	r1.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*96*/	r2.xyz = (-r0.xyzx + r1.wwww).xyz;
/*97*/	r0.xyz = (vsOut_T7.yyyy * r2.xyzx + r0.xyzx).xyz;
/*98*/	r1.w = dot(vec3(r4.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*99*/	r2.xyz = (-r4.xyzx + r1.wwww).xyz;
/*100*/	color2.xyz = saturate(vsOut_T7.yyyy * r2.xyzx + r4.xyzx).xyz;
/*101*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*102*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*103*/	r2.w = 1.000000;
/*104*/	r0.w = dot(r2.xyzw, cb0.data[11].xyzw);
/*105*/	r1.w = dot(r2.xyzw, cb0.data[12].xyzw);
/*106*/	color3.x = r0.w / r1.w;
/*107*/	r0.w = max(abs(r1.z), abs(r1.y));
/*108*/	r0.w = max(r0.w, abs(r1.x));
/*109*/	r1.xyz = (r1.xyzx / r0.wwww).xyz;
/*110*/	r3.xzw = (r1.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*111*/	color0.xyzw = saturate(r3.xzwy);
/*112*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*113*/	color2.w = 0;
