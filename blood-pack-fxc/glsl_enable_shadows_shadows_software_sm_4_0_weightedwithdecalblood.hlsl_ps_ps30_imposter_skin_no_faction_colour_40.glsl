...
// Fragment Shader
//
// id: 6487 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdecalblood.hlsl_PS_ps30_imposter_skin_no_faction_colour_40.glsl
//
...
/*16*/	}
/*17*/	r0.w = uintBitsToFloat((vsOut_T8.x < vsOut_T8.z) ? 0xffffffffu : 0x00000000u);
/*18*/	if(r0.w != 0) discard;
/*19*/	r1.xy = (vsOut_T1.xyxx * vec4(0.750000, 0.750000, 0.000000, 0.000000)).xy;
/*20*/	r1.xy = (r1.xyxx * cb1.data[2].xyxx + vsOut_T6.xyxx).xy;
/*21*/	r1.xyzw = (texture(s_decal_blood_map, r1.xyxx.st)).xyzw;
/*22*/	r0.w = saturate(r1.w + -1.000000);
/*23*/	r0.w = uintBitsToFloat((0.000000 < r0.w) ? 0xffffffffu : 0x00000000u);
/*24*/	if(floatBitsToUint(r0.w) != 0u) {
/*25*/	  r0.w = -r1.w + 1.000000;
/*26*/	  r0.w = saturate(-r0.w);
/*27*/	  r0.w = -r0.w + 1.000000;
/*28*/	  r0.w = -r0.w * r0.w + 1.000000;
/*29*/	  r0.w = r0.w * -0.600000 + 1.000000;
/*30*/	  r1.xyz = (r0.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*31*/	  r0.w = saturate(dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*32*/	  r0.w = uintBitsToFloat((r0.w < 0.225000) ? 0xffffffffu : 0x00000000u);
/*33*/	  r0.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3f800000u));
/*34*/	  r2.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r1.xzzx).xyz;
/*35*/	  r0.xyz = (r0.wwww * r2.xyzx + r1.xyzx).xyz;
/*36*/	}
