...
// Fragment Shader
//
// id: 5202 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdecalbloodmesh.hlsl_PS_ps40_rigid_forward_lighting_no_faction_colour_HDR.glsl
//
...
/*54*/	}
/*55*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy).zw;
/*56*/	r3.zw = (r3.zzzw * vec4(0.000000, 0.000000, 0.750000, 0.750000) + vsOut_T6.yyyz).zw;
/*57*/	r5.xyzw = (texture(s_decal_blood_map, r3.zwzz.st)).xyzw;
/*58*/	r2.w = -vsOut_T7.w * 0.900000 + 1.000000;
/*59*/	r2.w = saturate(-r2.w + r5.w);
/*60*/	r2.w = uintBitsToFloat((0.000000 < r2.w) ? 0xffffffffu : 0x00000000u);
/*61*/	if(floatBitsToUint(r2.w) != 0u) {
/*62*/	  r2.w = -r5.w + 1.000000;
/*63*/	  r2.w = saturate(vsOut_T7.w * 0.900000 + -r2.w);
/*64*/	  r2.w = -r2.w + 1.000000;
/*65*/	  r2.w = -r2.w * r2.w + 1.000000;
/*66*/	  r2.w = r2.w * -0.600000 + 1.000000;
/*67*/	  r5.xyz = (r2.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*68*/	  r2.w = saturate(dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*69*/	  r2.w = uintBitsToFloat((r2.w < 0.225000) ? 0xffffffffu : 0x00000000u);
/*70*/	  r2.w = uintBitsToFloat(floatBitsToUint(r2.w) & uint(0x3f800000u));
/*71*/	  r6.xyz = (r1.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r5.xzzx).xyz;
/*72*/	  r1.xyz = (r2.wwww * r6.xyzx + r5.xyzx).xyz;
/*73*/	  r2.xyz = (vec4(1.000000, 0.800000, 0.800000, 0)).xyz;
...
/*85*/	r8.xyz = (r0.yyyy * r6.xyzx).xyz;
/*86*/	r8.xyz = (r0.xxxx * r5.xyzx + r8.xyzx).xyz;
/*87*/	r8.xyz = (r0.wwww * r7.xyzx + r8.xyzx).xyz;
/*88*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*89*/	r2.w = inversesqrt(r2.w);
/*90*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*91*/	r0.xyz = (mix(r8.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
/*92*/	r0.w = uintBitsToFloat((floatBitsToInt(cb3.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
/*93*/	if(floatBitsToUint(r0.w) != 0u) {
/*94*/	  r0.w = uintBitsToFloat((0.990000 < r0.y) ? 0xffffffffu : 0x00000000u);
/*95*/	  r3.zw = (mix(vec4(0, 0, 2.500000, -0.100000), vec4(0, 0, 50.000000, -0.700000), greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).zw;
/*96*/	  r0.w = r3.w * cb0.data[26].x;
/*97*/	  r8.xy = (r0.wwww * vec4(-0.700000, 0.660000, 0.000000, 0.000000)).xy;
...
/*111*/	    r0.w = dot(vec2(r9.xyxx), vec2(r9.xyxx));
/*112*/	    r0.w = -r0.w + 1.000000;
/*113*/	    r0.w = max(r0.w, 0.000000);
/*114*/	    r9.z = sqrt(r0.w);
/*115*/	    r10.xyz = (r9.xzyx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r0.xyzx).xyz;
/*116*/	    r0.w = dot(vec3(r10.xyzx), vec3(r10.xyzx));
/*117*/	    r0.w = inversesqrt(r0.w);
/*118*/	    r10.xyz = (r0.wwww * r10.xyzx).xyz;
...
/*124*/	    r0.w = saturate(dot(vec3(-r11.xyzx), vec3(r10.xyzx)));
...
/*134*/	    r2.w = r0.w * -2.000000 + 3.000000;
/*135*/	    r0.w = r0.w * r0.w;
/*136*/	    r0.w = r0.w * r2.w;
/*137*/	    r3.x = r0.w * -r3.x + r3.x;
/*138*/	    r2.w = -r3.y + 0.200000;
/*139*/	    r3.y = r0.w * r2.w + r3.y;
/*140*/	    r10.xyz = (-r1.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*141*/	    r1.xyz = (r0.wwww * r10.xyzx + r1.xyzx).xyz;
/*142*/	    r10.xyz = (-r2.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*143*/	    r2.xyz = (r0.wwww * r10.xyzx + r2.xyzx).xyz;
...
/*161*/	    r2.w = -r0.y + 1.000000;
/*162*/	    r0.w = min(r0.w, r2.w);
/*163*/	    r5.xyz = (-r0.xyzx + r5.xyzx).xyz;
/*164*/	    r5.xyz = (r0.wwww * r5.xyzx + r0.xyzx).xyz;
/*165*/	    r0.w = dot(vec3(r5.xyzx), vec3(r5.xyzx));
/*166*/	    r0.w = inversesqrt(r0.w);
/*167*/	    r0.xyz = (r0.wwww * r5.xyzx).xyz;
/*168*/	  }
/*169*/	}
/*170*/	r0.w = vsOut_T7.y * -r3.y + r3.y;
/*171*/	r3.yzw = (r1.xxyz * vec4(0.000000, 5.000000, 5.000000, 5.000000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*172*/	r3.yzw = (-r1.xxyz + r3.yyzw).yzw;
/*173*/	r1.xyz = saturate(vsOut_T7.yyyy * r3.yzwy + r1.xyzx).xyz;
/*174*/	r2.w = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*175*/	r3.yzw = (-r1.xxyz + r2.wwww).yzw;
/*176*/	r1.xyz = (vsOut_T7.zzzz * r3.yzwy + r1.xyzx).xyz;
...
/*181*/	r2.w = dot(vec3(r0.xyzx), vec3(r0.xyzx));
/*182*/	r2.w = inversesqrt(r2.w);
/*183*/	r0.xyz = (r0.xyzx * r2.wwww).xyz;
...
/*320*/	r3.w = dot(vec3(r5.xyzx), vec3(r0.xyzx));
/*321*/	r3.w = r3.w + r3.w;
/*322*/	r6.xyz = (r0.xyzx * -r3.wwww + r5.xyzx).xyz;
...
/*328*/	r5.w = saturate(r0.w * 60.000000);
/*329*/	r5.w = -r0.w + r5.w;
/*330*/	r8.xzw = (r0.xxyz * vec4(1.000000, 0.000000, 4.000000, 1.000000)).xzw;
...
/*343*/	r8.xzw = (r1.xxyz * r8.xxzw).xzw;
/*344*/	r6.w = -r0.w + 1.000000;
...
/*359*/	}
/*360*/	r6.w = dot(vec3(r0.xyzx), vec3(-cb2.data[0].yzwy));
...
/*440*/	r5.xyz = (max(r0.wwww, r5.xyzx)).xyz;
/*441*/	r5.xyz = (-r5.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*442*/	r1.xyz = (r1.xyzx * r7.yyyy).xyz;
/*443*/	r1.xyz = (r1.xyzx * cb2.data[1].xyzx).xyz;
/*444*/	r1.xyz = (r5.xyzx * r1.xyzx).xyz;
/*445*/	r1.xyz = (r7.xxxx * r1.xyzx).xyz;
/*446*/	r1.xyz = (r6.xyzx * cb2.data[1].xyzx + r1.xyzx).xyz;
/*447*/	r1.xyz = (r3.zzzz * r1.xyzx + r8.xzwx).xyz;
...
/*452*/	r2.w = dot(vec3(-r3.xyzx), vec3(r0.xyzx));
/*453*/	r2.w = r2.w + r2.w;
/*454*/	r0.xyz = (r0.xyzx * -r2.wwww + -r3.xyzx).xyz;
/*455*/	r6.xyzw = (textureLod(s_environment, r0.xyzx.stp, r8.y)).xyzw;
/*456*/	r0.x = dot(vec3(r0.xyzx), vec3(-r3.xyzx));
/*457*/	r0.x = max(r0.x, 0.000000);
/*458*/	r0.x = log2(r0.x);
/*459*/	r0.x = r0.x * 10.000000;
/*460*/	r0.x = exp2(r0.x);
/*461*/	r0.x = r3.w * r0.x;
/*462*/	r0.x = r0.x * r5.w + r0.w;
/*463*/	r0.xyz = (r6.xyzx * r0.xxxx).xyz;
/*464*/	color0.xyz = (r0.xyzx * r2.xyzx + r1.xyzx).xyz;
