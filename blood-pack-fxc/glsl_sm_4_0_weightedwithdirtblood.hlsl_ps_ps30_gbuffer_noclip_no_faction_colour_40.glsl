...
// Fragment Shader
//
// id: 2719 - fxc/glsl_SM_4_0_weightedwithdirtblood.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour_40.glsl
//
...
/*53*/	r0.w = vsOut_T7.y * -r3.x + r3.x;
/*54*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*55*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*56*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*57*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
...
/*67*/	r5.xyz = (r1.yyyy * r5.xyzx).xyz;
/*68*/	r1.xyw = (r1.xxxx * r4.xyxz + r5.xyxz).xyw;
/*69*/	r1.xyz = (r1.zzzz * r6.xyzx + r1.xywx).xyz;
/*70*/	r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*71*/	r0.w = inversesqrt(r0.w);
/*72*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*73*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*74*/	r4.w = 1.000000;
/*75*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*76*/	r1.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*77*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*78*/	color3.x = r0.w / r1.w;
/*79*/	r0.w = max(abs(r1.z), abs(r1.y));
/*80*/	r0.w = max(r0.w, abs(r1.x));
/*81*/	r1.xyz = (r1.xyzx / r0.wwww).xyz;
/*82*/	r3.xyz = (r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*83*/	color0.xyzw = saturate(r3.xyzw);
/*84*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*85*/	r2.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*86*/	color2.xyzw = saturate(r2.xyzw);
