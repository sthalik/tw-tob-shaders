...
// Fragment Shader
//
// id: 6555 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdecaldirtblood.hlsl_PS_ps30_imposter_skin_40.glsl
//
...
/*30*/	r0.w = uintBitsToFloat((vsOut_T8.x < vsOut_T8.z) ? 0xffffffffu : 0x00000000u);
/*31*/	if(r0.w != 0) discard;
/*32*/	r1.xy = (vsOut_T1.xyxx * vec4(0.750000, 0.750000, 0.000000, 0.000000)).xy;
/*33*/	r1.xy = (r1.xyxx * cb1.data[2].xyxx + vsOut_T6.xyxx).xy;
/*34*/	r1.xyzw = (texture(s_decal_blood_map, r1.xyxx.st)).xyzw;
/*35*/	r0.w = saturate(r1.w + -1.000000);
/*36*/	r0.w = uintBitsToFloat((0.000000 < r0.w) ? 0xffffffffu : 0x00000000u);
/*37*/	if(floatBitsToUint(r0.w) != 0u) {
/*38*/	  r0.w = -r1.w + 1.000000;
/*39*/	  r0.w = saturate(-r0.w);
/*40*/	  r0.w = -r0.w + 1.000000;
/*41*/	  r0.w = -r0.w * r0.w + 1.000000;
/*42*/	  r0.w = r0.w * -0.600000 + 1.000000;
/*43*/	  r1.xyz = (r0.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
...
/*47*/	  r2.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r1.xzzx).xyz;
/*48*/	  r0.xyz = (r0.wwww * r2.xyzx + r1.xyzx).xyz;
/*49*/	}
/*50*/	r1.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*51*/	r1.xyz = (-r0.xyzx + r1.xyzx).xyz;
/*52*/	r0.xyz = saturate(vsOut_T7.xxxx * r1.xyzx + r0.xyzx).xyz;
/*53*/	r0.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*54*/	r1.xyz = (-r0.xyzx + r0.wwww).xyz;
/*55*/	r0.xyz = saturate(vsOut_T7.yyyy * r1.xyzx + r0.xyzx).xyz;
/*56*/	r0.xyz = (log2(r0.xyzx)).xyz;
/*57*/	r0.xyz = (r0.xyzx * cb0.data[0].zzzz).xyz;
/*58*/	color0.xyz = (exp2(r0.xyzx)).xyz;
/*59*/	color0.w = 1.000000;
/*60*/	return;
}
