...
// Fragment Shader
//
// id: 5271 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdirtbloodmesh.hlsl_PS_ps30_alpha_overlay_40.glsl
//
...
/*40*/	r2.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx).xy;
/*41*/	r3.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx + vsOut_T6.yzyy).xy;
...
/*128*/	    r2.w = saturate(cb3.data[1].x * cb3.data[1].x + -0.800000);
...
/*184*/	r4.xyz = (vsOut_T0.xyzx + -cb0.data[0].xyzx).xyz;
...
/*296*/	  r2.w = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
...
/*316*/	r0.xyz = (r2.xyzx * cb1.data[1].xyzx + r0.xyzx).xyz;
