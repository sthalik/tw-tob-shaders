...
// Fragment Shader
//
// id: 6441 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecalblood.hlsl_PS_ps30_alpha_overlay.glsl
//
...
/*62*/	r3.zw = (r3.zzzw * cb3.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*77*/	  r4.w = 1.000000;
/*78*/	  r5.xyzw = r0.xyzw * vec4(0.300000, 0.000000, 0.000000, 1.000000) + -r4.xzzw;
/*79*/	  r0.xyzw = r1.wwww * r5.xyzw + r4.xyzw;
