...
// Fragment Shader
//
// id: 5192 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecalbloodmesh.hlsl_PS_ps30_rigid_forward_lighting_no_clip_gamma_correct_LDR.glsl
//
...
/*64*/	}
/*65*/	r3.zw = (vsOut_T1.xxxy * cb5.data[2].xxxy).zw;
/*66*/	r3.zw = (r3.zzzw * vec4(0.000000, 0.000000, 0.750000, 0.750000) + vsOut_T6.yyyz).zw;
/*67*/	r4.xyzw = (texture(s_decal_blood_map, r3.zwzz.st)).xyzw;
/*68*/	r1.w = -vsOut_T7.w * 0.900000 + 1.000000;
/*69*/	r1.w = saturate(-r1.w + r4.w);
/*70*/	r1.w = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*71*/	if(floatBitsToUint(r1.w) != 0u) {
/*72*/	  r1.w = -r4.w + 1.000000;
/*73*/	  r1.w = saturate(vsOut_T7.w * 0.900000 + -r1.w);
/*74*/	  r1.w = -r1.w + 1.000000;
/*75*/	  r1.w = -r1.w * r1.w + 1.000000;
/*76*/	  r1.w = r1.w * -0.600000 + 1.000000;
/*77*/	  r4.xyz = (r1.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*78*/	  r1.w = saturate(dot(vec3(r0.xywx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*79*/	  r1.w = uintBitsToFloat((r1.w < 0.225000) ? 0xffffffffu : 0x00000000u);
/*80*/	  r1.w = uintBitsToFloat(floatBitsToUint(r1.w) & uint(0x3f800000u));
/*81*/	  r5.xyz = (r0.xywx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r4.xzzx).xyz;
/*82*/	  r0.xyw = (r1.wwww * r5.xyxz + r4.xyxz).xyw;
/*83*/	  r2.xyz = (vec4(1.000000, 0.800000, 0.800000, 0)).xyz;
/*84*/	  r3.xy = (vec4(0.800000, 0.020000, 0, 0)).xy;
/*85*/	}
...
/*102*/	r0.z = uintBitsToFloat((floatBitsToInt(cb4.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*115*/	  r0.z = uintBitsToFloat((0.000000 < cb4.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*323*/	r0.xyz = (r0.xyzx * cb2.data[1].xyzx).xyz;
