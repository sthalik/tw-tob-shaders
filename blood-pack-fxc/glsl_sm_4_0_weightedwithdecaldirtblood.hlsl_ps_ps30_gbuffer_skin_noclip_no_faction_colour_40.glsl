...
// Fragment Shader
//
// id: 2469 - fxc/glsl_SM_4_0_weightedwithdecaldirtblood.hlsl_PS_ps30_gbuffer_skin_noclip_no_faction_colour_40.glsl
//
...
/*37*/	r3.xy = (vsOut_T1.xyxx * cb1.data[2].xyxx + vsOut_T6.xyxx).xy;
/*38*/	r4.xyzw = (texture(s_decal_dirt_map, r3.xyxx.st)).xyzw;
/*39*/	r3.xy = (r4.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*40*/	r0.w = r3.w * r4.w;
/*41*/	r4.xyz = (-r0.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*42*/	r0.xyz = (r0.wwww * r4.xyzx + r0.xyzx).xyz;
/*43*/	r1.xy = (r3.xyxx * r3.wwww + r1.xyxx).xy;
...
/*49*/	r3.xy = (vsOut_T1.xyxx * vec4(0.750000, 0.750000, 0.000000, 0.000000)).xy;
/*50*/	r3.xy = (r3.xyxx * cb1.data[2].xyxx + vsOut_T6.xyxx).xy;
/*51*/	r3.xyzw = (texture(s_decal_blood_map, r3.xyxx.st)).xyzw;
...
/*83*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*84*/	r3.xyzw = (texture(s_skin_mask_map, vsOut_T1.xyxx.st)).xyzw;
/*85*/	r0.w = vsOut_T7.x * -r2.x + r2.x;
/*86*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*87*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*88*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
/*89*/	r1.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*90*/	r4.xyz = (-r0.xyzx + r1.wwww).xyz;
/*91*/	color1.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*92*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*93*/	r0.xyz = (vsOut_T0.xyzx).xyz;
/*94*/	r0.w = 1.000000;
/*95*/	r1.w = dot(r0.xyzw, cb0.data[11].xyzw);
/*96*/	r0.x = dot(r0.xyzw, cb0.data[12].xyzw);
/*97*/	color3.x = r1.w / r0.x;
/*98*/	r0.x = max(abs(r1.z), abs(r1.y));
/*99*/	r0.x = max(r0.x, abs(r1.x));
/*100*/	r0.xyz = (r1.xyzx / r0.xxxx).xyz;
/*101*/	r2.xzw = (r0.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*102*/	color0.xyzw = saturate(r2.xzwy);
/*103*/	color2.xyzw = r3.xyzz;
