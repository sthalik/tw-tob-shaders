...
// Fragment Shader
//
// id: 4739 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidstandardblood.hlsl_PS_ps30_main.glsl
//
...
/*29*/	r2.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx).xy;
/*30*/	r2.xy = (r2.xyxx * vec4(0.750000, 0.750000, 0.000000, 0.000000) + vsOut_T6.yzyy).xy;
/*31*/	r2.xyzw = (texture(s_decal_blood_map, r2.xyxx.st)).xyzw;
/*32*/	r1.w = -vsOut_T7.w * 0.900000 + 1.000000;
/*33*/	r1.w = saturate(-r1.w + r2.w);
/*34*/	r1.w = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*35*/	if(floatBitsToUint(r1.w) != 0u) {
/*36*/	  r1.w = -r2.w + 1.000000;
/*37*/	  r1.w = saturate(vsOut_T7.w * 0.900000 + -r1.w);
/*38*/	  r1.w = -r1.w + 1.000000;
/*39*/	  r1.w = -r1.w * r1.w + 1.000000;
/*40*/	  r1.w = r1.w * -0.600000 + 1.000000;
/*41*/	  r2.xyz = (r1.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
...
/*45*/	  r3.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r2.xzzx).xyz;
/*46*/	  r0.xyz = (r1.wwww * r3.xyzx + r2.xyzx).xyz;
...
/*62*/	r7.xyz = (r1.yyyy * r5.xyzx).xyz;
/*63*/	r1.xyw = (r1.xxxx * r4.xyxz + r7.xyxz).xyw;
/*64*/	r1.xyz = (r1.zzzz * r6.xyzx + r1.xywx).xyz;
/*65*/	r1.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*66*/	r1.w = inversesqrt(r1.w);
/*67*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*68*/	r1.xyz = (mix(r1.xyzx, vsOut_T2.xyzx, greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).xyz;
/*69*/	r0.w = uintBitsToFloat((floatBitsToInt(cb3.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
/*70*/	if(floatBitsToUint(r0.w) != 0u) {
/*71*/	  r0.w = uintBitsToFloat((0.990000 < r1.y) ? 0xffffffffu : 0x00000000u);
...
/*82*/	  r0.w = uintBitsToFloat((0.000000 < cb3.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*91*/	    r8.z = sqrt(r0.w);
/*92*/	    r9.xyz = (r8.xzyx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r1.xyzx).xyz;
/*93*/	    r0.w = dot(vec3(r9.xyzx), vec3(r9.xyzx));
/*94*/	    r0.w = inversesqrt(r0.w);
/*95*/	    r9.xyz = (r0.wwww * r9.xyzx).xyz;
/*96*/	    r10.xz = (cb3.data[0].xxyx).xz/**/;
/*97*/	    r10.y = -1.000000;
...
/*102*/	    r1.w = cb3.data[1].x * cb3.data[1].x;
/*103*/	    r1.w = r1.w * 1.250000;
/*104*/	    r1.w = min(r1.w, 1.000000);
/*105*/	    r2.w = saturate(cb3.data[1].x * cb3.data[1].x + -0.800000);
...
/*117*/	    r9.xyz = (-r0.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*118*/	    r0.xyz = (r0.wwww * r9.xyzx + r0.xyzx).xyz;
...
/*129*/	    r1.w = dot(vec2(cb3.data[0].xyxx), vec2(cb3.data[0].xyxx));
/*130*/	    r1.w = sqrt(r1.w);
...
/*138*/	    r1.w = -r1.y + 1.000000;
/*139*/	    r0.w = min(r0.w, r1.w);
/*140*/	    r4.xyz = (-r1.xyzx + r4.xyzx).xyz;
/*141*/	    r4.xyz = (r0.wwww * r4.xyzx + r1.xyzx).xyz;
/*142*/	    r0.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*143*/	    r0.w = inversesqrt(r0.w);
/*144*/	    r1.xyz = (r0.wwww * r4.xyzx).xyz;
/*145*/	  }
/*146*/	}
/*147*/	r0.w = vsOut_T7.y * -r3.y + r3.y;
/*148*/	r3.yzw = (r0.xxyz * vec4(0.000000, 5.000000, 5.000000, 5.000000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*149*/	r3.yzw = (-r0.xxyz + r3.yyzw).yzw;
/*150*/	r0.xyz = saturate(vsOut_T7.yyyy * r3.yzwy + r0.xyzx).xyz;
/*151*/	r1.w = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*152*/	r3.yzw = (-r0.xxyz + r1.wwww).yzw;
/*153*/	r0.xyz = (vsOut_T7.zzzz * r3.yzwy + r0.xyzx).xyz;
...
/*158*/	r1.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*159*/	r1.w = inversesqrt(r1.w);
/*160*/	r1.xyz = (r1.wwww * r1.xyzx).xyz;
/*161*/	r4.xyz = (vsOut_T0.xyzx + -cb0.data[0].xyzx).xyz;
/*162*/	r1.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*163*/	r2.w = inversesqrt(r1.w);
/*164*/	r3.yzw = (r2.wwww * r4.xxyz).yzw;
/*165*/	r2.w = -r3.x + 1.000000;
/*166*/	r5.x = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*167*/	r5.y = dot(vec3(r3.yzwy), vec3(r1.xyzx));
/*168*/	r5.y = r5.y + r5.y;
/*169*/	r5.yzw = (r1.xxyz * -r5.yyyy + r3.yyzw).yzw;
...
/*176*/	r7.x = -r0.w + r7.x;
/*177*/	r7.yzw = (r1.xxyz * vec4(0.000000, 1.000000, 4.000000, 1.000000)).yzw;
...
/*182*/	r9.xyz = (mix(cb1.data[2].xyzx, cb1.data[3].xyzx, greaterThan(floatBitsToUint(r8.xxxx), uvec4(0)))).xyz/**/;
/*183*/	r8.xyw = (mix(cb1.data[4].xyxz, cb1.data[5].xyxz, greaterThan(floatBitsToUint(r8.yyyy), uvec4(0)))).xyw/**/;
/*184*/	r10.xyz = (mix(cb1.data[6].xyzx, cb1.data[7].xyzx, greaterThan(floatBitsToUint(r8.zzzz), uvec4(0)))).xyz/**/;
...
/*190*/	r7.yzw = (r0.xxyz * r7.yyzw).yzw;
...
/*206*/	}
/*207*/	r1.x = dot(vec3(r1.xyzx), vec3(-cb1.data[0].yzwy));
/*208*/	r1.y = max(r1.x, 0.000000);
/*209*/	r1.x = uintBitsToFloat((0.000000 < r1.x) ? 0xffffffffu : 0x00000000u);
/*210*/	if(floatBitsToUint(r1.x) != 0u) {
/*211*/	  r1.x = dot(vec3(-cb1.data[0].yzwy), vec3(r5.yzwy));
/*212*/	  r1.x = max(r1.x, -1.000000);
/*213*/	  r1.x = min(r1.x, 1.000000);
/*214*/	  r1.z = -abs(r1.x) + 1.000000;
/*215*/	  r1.z = sqrt(r1.z);
/*216*/	  r5.y = abs(r1.x) * -0.018729 + 0.074261;
/*217*/	  r5.y = r5.y * abs(r1.x) + -0.212114;
/*218*/	  r5.y = r5.y * abs(r1.x) + 1.570729;
/*219*/	  r5.z = r1.z * r5.y;
/*220*/	  r5.z = r5.z * -2.000000 + 3.141593;
/*221*/	  r1.x = uintBitsToFloat((r1.x < -r1.x) ? 0xffffffffu : 0x00000000u);
/*222*/	  r1.x = uintBitsToFloat(floatBitsToUint(r1.x) & floatBitsToUint(r5.z));
/*223*/	  r1.x = r5.y * r1.z + r1.x;
/*224*/	  r1.z = r3.x * r3.x;
/*225*/	    r3.x = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*226*/	  r1.z = r1.z * r3.x + r6.x;
/*227*/	  r1.z = r1.z * 0.500000 + 0.500000;
/*228*/	  r1.z = r1.z * 2.000000 + -1.000000;
/*229*/	  r3.x = -r1.z * r1.z + 1.000000;
/*230*/	  r3.x = max(r3.x, 0.001000);
/*231*/	  r3.x = log2(r3.x);
/*232*/	  r5.x = r3.x * 4.950617;
/*233*/	  r3.x = r3.x * 0.346574 + 4.546885;
/*234*/	  r5.y = uintBitsToFloat((0.000000 < r1.z) ? 0xffffffffu : 0x00000000u);
/*235*/	  r1.z = uintBitsToFloat((r1.z < 0.000000) ? 0xffffffffu : 0x00000000u);
/*236*/	  r1.z = intBitsToFloat(1 + ~floatBitsToInt(r5.y) + floatBitsToInt(r1.z));
/*237*/	  r1.z = floatBitsToInt(r1.z);
...
/*242*/	  r3.x = sqrt(r3.x);
/*243*/	  r1.z = r1.z * r3.x;
/*244*/	  r1.z = r1.z * 1.414214;
/*245*/	  r1.z = 0.008727 / r1.z;
/*246*/	  r1.z = max(r1.z, 0.000100);
/*247*/	  r5.xy = (r1.xxxx + vec4(-0.008727, 0.008727, 0.000000, 0.000000)).xy;
/*248*/	  r1.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.z)).x;
/*249*/	  r1.xz = (r1.xxxx * r5.xxyx).xz;
/*250*/	  r5.xy = (r1.xzxx * vec4(0.707107, 0.707107, 0.000000, 0.000000)).xy;
...
/*255*/	  r5.zw = (uintBitsToFloat(uvec4(lessThan(vec4(0.000000, 0.000000, 0.000000, 0.000000), r1.xxxz)) * 0xffffffffu)).zw;
/*256*/	  r1.x = uintBitsToFloat((r1.x < 0.000000) ? 0xffffffffu : 0x00000000u);
/*257*/	  r1.x = intBitsToFloat(1 + ~floatBitsToInt(r5.z) + floatBitsToInt(r1.x));
/*258*/	  r1.x = floatBitsToInt(r1.x);
...
/*263*/	  r1.x = r1.x * r5.x + 1.000000;
/*264*/	  r1.x = r1.x * 0.500000;
/*265*/	  r1.z = 1 + ~floatBitsToInt(r5.w);
/*266*/	  r1.z = r1.z * r5.y + 1.000000;
/*267*/	  r1.x = r1.z * 0.500000 + -r1.x;
/*268*/	  r1.z = min(r1.y, 1.000000);
/*269*/	  r2.w = r2.w * 1.570796;
/*270*/	  r2.w = sin(r2.w);
/*271*/	  r1.z = r1.z + -1.000000;
/*272*/	  r1.z = r2.w * r1.z + 1.000000;
/*273*/	  r2.w = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
...
/*280*/	  r1.x = r1.z * abs(r1.x);
/*281*/	  r3.xyz = (r2.wwww * r1.xxxx).xyz;
/*282*/	} else {
...
/*289*/	r0.xyz = (r0.xyzx * r1.yyyy).xyz;
/*290*/	r0.xyz = (r0.xyzx * cb1.data[1].xyzx).xyz;
/*291*/	r0.xyz = (r3.xyzx * r0.xyzx).xyz;
/*292*/	r0.xyz = (r6.xxxx * r0.xyzx).xyz;
/*293*/	r0.xyz = (r2.xyzx * cb1.data[1].xyzx + r0.xyzx).xyz;
/*294*/	r0.xyz = (r0.xyzx + r7.yzwy).xyz;
/*295*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*296*/	r2.w = 1.000000;
/*297*/	r1.x = dot(r2.xyzw, cb0.data[9].xyzw);
/*298*/	r1.y = dot(r2.xyzw, cb0.data[10].xyzw);
/*299*/	r0.w = dot(r2.xyzw, cb0.data[12].xyzw);
/*300*/	r1.xy = (r1.xyxx / r0.wwww).xy;
/*301*/	r2.xy = (uintBitsToFloat(uvec4(greaterThanEqual(r1.xyxx, cb0.data[34].xyxx)) * 0xffffffffu)).xy;
/*302*/	r1.xy = (uintBitsToFloat(uvec4(greaterThanEqual(cb0.data[34].zwzz, r1.xyxx)) * 0xffffffffu)).xy;
...
/*308*/	r0.w = sqrt(r1.w);
/*309*/	r1.x = saturate(cb2.data[0].w)/**/;
/*310*/	r1.x = -r1.x + 1.000000;
/*311*/	r1.x = r1.x * 8.000000 + -4.000000;
/*312*/	r1.y = saturate(cb2.data[1].x)/**/;
...
/*318*/	r0.w = exp2(r0.w);
/*319*/	r0.w = cb2.data[1].y / r0.w;
/*320*/	r0.w = saturate(-r0.w + cb2.data[1].y);
/*321*/	r1.x = -vsOut_T0.y + cb2.data[1].w;
/*322*/	r1.y = -cb2.data[1].z + cb2.data[1].w;
/*323*/	r1.x = r1.x + -cb2.data[1].z;
...
/*330*/	r1.y = sqrt(r1.y);
/*331*/	r1.z = max(cb2.data[2].z, 0.001000);
...
/*336*/	r1.y = r1.y * r1.y;
/*337*/	r1.y = r1.y * r1.z;
/*338*/	r0.w = cb2.data[2].x * r1.x + r0.w;
/*339*/	r1.xzw = (cb1.data[1].xxyz * cb2.data[0].xxyz).xzw;
/*340*/	r1.xzw = (r1.xxzw * vec4(1.500000, 0.000000, 1.500000, 1.500000)).xzw;
/*341*/	r1.xzw = (r1.xxzw * abs(cb1.data[0].zzzz)).xzw;
/*342*/	r2.xyz = (r6.xxxx * r1.xzwx).xyz;
/*343*/	r4.w = max(r4.y, 0.000000);
/*344*/	r3.xyzw = (texture(s_sky, r4.xwzx.stp)).xyzw;
/*345*/	r2.w = saturate(dot(vec2(r0.wwww), vec2(cb2.data[2].yyyy)));
...
/*350*/	color0.xyz = (r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*351*/	color0.w = 1.000000;
/*352*/	return;
}
