...
// Fragment Shader
//
// id: 2579 - fxc/glsl_SM_4_0_weightedwithblood.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour_40.glsl
//
...
/*40*/	r1.z = vsOut_T7.y * -r3.x + r3.x;
/*41*/	color1.w = saturate(vsOut_T7.x * -r1.z + r1.z);
/*42*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*43*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*44*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
/*45*/	r1.z = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*46*/	r1.z = inversesqrt(r1.z);
/*47*/	r4.xyz = (r1.zzzz * vsOut_T3.xyzx).xyz;
/*48*/	r1.z = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*49*/	r1.z = inversesqrt(r1.z);
/*50*/	r5.xyz = (r1.zzzz * vsOut_T5.xyzx).xyz;
/*51*/	r1.z = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*52*/	r1.z = inversesqrt(r1.z);
/*53*/	r6.xyz = (r1.zzzz * vsOut_T2.xyzx).xyz;
/*54*/	r1.yzw = (r1.yyyy * r5.xxyz).yzw;
/*55*/	r1.xyz = (r1.xxxx * r4.xyzx + r1.yzwy).xyz;
/*56*/	r1.xyz = (r0.wwww * r6.xyzx + r1.xyzx).xyz;
/*57*/	r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*58*/	r0.w = inversesqrt(r0.w);
/*59*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*60*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*61*/	r4.w = 1.000000;
/*62*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*63*/	r1.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*64*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*65*/	color3.x = r0.w / r1.w;
/*66*/	r0.w = max(abs(r1.z), abs(r1.y));
/*67*/	r0.w = max(r0.w, abs(r1.x));
/*68*/	r1.xyz = (r1.xyzx / r0.wwww).xyz;
/*69*/	r3.xyz = (r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*70*/	color0.xyzw = saturate(r3.xyzw);
/*71*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*72*/	r2.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*73*/	color2.xyzw = saturate(r2.xyzw);
