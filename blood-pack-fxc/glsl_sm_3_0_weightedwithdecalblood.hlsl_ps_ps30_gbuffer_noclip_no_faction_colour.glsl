...
// Fragment Shader
//
// id: 2859 - fxc/glsl_SM_3_0_weightedwithdecalblood.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour.glsl
//
...
/*68*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*69*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*70*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*71*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
...
/*87*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*88*/	r4.w = 1.000000;
/*89*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*90*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*91*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*92*/	color3.x = r0.w / r2.w;
/*93*/	r0.w = max(abs(r2.z), abs(r2.y));
/*94*/	r0.w = max(r0.w, abs(r2.x));
/*95*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*96*/	r3.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*97*/	color0.xyzw = saturate(r3.xzwy);
/*98*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*99*/	r1.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*100*/	color2.xyzw = saturate(r1.xyzw);
