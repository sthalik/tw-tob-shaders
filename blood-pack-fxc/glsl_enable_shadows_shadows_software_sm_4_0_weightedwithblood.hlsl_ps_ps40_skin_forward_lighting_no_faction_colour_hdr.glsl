...
// Fragment Shader
//
// id: 6216 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithblood.hlsl_PS_ps40_skin_forward_lighting_no_faction_colour_HDR.glsl
//
...
/*60*/	r5.w = 1.000000;
/*61*/	r2.y = dot(r5.xyzw, cb0.data[12].xyzw);
/*62*/	r6.xyz = (-cb1.data[35].xyzx * cb1.data[34].zzzz + vsOut_T0.xyzx).xyz;
/*63*/	r7.x = uintBitsToFloat((r2.y >= cb1.data[37].x) ? 0xffffffffu : 0x00000000u);
/*64*/	r7.y = uintBitsToFloat((r2.y >= cb1.data[38].x) ? 0xffffffffu : 0x00000000u);
/*65*/	r7.z = uintBitsToFloat((r2.y >= cb1.data[39].x) ? 0xffffffffu : 0x00000000u);
/*66*/	r7.w = uintBitsToFloat((r2.y >= cb1.data[40].x) ? 0xffffffffu : 0x00000000u);
...
/*70*/	r3.w = uintBitsToFloat((r2.z < cb1.data[34].w) ? 0xffffffffu : 0x00000000u);
/*71*/	if(floatBitsToUint(r3.w) != 0u) {
/*72*/	  r3.w = intBitsToFloat(floatBitsToInt(r2.w) << int(2));
/*73*/	  r6.w = vsOut_T0.w;
/*74*/	  r7.x = dot(r6.xyzw, cb1.data[floatBitsToUint(r3.w)+2u].xyzw);
/*75*/	  r7.y = dot(r6.xyzw, cb1.data[floatBitsToUint(r3.w)+3u].xyzw);
/*76*/	  r7.z = dot(r6.xyzw, cb1.data[floatBitsToUint(r3.w)+4u].xyzw);
/*77*/	  r3.w = dot(r6.xyzw, cb1.data[floatBitsToUint(r3.w)+5u].xyzw);
/*78*/	  r7.xyz = (r7.xyzx / r3.wwww).xyz;
/*79*/	  r8.xy = (uintBitsToFloat(uvec4(lessThan(r7.xyxx, cb1.data[floatBitsToUint(r2.w)+41u].xyxx)) * 0xffffffffu)).xy;
/*80*/	  r4.w = uintBitsToFloat(floatBitsToUint(r8.y) | floatBitsToUint(r8.x));
/*81*/	  r8.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r2.w)+41u].zwzz, r7.xyxx)) * 0xffffffffu)).xy;
...
/*85*/	    r7.xy = (r7.xyxx * cb1.data[0].xyxx + vec4(0.500000, 0.500000, 0.000000, 0.000000)).xy;
/*86*/	    r8.xy = floor((r7.xyxx).xy);
/*87*/	    r9.xy = (r8.xyxx / cb1.data[0].xyxx).xy;
/*88*/	    r3.w = -0.000400 / r3.w;
/*89*/	    r3.w = r3.w + r7.z;
/*90*/	    r9.z = -r9.y + 1.000000;
/*91*/	    r10.xyzw = (textureLod(sHardShadowBuffer, r9.xzxx.st, 0.000000)).xyzw;
/*92*/	    r9.w = -r9.y;
/*93*/	    r11.x = cb1.data[0].z/**/;
...
/*97*/	    r11.w = -cb1.data[0].w/**/;
/*98*/	    r7.zw = (r9.xxxz + r11.zzzw).zw;
/*99*/	    r11.xyzw = (textureLod(sHardShadowBuffer, r7.zwzz.st, 0.000000)).xyzw;
/*100*/	    r7.zw = (cb1.data[0].zzzw * vec4(0.000000, 0.000000, 1.000000, -1.000000) + r9.xxxz).zw;
...
/*117*/	  r3.w = 1.000000;
/*118*/	}
/*119*/	r4.w = cb1.data[34].w + -1.000000;
...
/*125*/	  r2.z = uintBitsToFloat((r2.z < cb1.data[34].w) ? 0xffffffffu : 0x00000000u);
/*126*/	  if(floatBitsToUint(r2.z) != 0u) {
/*127*/	    r2.z = intBitsToFloat(floatBitsToInt(r2.w) << int(2));
/*128*/	    r6.w = vsOut_T0.w;
/*129*/	    r7.x = dot(r6.xyzw, cb1.data[floatBitsToUint(r2.z)+6u].xyzw);
/*130*/	    r7.y = dot(r6.xyzw, cb1.data[floatBitsToUint(r2.z)+7u].xyzw);
/*131*/	    r7.z = dot(r6.xyzw, cb1.data[floatBitsToUint(r2.z)+8u].xyzw);
/*132*/	    r2.z = dot(r6.xyzw, cb1.data[floatBitsToUint(r2.z)+9u].xyzw);
/*133*/	    r6.xyz = (r7.xyzx / r2.zzzz).xyz;
/*134*/	    r7.xy = (uintBitsToFloat(uvec4(lessThan(r6.xyxx, cb1.data[floatBitsToUint(r2.w)+42u].xyxx)) * 0xffffffffu)).xy;
/*135*/	    r6.w = uintBitsToFloat(floatBitsToUint(r7.y) | floatBitsToUint(r7.x));
/*136*/	    r7.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r2.w)+42u].zwzz, r6.xyxx)) * 0xffffffffu)).xy;
...
/*172*/	    r2.z = 1.000000;
/*173*/	  }
/*174*/	  r6.x = -cb1.data[floatBitsToUint(r2.w)+36u].x + cb1.data[floatBitsToUint(r2.w)+37u].x;
/*175*/	  r6.y = r6.x * cb1.data[34].x;
/*176*/	  r6.x = -r6.x * cb1.data[34].x + cb1.data[floatBitsToUint(r2.w)+37u].x;
/*177*/	  r6.x = r2.y + -r6.x;
...
/*183*/	  r2.z = -cb1.data[floatBitsToUint(r2.w)+36u].x + cb1.data[floatBitsToUint(r2.w)+37u].x;
/*184*/	  r4.w = r2.z * cb1.data[34].y;
/*185*/	  r2.z = -r2.z * cb1.data[34].y + cb1.data[floatBitsToUint(r2.w)+37u].x;
/*186*/	  r2.z = -r2.z + r2.y;
...
/*192*/	r6.xyz = (vsOut_T0.xyzx + -cb0.data[0].xyzx).xyz;
/*193*/	r2.z = dot(vec3(r6.xyzx), vec3(r6.xyzx));
/*194*/	r2.z = inversesqrt(r2.z);
/*195*/	r6.xyz = (r2.zzzz * r6.xyzx).xyz;
/*196*/	r2.z = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*197*/	r7.xyzw = mix(vec4(1.000000, 1.000000, 0.800000, 0.650000), vec4(0.004000, 360.000000, 0.600000, 1.000000), greaterThan(floatBitsToUint(r2.zzzz), uvec4(0)));
/*198*/	r2.z = dot(vec3(r3.xyzx), vec3(-cb2.data[0].yzwy));
/*199*/	r8.xyz = (r2.zzzz * vec4(0.800000, 0.900000, 0.300000, 0.000000) + vec4(0.300000, 0.500000, 0.300000, 0.000000)).xyz;
/*200*/	r8.xyz = saturate(r8.xyzx * vec4(0.694444, 0.694444, 0.444444, 0.000000)).xyz;
/*201*/	r9.xyz = (r8.yyyy * vec4(0.612066, 0.456263, 0.050000, 0.000000)).xyz;
/*202*/	r2.w = r2.z * r8.x + 0.300000;
/*203*/	r2.w = saturate(-r2.w + 1.000000);
/*204*/	r10.xyz = (r2.wwww * r9.xyzx).xyz;
/*205*/	r8.yzw = (r8.zzzz * vec4(0.000000, 0.320000, 0.050000, 0.006000)).yzw;
/*206*/	r4.w = -r2.z * r8.x + 1.000000;
/*207*/	r8.yzw = (r4.wwww * r8.yyzw).yzw;
/*208*/	r9.xyz = (-r9.xyzx * r2.wwww + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*209*/	r10.xyz = (r2.zzzz * r8.xxxx + r10.xyzx).xyz;
/*210*/	r8.xyz = (r8.yzwy * r9.xyzx + r10.xyzx).xyz;
/*211*/	r8.xyz = (-r2.zzzz + r8.xyzx).xyz;
/*212*/	r8.xyz = saturate(r4.yyyy * r8.xyzx + r2.zzzz).xyz;
/*213*/	r8.xyz = (r0.xyzx * r8.xyzx).xyz;
/*214*/	r8.xyz = (r8.xyzx * cb2.data[1].xyzx).xyz;
/*215*/	r8.xyz = (r7.xxxx * r8.xyzx).xyz;
/*216*/	r2.z = dot(vec3(r3.xyzx), vec3(cb2.data[0].yzwy));
/*217*/	r2.w = saturate(r2.z);
/*218*/	r2.w = r2.w * r2.w;
/*219*/	r4.w = saturate(dot(vec3(r6.xyzx), vec3(-cb2.data[0].yzwy)));
/*220*/	r4.w = r4.w * r4.w;
/*221*/	r4.w = r4.w * r4.w;
/*222*/	r2.w = r2.w * r4.w;
/*223*/	r2.w = r4.z * r2.w;
/*224*/	r4.yzw = (r4.yyyy * cb2.data[1].xxyz).yzw;
/*225*/	r4.yzw = (r4.yyzw * vec4(0.000000, -0.300000, -1.000000, -1.000000) + cb2.data[1].xxyz).yzw;
/*226*/	r4.yzw = (r7.xxxx * r4.yyzw).yzw;
/*227*/	r4.yzw = (r2.wwww * r4.yyzw).yzw;
...
/*231*/	r4.yzw = (r8.xxyz * vec4(0.000000, 0.900000, 0.900000, 0.900000) + r4.yyzw).yzw;
/*232*/	r8.xyz = (r3.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*233*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*234*/	r2.w = inversesqrt(r2.w);
/*235*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*236*/	r9.xyz = (uintBitsToFloat(uvec4(lessThan(r8.xyzx, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xyz;
...
/*240*/	r8.xyz = (r8.xyzx * r8.xyzx).xyz;
/*241*/	r9.xyz = (r9.xywx * r8.yyyy).xyz;
/*242*/	r8.xyw = (r8.xxxx * r10.xyxz + r9.xyxz).xyw;
/*243*/	r8.xyz = (r8.zzzz * r11.xyzx + r8.xywx).xyz;
/*244*/	r0.xyz = (r0.xyzx * r8.xyzx).xyz;
/*245*/	r0.xyz = (r7.yyyy * r0.xyzx).xyz;
/*246*/	r2.w = r7.z * r7.x;
/*247*/	r2.x = r2.x * r2.x;
/*248*/	r2.z = r2.z + r2.z;
/*249*/	r8.xyz = (r3.xyzx * -r2.zzzz + cb2.data[0].yzwy).xyz;
/*250*/	r2.z = dot(vec3(r8.xyzx), vec3(-r6.xyzx));
/*251*/	r2.z = max(r2.z, 0.000000);
/*252*/	r2.x = r2.x * 127.000000 + 1.600000;
/*253*/	r2.z = log2(r2.z);
/*254*/	r2.x = r2.z * r2.x;
/*255*/	r2.x = exp2(r2.x);
/*256*/	r2.x = min(r2.x, 1.000000);
/*257*/	r1.w = r1.w * r2.x;
/*258*/	r8.xyz = (r1.wwww * cb2.data[1].xyzx).xyz;
/*259*/	r7.xyz = (r7.xxxx * r8.xyzx).xyz;
/*260*/	r1.w = dot(vec3(-r6.xyzx), vec3(r3.xyzx));
/*261*/	r2.x = r1.w + r1.w;
/*262*/	r3.xyz = (r3.xyzx * -r2.xxxx + -r6.xyzx).xyz;
/*263*/	r3.xyz = (r3.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*264*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*265*/	r2.x = inversesqrt(r2.x);
/*266*/	r3.xyz = (r2.xxxx * r3.xyzx).xyz;
/*267*/	r6.xyz = (uintBitsToFloat(uvec4(lessThan(r3.xyzx, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xyz;
/*268*/	r8.xyz = (mix(cb2.data[2].xyzx, cb2.data[3].xyzx, greaterThan(floatBitsToUint(r6.xxxx), uvec4(0)))).xyz/**/;
/*269*/	r6.xyw = (mix(cb2.data[4].xyxz, cb2.data[5].xyxz, greaterThan(floatBitsToUint(r6.yyyy), uvec4(0)))).xyw/**/;
/*270*/	r9.xyz = (mix(cb2.data[6].xyzx, cb2.data[7].xyzx, greaterThan(floatBitsToUint(r6.zzzz), uvec4(0)))).xyz/**/;
/*271*/	r3.xyz = (r3.xyzx * r3.xyzx).xyz;
/*272*/	r6.xyz = (r6.xywx * r3.yyyy).xyz;
/*273*/	r6.xyz = (r3.xxxx * r8.xyzx + r6.xyzx).xyz;
/*274*/	r3.xyz = (r3.zzzz * r9.xyzx + r6.xyzx).xyz;
...
/*287*/	r0.xyz = (r0.xyzx * r2.wwww + r1.xyzx).xyz;
/*288*/	r1.xyz = (r7.xyzx * vec4(2.000000, 2.000000, 2.000000, 0.000000) + r4.yzwy).xyz;
/*289*/	color0.xyz = (r3.wwww * r1.xyzx + r0.xyzx).xyz;
/*290*/	r0.x = dot(r5.xyzw, cb0.data[9].xyzw);
/*291*/	r0.y = dot(r5.xyzw, cb0.data[10].xyzw);
/*292*/	r0.xy = (r0.xyxx / r2.yyyy).xy;
...
/*300*/	color0.w = 1.000000;
/*301*/	color1.x = 1.000000;
/*302*/	return;
}
