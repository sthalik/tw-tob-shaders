...
// Fragment Shader
//
// id: 2998 - fxc/glsl_SM_3_0_weightedwithdecaldirtblood.hlsl_PS_ps30_gbuffer_noclip.glsl
//
...
/*57*/	r4.xy = (vsOut_T1.xyxx * cb1.data[2].xyxx + vsOut_T6.xyxx).xy;
/*58*/	r5.xyzw = (texture(s_decal_dirt_map, r4.xyxx.st)).xyzw;
/*59*/	r4.xy = (r5.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*60*/	r0.w = r4.w * r5.w;
/*61*/	r5.xyz = (-r0.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*62*/	r0.xyz = (r0.wwww * r5.xyzx + r0.xyzx).xyz;
/*63*/	r2.xy = (r4.xyxx * r4.wwww + r2.xyxx).xy;
...
/*69*/	r4.xy = (vsOut_T1.xyxx * vec4(0.750000, 0.750000, 0.000000, 0.000000)).xy;
/*70*/	r4.xy = (r4.xyxx * cb1.data[2].xyxx + vsOut_T6.xyxx).xy;
/*71*/	r4.xyzw = (texture(s_decal_blood_map, r4.xyxx.st)).xyzw;
...
/*100*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*101*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*102*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*103*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
/*104*/	r0.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*105*/	r0.w = inversesqrt(r0.w);
/*106*/	r4.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
/*107*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*108*/	r0.w = inversesqrt(r0.w);
/*109*/	r5.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*110*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*111*/	r0.w = inversesqrt(r0.w);
/*112*/	r6.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*113*/	r5.xyz = (r2.yyyy * r5.xyzx).xyz;
/*114*/	r2.xyw = (r2.xxxx * r4.xyxz + r5.xyxz).xyw;
/*115*/	r2.xyz = (r2.zzzz * r6.xyzx + r2.xywx).xyz;
/*116*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*117*/	r0.w = inversesqrt(r0.w);
/*118*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*119*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*120*/	r4.w = 1.000000;
/*121*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*122*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*123*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*124*/	color3.x = r0.w / r2.w;
/*125*/	r0.w = max(abs(r2.z), abs(r2.y));
/*126*/	r0.w = max(r0.w, abs(r2.x));
/*127*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*128*/	r3.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*129*/	color0.xyzw = saturate(r3.xzwy);
/*130*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*131*/	r1.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*132*/	color2.xyzw = saturate(r1.xyzw);
/*133*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*134*/	color4 = floatBitsToUint(vsOut_T9.z);
/*135*/	return;
}
