...
// Fragment Shader
//
// id: 6447 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecalblood.hlsl_PS_ps30_alpha_overlay_no_clip_no_faction_colour.glsl
//
...
/*90*/	r3.x = inversesqrt(r2.w);
/*91*/	r3.xzw = (r3.xxxx * r4.xxyz).xzw;
/*92*/	r5.x = -r3.y + 1.000000;
/*93*/	r5.y = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*94*/	r5.z = dot(vec3(r3.xzwx), vec3(r2.xyzx));
/*95*/	r5.z = r5.z + r5.z;
/*96*/	r6.xyz = (r2.xyzx * -r5.zzzz + r3.xzwx).xyz;
/*97*/	r7.xyz = (mix(vec4(1.000000, 1.000000, 273.000000, 0), vec4(0.004000, 360.000000, 1.000000, 0), greaterThan(floatBitsToUint(r5.yyyy), uvec4(0)))).xyz;
/*98*/	r5.z = r5.x * 1.539380;
/*99*/	r5.z = cos((r5.z));
/*100*/	r5.z = inversesqrt(r5.z);
/*101*/	r5.z = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r5.z)).z;
/*102*/	r5.w = saturate(r1.w * 60.000000);
/*103*/	r5.w = -r1.w + r5.w;
/*104*/	r8.xyz = (r2.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*105*/	r6.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*106*/	r6.w = inversesqrt(r6.w);
/*107*/	r8.xyz = (r6.wwww * r8.xyzx).xyz;
/*108*/	r9.xyz = (uintBitsToFloat(uvec4(lessThan(r8.xyzx, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xyz;
...
/*113*/	r9.xyz = (r9.xywx * r8.yyyy).xyz;
/*114*/	r8.xyw = (r8.xxxx * r10.xyxz + r9.xyxz).xyw;
/*115*/	r8.xyz = (r8.zzzz * r11.xyzx + r8.xywx).xyz;
/*116*/	r8.xyz = (r7.yyyy * r8.xyzx).xyz;
/*117*/	r8.xyz = (r0.xyzx * r8.xyzx).xyz;
/*118*/	r6.w = -r1.w + 1.000000;
/*119*/	r8.xyz = (r6.wwww * r8.xyzx).xyz;
/*120*/	r8.xyz = (r7.xxxx * r8.xyzx).xyz;
/*121*/	if(floatBitsToUint(cb1.data[0].x) != 0u) {
/*122*/	  r6.w = dot(vec3(r6.xyzx), vec3(r3.xzwx));
/*123*/	  r6.w = max(r6.w, 0.000000);
/*124*/	  r6.w = log2(r6.w);
/*125*/	  r6.w = r6.w * 10.000000;
/*126*/	  r6.w = exp2(r6.w);
/*127*/	  r6.w = r5.z * r6.w;
/*128*/	  r6.w = r6.w * r5.w + r1.w;
/*129*/	  r7.y = r5.x * 8.000000;
/*130*/	  r9.xyzw = (textureLod(s_environment, r6.xyzx.stp, r7.y)).xyzw;
/*131*/	  r9.xyz = (r6.wwww * r9.xyzx).xyz;
/*132*/	  r8.xyz = (r9.xyzx * r1.xyzx + r8.xyzx).xyz;
/*133*/	}
...
/*138*/	  r2.x = dot(vec3(-cb1.data[0].yzwy), vec3(r6.xyzx));
/*139*/	  r2.x = max(r2.x, -1.000000);
/*140*/	  r2.x = min(r2.x, 1.000000);
/*141*/	  r2.z = -abs(r2.x) + 1.000000;
/*142*/	  r2.z = sqrt(r2.z);
/*143*/	  r6.x = abs(r2.x) * -0.018729 + 0.074261;
/*144*/	  r6.x = r6.x * abs(r2.x) + -0.212114;
/*145*/	  r6.x = r6.x * abs(r2.x) + 1.570729;
/*146*/	  r6.y = r2.z * r6.x;
/*147*/	  r6.y = r6.y * -2.000000 + 3.141593;
/*148*/	  r2.x = uintBitsToFloat((r2.x < -r2.x) ? 0xffffffffu : 0x00000000u);
/*149*/	  r2.x = uintBitsToFloat(floatBitsToUint(r2.x) & floatBitsToUint(r6.y));
/*150*/	  r2.x = r6.x * r2.z + r2.x;
/*151*/	  r2.z = r3.y * r3.y;
/*152*/	    r3.y = (floatBitsToUint(r5.y) > 0x00000000u) ? 0.995900 : -0.000100;
...
/*158*/	  r3.y = log2(r3.y);
/*159*/	  r5.y = r3.y * 4.950617;
/*160*/	  r3.y = r3.y * 0.346574 + 4.546885;
/*161*/	  r6.x = uintBitsToFloat((0.000000 < r2.z) ? 0xffffffffu : 0x00000000u);
/*162*/	  r2.z = uintBitsToFloat((r2.z < 0.000000) ? 0xffffffffu : 0x00000000u);
/*163*/	  r2.z = intBitsToFloat(1 + ~floatBitsToInt(r6.x) + floatBitsToInt(r2.z));
/*164*/	  r2.z = floatBitsToInt(r2.z);
/*165*/	  r5.y = r3.y * r3.y + -r5.y;
/*166*/	  r5.y = sqrt(r5.y);
/*167*/	  r3.y = -r3.y + r5.y;
...
/*208*/	  r3.xyz = (r3.xxxx * r2.xxxx).xyz;
/*209*/	} else {
/*210*/	  r3.xyz = (vec4(0, 0, 0, 0)).xyz;
/*211*/	}
/*212*/	r5.xyz = saturate(r7.zzzz * r3.xyzx).xyz;
/*213*/	r1.xyz = (r1.xyzx * r5.xyzx).xyz;
...
/*219*/	r0.xyz = (r7.xxxx * r0.xyzx).xyz;
/*220*/	r0.xyz = (r1.xyzx * cb1.data[1].xyzx + r0.xyzx).xyz;
/*221*/	r0.xyz = (r0.xyzx + r8.xyzx).xyz;
/*222*/	r1.x = sqrt(r2.w);
/*223*/	r1.y = saturate(cb2.data[0].w)/**/;
/*224*/	r1.y = -r1.y + 1.000000;
/*225*/	r1.y = r1.y * 8.000000 + -4.000000;
/*226*/	r1.z = saturate(cb2.data[1].x)/**/;
/*227*/	r1.z = -r1.z + 1.000000;
/*228*/	r1.z = r1.z * 1000.000000;
/*229*/	r1.x = r1.x / r1.z;
/*230*/	r1.x = r1.x + r1.y;
/*231*/	r1.x = r1.x * 1.442695;
/*232*/	r1.x = exp2(r1.x);
/*233*/	r1.x = cb2.data[1].y / r1.x;
/*234*/	r1.x = saturate(-r1.x + cb2.data[1].y);
/*235*/	r1.y = -vsOut_T0.y + cb2.data[1].w;
/*236*/	r1.z = -cb2.data[1].z + cb2.data[1].w;
/*237*/	r1.y = r1.y + -cb2.data[1].z;
/*238*/	r1.z = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.z)).z;
/*239*/	r1.y = saturate(r1.z * r1.y);
/*240*/	r1.z = r1.y * -2.000000 + 3.000000;
/*241*/	r1.y = r1.y * r1.y;
/*242*/	r1.y = r1.y * r1.z;
/*243*/	r1.z = dot(vec2(r4.xzxx), vec2(r4.xzxx));
/*244*/	r1.z = sqrt(r1.z);
/*245*/	r1.w = max(cb2.data[2].z, 0.001000);
/*246*/	r1.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.w)).w;
/*247*/	r1.z = r1.w * r1.z;
/*248*/	r1.z = min(r1.z, 1.000000);
/*249*/	r1.w = r1.z * -2.000000 + 3.000000;
/*250*/	r1.z = r1.z * r1.z;
/*251*/	r1.z = r1.z * r1.w;
/*252*/	r1.x = cb2.data[2].x * r1.y + r1.x;
/*253*/	r2.xyz = (cb1.data[1].xyzx * cb2.data[0].xyzx).xyz;
/*254*/	r2.xyz = (r2.xyzx * vec4(1.500000, 1.500000, 1.500000, 0.000000)).xyz;
/*255*/	r2.xyz = (r2.xyzx * abs(cb1.data[0].zzzz)).xyz;
/*256*/	r3.xyz = (r7.xxxx * r2.xyzx).xyz;
/*257*/	r4.w = max(r4.y, 0.000000);
/*258*/	r4.xyzw = (texture(s_sky, r4.xwzx.stp)).xyzw;
/*259*/	r1.y = saturate(dot(vec2(r1.xxxx), vec2(cb2.data[2].yyyy)));
/*260*/	r2.xyz = (-r2.xyzx * r7.xxxx + r4.xyzx).xyz;
/*261*/	r2.xyz = (r1.yyyy * r2.xyzx + r3.xyzx).xyz;
/*262*/	r1.x = saturate(r1.x * r1.z);
/*263*/	r1.yzw = (-r0.xxyz + r2.xxyz).yzw;
/*264*/	color0.xyz = (r1.xxxx * r1.yzwy + r0.xyzx).xyz;
/*265*/	color0.w = r0.w * vsOut_T6.w;
/*266*/	return;
}
