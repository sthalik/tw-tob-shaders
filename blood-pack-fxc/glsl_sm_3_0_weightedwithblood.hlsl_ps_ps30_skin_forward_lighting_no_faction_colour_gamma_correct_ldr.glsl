...
// Fragment Shader
//
// id: 2147 - fxc/glsl_SM_3_0_weightedwithblood.hlsl_PS_ps30_skin_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*60*/	r2.y = dot(vec3(r5.xyzx), vec3(r5.xyzx));
/*61*/	r2.z = inversesqrt(r2.y);
...
/*127*/	r2.x = r1.w + r1.w;
/*128*/	r3.xyz = (r3.xyzx * -r2.xxxx + -r6.xyzx).xyz;
/*129*/	r3.xyz = (r3.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*130*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*131*/	r2.x = inversesqrt(r2.x);
/*132*/	r3.xyz = (r2.xxxx * r3.xyzx).xyz;
