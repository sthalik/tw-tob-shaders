...
// Fragment Shader
//
// id: 3006 - fxc/glsl_SM_3_0_weightedwithdecaldirtblood.hlsl_PS_ps30_gbuffer_no_faction_colour.glsl
//
...
/*85*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
...
/*89*/	r0.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*90*/	r0.w = inversesqrt(r0.w);
/*91*/	r4.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
/*92*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*93*/	r0.w = inversesqrt(r0.w);
/*94*/	r5.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*95*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*96*/	r0.w = inversesqrt(r0.w);
/*97*/	r6.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*98*/	r5.xyz = (r2.yyyy * r5.xyzx).xyz;
/*99*/	r2.xyw = (r2.xxxx * r4.xyxz + r5.xyxz).xyw;
/*100*/	r2.xyz = (r2.zzzz * r6.xyzx + r2.xywx).xyz;
/*101*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*102*/	r0.w = inversesqrt(r0.w);
/*103*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*104*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*105*/	r4.w = 1.000000;
/*106*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*107*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*108*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*109*/	color3.x = r0.w / r2.w;
/*110*/	r0.w = max(abs(r2.z), abs(r2.y));
/*111*/	r0.w = max(r0.w, abs(r2.x));
/*112*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*113*/	r3.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*114*/	color0.xyzw = saturate(r3.xzwy);
/*115*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*116*/	r1.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*117*/	color2.xyzw = saturate(r1.xyzw);
/*118*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*119*/	color4 = floatBitsToUint(vsOut_T9.z);
/*120*/	return;
}
