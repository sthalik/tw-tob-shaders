...
// Fragment Shader
//
// id: 4975 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdecaldirtbloodmesh.hlsl_PS_ps30_alpha_blend_40.glsl
//
...
/*76*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy).zw;
/*77*/	r4.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx + vsOut_T6.yzyy).xy;
/*78*/	r5.xyzw = (texture(s_decal_dirt_map, r4.xyxx.st)).xyzw;
/*79*/	r4.xy = (r5.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*80*/	r2.w = r4.w * r5.w;
/*81*/	r5.xyz = (-r0.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*82*/	r0.xyz = (r2.wwww * r5.xyzx + r0.xyzx).xyz;
/*83*/	r1.xy = (r4.xyxx * r4.wwww + r1.xyxx).xy;
/*84*/	r4.x = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*85*/	r4.x = inversesqrt(r4.x);
/*86*/	r1.xyz = (r1.xyzx * r4.xxxx).xyz;
/*87*/	r3.zw = (r3.zzzw * vec4(0.000000, 0.000000, 0.750000, 0.750000) + vsOut_T6.yyyz).zw;
/*88*/	r4.xyzw = (texture(s_decal_blood_map, r3.zwzz.st)).xyzw;
/*89*/	r3.z = -vsOut_T7.w * 0.900000 + 1.000000;
/*90*/	r3.z = saturate(-r3.z + r4.w);
/*91*/	r3.z = uintBitsToFloat((0.000000 < r3.z) ? 0xffffffffu : 0x00000000u);
/*92*/	if(floatBitsToUint(r3.z) != 0u) {
/*93*/	  r3.z = -r4.w + 1.000000;
/*94*/	  r3.z = saturate(vsOut_T7.w * 0.900000 + -r3.z);
/*95*/	  r3.z = -r3.z + 1.000000;
/*96*/	  r3.z = -r3.z * r3.z + 1.000000;
/*97*/	  r3.z = r3.z * -0.600000 + 1.000000;
/*98*/	  r4.xyz = (r3.zzzz * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*99*/	  r3.z = saturate(dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*100*/	  r3.z = uintBitsToFloat((r3.z < 0.225000) ? 0xffffffffu : 0x00000000u);
/*101*/	  r3.z = uintBitsToFloat(floatBitsToUint(r3.z) & uint(0x3f800000u));
/*102*/	  r5.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r4.xzzx).xyz;
/*103*/	  r0.xyz = (r3.zzzz * r5.xyzx + r4.xyzx).xyz;
/*104*/	  r4.xyz = (vec4(1.000000, 0.800000, 0.800000, 0)).xyz;
/*105*/	  r3.xy = (vec4(0.800000, 0.020000, 0, 0)).xy;
/*106*/	} else {
/*107*/	  r5.xyz = (r2.wwww * r2.xyzx).xyz;
/*108*/	  r4.xyz = (r5.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r2.xyzx).xyz;
/*109*/	}
/*110*/	r2.x = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*111*/	r2.x = inversesqrt(r2.x);
/*112*/	r2.xyz = (r2.xxxx * vsOut_T3.xyzx).xyz;
...
/*120*/	r7.xyz = (r1.xxxx * r2.xyzx + r7.xyzx).xyz;
...
/*134*/	  r4.xyz = (r7.xxxx * vec4(0.600000, 0.600000, 0.600000, 0.000000) + r4.xyzx).xyz;
/*135*/	  r3.xy = (r3.xyxx + vec4(0.300000, 0.200000, 0.000000, 0.000000)).xy;
/*136*/	}
...
/*169*/	    r0.w = r0.w * r0.w;
/*170*/	    r0.w = r0.w * r2.w;
/*171*/	    r3.x = r0.w * -r3.x + r3.x;
/*172*/	    r2.w = -r3.y + 0.200000;
/*173*/	    r3.y = r0.w * r2.w + r3.y;
/*174*/	    r9.xyz = (-r0.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*175*/	    r0.xyz = (r0.wwww * r9.xyzx + r0.xyzx).xyz;
/*176*/	    r9.xyz = (-r4.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*177*/	    r4.xyz = (r0.wwww * r9.xyzx + r4.xyzx).xyz;
...
/*193*/	    r2.xyz = (r7.xxxx * r2.xyzx + r5.xyzx).xyz;
/*194*/	    r2.xyz = (r7.zzzz * r6.xyzx + r2.xyzx).xyz;
/*195*/	    r2.w = -r1.y + 1.000000;
/*196*/	    r0.w = min(r0.w, r2.w);
/*197*/	    r2.xyz = (-r1.xyzx + r2.xyzx).xyz;
/*198*/	    r2.xyz = (r0.wwww * r2.xyzx + r1.xyzx).xyz;
/*199*/	    r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*200*/	    r0.w = inversesqrt(r0.w);
/*201*/	    r1.xyz = (r0.wwww * r2.xyzx).xyz;
/*202*/	  }
/*203*/	}
/*204*/	r0.w = vsOut_T7.y * -r3.y + r3.y;
/*205*/	r2.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*206*/	r2.xyz = (-r0.xyzx + r2.xyzx).xyz;
/*207*/	r0.xyz = saturate(vsOut_T7.yyyy * r2.xyzx + r0.xyzx).xyz;
/*208*/	r2.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*209*/	r2.xyz = (-r0.xyzx + r2.xxxx).xyz;
/*210*/	r0.xyz = (vsOut_T7.zzzz * r2.xyzx + r0.xyzx).xyz;
/*211*/	r2.x = dot(vec3(r4.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*212*/	r2.xyz = (-r4.xyzx + r2.xxxx).xyz;
/*213*/	r2.xyz = (vsOut_T7.zzzz * r2.xyzx + r4.xyzx).xyz;
...
/*220*/	r3.y = inversesqrt(r2.w);
/*221*/	r3.yzw = (r3.yyyy * r4.xxyz).yzw;
/*222*/	r5.x = -r3.x + 1.000000;
/*223*/	r5.y = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*224*/	r5.z = dot(vec3(r3.yzwy), vec3(r1.xyzx));
/*225*/	r5.z = r5.z + r5.z;
/*226*/	r6.xyz = (r1.xyzx * -r5.zzzz + r3.yzwy).xyz;
...
/*252*/	  r6.w = dot(vec3(r6.xyzx), vec3(r3.yzwy));
...
/*281*/	  r1.z = r3.x * r3.x;
/*282*/	    r3.x = (floatBitsToUint(r5.y) > 0x00000000u) ? 0.995900 : -0.000100;
/*283*/	  r1.z = r1.z * r3.x + r7.x;
/*284*/	  r1.z = r1.z * 0.500000 + 0.500000;
/*285*/	  r1.z = r1.z * 2.000000 + -1.000000;
/*286*/	  r3.x = -r1.z * r1.z + 1.000000;
/*287*/	  r3.x = max(r3.x, 0.001000);
/*288*/	  r3.x = log2(r3.x);
/*289*/	  r5.y = r3.x * 4.950617;
/*290*/	  r3.x = r3.x * 0.346574 + 4.546885;
...
/*295*/	  r5.y = r3.x * r3.x + -r5.y;
/*296*/	  r5.y = sqrt(r5.y);
/*297*/	  r3.x = -r3.x + r5.y;
/*298*/	  r3.x = max(r3.x, 0.000000);
/*299*/	  r3.x = sqrt(r3.x);
/*300*/	  r1.z = r1.z * r3.x;
...
/*326*/	  r3.x = r5.x * 1.570796;
/*327*/	  r3.x = sin(r3.x);
/*328*/	  r1.z = r1.z + -1.000000;
/*329*/	  r1.z = r3.x * r1.z + 1.000000;
/*330*/	  r3.x = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
