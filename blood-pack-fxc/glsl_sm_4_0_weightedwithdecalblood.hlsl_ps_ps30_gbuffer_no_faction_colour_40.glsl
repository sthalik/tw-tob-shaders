...
// Fragment Shader
//
// id: 2861 - fxc/glsl_SM_4_0_weightedwithdecalblood.hlsl_PS_ps30_gbuffer_no_faction_colour_40.glsl
//
...
/*86*/	r2.xyw = (r2.xxxx * r4.xyxz + r5.xyxz).xyw;
/*87*/	r2.xyz = (r2.zzzz * r6.xyzx + r2.xywx).xyz;
...
/*94*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*95*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*96*/	color3.x = r0.w / r2.w;
/*97*/	r0.w = max(abs(r2.z), abs(r2.y));
/*98*/	r0.w = max(r0.w, abs(r2.x));
/*99*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*100*/	r3.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*101*/	color0.xyzw = saturate(r3.xzwy);
/*102*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*103*/	r1.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*104*/	color2.xyzw = saturate(r1.xyzw);
