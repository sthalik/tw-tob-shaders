...
// Fragment Shader
//
// id: 1127 - fxc/glsl_SM_3_0_rigidwithdecalbloodmesh.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*81*/	}
/*82*/	r4.xy = (vsOut_T1.xyxx * cb3.data[2].xyxx).xy;
...
/*199*/	  r4.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*200*/	  r5.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*201*/	  r4.xyzw = r4.xyzw / r5.xyzw;
/*202*/	  r5.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*203*/	  r4.xyzw = r4.xyzw * r5.xyzw + cb1.data[4].xyxy;
/*204*/	  r5.xyzw = (textureLod(s_shroud, r4.zwzz.st, r4.w)).xyzw;
/*205*/	  r4.xyzw = r4.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*206*/	  r4.xyzw = saturate(r4.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*207*/	  r6.xyzw = r4.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*208*/	  r4.xyzw = r4.xyzw * r4.xyzw;
/*209*/	  r4.xyzw = r4.xyzw * r6.xyzw;
/*210*/	  r0.w = r5.x * r4.x;
/*211*/	  r0.w = r0.w * r4.y;
/*212*/	  r0.w = r4.z * -r0.w + r0.w;
/*213*/	  r0.w = r4.w * -r0.w + r0.w;
/*214*/	} else {
/*215*/	  r0.w = 1.000000;
/*216*/	}
/*217*/	r4.xy = (r0.wwww + vec4(-0.100000, -0.500000, 0.000000, 0.000000)).xy;
/*218*/	r0.w = saturate(r4.x * 2.500000);
/*219*/	r4.x = r0.w * -2.000000 + 3.000000;
/*220*/	r0.w = r0.w * r0.w;
/*221*/	r0.w = r0.w * r4.x;
/*222*/	r4.x = saturate(r4.y + r4.y);
/*223*/	r4.y = r4.x * -2.000000 + 3.000000;
/*224*/	r4.x = r4.x * r4.x;
/*225*/	r4.x = r4.x * r4.y;
/*226*/	r0.w = r0.w * 0.200000;
/*227*/	r4.yzw = saturate(r0.wwww * r0.xxyz).yzw;
/*228*/	r0.xyz = (r0.xyzx + -r4.yzwy).xyz;
/*229*/	r0.xyz = (r4.xxxx * r0.xyzx + r4.yzwy).xyz;
/*230*/	r0.w = vsOut_T7.y * -r1.x + r1.x;
/*231*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*232*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*233*/	r0.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r0.xyzx).xyz;
/*234*/	r4.x = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*235*/	r4.xyz = (-r0.xyzx + r4.xxxx).xyz;
/*236*/	r0.xyz = (vsOut_T7.zzzz * r4.xyzx + r0.xyzx).xyz;
/*237*/	r4.x = dot(vec3(r2.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*238*/	r4.xyz = (-r2.xyzx + r4.xxxx).xyz;
/*239*/	r4.xyz = (vsOut_T7.zzzz * r4.xyzx + r2.xyzx).xyz;
/*240*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*241*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*242*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*243*/	r2.x = inversesqrt(r2.x);
/*244*/	r2.xyz = (r2.xxxx * r3.xyzx).xyz;
/*245*/	color3.x = r2.w / r3.w;
...
/*252*/	r4.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*253*/	color2.xyzw = saturate(r4.xyzw);
