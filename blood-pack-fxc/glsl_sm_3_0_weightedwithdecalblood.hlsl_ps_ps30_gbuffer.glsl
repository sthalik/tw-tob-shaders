...
// Fragment Shader
//
// id: 2851 - fxc/glsl_SM_3_0_weightedwithdecalblood.hlsl_PS_ps30_gbuffer.glsl
//
...
/*58*/	}
/*59*/	r0.w = uintBitsToFloat((vsOut_T8.x < vsOut_T8.z) ? 0xffffffffu : 0x00000000u);
/*60*/	if(r0.w != 0) discard;
...
/*64*/	r0.w = -vsOut_T4.z * 0.900000 + 1.000000;
/*65*/	r0.w = saturate(-r0.w + r4.w);
/*66*/	r0.w = uintBitsToFloat((0.000000 < r0.w) ? 0xffffffffu : 0x00000000u);
/*67*/	if(floatBitsToUint(r0.w) != 0u) {
/*68*/	  r0.w = -r4.w + 1.000000;
/*69*/	  r0.w = saturate(vsOut_T4.z * 0.900000 + -r0.w);
/*70*/	  r0.w = -r0.w + 1.000000;
/*71*/	  r0.w = -r0.w * r0.w + 1.000000;
/*72*/	  r0.w = r0.w * -0.600000 + 1.000000;
/*73*/	  r4.xyz = (r0.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*74*/	  r0.w = saturate(dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*75*/	  r0.w = uintBitsToFloat((r0.w < 0.225000) ? 0xffffffffu : 0x00000000u);
/*76*/	  r0.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3f800000u));
/*77*/	  r5.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r4.xzzx).xyz;
/*78*/	  r0.xyz = (r0.wwww * r5.xyzx + r4.xyzx).xyz;
/*79*/	  r1.xyz = (vec4(1.000000, 0.800000, 0.800000, 0)).xyz;
...
/*95*/	r4.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
/*96*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*97*/	r0.w = inversesqrt(r0.w);
/*98*/	r5.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*99*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*100*/	r0.w = inversesqrt(r0.w);
/*101*/	r6.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*102*/	r5.xyz = (r2.yyyy * r5.xyzx).xyz;
/*103*/	r2.xyw = (r2.xxxx * r4.xyxz + r5.xyxz).xyw;
/*104*/	r2.xyz = (r2.zzzz * r6.xyzx + r2.xywx).xyz;
...
/*112*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*113*/	color3.x = r0.w / r2.w;
/*114*/	r0.w = max(abs(r2.z), abs(r2.y));
/*115*/	r0.w = max(r0.w, abs(r2.x));
/*116*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*117*/	r3.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*118*/	color0.xyzw = saturate(r3.xzwy);
/*119*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*120*/	r1.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
