...
// Fragment Shader
//
// id: 6934 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdecalblood.hlsl_PS_ps30_weighted_forward_lighting_gamma_correct_LDR.glsl
//
...
/*61*/	r3.zw = (vsOut_T1.xxxy * vec4(0.000000, 0.000000, 0.750000, 0.750000)).zw;
/*62*/	r3.zw = (r3.zzzw * cb4.data[2].xxxy + vsOut_T6.xxxy).zw;
/*63*/	r4.xyzw = (texture(s_decal_blood_map, r3.zwzz.st)).xyzw;
