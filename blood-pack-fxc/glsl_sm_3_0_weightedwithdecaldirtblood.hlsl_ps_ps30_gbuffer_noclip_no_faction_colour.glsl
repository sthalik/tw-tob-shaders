...
// Fragment Shader
//
// id: 3002 - fxc/glsl_SM_3_0_weightedwithdecaldirtblood.hlsl_PS_ps30_gbuffer_noclip_no_faction_colour.glsl
//
...
/*82*/	color1.w = saturate(vsOut_T7.x * -r0.w + r0.w);
/*83*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*84*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*85*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
/*86*/	r0.w = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*87*/	r0.w = inversesqrt(r0.w);
/*88*/	r4.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
...
/*96*/	r2.xyw = (r2.xxxx * r4.xyxz + r5.xyxz).xyw;
/*97*/	r2.xyz = (r2.zzzz * r6.xyzx + r2.xywx).xyz;
/*98*/	r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*99*/	r0.w = inversesqrt(r0.w);
/*100*/	r2.xyz = (r0.wwww * r2.xyzx).xyz;
/*101*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*102*/	r4.w = 1.000000;
/*103*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*104*/	r2.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*105*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*106*/	color3.x = r0.w / r2.w;
/*107*/	r0.w = max(abs(r2.z), abs(r2.y));
/*108*/	r0.w = max(r0.w, abs(r2.x));
/*109*/	r2.xyz = (r2.xyzx / r0.wwww).xyz;
/*110*/	r3.xzw = (r2.xxyz * vec4(0.500000, 0.000000, 0.500000, 0.500000) + vec4(0.500000, 0.000000, 0.500000, 0.500000)).xzw;
/*111*/	color0.xyzw = saturate(r3.xzwy);
/*112*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*113*/	r1.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*114*/	color2.xyzw = saturate(r1.xyzw);
/*115*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*116*/	color4 = floatBitsToUint(vsOut_T9.z);
/*117*/	return;
}
