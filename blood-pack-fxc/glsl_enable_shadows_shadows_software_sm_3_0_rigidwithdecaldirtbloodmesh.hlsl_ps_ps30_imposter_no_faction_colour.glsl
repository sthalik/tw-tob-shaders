...
// Fragment Shader
//
// id: 5007 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_rigidwithdecaldirtbloodmesh.hlsl_PS_ps30_imposter_no_faction_colour.glsl
//
...
/*37*/	r3.xy = (vsOut_T1.xyxx * cb2.data[2].xyxx + vsOut_T6.yzyy).xy;
/*38*/	r3.xyzw = (texture(s_decal_dirt_map, r3.xyxx.st)).xyzw;
/*39*/	r1.w = r2.w * r3.w;
/*40*/	r4.xyz = (-r0.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*41*/	r0.xyz = (r1.wwww * r4.xyzx + r0.xyzx).xyz;
/*42*/	r2.xy = (r2.xyxx * vec4(0.750000, 0.750000, 0.000000, 0.000000) + vsOut_T6.yzyy).xy;
/*43*/	r4.xyzw = (texture(s_decal_blood_map, r2.xyxx.st)).xyzw;
/*44*/	r1.w = -vsOut_T7.w * 0.900000 + 1.000000;
/*45*/	r1.w = saturate(-r1.w + r4.w);
/*46*/	r1.w = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*47*/	if(floatBitsToUint(r1.w) != 0u) {
/*48*/	  r1.w = -r4.w + 1.000000;
/*49*/	  r1.w = saturate(vsOut_T7.w * 0.900000 + -r1.w);
/*50*/	  r1.w = -r1.w + 1.000000;
/*51*/	  r1.w = -r1.w * r1.w + 1.000000;
/*52*/	  r1.w = r1.w * -0.600000 + 1.000000;
/*53*/	  r2.xyz = (r1.wwww * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*54*/	  r1.w = saturate(dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*55*/	  r1.w = uintBitsToFloat((r1.w < 0.225000) ? 0xffffffffu : 0x00000000u);
/*56*/	  r1.w = uintBitsToFloat(floatBitsToUint(r1.w) & uint(0x3f800000u));
/*57*/	  r4.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r2.xzzx).xyz;
/*58*/	  r0.xyz = (r1.wwww * r4.xyzx + r2.xyzx).xyz;
/*59*/	}
