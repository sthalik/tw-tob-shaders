...
// Fragment Shader
//
// id: 6208 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithblood.hlsl_PS_ps30_skin_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*14*/	r1.zw = (r1.zzzw * cb5.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*60*/	r5.w = 1.000000;
/*61*/	r2.y = dot(r5.xyzw, cb1.data[12].xyzw);
/*62*/	r6.xyz = (-cb2.data[35].xyzx * cb2.data[34].zzzz + vsOut_T0.xyzx).xyz;
/*63*/	r7.x = uintBitsToFloat((r2.y >= cb2.data[37].x) ? 0xffffffffu : 0x00000000u);
/*64*/	r7.y = uintBitsToFloat((r2.y >= cb2.data[38].x) ? 0xffffffffu : 0x00000000u);
/*65*/	r7.z = uintBitsToFloat((r2.y >= cb2.data[39].x) ? 0xffffffffu : 0x00000000u);
/*66*/	r7.w = uintBitsToFloat((r2.y >= cb2.data[40].x) ? 0xffffffffu : 0x00000000u);
...
/*261*/	r2.x = r1.w + r1.w;
/*262*/	r3.xyz = (r3.xyzx * -r2.xxxx + -r7.xyzx).xyz;
