...
// Fragment Shader
//
// id: 1225 - fxc/glsl_SM_3_0_rigidwithdirtbloodmesh.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*26*/	r3.xyz = (r3.xyzx + -cb4.data[0].xyzx).xyz;
/*27*/	r3.xyz = (r1.wwww * r3.xyzx + cb4.data[0].xyzx).xyz;
/*28*/	r2.xyw = (mix(vec4(1.000000, 1.000000, 0, 1.000000), vsOut_N0.xyxz, greaterThan(floatBitsToUint(r2.yyyy), uvec4(0)))).xyw;
/*29*/	r2.xyw = (r2.xyxw + -cb4.data[1].xyxz).xyw;
/*30*/	r2.xyw = (r1.wwww * r2.xyxw + cb4.data[1].xyxz).xyw;
/*31*/	r4.xyz = (mix(vec4(1.000000, 1.000000, 1.000000, 0), vsOut_N0.xyzx, greaterThan(floatBitsToUint(r2.zzzz), uvec4(0)))).xyz;
/*32*/	r4.xyz = (r4.xyzx + -cb4.data[2].xyzx).xyz;
/*33*/	r4.xyz = (r1.wwww * r4.xyzx + cb4.data[2].xyzx).xyz;
...
/*53*/	r2.yz = (vsOut_T1.xxyx * cb3.data[2].xxyx).yz;
/*54*/	r3.xy = (vsOut_T1.xyxx * cb3.data[2].xyxx + vsOut_T6.yzyy).xy;
...
/*105*/	r0.w = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*118*/	  r0.w = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*138*/	    r3.w = cb2.data[1].x * cb2.data[1].x;
/*139*/	    r3.w = r3.w * 1.250000;
/*140*/	    r3.w = min(r3.w, 1.000000);
/*141*/	    r5.w = saturate(cb2.data[1].x * cb2.data[1].x + -0.800000);
...
/*165*/	    r3.w = dot(vec2(cb2.data[0].xyxx), vec2(cb2.data[0].xyxx));
/*166*/	    r3.w = sqrt(r3.w);
...
/*181*/	  }
/*182*/	}
/*183*/	r0.w = uintBitsToFloat((0.500000 < cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*184*/	if(floatBitsToUint(r0.w) != 0u) {
/*185*/	  r5.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*186*/	  r6.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*187*/	  r5.xyzw = r5.xyzw / r6.xyzw;
/*188*/	  r6.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*189*/	  r5.xyzw = r5.xyzw * r6.xyzw + cb1.data[4].xyxy;
/*190*/	  r6.xyzw = (textureLod(s_shroud, r5.zwzz.st, r5.w)).xyzw;
/*191*/	  r5.xyzw = r5.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*192*/	  r5.xyzw = saturate(r5.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*193*/	  r7.xyzw = r5.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*194*/	  r5.xyzw = r5.xyzw * r5.xyzw;
/*195*/	  r5.xyzw = r5.xyzw * r7.xyzw;
/*196*/	  r0.w = r6.x * r5.x;
/*197*/	  r0.w = r0.w * r5.y;
/*198*/	  r0.w = r5.z * -r0.w + r0.w;
/*199*/	  r0.w = r5.w * -r0.w + r0.w;
/*200*/	} else {
/*201*/	  r0.w = 1.000000;
/*202*/	}
/*203*/	r2.yz = (r0.wwww + vec4(0.000000, -0.100000, -0.500000, 0.000000)).yz;
/*204*/	r0.w = saturate(r2.y * 2.500000);
/*205*/	r2.y = r0.w * -2.000000 + 3.000000;
/*206*/	r0.w = r0.w * r0.w;
/*207*/	r0.w = r0.w * r2.y;
/*208*/	r2.y = saturate(r2.z + r2.z);
/*209*/	r2.z = r2.y * -2.000000 + 3.000000;
/*210*/	r2.y = r2.y * r2.y;
/*211*/	r2.y = r2.y * r2.z;
/*212*/	r0.w = r0.w * 0.200000;
/*213*/	r5.xyz = saturate(r0.wwww * r0.xyzx).xyz;
/*214*/	r0.xyz = (r0.xyzx + -r5.xyzx).xyz;
/*215*/	r0.xyz = (r2.yyyy * r0.xyzx + r5.xyzx).xyz;
/*216*/	r0.w = vsOut_T7.y * -r4.x + r4.x;
/*217*/	r2.yzw = (r0.xxyz * vec4(0.000000, 5.000000, 5.000000, 5.000000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*218*/	r2.yzw = (-r0.xxyz + r2.yyzw).yzw;
/*219*/	r0.xyz = saturate(vsOut_T7.yyyy * r2.yzwy + r0.xyzx).xyz;
/*220*/	r2.y = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*221*/	r2.yzw = (-r0.xxyz + r2.yyyy).yzw;
/*222*/	r0.xyz = (vsOut_T7.zzzz * r2.yzwy + r0.xyzx).xyz;
/*223*/	r2.y = dot(vec3(r3.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*224*/	r2.yzw = (-r3.xxyz + r2.yyyy).yzw;
/*225*/	r3.xyz = (vsOut_T7.zzzz * r2.yzwy + r3.xyzx).xyz;
/*226*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*227*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*228*/	r2.y = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*229*/	r2.y = inversesqrt(r2.y);
/*230*/	r1.xyz = (r1.xyzx * r2.yyyy).xyz;
/*231*/	color3.x = r1.w / r2.x;
/*232*/	r1.w = max(abs(r1.z), abs(r1.y));
/*233*/	r1.w = max(r1.w, abs(r1.x));
/*234*/	r1.xyz = (r1.xyzx / r1.wwww).xyz;
/*235*/	r4.xyz = (r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*236*/	color0.xyzw = saturate(r4.xyzw);
/*237*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*238*/	r3.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*239*/	color2.xyzw = saturate(r3.xyzw);
/*240*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*241*/	color4 = vsOut_P1;
/*242*/	return;
}
