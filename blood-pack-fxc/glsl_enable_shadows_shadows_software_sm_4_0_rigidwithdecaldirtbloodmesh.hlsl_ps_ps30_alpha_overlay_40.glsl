...
// Fragment Shader
//
// id: 4981 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdecaldirtbloodmesh.hlsl_PS_ps30_alpha_overlay_40.glsl
//
...
/*71*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy).zw;
/*72*/	r4.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx + vsOut_T6.yzyy).xy;
...
/*154*/	    r1.w = cb3.data[1].x * cb3.data[1].x;
/*155*/	    r1.w = r1.w * 1.250000;
/*156*/	    r1.w = min(r1.w, 1.000000);
/*157*/	    r2.w = saturate(cb3.data[1].x * cb3.data[1].x + -0.800000);
...
/*181*/	    r1.w = dot(vec2(cb3.data[0].xyxx), vec2(cb3.data[0].xyxx));
/*182*/	    r1.w = sqrt(r1.w);
...
/*213*/	r4.xyz = (vsOut_T0.xyzx + -cb0.data[0].xyzx).xyz;
/*214*/	r1.w = dot(vec3(r4.xyzx), vec3(r4.xyzx));
/*215*/	r2.w = inversesqrt(r1.w);
/*216*/	r3.yzw = (r2.wwww * r4.xxyz).yzw;
/*217*/	r2.w = -r3.x + 1.000000;
/*218*/	r5.x = uintBitsToFloat((0.000000 < cb1.data[11].x) ? 0xffffffffu : 0x00000000u);
/*219*/	r5.y = dot(vec3(r3.yzwy), vec3(r1.xyzx));
/*220*/	r5.y = r5.y + r5.y;
/*221*/	r5.yzw = (r1.xxyz * -r5.yyyy + r3.yyzw).yzw;
/*222*/	r6.xyz = (mix(vec4(1.000000, 1.000000, 273.000000, 0), vec4(0.004000, 360.000000, 1.000000, 0), greaterThan(floatBitsToUint(r5.xxxx), uvec4(0)))).xyz;
/*223*/	r6.w = r2.w * 1.539380;
/*224*/	r6.w = cos((r6.w));
/*225*/	r6.w = inversesqrt(r6.w);
/*226*/	r6.w = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r6.w)).w;
/*227*/	r7.x = saturate(r0.z * 60.000000);
/*228*/	r7.x = -r0.z + r7.x;
/*229*/	r7.yzw = (r1.xxyz * vec4(0.000000, 1.000000, 4.000000, 1.000000)).yzw;
/*230*/	r8.x = dot(vec3(r7.yzwy), vec3(r7.yzwy));
/*231*/	r8.x = inversesqrt(r8.x);
/*232*/	r7.yzw = (r7.yyzw * r8.xxxx).yzw;
/*233*/	r8.xyz = (uintBitsToFloat(uvec4(lessThan(r7.yzwy, vec4(0.000000, 0.000000, 0.000000, 0.000000))) * 0xffffffffu)).xyz;
/*234*/	r9.xyz = (mix(cb1.data[2].xyzx, cb1.data[3].xyzx, greaterThan(floatBitsToUint(r8.xxxx), uvec4(0)))).xyz/**/;
/*235*/	r8.xyw = (mix(cb1.data[4].xyxz, cb1.data[5].xyxz, greaterThan(floatBitsToUint(r8.yyyy), uvec4(0)))).xyw/**/;
/*236*/	r10.xyz = (mix(cb1.data[6].xyzx, cb1.data[7].xyzx, greaterThan(floatBitsToUint(r8.zzzz), uvec4(0)))).xyz/**/;
/*237*/	r7.yzw = (r7.yyzw * r7.yyzw).yzw;
/*238*/	r8.xyz = (r8.xywx * r7.zzzz).xyz;
/*239*/	r8.xyz = (r7.yyyy * r9.xyzx + r8.xyzx).xyz;
/*240*/	r7.yzw = (r7.wwww * r10.xxyz + r8.xxyz).yzw;
/*241*/	r7.yzw = (r6.yyyy * r7.yyzw).yzw;
/*242*/	r7.yzw = (r0.xxyw * r7.yyzw).yzw;
/*243*/	r6.y = -r0.z + 1.000000;
/*244*/	r7.yzw = (r6.yyyy * r7.yyzw).yzw;
/*245*/	r7.yzw = (r6.xxxx * r7.yyzw).yzw;
/*246*/	if(floatBitsToUint(cb1.data[0].x) != 0u) {
/*247*/	  r6.y = dot(vec3(r5.yzwy), vec3(r3.yzwy));
/*248*/	  r6.y = max(r6.y, 0.000000);
/*249*/	  r6.y = log2(r6.y);
/*250*/	  r6.y = r6.y * 10.000000;
/*251*/	  r6.y = exp2(r6.y);
/*252*/	  r6.y = r6.w * r6.y;
/*253*/	  r6.y = r6.y * r7.x + r0.z;
/*254*/	  r8.x = r2.w * 8.000000;
/*255*/	  r8.xyzw = (textureLod(s_environment, r5.yzwy.stp, r8.x)).xyzw;
/*256*/	  r8.xyz = (r6.yyyy * r8.xyzx).xyz;
/*257*/	  r7.yzw = (r8.xxyz * r2.xxyz + r7.yyzw).yzw;
/*258*/	}
/*259*/	r1.x = dot(vec3(r1.xyzx), vec3(-cb1.data[0].yzwy));
/*260*/	r1.y = max(r1.x, 0.000000);
/*261*/	r1.x = uintBitsToFloat((0.000000 < r1.x) ? 0xffffffffu : 0x00000000u);
/*262*/	if(floatBitsToUint(r1.x) != 0u) {
/*263*/	  r1.x = dot(vec3(-cb1.data[0].yzwy), vec3(r5.yzwy));
/*264*/	  r1.x = max(r1.x, -1.000000);
/*265*/	  r1.x = min(r1.x, 1.000000);
/*266*/	  r1.z = -abs(r1.x) + 1.000000;
/*267*/	  r1.z = sqrt(r1.z);
/*268*/	  r5.y = abs(r1.x) * -0.018729 + 0.074261;
/*269*/	  r5.y = r5.y * abs(r1.x) + -0.212114;
/*270*/	  r5.y = r5.y * abs(r1.x) + 1.570729;
/*271*/	  r5.z = r1.z * r5.y;
/*272*/	  r5.z = r5.z * -2.000000 + 3.141593;
/*273*/	  r1.x = uintBitsToFloat((r1.x < -r1.x) ? 0xffffffffu : 0x00000000u);
/*274*/	  r1.x = uintBitsToFloat(floatBitsToUint(r1.x) & floatBitsToUint(r5.z));
/*275*/	  r1.x = r5.y * r1.z + r1.x;
/*276*/	  r1.z = r3.x * r3.x;
/*277*/	    r3.x = (floatBitsToUint(r5.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*278*/	  r1.z = r1.z * r3.x + r6.x;
/*279*/	  r1.z = r1.z * 0.500000 + 0.500000;
/*280*/	  r1.z = r1.z * 2.000000 + -1.000000;
/*281*/	  r3.x = -r1.z * r1.z + 1.000000;
/*282*/	  r3.x = max(r3.x, 0.001000);
/*283*/	  r3.x = log2(r3.x);
/*284*/	  r5.x = r3.x * 4.950617;
/*285*/	  r3.x = r3.x * 0.346574 + 4.546885;
/*286*/	  r5.y = uintBitsToFloat((0.000000 < r1.z) ? 0xffffffffu : 0x00000000u);
/*287*/	  r1.z = uintBitsToFloat((r1.z < 0.000000) ? 0xffffffffu : 0x00000000u);
/*288*/	  r1.z = intBitsToFloat(1 + ~floatBitsToInt(r5.y) + floatBitsToInt(r1.z));
/*289*/	  r1.z = floatBitsToInt(r1.z);
/*290*/	  r5.x = r3.x * r3.x + -r5.x;
/*291*/	  r5.x = sqrt(r5.x);
/*292*/	  r3.x = -r3.x + r5.x;
/*293*/	  r3.x = max(r3.x, 0.000000);
/*294*/	  r3.x = sqrt(r3.x);
/*295*/	  r1.z = r1.z * r3.x;
/*296*/	  r1.z = r1.z * 1.414214;
/*297*/	  r1.z = 0.008727 / r1.z;
/*298*/	  r1.z = max(r1.z, 0.000100);
/*299*/	  r5.xy = (r1.xxxx + vec4(-0.008727, 0.008727, 0.000000, 0.000000)).xy;
/*300*/	  r1.x = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.z)).x;
/*301*/	  r1.xz = (r1.xxxx * r5.xxyx).xz;
/*302*/	  r5.xy = (r1.xzxx * vec4(0.707107, 0.707107, 0.000000, 0.000000)).xy;
/*303*/	  r5.xy = (r5.xyxx * r5.xyxx).xy;
/*304*/	  r8.xyzw = r5.xxyy * vec4(0.140012, 0.140012, 0.140012, 0.140012) + vec4(1.273239, 1.000000, 1.273239, 1.000000);
/*305*/	  r5.zw = (r8.xxxz / r8.yyyw).zw;
/*306*/	  r5.xy = (r5.zwzz * -r5.xyxx).xy;
/*307*/	  r5.zw = (uintBitsToFloat(uvec4(lessThan(vec4(0.000000, 0.000000, 0.000000, 0.000000), r1.xxxz)) * 0xffffffffu)).zw;
/*308*/	  r1.x = uintBitsToFloat((r1.x < 0.000000) ? 0xffffffffu : 0x00000000u);
/*309*/	  r1.x = intBitsToFloat(1 + ~floatBitsToInt(r5.z) + floatBitsToInt(r1.x));
/*310*/	  r1.x = floatBitsToInt(r1.x);
/*311*/	  r5.xy = (r5.xyxx * vec4(1.442695, 1.442695, 0.000000, 0.000000)).xy;
/*312*/	  r5.xy = (exp2(r5.xyxx)).xy;
/*313*/	  r5.xy = (-r5.xyxx + vec4(1.000000, 1.000000, 0.000000, 0.000000)).xy;
/*314*/	  r5.xy = (sqrt(r5.xyxx)).xy;
/*315*/	  r1.x = r1.x * r5.x + 1.000000;
/*316*/	  r1.x = r1.x * 0.500000;
/*317*/	  r1.z = 1 + ~floatBitsToInt(r5.w);
/*318*/	  r1.z = r1.z * r5.y + 1.000000;
/*319*/	  r1.x = r1.z * 0.500000 + -r1.x;
/*320*/	  r1.z = min(r1.y, 1.000000);
/*321*/	  r2.w = r2.w * 1.570796;
/*322*/	  r2.w = sin(r2.w);
/*323*/	  r1.z = r1.z + -1.000000;
/*324*/	  r1.z = r2.w * r1.z + 1.000000;
/*325*/	  r2.w = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
/*326*/	  r2.w = max(r2.w, 0.000000);
/*327*/	  r2.w = log2(r2.w);
/*328*/	  r2.w = r2.w * 10.000000;
/*329*/	  r2.w = exp2(r2.w);
/*330*/	  r2.w = r6.w * r2.w;
/*331*/	  r2.w = r2.w * r7.x + r0.z;
/*332*/	  r1.x = r1.z * abs(r1.x);
/*333*/	  r3.xyz = (r2.wwww * r1.xxxx).xyz;
/*334*/	} else {
/*335*/	  r3.xyz = (vec4(0, 0, 0, 0)).xyz;
/*336*/	}
/*337*/	r5.xyz = saturate(r6.zzzz * r3.xyzx).xyz;
/*338*/	r2.xyz = (r2.xyzx * r5.xyzx).xyz;
/*339*/	r3.xyz = (max(r0.zzzz, r3.xyzx)).xyz;
/*340*/	r3.xyz = (-r3.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*341*/	r0.xyz = (r0.xywx * r1.yyyy).xyz;
/*342*/	r0.xyz = (r0.xyzx * cb1.data[1].xyzx).xyz;
/*343*/	r0.xyz = (r3.xyzx * r0.xyzx).xyz;
/*344*/	r0.xyz = (r6.xxxx * r0.xyzx).xyz;
/*345*/	r0.xyz = (r2.xyzx * cb1.data[1].xyzx + r0.xyzx).xyz;
/*346*/	r0.xyz = (r0.xyzx + r7.yzwy).xyz;
/*347*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*348*/	r2.w = 1.000000;
/*349*/	r1.x = dot(r2.xyzw, cb0.data[9].xyzw);
/*350*/	r1.y = dot(r2.xyzw, cb0.data[10].xyzw);
/*351*/	r0.w = dot(r2.xyzw, cb0.data[12].xyzw);
/*352*/	r1.xy = (r1.xyxx / r0.wwww).xy;
/*353*/	r2.xy = (uintBitsToFloat(uvec4(greaterThanEqual(r1.xyxx, cb0.data[34].xyxx)) * 0xffffffffu)).xy;
/*354*/	r1.xy = (uintBitsToFloat(uvec4(greaterThanEqual(cb0.data[34].zwzz, r1.xyxx)) * 0xffffffffu)).xy;
/*355*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.x) & floatBitsToUint(r2.x));
/*356*/	r0.w = uintBitsToFloat(floatBitsToUint(r2.y) & floatBitsToUint(r0.w));
/*357*/	r0.w = uintBitsToFloat(floatBitsToUint(r1.y) & floatBitsToUint(r0.w));
/*358*/	r0.w = uintBitsToFloat(~floatBitsToUint(r0.w));
/*359*/	if(r0.w != 0) discard;
/*360*/	r0.w = sqrt(r1.w);
/*361*/	r1.x = saturate(cb2.data[0].w)/**/;
/*362*/	r1.x = -r1.x + 1.000000;
/*363*/	r1.x = r1.x * 8.000000 + -4.000000;
/*364*/	r1.y = saturate(cb2.data[1].x)/**/;
/*365*/	r1.y = -r1.y + 1.000000;
/*366*/	r1.y = r1.y * 1000.000000;
/*367*/	r0.w = r0.w / r1.y;
/*368*/	r0.w = r0.w + r1.x;
/*369*/	r0.w = r0.w * 1.442695;
/*370*/	r0.w = exp2(r0.w);
/*371*/	r0.w = cb2.data[1].y / r0.w;
/*372*/	r0.w = saturate(-r0.w + cb2.data[1].y);
/*373*/	r1.x = -vsOut_T0.y + cb2.data[1].w;
/*374*/	r1.y = -cb2.data[1].z + cb2.data[1].w;
/*375*/	r1.x = r1.x + -cb2.data[1].z;
/*376*/	r1.y = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.y)).y;
/*377*/	r1.x = saturate(r1.y * r1.x);
/*378*/	r1.y = r1.x * -2.000000 + 3.000000;
/*379*/	r1.x = r1.x * r1.x;
/*380*/	r1.x = r1.x * r1.y;
/*381*/	r1.y = dot(vec2(r4.xzxx), vec2(r4.xzxx));
/*382*/	r1.y = sqrt(r1.y);
/*383*/	r1.z = max(cb2.data[2].z, 0.001000);
/*384*/	r1.z = (vec4(1.000000, 1.000000, 1.000000, 1.000000) / vec4(r1.z)).z;
/*385*/	r1.y = r1.z * r1.y;
/*386*/	r1.y = min(r1.y, 1.000000);
/*387*/	r1.z = r1.y * -2.000000 + 3.000000;
/*388*/	r1.y = r1.y * r1.y;
/*389*/	r1.y = r1.y * r1.z;
/*390*/	r0.w = cb2.data[2].x * r1.x + r0.w;
/*391*/	r1.xzw = (cb1.data[1].xxyz * cb2.data[0].xxyz).xzw;
/*392*/	r1.xzw = (r1.xxzw * vec4(1.500000, 0.000000, 1.500000, 1.500000)).xzw;
/*393*/	r1.xzw = (r1.xxzw * abs(cb1.data[0].zzzz)).xzw;
/*394*/	r2.xyz = (r6.xxxx * r1.xzwx).xyz;
/*395*/	r4.w = max(r4.y, 0.000000);
/*396*/	r3.xyzw = (texture(s_sky, r4.xwzx.stp)).xyzw;
/*397*/	r2.w = saturate(dot(vec2(r0.wwww), vec2(cb2.data[2].yyyy)));
/*398*/	r1.xzw = (-r1.xxzw * r6.xxxx + r3.xxyz).xzw;
/*399*/	r1.xzw = (r2.wwww * r1.xxzw + r2.xxyz).xzw;
/*400*/	r0.w = saturate(r0.w * r1.y);
/*401*/	r1.xyz = (-r0.xyzx + r1.xzwx).xyz;
/*402*/	color0.xyz = (r0.wwww * r1.xyzx + r0.xyzx).xyz;
/*403*/	return;
}
