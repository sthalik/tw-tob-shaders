...
// Fragment Shader
//
// id: 4747 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidstandardblood.hlsl_PS_ps30_alpha_overlay_40.glsl
//
...
/*39*/	r2.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx).xy;
...
/*79*/	r0.z = uintBitsToFloat((floatBitsToInt(cb3.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*92*/	  r0.z = uintBitsToFloat((0.000000 < cb3.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*115*/	    r2.w = saturate(cb3.data[1].x * cb3.data[1].x + -0.800000);
...
/*221*/	  r1.x = dot(vec3(-cb1.data[0].yzwy), vec3(r5.yzwy));
...
/*283*/	  r2.w = dot(vec3(-cb1.data[0].yzwy), vec3(r3.yzwy));
