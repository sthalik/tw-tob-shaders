...
// Fragment Shader
//
// id: 748 - fxc/glsl_SM_3_0_rigidstandardblood.hlsl_PS_ps30_gbuffer_shroud.glsl
//
...
/*52*/	r2.yz = (vsOut_T1.xxyx * cb3.data[2].xxyx).yz;
...
/*92*/	r0.w = uintBitsToFloat((floatBitsToInt(cb2.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*105*/	  r0.w = uintBitsToFloat((0.000000 < cb2.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*125*/	    r3.w = cb2.data[1].x * cb2.data[1].x;
/*126*/	    r3.w = r3.w * 1.250000;
/*127*/	    r3.w = min(r3.w, 1.000000);
/*128*/	    r5.w = saturate(cb2.data[1].x * cb2.data[1].x + -0.800000);
...
/*152*/	    r3.w = dot(vec2(cb2.data[0].xyxx), vec2(cb2.data[0].xyxx));
/*153*/	    r3.w = sqrt(r3.w);
...
/*168*/	  }
/*169*/	}
/*170*/	r0.w = uintBitsToFloat((0.500000 < cb1.data[0].x) ? 0xffffffffu : 0x00000000u);
/*171*/	if(floatBitsToUint(r0.w) != 0u) {
/*172*/	  r5.xyzw = vsOut_T0.xzxz + -cb1.data[1].xyxy;
/*173*/	  r6.xyzw = -cb1.data[1].xyxy + cb1.data[1].zwzw;
/*174*/	  r5.xyzw = r5.xyzw / r6.xyzw;
/*175*/	  r6.xyzw = -cb1.data[4].xyxy * vec4(2.000000, 2.000000, 2.000000, 2.000000) + vec4(1.000000, 1.000000, 1.000000, 1.000000);
/*176*/	  r5.xyzw = r5.xyzw * r6.xyzw + cb1.data[4].xyxy;
/*177*/	  r6.xyzw = (textureLod(s_shroud, r5.zwzz.st, r5.w)).xyzw;
/*178*/	  r5.xyzw = r5.xyzw + vec4(0.010000, 0.010000, -1.000000, -1.000000);
/*179*/	  r5.xyzw = saturate(r5.xyzw * vec4(100.000000, 100.000000, 100.000099, 100.000099));
/*180*/	  r7.xyzw = r5.xyzw * vec4(-2.000000, -2.000000, -2.000000, -2.000000) + vec4(3.000000, 3.000000, 3.000000, 3.000000);
/*181*/	  r5.xyzw = r5.xyzw * r5.xyzw;
/*182*/	  r5.xyzw = r5.xyzw * r7.xyzw;
/*183*/	  r0.w = r6.x * r5.x;
/*184*/	  r0.w = r0.w * r5.y;
/*185*/	  r0.w = r5.z * -r0.w + r0.w;
/*186*/	  r0.w = r5.w * -r0.w + r0.w;
/*187*/	} else {
/*188*/	  r0.w = 1.000000;
/*189*/	}
/*190*/	r2.yz = (r0.wwww + vec4(0.000000, -0.100000, -0.500000, 0.000000)).yz;
/*191*/	r0.w = saturate(r2.y * 2.500000);
/*192*/	r2.y = r0.w * -2.000000 + 3.000000;
/*193*/	r0.w = r0.w * r0.w;
/*194*/	r0.w = r0.w * r2.y;
/*195*/	r2.y = saturate(r2.z + r2.z);
/*196*/	r2.z = r2.y * -2.000000 + 3.000000;
/*197*/	r2.y = r2.y * r2.y;
/*198*/	r2.y = r2.y * r2.z;
/*199*/	r0.w = r0.w * 0.200000;
/*200*/	r5.xyz = saturate(r0.wwww * r0.xyzx).xyz;
/*201*/	r0.xyz = (r0.xyzx + -r5.xyzx).xyz;
/*202*/	r0.xyz = (r2.yyyy * r0.xyzx + r5.xyzx).xyz;
/*203*/	r0.w = vsOut_T7.y * -r4.x + r4.x;
/*204*/	r2.yzw = (r0.xxyz * vec4(0.000000, 5.000000, 5.000000, 5.000000) + vec4(0.000000, 0.200000, 0.200000, 0.200000)).yzw;
/*205*/	r2.yzw = (-r0.xxyz + r2.yyzw).yzw;
/*206*/	r0.xyz = saturate(vsOut_T7.yyyy * r2.yzwy + r0.xyzx).xyz;
/*207*/	r2.y = dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*208*/	r2.yzw = (-r0.xxyz + r2.yyyy).yzw;
/*209*/	r0.xyz = (vsOut_T7.zzzz * r2.yzwy + r0.xyzx).xyz;
/*210*/	r2.y = dot(vec3(r3.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*211*/	r2.yzw = (-r3.xxyz + r2.yyyy).yzw;
/*212*/	r3.xyz = (vsOut_T7.zzzz * r2.yzwy + r3.xyzx).xyz;
/*213*/	color1.w = saturate(vsOut_T7.z * -r0.w + r0.w);
/*214*/	r0.w = uintBitsToFloat((cb3.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*215*/	r2.y = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*216*/	r2.y = inversesqrt(r2.y);
/*217*/	r1.xyz = (r1.xyzx * r2.yyyy).xyz;
/*218*/	color3.x = r1.w / r2.x;
/*219*/	r1.w = max(abs(r1.z), abs(r1.y));
/*220*/	r1.w = max(r1.w, abs(r1.x));
/*221*/	r1.xyz = (r1.xyzx / r1.wwww).xyz;
/*222*/	r4.xyz = (r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*223*/	color0.xyzw = saturate(r4.xyzw);
/*224*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*225*/	r3.w = uintBitsToFloat(floatBitsToUint(r0.w) & uint(0x3c008081u));
/*226*/	color2.xyzw = saturate(r3.xyzw);
/*227*/	color3.yzw = (vec4(0, 0, 0, 0)).yzw;
/*228*/	color4 = vsOut_P1;
/*229*/	return;
}
