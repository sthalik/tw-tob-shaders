...
// Fragment Shader
//
// id: 6361 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdirtblood.hlsl_PS_ps40_skin_forward_lighting_no_faction_colour_HDR.glsl
//
...
/*71*/	r5.w = 1.000000;
/*72*/	r2.y = dot(r5.xyzw, cb0.data[12].xyzw);
/*73*/	r6.xyz = (-cb1.data[35].xyzx * cb1.data[34].zzzz + vsOut_T0.xyzx).xyz;
/*74*/	r7.x = uintBitsToFloat((r2.y >= cb1.data[37].x) ? 0xffffffffu : 0x00000000u);
/*75*/	r7.y = uintBitsToFloat((r2.y >= cb1.data[38].x) ? 0xffffffffu : 0x00000000u);
/*76*/	r7.z = uintBitsToFloat((r2.y >= cb1.data[39].x) ? 0xffffffffu : 0x00000000u);
/*77*/	r7.w = uintBitsToFloat((r2.y >= cb1.data[40].x) ? 0xffffffffu : 0x00000000u);
...
/*272*/	r2.x = r1.w + r1.w;
/*273*/	r3.xyz = (r3.xyzx * -r2.xxxx + -r6.xyzx).xyz;
