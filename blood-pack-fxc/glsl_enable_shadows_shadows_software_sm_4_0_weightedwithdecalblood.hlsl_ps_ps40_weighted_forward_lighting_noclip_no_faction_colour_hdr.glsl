...
// Fragment Shader
//
// id: 6948 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdecalblood.hlsl_PS_ps40_weighted_forward_lighting_noclip_no_faction_colour_HDR.glsl
//
...
/*42*/	r3.zw = (r3.zzzw * cb3.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*89*/	r4.w = 1.000000;
/*90*/	r1.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*91*/	r5.xyz = (-cb1.data[35].xyzx * cb1.data[34].zzzz + vsOut_T0.xyzx).xyz;
/*92*/	r6.x = uintBitsToFloat((r1.w >= cb1.data[37].x) ? 0xffffffffu : 0x00000000u);
/*93*/	r6.y = uintBitsToFloat((r1.w >= cb1.data[38].x) ? 0xffffffffu : 0x00000000u);
/*94*/	r6.z = uintBitsToFloat((r1.w >= cb1.data[39].x) ? 0xffffffffu : 0x00000000u);
/*95*/	r6.w = uintBitsToFloat((r1.w >= cb1.data[40].x) ? 0xffffffffu : 0x00000000u);
...
/*108*/	  r7.xy = (uintBitsToFloat(uvec4(lessThan(r6.xyxx, cb1.data[floatBitsToUint(r3.x)+41u].xyxx)) * 0xffffffffu)).xy;
/*109*/	  r3.w = uintBitsToFloat(floatBitsToUint(r7.y) | floatBitsToUint(r7.x));
/*110*/	  r7.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r3.x)+41u].zwzz, r6.xyxx)) * 0xffffffffu)).xy;
...
/*152*/	  r2.w = intBitsToFloat(floatBitsToInt(r3.x) + int(1));
...
/*156*/	    r2.w = intBitsToFloat(floatBitsToInt(r3.x) << int(2));
/*157*/	    r5.w = vsOut_T0.w;
...
/*163*/	    r6.xy = (uintBitsToFloat(uvec4(lessThan(r5.xyxx, cb1.data[floatBitsToUint(r3.x)+42u].xyxx)) * 0xffffffffu)).xy;
/*164*/	    r5.w = uintBitsToFloat(floatBitsToUint(r6.y) | floatBitsToUint(r6.x));
/*165*/	    r6.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r3.x)+42u].zwzz, r5.xyxx)) * 0xffffffffu)).xy;
...
/*201*/	    r2.w = 1.000000;
/*202*/	  }
/*203*/	  r5.x = -cb1.data[floatBitsToUint(r3.x)+36u].x + cb1.data[floatBitsToUint(r3.x)+37u].x;
/*204*/	  r5.y = r5.x * cb1.data[34].x;
/*205*/	  r5.x = -r5.x * cb1.data[34].x + cb1.data[floatBitsToUint(r3.x)+37u].x;
/*206*/	  r5.x = r1.w + -r5.x;
...
/*212*/	  r2.w = -cb1.data[floatBitsToUint(r3.x)+36u].x + cb1.data[floatBitsToUint(r3.x)+37u].x;
/*213*/	  r3.w = r2.w * cb1.data[34].y;
/*214*/	  r2.w = -r2.w * cb1.data[34].y + cb1.data[floatBitsToUint(r3.x)+37u].x;
/*215*/	  r2.w = r1.w + -r2.w;
/*216*/	  r2.w = saturate(r2.w / r3.w);
/*217*/	  r3.x = -r3.z + 1.000000;
/*218*/	  r3.z = r2.w * r3.x + r3.z;
/*219*/	}
...
/*225*/	r2.w = -r3.y + 1.000000;
/*226*/	r3.x = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*227*/	r3.w = dot(vec3(r5.xyzx), vec3(r2.xyzx));
/*228*/	r3.w = r3.w + r3.w;
/*229*/	r6.xyz = (r2.xyzx * -r3.wwww + r5.xyzx).xyz;
/*230*/	r7.xyz = (mix(vec4(1.000000, 1.000000, 273.000000, 0), vec4(0.004000, 360.000000, 1.000000, 0), greaterThan(floatBitsToUint(r3.xxxx), uvec4(0)))).xyz;
...
/*284*/	  r3.y = r3.y * r3.y;
/*285*/	    r3.x = (floatBitsToUint(r3.x) > 0x00000000u) ? 0.995900 : -0.000100;
/*286*/	  r3.x = r3.y * r3.x + r7.x;
...
/*347*/	r5.xyz = (max(r0.wwww, r5.xyzx)).xyz;
...
/*367*/	r2.x = exp2(r2.x);
/*368*/	r2.x = r3.w * r2.x;
/*369*/	r0.w = r2.x * r5.w + r0.w;
/*370*/	r2.xyz = (r6.xyzx * r0.wwww).xyz;
