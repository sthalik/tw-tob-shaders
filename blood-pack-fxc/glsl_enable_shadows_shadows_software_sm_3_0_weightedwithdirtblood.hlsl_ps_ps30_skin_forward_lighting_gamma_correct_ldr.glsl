...
// Fragment Shader
//
// id: 6349 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdirtblood.hlsl_PS_ps30_skin_forward_lighting_gamma_correct_LDR.glsl
//
...
/*19*/	r1.zw = (vsOut_T1.xxxy * cb5.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*32*/	r2.xy = (r2.xyxx * cb5.data[2].xyxx + vsOut_T6.xyxx).xy;
...
/*81*/	r5.w = 1.000000;
/*82*/	r2.y = dot(r5.xyzw, cb1.data[12].xyzw);
/*83*/	r6.xyz = (-cb2.data[35].xyzx * cb2.data[34].zzzz + vsOut_T0.xyzx).xyz;
/*84*/	r7.x = uintBitsToFloat((r2.y >= cb2.data[37].x) ? 0xffffffffu : 0x00000000u);
/*85*/	r7.y = uintBitsToFloat((r2.y >= cb2.data[38].x) ? 0xffffffffu : 0x00000000u);
/*86*/	r7.z = uintBitsToFloat((r2.y >= cb2.data[39].x) ? 0xffffffffu : 0x00000000u);
/*87*/	r7.w = uintBitsToFloat((r2.y >= cb2.data[40].x) ? 0xffffffffu : 0x00000000u);
...
/*282*/	r2.x = r1.w + r1.w;
/*283*/	r3.xyz = (r3.xyzx * -r2.xxxx + -r7.xyzx).xyz;
