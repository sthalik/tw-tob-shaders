...
// Fragment Shader
//
// id: 2143 - fxc/glsl_SM_3_0_weightedwithblood.hlsl_PS_ps30_skin_forward_lighting_gamma_correct_LDR.glsl
//
...
/*21*/	r1.zw = (r1.zzzw * cb4.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*70*/	r2.y = dot(vec3(r5.xyzx), vec3(r5.xyzx));
/*71*/	r2.z = inversesqrt(r2.y);
...
/*137*/	r2.x = r1.w + r1.w;
/*138*/	r3.xyz = (r3.xyzx * -r2.xxxx + -r6.xyzx).xyz;
/*139*/	r3.xyz = (r3.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*140*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*141*/	r2.x = inversesqrt(r2.x);
/*142*/	r3.xyz = (r2.xxxx * r3.xyzx).xyz;
