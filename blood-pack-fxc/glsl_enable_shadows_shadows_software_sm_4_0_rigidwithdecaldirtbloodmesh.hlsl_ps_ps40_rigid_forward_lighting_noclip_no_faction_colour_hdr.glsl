...
// Fragment Shader
//
// id: 5027 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdecaldirtbloodmesh.hlsl_PS_ps40_rigid_forward_lighting_noclip_no_faction_colour_HDR.glsl
//
...
/*52*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy).zw;
/*53*/	r5.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx + vsOut_T6.yzyy).xy;
/*54*/	r6.xyzw = (texture(s_decal_dirt_map, r5.xyxx.st)).xyzw;
/*55*/	r5.xy = (r6.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*56*/	r2.w = r5.w * r6.w;
/*57*/	r6.xyz = (-r1.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*58*/	r1.xyz = (r2.wwww * r6.xyzx + r1.xyzx).xyz;
/*59*/	r0.xy = (r5.xyxx * r5.wwww + r0.xyxx).xy;
/*60*/	r5.x = dot(vec3(r0.xywx), vec3(r0.xywx));
/*61*/	r5.x = inversesqrt(r5.x);
/*62*/	r0.xyw = (r0.xyxw * r5.xxxx).xyw;
/*63*/	r3.zw = (r3.zzzw * vec4(0.000000, 0.000000, 0.750000, 0.750000) + vsOut_T6.yyyz).zw;
/*64*/	r5.xyzw = (texture(s_decal_blood_map, r3.zwzz.st)).xyzw;
/*65*/	r3.z = -vsOut_T7.w * 0.900000 + 1.000000;
/*66*/	r3.z = saturate(-r3.z + r5.w);
/*67*/	r3.z = uintBitsToFloat((0.000000 < r3.z) ? 0xffffffffu : 0x00000000u);
/*68*/	if(floatBitsToUint(r3.z) != 0u) {
/*69*/	  r3.z = -r5.w + 1.000000;
/*70*/	  r3.z = saturate(vsOut_T7.w * 0.900000 + -r3.z);
/*71*/	  r3.z = -r3.z + 1.000000;
/*72*/	  r3.z = -r3.z * r3.z + 1.000000;
/*73*/	  r3.z = r3.z * -0.600000 + 1.000000;
/*74*/	  r5.xyz = (r3.zzzz * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*75*/	  r3.z = saturate(dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*76*/	  r3.z = uintBitsToFloat((r3.z < 0.225000) ? 0xffffffffu : 0x00000000u);
/*77*/	  r3.z = uintBitsToFloat(floatBitsToUint(r3.z) & uint(0x3f800000u));
/*78*/	  r6.xyz = (r1.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r5.xzzx).xyz;
/*79*/	  r1.xyz = (r3.zzzz * r6.xyzx + r5.xyzx).xyz;
/*80*/	  r5.xyz = (vec4(1.000000, 0.800000, 0.800000, 0)).xyz;
/*81*/	  r3.xy = (vec4(0.800000, 0.020000, 0, 0)).xy;
/*82*/	} else {
/*83*/	  r6.xyz = (r2.wwww * r2.xyzx).xyz;
/*84*/	  r5.xyz = (r6.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r2.xyzx).xyz;
/*85*/	}
/*86*/	r2.x = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*87*/	r2.x = inversesqrt(r2.x);
/*88*/	r2.xyz = (r2.xxxx * vsOut_T3.xyzx).xyz;
...
/*95*/	r8.xyz = (r0.yyyy * r6.xyzx).xyz;
/*96*/	r8.xyz = (r0.xxxx * r2.xyzx + r8.xyzx).xyz;
/*97*/	r8.xyz = (r0.wwww * r7.xyzx + r8.xyzx).xyz;
/*98*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*99*/	r2.w = inversesqrt(r2.w);
/*100*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*101*/	r0.xyz = (mix(r8.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
/*102*/	r0.w = uintBitsToFloat((floatBitsToInt(cb3.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
...
/*106*/	  r0.w = r3.w * cb0.data[26].x;
/*107*/	  r8.xy = (r0.wwww * vec4(-0.700000, 0.660000, 0.000000, 0.000000)).xy;
/*108*/	  r3.zw = (vsOut_T1.xxxy * r3.zzzz + r8.xxxy).zw;
/*109*/	  r8.xyzw = (texture(s_fire_map, r3.zwzz.st)).xyzw;
/*110*/	  r5.xyz = (r8.xxxx * vec4(0.600000, 0.600000, 0.600000, 0.000000) + r5.xyzx).xyz;
...
/*115*/	  r0.w = uintBitsToFloat((0.000000 < cb3.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*121*/	    r0.w = dot(vec2(r9.xyxx), vec2(r9.xyxx));
/*122*/	    r0.w = -r0.w + 1.000000;
/*123*/	    r0.w = max(r0.w, 0.000000);
/*124*/	    r9.z = sqrt(r0.w);
/*125*/	    r10.xyz = (r9.xzyx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r0.xyzx).xyz;
...
/*130*/	    r11.y = -1.000000;
/*131*/	    r0.w = dot(vec3(r11.xyzx), vec3(r11.xyzx));
/*132*/	    r0.w = inversesqrt(r0.w);
/*133*/	    r11.xyz = (r0.wwww * r11.xyzx).xyz;
/*134*/	    r0.w = saturate(dot(vec3(-r11.xyzx), vec3(r10.xyzx)));
...
/*144*/	    r2.w = r0.w * -2.000000 + 3.000000;
/*145*/	    r0.w = r0.w * r0.w;
/*146*/	    r0.w = r0.w * r2.w;
/*147*/	    r3.x = r0.w * -r3.x + r3.x;
/*148*/	    r2.w = -r3.y + 0.200000;
/*149*/	    r3.y = r0.w * r2.w + r3.y;
/*150*/	    r10.xyz = (-r1.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*151*/	    r1.xyz = (r0.wwww * r10.xyzx + r1.xyzx).xyz;
/*152*/	    r10.xyz = (-r5.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*153*/	    r5.xyz = (r0.wwww * r10.xyzx + r5.xyzx).xyz;
...
/*169*/	    r2.xyz = (r8.xxxx * r2.xyzx + r6.xyzx).xyz;
/*170*/	    r2.xyz = (r8.zzzz * r7.xyzx + r2.xyzx).xyz;
/*171*/	    r2.w = -r0.y + 1.000000;
/*172*/	    r0.w = min(r0.w, r2.w);
...
/*184*/	r2.x = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*185*/	r2.xyz = (-r1.xyzx + r2.xxxx).xyz;
/*186*/	r1.xyz = (vsOut_T7.zzzz * r2.xyzx + r1.xyzx).xyz;
/*187*/	r2.x = dot(vec3(r5.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*188*/	r2.xyz = (-r5.xyzx + r2.xxxx).xyz;
/*189*/	r2.xyz = (vsOut_T7.zzzz * r2.xyzx + r5.xyzx).xyz;
/*190*/	r0.w = vsOut_T7.z * -r0.w + r0.w;
/*191*/	r2.w = dot(vec3(r0.xyzx), vec3(r0.xyzx));
/*192*/	r2.w = inversesqrt(r2.w);
/*193*/	r0.xyz = (r0.xyzx * r2.wwww).xyz;
...
/*211*/	  r7.xy = (uintBitsToFloat(uvec4(lessThan(r6.xyxx, cb1.data[floatBitsToUint(r3.y)+41u].xyxx)) * 0xffffffffu)).xy;
/*212*/	  r3.w = uintBitsToFloat(floatBitsToUint(r7.y) | floatBitsToUint(r7.x));
/*213*/	  r7.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r3.y)+41u].zwzz, r6.xyxx)) * 0xffffffffu)).xy;
...
/*255*/	  r2.w = intBitsToFloat(floatBitsToInt(r3.y) + int(1));
...
/*259*/	    r2.w = intBitsToFloat(floatBitsToInt(r3.y) << int(2));
/*260*/	    r5.w = vsOut_T0.w;
...
/*266*/	    r6.xy = (uintBitsToFloat(uvec4(lessThan(r5.xyxx, cb1.data[floatBitsToUint(r3.y)+42u].xyxx)) * 0xffffffffu)).xy;
/*267*/	    r5.w = uintBitsToFloat(floatBitsToUint(r6.y) | floatBitsToUint(r6.x));
/*268*/	    r6.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r3.y)+42u].zwzz, r5.xyxx)) * 0xffffffffu)).xy;
...
/*304*/	    r2.w = 1.000000;
/*305*/	  }
/*306*/	  r5.x = -cb1.data[floatBitsToUint(r3.y)+36u].x + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*307*/	  r5.y = r5.x * cb1.data[34].x;
/*308*/	  r5.x = -r5.x * cb1.data[34].x + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*309*/	  r5.x = r1.w + -r5.x;
...
/*315*/	  r2.w = -cb1.data[floatBitsToUint(r3.y)+36u].x + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*316*/	  r3.w = r2.w * cb1.data[34].y;
/*317*/	  r2.w = -r2.w * cb1.data[34].y + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*318*/	  r2.w = r1.w + -r2.w;
/*319*/	  r2.w = saturate(r2.w / r3.w);
/*320*/	  r3.y = -r3.z + 1.000000;
/*321*/	  r3.z = r2.w * r3.y + r3.z;
/*322*/	}
...
/*328*/	r2.w = -r3.x + 1.000000;
/*329*/	r3.y = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*330*/	r3.w = dot(vec3(r5.xyzx), vec3(r0.xyzx));
/*331*/	r3.w = r3.w + r3.w;
/*332*/	r6.xyz = (r0.xyzx * -r3.wwww + r5.xyzx).xyz;
/*333*/	r7.xyz = (mix(vec4(1.000000, 1.000000, 273.000000, 0), vec4(0.004000, 360.000000, 1.000000, 0), greaterThan(floatBitsToUint(r3.yyyy), uvec4(0)))).xyz;
...
/*338*/	r5.w = saturate(r0.w * 60.000000);
/*339*/	r5.w = -r0.w + r5.w;
/*340*/	r8.xzw = (r0.xxyz * vec4(1.000000, 0.000000, 4.000000, 1.000000)).xzw;
...
/*353*/	r8.xzw = (r1.xxyz * r8.xxzw).xzw;
/*354*/	r6.w = -r0.w + 1.000000;
...
/*369*/	}
/*370*/	r6.w = dot(vec3(r0.xyzx), vec3(-cb2.data[0].yzwy));
...
/*387*/	  r3.x = r3.x * r3.x;
/*388*/	    r3.y = (floatBitsToUint(r3.y) > 0x00000000u) ? 0.995900 : -0.000100;
/*389*/	  r3.x = r3.x * r3.y + r7.x;
...
/*450*/	r5.xyz = (max(r0.wwww, r5.xyzx)).xyz;
/*451*/	r5.xyz = (-r5.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*452*/	r1.xyz = (r1.xyzx * r7.yyyy).xyz;
/*453*/	r1.xyz = (r1.xyzx * cb2.data[1].xyzx).xyz;
/*454*/	r1.xyz = (r5.xyzx * r1.xyzx).xyz;
/*455*/	r1.xyz = (r7.xxxx * r1.xyzx).xyz;
/*456*/	r1.xyz = (r6.xyzx * cb2.data[1].xyzx + r1.xyzx).xyz;
/*457*/	r1.xyz = (r3.zzzz * r1.xyzx + r8.xzwx).xyz;
...
/*462*/	r2.w = dot(vec3(-r3.xyzx), vec3(r0.xyzx));
/*463*/	r2.w = r2.w + r2.w;
/*464*/	r0.xyz = (r0.xyzx * -r2.wwww + -r3.xyzx).xyz;
/*465*/	r6.xyzw = (textureLod(s_environment, r0.xyzx.stp, r8.y)).xyzw;
/*466*/	r0.x = dot(vec3(r0.xyzx), vec3(-r3.xyzx));
/*467*/	r0.x = max(r0.x, 0.000000);
/*468*/	r0.x = log2(r0.x);
/*469*/	r0.x = r0.x * 10.000000;
/*470*/	r0.x = exp2(r0.x);
/*471*/	r0.x = r3.w * r0.x;
/*472*/	r0.x = r0.x * r5.w + r0.w;
/*473*/	r0.xyz = (r6.xyzx * r0.xxxx).xyz;
/*474*/	color0.xyz = (r0.xyzx * r2.xyzx + r1.xyzx).xyz;
