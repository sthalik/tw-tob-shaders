...
// Fragment Shader
//
// id: 5025 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_rigidwithdecaldirtbloodmesh.hlsl_PS_ps40_rigid_forward_lighting_no_faction_colour_HDR.glsl
//
...
/*56*/	r3.zw = (vsOut_T1.xxxy * cb4.data[2].xxxy).zw;
/*57*/	r5.xy = (vsOut_T1.xyxx * cb4.data[2].xyxx + vsOut_T6.yzyy).xy;
/*58*/	r6.xyzw = (texture(s_decal_dirt_map, r5.xyxx.st)).xyzw;
/*59*/	r5.xy = (r6.xyxx * vec4(2.000000, 2.000000, 0.000000, 0.000000) + vec4(-1.000000, -1.000000, 0.000000, 0.000000)).xy;
/*60*/	r2.w = r5.w * r6.w;
/*61*/	r6.xyz = (-r1.xyzx + vec4(0.030000, 0.025000, 0.020000, 0.000000)).xyz;
/*62*/	r1.xyz = (r2.wwww * r6.xyzx + r1.xyzx).xyz;
/*63*/	r0.xy = (r5.xyxx * r5.wwww + r0.xyxx).xy;
/*64*/	r5.x = dot(vec3(r0.xywx), vec3(r0.xywx));
/*65*/	r5.x = inversesqrt(r5.x);
/*66*/	r0.xyw = (r0.xyxw * r5.xxxx).xyw;
/*67*/	r3.zw = (r3.zzzw * vec4(0.000000, 0.000000, 0.750000, 0.750000) + vsOut_T6.yyyz).zw;
/*68*/	r5.xyzw = (texture(s_decal_blood_map, r3.zwzz.st)).xyzw;
/*69*/	r3.z = -vsOut_T7.w * 0.900000 + 1.000000;
/*70*/	r3.z = saturate(-r3.z + r5.w);
/*71*/	r3.z = uintBitsToFloat((0.000000 < r3.z) ? 0xffffffffu : 0x00000000u);
/*72*/	if(floatBitsToUint(r3.z) != 0u) {
/*73*/	  r3.z = -r5.w + 1.000000;
/*74*/	  r3.z = saturate(vsOut_T7.w * 0.900000 + -r3.z);
/*75*/	  r3.z = -r3.z + 1.000000;
/*76*/	  r3.z = -r3.z * r3.z + 1.000000;
/*77*/	  r3.z = r3.z * -0.600000 + 1.000000;
/*78*/	  r5.xyz = (r3.zzzz * vec4(0.240000, 0.000000, 0.000000, 0.000000)).xyz;
/*79*/	  r3.z = saturate(dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
/*80*/	  r3.z = uintBitsToFloat((r3.z < 0.225000) ? 0xffffffffu : 0x00000000u);
/*81*/	  r3.z = uintBitsToFloat(floatBitsToUint(r3.z) & uint(0x3f800000u));
/*82*/	  r6.xyz = (r1.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r5.xzzx).xyz;
/*83*/	  r1.xyz = (r3.zzzz * r6.xyzx + r5.xyzx).xyz;
/*84*/	  r5.xyz = (vec4(1.000000, 0.800000, 0.800000, 0)).xyz;
/*85*/	  r3.xy = (vec4(0.800000, 0.020000, 0, 0)).xy;
/*86*/	} else {
/*87*/	  r6.xyz = (r2.wwww * r2.xyzx).xyz;
/*88*/	  r5.xyz = (r6.xyzx * vec4(-0.990000, -0.990000, -0.990000, 0.000000) + r2.xyzx).xyz;
/*89*/	}
/*90*/	r2.x = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*91*/	r2.x = inversesqrt(r2.x);
/*92*/	r2.xyz = (r2.xxxx * vsOut_T3.xyzx).xyz;
...
/*99*/	r8.xyz = (r0.yyyy * r6.xyzx).xyz;
/*100*/	r8.xyz = (r0.xxxx * r2.xyzx + r8.xyzx).xyz;
/*101*/	r8.xyz = (r0.wwww * r7.xyzx + r8.xyzx).xyz;
/*102*/	r2.w = dot(vec3(r8.xyzx), vec3(r8.xyzx));
/*103*/	r2.w = inversesqrt(r2.w);
/*104*/	r8.xyz = (r2.wwww * r8.xyzx).xyz;
/*105*/	r0.xyz = (mix(r8.xyzx, r0.xywx, greaterThan(floatBitsToUint(r0.zzzz), uvec4(0)))).xyz;
/*106*/	r0.w = uintBitsToFloat((floatBitsToInt(cb3.data[1].y) == int(1)) ? 0xffffffffu : 0x00000000u) /**/;
/*107*/	if(floatBitsToUint(r0.w) != 0u) {
/*108*/	  r0.w = uintBitsToFloat((0.990000 < r0.y) ? 0xffffffffu : 0x00000000u);
/*109*/	  r3.zw = (mix(vec4(0, 0, 2.500000, -0.100000), vec4(0, 0, 50.000000, -0.700000), greaterThan(floatBitsToUint(r0.wwww), uvec4(0)))).zw;
/*110*/	  r0.w = r3.w * cb0.data[26].x;
/*111*/	  r8.xy = (r0.wwww * vec4(-0.700000, 0.660000, 0.000000, 0.000000)).xy;
/*112*/	  r3.zw = (vsOut_T1.xxxy * r3.zzzz + r8.xxxy).zw;
/*113*/	  r8.xyzw = (texture(s_fire_map, r3.zwzz.st)).xyzw;
/*114*/	  r5.xyz = (r8.xxxx * vec4(0.600000, 0.600000, 0.600000, 0.000000) + r5.xyzx).xyz;
/*115*/	  r3.xy = (r3.xyxx + vec4(0.300000, 0.200000, 0.000000, 0.000000)).xy;
/*116*/	}
/*117*/	r0.w = uintBitsToFloat((0.000000 < vsOut_T6.w) ? 0xffffffffu : 0x00000000u);
/*118*/	if(floatBitsToUint(r0.w) != 0u) {
/*119*/	  r0.w = uintBitsToFloat((0.000000 < cb3.data[1].x) ? 0xffffffffu : 0x00000000u);
...
/*125*/	    r0.w = dot(vec2(r9.xyxx), vec2(r9.xyxx));
/*126*/	    r0.w = -r0.w + 1.000000;
/*127*/	    r0.w = max(r0.w, 0.000000);
/*128*/	    r9.z = sqrt(r0.w);
/*129*/	    r10.xyz = (r9.xzyx * vec4(0.100000, 0.100000, 0.100000, 0.000000) + r0.xyzx).xyz;
...
/*134*/	    r11.y = -1.000000;
/*135*/	    r0.w = dot(vec3(r11.xyzx), vec3(r11.xyzx));
/*136*/	    r0.w = inversesqrt(r0.w);
/*137*/	    r11.xyz = (r0.wwww * r11.xyzx).xyz;
/*138*/	    r0.w = saturate(dot(vec3(-r11.xyzx), vec3(r10.xyzx)));
...
/*146*/	    r0.w = r0.w + -r2.w;
/*147*/	    r0.w = saturate(r0.w * 200.000000);
/*148*/	    r2.w = r0.w * -2.000000 + 3.000000;
/*149*/	    r0.w = r0.w * r0.w;
/*150*/	    r0.w = r0.w * r2.w;
/*151*/	    r3.x = r0.w * -r3.x + r3.x;
/*152*/	    r2.w = -r3.y + 0.200000;
/*153*/	    r3.y = r0.w * r2.w + r3.y;
/*154*/	    r10.xyz = (-r1.xyzx + vec4(0.400000, 0.400000, 0.400000, 0.000000)).xyz;
/*155*/	    r1.xyz = (r0.wwww * r10.xyzx + r1.xyzx).xyz;
/*156*/	    r10.xyz = (-r5.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*157*/	    r5.xyz = (r0.wwww * r10.xyzx + r5.xyzx).xyz;
...
/*173*/	    r2.xyz = (r8.xxxx * r2.xyzx + r6.xyzx).xyz;
/*174*/	    r2.xyz = (r8.zzzz * r7.xyzx + r2.xyzx).xyz;
/*175*/	    r2.w = -r0.y + 1.000000;
/*176*/	    r0.w = min(r0.w, r2.w);
/*177*/	    r2.xyz = (-r0.xyzx + r2.xyzx).xyz;
/*178*/	    r2.xyz = (r0.wwww * r2.xyzx + r0.xyzx).xyz;
/*179*/	    r0.w = dot(vec3(r2.xyzx), vec3(r2.xyzx));
/*180*/	    r0.w = inversesqrt(r0.w);
/*181*/	    r0.xyz = (r0.wwww * r2.xyzx).xyz;
/*182*/	  }
/*183*/	}
/*184*/	r0.w = vsOut_T7.y * -r3.y + r3.y;
/*185*/	r2.xyz = (r1.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*186*/	r2.xyz = (-r1.xyzx + r2.xyzx).xyz;
/*187*/	r1.xyz = saturate(vsOut_T7.yyyy * r2.xyzx + r1.xyzx).xyz;
/*188*/	r2.x = dot(vec3(r1.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*189*/	r2.xyz = (-r1.xyzx + r2.xxxx).xyz;
/*190*/	r1.xyz = (vsOut_T7.zzzz * r2.xyzx + r1.xyzx).xyz;
/*191*/	r2.x = dot(vec3(r5.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*192*/	r2.xyz = (-r5.xyzx + r2.xxxx).xyz;
/*193*/	r2.xyz = (vsOut_T7.zzzz * r2.xyzx + r5.xyzx).xyz;
/*194*/	r0.w = vsOut_T7.z * -r0.w + r0.w;
/*195*/	r2.w = dot(vec3(r0.xyzx), vec3(r0.xyzx));
/*196*/	r2.w = inversesqrt(r2.w);
/*197*/	r0.xyz = (r0.xyzx * r2.wwww).xyz;
...
/*334*/	r3.w = dot(vec3(r5.xyzx), vec3(r0.xyzx));
/*335*/	r3.w = r3.w + r3.w;
/*336*/	r6.xyz = (r0.xyzx * -r3.wwww + r5.xyzx).xyz;
...
/*342*/	r5.w = saturate(r0.w * 60.000000);
/*343*/	r5.w = -r0.w + r5.w;
/*344*/	r8.xzw = (r0.xxyz * vec4(1.000000, 0.000000, 4.000000, 1.000000)).xzw;
...
/*357*/	r8.xzw = (r1.xxyz * r8.xxzw).xzw;
/*358*/	r6.w = -r0.w + 1.000000;
...
/*373*/	}
/*374*/	r6.w = dot(vec3(r0.xyzx), vec3(-cb2.data[0].yzwy));
...
/*454*/	r5.xyz = (max(r0.wwww, r5.xyzx)).xyz;
/*455*/	r5.xyz = (-r5.xyzx + vec4(1.000000, 1.000000, 1.000000, 0.000000)).xyz;
/*456*/	r1.xyz = (r1.xyzx * r7.yyyy).xyz;
/*457*/	r1.xyz = (r1.xyzx * cb2.data[1].xyzx).xyz;
/*458*/	r1.xyz = (r5.xyzx * r1.xyzx).xyz;
/*459*/	r1.xyz = (r7.xxxx * r1.xyzx).xyz;
/*460*/	r1.xyz = (r6.xyzx * cb2.data[1].xyzx + r1.xyzx).xyz;
/*461*/	r1.xyz = (r3.zzzz * r1.xyzx + r8.xzwx).xyz;
...
/*466*/	r2.w = dot(vec3(-r3.xyzx), vec3(r0.xyzx));
/*467*/	r2.w = r2.w + r2.w;
/*468*/	r0.xyz = (r0.xyzx * -r2.wwww + -r3.xyzx).xyz;
/*469*/	r6.xyzw = (textureLod(s_environment, r0.xyzx.stp, r8.y)).xyzw;
/*470*/	r0.x = dot(vec3(r0.xyzx), vec3(-r3.xyzx));
/*471*/	r0.x = max(r0.x, 0.000000);
/*472*/	r0.x = log2(r0.x);
/*473*/	r0.x = r0.x * 10.000000;
/*474*/	r0.x = exp2(r0.x);
/*475*/	r0.x = r3.w * r0.x;
/*476*/	r0.x = r0.x * r5.w + r0.w;
/*477*/	r0.xyz = (r6.xyzx * r0.xxxx).xyz;
/*478*/	color0.xyz = (r0.xyzx * r2.xyzx + r1.xyzx).xyz;
