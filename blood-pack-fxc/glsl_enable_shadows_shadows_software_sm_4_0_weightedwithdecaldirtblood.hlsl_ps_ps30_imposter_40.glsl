...
// Fragment Shader
//
// id: 7067 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdecaldirtblood.hlsl_PS_ps30_imposter_40.glsl
//
...
/*47*/	r1.w = uintBitsToFloat((vsOut_T8.x < vsOut_T8.z) ? 0xffffffffu : 0x00000000u);
/*48*/	if(r1.w != 0) discard;
/*49*/	r2.yz = (vsOut_T1.xxyx * vec4(0.000000, 0.750000, 0.750000, 0.000000)).yz;
/*50*/	r2.yz = (r2.yyzy * cb1.data[2].xxyx + vsOut_T6.xxyx).yz;
/*51*/	r3.xyzw = (texture(s_decal_blood_map, r2.yzyy.st)).xyzw;
/*52*/	r1.w = saturate(r3.w + -1.000000);
/*53*/	r1.w = uintBitsToFloat((0.000000 < r1.w) ? 0xffffffffu : 0x00000000u);
/*54*/	if(floatBitsToUint(r1.w) != 0u) {
/*55*/	  r1.w = -r3.w + 1.000000;
/*56*/	  r1.w = saturate(-r1.w);
/*57*/	  r1.w = -r1.w + 1.000000;
/*58*/	  r1.w = -r1.w * r1.w + 1.000000;
/*59*/	  r1.w = r1.w * -0.600000 + 1.000000;
/*60*/	  r2.yzw = (r1.wwww * vec4(0.000000, 0.240000, 0.000000, 0.000000)).yzw;
/*61*/	  r1.w = saturate(dot(vec3(r0.xyzx), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000))));
...
/*64*/	  r3.xyz = (r0.xyzx * vec4(0.300000, 0.000000, 0.000000, 0.000000) + -r2.ywwy).xyz;
/*65*/	  r0.xyz = (r1.wwww * r3.xyzx + r2.yzwy).xyz;
/*66*/	  r2.xyzw = vec4(0.020000, 1.000000, 0.800000, 0.800000);
/*67*/	} else {
/*68*/	  r3.xyz = (r0.wwww * r1.xyzx).xyz;
/*69*/	  r2.yzw = (r3.xxyz * vec4(0.000000, -0.990000, -0.990000, -0.990000) + r1.xxyz).yzw;
/*70*/	}
...
/*74*/	r0.w = dot(vec3(r2.yzwy), vec3(vec4(0.212600, 0.715200, 0.072200, 0.000000)));
/*75*/	r1.xyz = (-r2.yzwy + r0.wwww).xyz;
/*76*/	r1.xyz = (vsOut_T7.yyyy * r1.xyzx + r2.yzwy).xyz;
