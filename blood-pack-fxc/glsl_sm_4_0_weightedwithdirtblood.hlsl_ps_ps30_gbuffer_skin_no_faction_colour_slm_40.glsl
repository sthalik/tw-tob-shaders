...
// Fragment Shader
//
// id: 2273 - fxc/glsl_SM_4_0_weightedwithdirtblood.hlsl_PS_ps30_gbuffer_skin_no_faction_colour_slm_40.glsl
//
...
/*52*/	r4.xyz = (r0.wwww * vsOut_T3.xyzx).xyz;
/*53*/	r0.w = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*54*/	r0.w = inversesqrt(r0.w);
/*55*/	r5.xyz = (r0.wwww * vsOut_T5.xyzx).xyz;
/*56*/	r0.w = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*57*/	r0.w = inversesqrt(r0.w);
/*58*/	r6.xyz = (r0.wwww * vsOut_T2.xyzx).xyz;
/*59*/	r5.xyz = (r1.yyyy * r5.xyzx).xyz;
/*60*/	r1.xyw = (r1.xxxx * r4.xyxz + r5.xyxz).xyw;
/*61*/	r1.xyz = (r1.zzzz * r6.xyzx + r1.xywx).xyz;
/*62*/	r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*63*/	r0.w = inversesqrt(r0.w);
/*64*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*65*/	r0.w = vsOut_T7.x * -r3.x + r3.x;
/*66*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*67*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*68*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
...
/*74*/	color2.xyz = saturate(vsOut_T7.yyyy * r4.xyzx + r2.xyzx).xyz;
/*75*/	color1.w = saturate(vsOut_T7.y * -r0.w + r0.w);
/*76*/	r2.xyz = (vsOut_T0.xyzx).xyz;
/*77*/	r2.w = 1.000000;
/*78*/	r0.w = dot(r2.xyzw, cb0.data[11].xyzw);
/*79*/	r1.w = dot(r2.xyzw, cb0.data[12].xyzw);
/*80*/	color3.x = r0.w / r1.w;
/*81*/	r0.w = max(abs(r1.z), abs(r1.y));
/*82*/	r0.w = max(r0.w, abs(r1.x));
/*83*/	r1.xyz = (r1.xyzx / r0.wwww).xyz;
/*84*/	r3.xyz = (r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*85*/	color0.xyzw = saturate(r3.xyzw);
/*86*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*87*/	color2.w = 0;
