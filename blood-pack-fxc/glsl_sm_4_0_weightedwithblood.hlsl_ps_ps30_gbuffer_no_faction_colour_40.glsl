...
// Fragment Shader
//
// id: 2583 - fxc/glsl_SM_4_0_weightedwithblood.hlsl_PS_ps30_gbuffer_no_faction_colour_40.glsl
//
...
/*43*/	r1.z = vsOut_T7.y * -r3.x + r3.x;
/*44*/	color1.w = saturate(vsOut_T7.x * -r1.z + r1.z);
/*45*/	r4.xyz = (r0.xyzx * vec4(5.000000, 5.000000, 5.000000, 0.000000) + vec4(0.200000, 0.200000, 0.200000, 0.000000)).xyz;
/*46*/	r4.xyz = (-r0.xyzx + r4.xyzx).xyz;
/*47*/	r0.xyz = saturate(vsOut_T7.xxxx * r4.xyzx + r0.xyzx).xyz;
/*48*/	r1.z = dot(vec3(vsOut_T3.xyzx), vec3(vsOut_T3.xyzx));
/*49*/	r1.z = inversesqrt(r1.z);
/*50*/	r4.xyz = (r1.zzzz * vsOut_T3.xyzx).xyz;
/*51*/	r1.z = dot(vec3(vsOut_T5.xyzx), vec3(vsOut_T5.xyzx));
/*52*/	r1.z = inversesqrt(r1.z);
/*53*/	r5.xyz = (r1.zzzz * vsOut_T5.xyzx).xyz;
/*54*/	r1.z = dot(vec3(vsOut_T2.xyzx), vec3(vsOut_T2.xyzx));
/*55*/	r1.z = inversesqrt(r1.z);
/*56*/	r6.xyz = (r1.zzzz * vsOut_T2.xyzx).xyz;
/*57*/	r1.yzw = (r1.yyyy * r5.xxyz).yzw;
/*58*/	r1.xyz = (r1.xxxx * r4.xyzx + r1.yzwy).xyz;
/*59*/	r1.xyz = (r0.wwww * r6.xyzx + r1.xyzx).xyz;
/*60*/	r0.w = dot(vec3(r1.xyzx), vec3(r1.xyzx));
/*61*/	r0.w = inversesqrt(r0.w);
/*62*/	r1.xyz = (r0.wwww * r1.xyzx).xyz;
/*63*/	r4.xyz = (vsOut_T0.xyzx).xyz;
/*64*/	r4.w = 1.000000;
/*65*/	r0.w = dot(r4.xyzw, cb0.data[11].xyzw);
/*66*/	r1.w = dot(r4.xyzw, cb0.data[12].xyzw);
/*67*/	r4.x = uintBitsToFloat((cb1.data[4].y != 0.000000) ? 0xffffffffu : 0x00000000u);
/*68*/	color3.x = r0.w / r1.w;
/*69*/	r0.w = max(abs(r1.z), abs(r1.y));
/*70*/	r0.w = max(r0.w, abs(r1.x));
/*71*/	r1.xyz = (r1.xyzx / r0.wwww).xyz;
/*72*/	r3.xyz = (r1.xyzx * vec4(0.500000, 0.500000, 0.500000, 0.000000) + vec4(0.500000, 0.500000, 0.500000, 0.000000)).xyz;
/*73*/	color0.xyzw = saturate(r3.xyzw);
/*74*/	color1.xyz = saturate(sqrt(r0.xyzx)).xyz;
/*75*/	r2.w = uintBitsToFloat(floatBitsToUint(r4.x) & uint(0x3c008081u));
/*76*/	color2.xyzw = saturate(r2.xyzw);
