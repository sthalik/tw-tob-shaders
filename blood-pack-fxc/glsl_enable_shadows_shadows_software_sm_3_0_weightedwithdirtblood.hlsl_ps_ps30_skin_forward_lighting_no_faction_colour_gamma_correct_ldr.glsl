...
// Fragment Shader
//
// id: 6353 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_3_0_weightedwithdirtblood.hlsl_PS_ps30_skin_forward_lighting_no_faction_colour_gamma_correct_LDR.glsl
//
...
/*12*/	r1.zw = (vsOut_T1.xxxy * cb5.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*25*/	r2.xy = (r2.xyxx * cb5.data[2].xyxx + vsOut_T6.xyxx).xy;
...
/*71*/	r5.w = 1.000000;
/*72*/	r2.y = dot(r5.xyzw, cb1.data[12].xyzw);
/*73*/	r6.xyz = (-cb2.data[35].xyzx * cb2.data[34].zzzz + vsOut_T0.xyzx).xyz;
/*74*/	r7.x = uintBitsToFloat((r2.y >= cb2.data[37].x) ? 0xffffffffu : 0x00000000u);
/*75*/	r7.y = uintBitsToFloat((r2.y >= cb2.data[38].x) ? 0xffffffffu : 0x00000000u);
/*76*/	r7.z = uintBitsToFloat((r2.y >= cb2.data[39].x) ? 0xffffffffu : 0x00000000u);
/*77*/	r7.w = uintBitsToFloat((r2.y >= cb2.data[40].x) ? 0xffffffffu : 0x00000000u);
...
/*263*/	r2.x = r2.x * 127.000000 + 1.600000;
/*264*/	r2.w = log2(r2.w);
/*265*/	r2.x = r2.w * r2.x;
/*266*/	r2.x = exp2(r2.x);
/*267*/	r2.x = min(r2.x, 1.000000);
/*268*/	r1.w = r1.w * r2.x;
/*269*/	r9.xyz = (r1.wwww * cb3.data[1].xyzx).xyz;
/*270*/	r9.xyz = (r8.xxxx * r9.xyzx).xyz;
/*271*/	r1.w = dot(vec3(-r7.xyzx), vec3(r3.xyzx));
/*272*/	r2.x = r1.w + r1.w;
/*273*/	r3.xyz = (r3.xyzx * -r2.xxxx + -r7.xyzx).xyz;
/*274*/	r3.xyz = (r3.xyzx * vec4(1.000000, 4.000000, 1.000000, 0.000000)).xyz;
/*275*/	r2.x = dot(vec3(r3.xyzx), vec3(r3.xyzx));
/*276*/	r2.x = inversesqrt(r2.x);
/*277*/	r3.xyz = (r2.xxxx * r3.xyzx).xyz;
