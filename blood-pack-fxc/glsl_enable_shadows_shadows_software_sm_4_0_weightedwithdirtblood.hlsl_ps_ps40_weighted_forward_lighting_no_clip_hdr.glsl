...
// Fragment Shader
//
// id: 6806 - fxc/glsl_ENABLE_SHADOWS_SHADOWS_SOFTWARE_SM_4_0_weightedwithdirtblood.hlsl_PS_ps40_weighted_forward_lighting_no_clip_HDR.glsl
//
...
/*27*/	r1.zw = (vsOut_T1.xxxy * cb3.data[2].xxxy + vsOut_T6.xxxy).zw;
...
/*111*/	  r7.xy = (uintBitsToFloat(uvec4(lessThan(r6.xyxx, cb1.data[floatBitsToUint(r3.y)+41u].xyxx)) * 0xffffffffu)).xy;
/*112*/	  r3.w = uintBitsToFloat(floatBitsToUint(r7.y) | floatBitsToUint(r7.x));
/*113*/	  r7.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r3.y)+41u].zwzz, r6.xyxx)) * 0xffffffffu)).xy;
...
/*155*/	  r2.w = intBitsToFloat(floatBitsToInt(r3.y) + int(1));
...
/*159*/	    r2.w = intBitsToFloat(floatBitsToInt(r3.y) << int(2));
/*160*/	    r5.w = vsOut_T0.w;
...
/*166*/	    r6.xy = (uintBitsToFloat(uvec4(lessThan(r5.xyxx, cb1.data[floatBitsToUint(r3.y)+42u].xyxx)) * 0xffffffffu)).xy;
/*167*/	    r5.w = uintBitsToFloat(floatBitsToUint(r6.y) | floatBitsToUint(r6.x));
/*168*/	    r6.xy = (uintBitsToFloat(uvec4(lessThan(cb1.data[floatBitsToUint(r3.y)+42u].zwzz, r5.xyxx)) * 0xffffffffu)).xy;
...
/*204*/	    r2.w = 1.000000;
/*205*/	  }
/*206*/	  r5.x = -cb1.data[floatBitsToUint(r3.y)+36u].x + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*207*/	  r5.y = r5.x * cb1.data[34].x;
/*208*/	  r5.x = -r5.x * cb1.data[34].x + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*209*/	  r5.x = r1.w + -r5.x;
...
/*215*/	  r2.w = -cb1.data[floatBitsToUint(r3.y)+36u].x + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*216*/	  r3.w = r2.w * cb1.data[34].y;
/*217*/	  r2.w = -r2.w * cb1.data[34].y + cb1.data[floatBitsToUint(r3.y)+37u].x;
/*218*/	  r2.w = r1.w + -r2.w;
/*219*/	  r2.w = saturate(r2.w / r3.w);
/*220*/	  r3.y = -r3.z + 1.000000;
/*221*/	  r3.z = r2.w * r3.y + r3.z;
/*222*/	}
...
/*228*/	r2.w = -r3.x + 1.000000;
/*229*/	r3.y = uintBitsToFloat((0.000000 < cb2.data[11].x) ? 0xffffffffu : 0x00000000u);
/*230*/	r3.w = dot(vec3(r5.xyzx), vec3(r1.xyzx));
/*231*/	r3.w = r3.w + r3.w;
/*232*/	r6.xyz = (r1.xyzx * -r3.wwww + r5.xyzx).xyz;
/*233*/	r7.xyz = (mix(vec4(1.000000, 1.000000, 273.000000, 0), vec4(0.004000, 360.000000, 1.000000, 0), greaterThan(floatBitsToUint(r3.yyyy), uvec4(0)))).xyz;
...
/*239*/	r5.w = -r0.w + r5.w;
/*240*/	r8.xzw = (r1.xxyz * vec4(1.000000, 0.000000, 4.000000, 1.000000)).xzw;
...
/*268*/	  r8.xzw = (r9.xxyz * r2.xxyz + r8.xxzw).xzw;
/*269*/	}
/*270*/	r6.w = dot(vec3(r1.xyzx), vec3(-cb2.data[0].yzwy));
...
/*287*/	  r3.x = r3.x * r3.x;
/*288*/	    r3.y = (floatBitsToUint(r3.y) > 0x00000000u) ? 0.995900 : -0.000100;
/*289*/	  r3.x = r3.x * r3.y + r7.x;
...
/*349*/	r6.xyz = (r2.xyzx * r6.xyzx).xyz;
...
/*362*/	r2.w = dot(vec3(-r3.xyzx), vec3(r1.xyzx));
/*363*/	r2.w = r2.w + r2.w;
/*364*/	r1.xyz = (r1.xyzx * -r2.wwww + -r3.xyzx).xyz;
/*365*/	r6.xyzw = (textureLod(s_environment, r1.xyzx.stp, r8.y)).xyzw;
/*366*/	r1.x = dot(vec3(r1.xyzx), vec3(-r3.xyzx));
/*367*/	r1.x = max(r1.x, 0.000000);
/*368*/	r1.x = log2(r1.x);
/*369*/	r1.x = r1.x * 10.000000;
/*370*/	r1.x = exp2(r1.x);
/*371*/	r1.x = r3.w * r1.x;
/*372*/	r0.w = r1.x * r5.w + r0.w;
/*373*/	r1.xyz = (r6.xyzx * r0.wwww).xyz;
/*374*/	color0.xyz = (r1.xyzx * r2.xyzx + r0.xyzx).xyz;
